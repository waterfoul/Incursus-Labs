...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'Ninvía_mensache', 'Nimbía_mensache' ),
	...
	'Listwiki_users'                 => array( 'Lista_d\'usuarios' ),
...
'tog-enotifwiki_usertalkpages' => 'Ninviar-me un correu quan cambee a mía pachina de descusión',
...
'wiki_userpage' => "Veyer a pachina d'usuario",
...
'nstab-main' => 'Pachina',
'nstab-wiki_user' => "Pachina d'usuario",
...
'wiki_userlogin' => 'Encetar una sesión / creyar cuenta',
'wiki_userloginnocreate' => 'Encetar una sesión',
...
'wiki_userlogin-resetlink' => "Ha xublidau os suyos datos d'acceso?",
'createaccountmail' => 'por correu electronico',
'createaccountreason' => 'Razón:',
'badretype' => 'As claus que ha escrito no son iguals.',
'wiki_userexists' => "O nombre d'usuario que ha escrito ya ye en uso.
...
'nosuchwiki_user' => 'No bi ha garra usuario clamato "$1".
...
'nosuchwiki_usershort' => 'No bi ha garra usuario con o nombre "$1". Comprebe si o nombre ye bien escrito.',
'nowiki_userspecified' => "Ha d'escribir un nombre d'usuario.",
'login-wiki_userblocked' => "Iste usuario ye bloqueyau. No se permite l'inicio de sesión.",
...
'wiki_usernamehasherror' => "O nombre d'usuario no puet contener simbolos hash",
...
'suspicious-wiki_userlogout' => "S'ha denegau a suya demanda de zarrar a sesión ya que pareix que la ninvió un navegador defectuoso u bell proxy amagau.",

# E-mail sending
'php-mail-error-unknown' => 'Error desconoixito en a función mail() de PHP',
'wiki_user-mail-no-addy' => 'Ha mirau de ninviar un mensache de correu sin una adreza de correu electronico.',
...
'passwordreset-wiki_username' => "Nombre d'usuario:",
...
'passwordreset-emailtext-wiki_user' => "L'usuario $1 en {{SITENAME}} ha demandau un recordatorio d'a información d'a suya cuenta en {{SITENAME}} ($4). {{PLURAL:$3|A cuenta d'usuario siguient ye asociata|As cuentas d'usuario siguients son asociatas}} a ista adreza de correu-e:
...
'wiki_userpage-wiki_userdoesnotexist' => 'A cuenta d\'usuario "<nowiki>$1</nowiki>" no ye rechistrada. Piense si quiere creyar u editar ista pachina.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'A cuenta d\'usuario "$1" no ye rechistrada.',
...
'wiki_usercssyoucanpreview' => "'''Consello:''' Faiga servir o botón «{{int:showpreview}}» ta fer una prebatina con o nuevo CSS antes de no grabar-lo.",
'wiki_userjsyoucanpreview' => "'''Consello:''' Faiga servir o botón «{{int:showpreview}}» ta fer una prebatina con o nuevo css/js antes de no grabar-lo.",
'wiki_usercsspreview' => "'''Remere que isto no ye que una previsualización d'o suyo CSS d'usuario.'''
'''Encara no s'ha alzato!'''",
'wiki_userjspreview' => "'''Remere que sólo ye previsualizando o suyo javascript d'usuario y encara no ye grabato!'''",
...
'''Encara no s'ha alzato!'''",
'wiki_userinvalidcssjstitle' => "'''Pare cuenta:''' No bi ha garra aparencia clamata \"\$1\". Remere que as pachinas presonalizatas .css y .js tienen un títol en minusclas, p.e. {{ns:wiki_user}}:Foo/vector.css en cuenta de {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(Esviellato)',
'note' => "'''Nota:'''",
...
'rev-deleted-wiki_user' => "(s'ha sacato iste nombre d'usuario)",
'rev-deleted-event' => "(acción borrata d'o rechistro)",
'rev-deleted-wiki_user-contribs' => "[nombre d'usuario u adreza IP elminada - edición amagada d'as contribucions]",
...
'revdelete-hide-wiki_user' => "Amagar o nombre/l'adreza IP d'o editor",
...
'diff-multi-manywiki_users' => "(No s'amuestra {{PLURAL:$1|una edición entremeya|$1 edicions entremeyas}} feitas por más {{PLURAL:$2|d'un usuario|de $2 usuarios}})",
...
'wiki_username' => "Nombre d'usuario:",
'uid' => "ID d'usuario:",
...
# wiki_user rights
'wiki_userrights' => "Confeguración d'os dreitos d'os usuarios",
'wiki_userrights-lookup-wiki_user' => "Confegurar collas d'usuarios",
'wiki_userrights-wiki_user-editname' => "Escriba un nombre d'usuario:",
'editwiki_usergroup' => "Editar as collas d'usuarios",
'editingwiki_user' => "S'está cambiando os permisos de l'usuario '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => "Editar as collas d'usuarios",
'savewiki_usergroups' => "Alzar as collas d'usuarios",
'wiki_userrights-groupsmember' => 'Miembro de:',
'wiki_userrights-groupsmember-auto' => 'Miembro implicito de:',
'wiki_userrights-groups-help' => "Puede cambiar as collas a on que bi ye iste usuario.
...
'wiki_userrights-reason' => 'Razón:',
'wiki_userrights-no-interwiki' => "No tiene premiso ta editar os dreitos d'usuario en atras wikis.",
'wiki_userrights-nodatabase' => 'A base de datos $1 no existe u no ye local.',
'wiki_userrights-nologin' => "Ha d'[[Special:wiki_userLogin|encetar una sesión]] con una cuenta d'almenistrador ta poder dar dreitos d'usuario.",
'wiki_userrights-notallowed' => "A suya cuenta no tien permisos ta asignar u desasignar permisos d'usuario.",
'wiki_userrights-changeable-col' => 'Grupos que puede cambiar',
'wiki_userrights-unchangeable-col' => 'Collas que no puede cambiar',
...
'right-move-rootwiki_userpages' => "Tresladar pachinas de l'usuario radiz",
...
'right-hidewiki_user' => "Bloqueyar un nombre d'usuario, amagando-lo d'o publico",
...
'right-editwiki_usercssjs' => "Editar os fichers CSS y JS d'atros usuarios",
'right-editwiki_usercss' => "Editar os fichers CSS d'atros usuarios",
'right-editwiki_userjs' => "Editar os fichers JS d'atros usuarios",
...
'right-wiki_userrights' => "Editar totz os dreitos d'usuario",
'right-wiki_userrights-interwiki' => "Editar os dreitos d'usuario d'os usuarios d'atros wikis",
...
'action-move-rootwiki_userpages' => "tresladar as pachinas de l'usuario radiz",
...
'action-wiki_userrights' => "cambiar totz os dreitos d'usuario",
'action-wiki_userrights-interwiki' => "cambiar os dreitos d'usuario en atros wikis",
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|usuario|usuarios}} cosirando]',
...
'statistics-header-wiki_users' => "Estatisticas d'usuarios",
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Usuarios]] rechistratos',
'statistics-wiki_users-active' => 'Usuarios activos',
'statistics-wiki_users-active-desc' => 'Usuarios que han feito qualsiquier acción en {{PLURAL:$1|o zaguer día|os zaguers $1 días}}',
...
'listwiki_users' => "Lista d'usuarios",
'listwiki_users-editsonly' => 'Amostrar nomás usuarios con edicions',
'listwiki_users-creationsort' => 'Ordenato por calendata de creyación',
'wiki_usereditcount' => '$1 {{PLURAL:$1|edición|edicions}}',
'wiki_usercreated' => '{{GENDER:$3|Creyato}} en  $1  a las $2',
'newpages' => 'Pachinas nuevas',
'newpages-wiki_username' => "Nombre d'usuario",
...
# Special:Log
'speciallogwiki_userlabel' => 'Fedor:',
...
'listwiki_usersfrom' => 'Amostrar usuarios que o nombre suyo prencipie por:',
'listwiki_users-submit' => 'Amostrar',
'listwiki_users-noresult' => "No s'ha trobato ixe usuario.",
'listwiki_users-blocked' => '({{GENDER:$1|bloqueyato|bloqueyata}})',

# Special:Activewiki_users
'activewiki_users' => "Lista d'usuarios activos",
'activewiki_users-intro' => "Ista ye una lista d'usuarios que han teniu bella actividat en os zaguers $1 {{PLURAL:$1|diya|diyas}}.",
'activewiki_users-count' => '$1 {{PLURAL:$1|edición|edicions}} en os zaguers {{PLURAL:$3|diya|$3 diyas}}',
'activewiki_users-from' => "Amostrar nombres d'usuario que prencipien por:",
'activewiki_users-hidebots' => 'Amagar robots',
'activewiki_users-hidesysops' => 'Amagar administradors',
'activewiki_users-noresult' => "No s'han trobato usuarios.",

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Rechistro de nuevos usuarios',
'newwiki_userlogpagetext' => "Isto ye un rechistro de creyación d'usuarios.",
...
'emailwiki_user' => 'Ninviar un correu electronico ta iste usuario',
...
'wiki_usermailererror' => "L'obchecto de correu retornó una error:",
'defemailsubject' => "Correu de {{SITENAME}} de l'usuario $1",
'wiki_usermaildisabled' => "S'ha desactivau o ninvío de correus electronicos a os usuarios",
'wiki_usermaildisabledtext' => 'En ista wiki no puet ninviar un correu-e a atros usuarios',
...
'emailwiki_username' => "Nombre d'usuario:",
'emailwiki_usernamesubmit' => 'Ninviar',
...
'emailwiki_userfooter' => 'Iste correu-e s\'ha ninviato por $1 ta $2 fendo servir a función "Email wiki_user" de {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Deixando un mensache de sistema.',
'wiki_usermessage-editor' => "Mensachero d'o sistema",
...
'revertpage-nowiki_user' => "S'han revertito as edicions feitas por (nombre d'usuario eliminato) a la zaguera versión feita por [[wiki_user:$1|$1]]",
...
'sp-contributions-wiki_userrights' => "administración de dreitos d'usuario",
...
'sp-contributions-wiki_username' => "Adreza IP u nombre d'usuario:",
...
'ipadressorwiki_username' => "Adreza IP u nombre d'usuario",
...
'ipbwatchwiki_user' => "Cosirar as pachinas d'usuario y de descusión d'iste usuario",
'ipb-disablewiki_usertalk' => 'Privar que iste usuario edite a suya propia pachina de discusión entre que sía bloqueyau',
...
'ipb-confirmhidewiki_user' => "Yes en momentos de bloqueyar a un usuario con a opción de supresión activada. Isto borrará o nombre d'usuario en todas as listas y dentradas de rechistro. Ye seguro de querer fer ixo?",
...
'blocklist-wiki_userblocks' => 'Amagar bloqueyos de cuenta',
...
'blocklist-nowiki_usertalk' => 'No puet editar a suya propia pachina de descusión',
...
'block-log-flags-nowiki_usertalk' => 'no puet editar a suya pachina de descusión',
...
'unblock-hidewiki_user' => "No se puede desbloqueyar a iste usuario, porque o suyo nombre d'usuario ye amagau.",
...
'cant-see-hidden-wiki_user' => "L'usuario a qui ye mirando de bloqueyar ya ye bloqueyau y amagau. Como que ye posible que vusté no tienga o dreito hidewiki_user, no puede veyer ni editar os bloqueyos d'ixe usuario.",
...
'movewiki_userpage-warning' => "'''Pare cuenta:''' ye en momentos de tresladar una pachina d'usuario. Pare cuenta en que nomás a pachina será tresladada peor l'usuario '''no''' será renombrau.",
...
'cant-move-wiki_user-page' => "No tien premiso ta tresladar pachinas d'usuario (fueras de subpachinas).",
'cant-move-to-wiki_user-page' => "No tiene premisos ta tresladar una pachina ta una pachina d'usuario (fueras de si ye ta una subpachina).",
...
'tooltip-pt-wiki_userpage' => "A suya pachina d'usuario",
'tooltip-pt-anonwiki_userpage' => "A pachina d'usuario de l'adreza IP dende a que ye editando",
...
'tooltip-t-emailwiki_user' => 'Ninviar un correu electronico ta iste usuario',
...
'tooltip-ca-nstab-wiki_user' => "Veyer a pachina d'usuario",
...
'sitewiki_user' => 'Usuario $1 de {{SITENAME}}',
'anonwiki_user' => '{{SITENAME}} usuario anonimo $1',
...
'anonwiki_users' => '{{SITENAME}} {{PLURAL:$2|usuario|usuarios}} anonimos $1',
...
'spambot_wiki_username' => 'Esporga de spam de MediaWiki',
...
'exif-wiki_usercomment' => "Comentarios de l'usuario",
...
'specialpages-group-wiki_users' => 'Usuarios y dreitos',
...
'logentry-newwiki_users-newwiki_users' => "$1 creyó una cuenta d'usuario",
'logentry-newwiki_users-create' => "$1 creyó una cuenta d'usuario",
'logentry-newwiki_users-create2' => "$1 creyó una cuenta d'usuario $3",
'logentry-newwiki_users-autocreate' => "S'ha creyau automaticament a cuenta $1",
'newwiki_userlog-byemail' => 'Clau ninviata por correu electronico',
