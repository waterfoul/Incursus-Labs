...
'tog-enotifwiki_usertalkpages' => 'Ig-e-mail ako kun may nagbag-o han akon pakli-himangrawon',
...
'views' => 'Mga paglantaw',
'toolbox' => 'Garamiton',
'wiki_userpage' => 'Kitaa in pakli hin gumaramit',
...
'youhavenewmessagesfromwiki_users' => 'May-ada ka $1 tikang ha {{PLURAL:$3|iba nga gumaramit|$3 mga gumaramit}} ($2).',
'youhavenewmessagesmanywiki_users' => 'May-ada ka $1 tikang ha damo nga mga gumaramit ($2).',
...
'nstab-main' => 'Pakli',
'nstab-wiki_user' => 'Pakli hin gumaramit',
...
'wiki_userlogin' => 'Magpasabot nga masakob / paghimo hin akawnt',
'wiki_userloginnocreate' => 'Magpasabot nga masakob',
'logout' => 'Gawas',
'wiki_userlogout' => 'Gawas',
...
'wiki_userlogin-resetlink' => 'Nangalimot han imo detalye han pagsakob?',
'createaccountmail' => 'Ha e-mail',
'createaccountreason' => 'Rason:',
'badretype' => 'Diri naangay an mga tigaman-pagsulod nga im ginbutang',
'wiki_userexists' => 'An agnay hiton gumaramit nga im ginbutang in gingamit na.
...
'nosuchwiki_user' => 'Waray gumaramit an may-ada ngaran nga "$1".
...
'nosuchwiki_usershort' => 'Waray nagamit it may ngaran nga "$1".
Kitaa kun amo it im pagbaybay.',
'nowiki_userspecified' => 'Dapat nim magbutang hin agnay hit gumaramit.',
'login-wiki_userblocked' => 'Ini nga gumaramit in ginpugngan.  Diri gintutugutan an pagsakob.',
...
'wiki_usernamehasherror' => 'Agnay-hin-gumaramit in diri puydi magkamay-ada hin mga hash karakter',
...
'passwordreset-wiki_username' => 'Agnay hiton gumaramit:',
...
'wiki_userpage-wiki_userdoesnotexist-view' => "An akawnt han gumaramit ni ''$1'' in diri nakarehistro.",
'updated' => '(Ginbag-ohan)',
'note' => "'''Pahibaro:'''",
...
'rev-deleted-wiki_user' => '(gintanggal an agnay hiton gumaramit)',
'rev-deleted-event' => '(gintanggal an talaan han mga buhat)',
'rev-deleted-wiki_user-contribs' => '[gintanggal an agnay-hit-gumaramit o IP address - an pagliwat in gintago tikang han mga amot]',
...
'prefs-wiki_user-pages' => 'Mga pakli hin gumaramit',
...
'youremail' => 'E-mail:',
'wiki_username' => 'Agnay hiton gumaramit:',
...
# wiki_user rights
'wiki_userrights' => 'Pagdudumara hin mga katungod han gumaramit',
'wiki_userrights-lookup-wiki_user' => 'Pagdumaraa han mga hugpo han gumaramit',
'wiki_userrights-wiki_user-editname' => 'Igbutang an agnay han gumaramit:',
'editwiki_usergroup' => 'Igliwat han mga hugpo han gumaramit',
'editingwiki_user' => "Igliliwat an mga katungod han gumaramit han gumaramit '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Igliwat an mga hugpo hin gumaramit',
'savewiki_usergroups' => 'Igtipig an mga hugpo han gumaramit',
'wiki_userrights-groupsmember' => 'Api han:',
'wiki_userrights-reason' => 'Katadungan:',
'wiki_userrights-no-interwiki' => '
Diri ka gintutugotan pagliwat han mga katungod han gumaramit ha iba nga mga wiki.',
'wiki_userrights-nodatabase' => 'Waray kaaagii an Database $1 o diri ini aada ha lokal.',
'wiki_userrights-changeable-col' => 'Mga hugpo nga puydi mo labtan',
'wiki_userrights-unchangeable-col' => 'Mga hugpo nga diri mo puydi labtan',

# Groups
'group' => 'Hugpo:',
'group-wiki_user' => 'Mga gumaramit',
...
'group-wiki_user-member' => '{{HENERO:$1|gumaramit}}',
'group-bot-member' => 'bot',
'group-sysop-member' => 'magdudumara',
'group-bureaucrat-member' => '{{GENDER:$1|burokrata}}',

'grouppage-wiki_user' => '{{ns:project}}:Mga gumaramit',
...
'right-move-rootwiki_userpages' => 'Igbalhin an gamot nga mga pakli han gumaramit',
...
'right-hidewiki_user' => 'Pugnga an uska agnay-hin-gumaramit, tago-a ito tikang ha publiko',
'right-unblockself' => 'Lugaring nga makakatanggal han pagpugong',
'right-editwiki_usercssjs' => 'Igliwat an kanan iba mga gumaramit nga mga paypay han CSS ngan JavaScript',
'right-editwiki_usercss' => 'Igliwat an kanan iba mga gumaramit nga mga paypay han CSS',
'right-editwiki_userjs' => 'Iliwat an kanan iba mga gumaramit nga paypay han JavaScript',
...
'right-wiki_userrights' => 'Igliwat an ngatanan nga mga katungod han gumaramit',
'right-wiki_userrights-interwiki' => 'Igliwat an mga katungod han gumaramit han mga gumaramit ha iba nga mga wiki',
...
'action-move-rootwiki_userpages' => 'Igbalhin an gamot nga mga pakli han gumaramit',
...
'action-wiki_userrights' => 'Igliwat an ngatanan nga mga katungod han gumaramit',
...
'statistics-header-wiki_users' => 'Mga estadistika han gumaramit',
...
'statistics-wiki_users' => 'Mga [[Special:Listwiki_users|gumaramit]] nga nakarehistro',
'statistics-wiki_users-active' => 'Mga gumaramit nga nanggigios',
'statistics-wiki_users-active-desc' => 'Mga gumaramit nga may-ada iginbuhat ha urhi nga {{PLURAL:$1|ka adlaw|$1 ka mga adlaw}}',
...
'listwiki_users' => 'Lista han mga gumaramit',
'listwiki_users-creationsort' => 'Ginsusunodsunod pinaagi han paghimo nga petsa',
'wiki_usereditcount' => '$1 {{PLURAL:$1|ka pagliwat|ka mga pagliwat}}',
'wiki_usercreated' => '{{GENDER:$3|Ginhimo}} han $1 ha $2',
'newpages' => 'Bag-o nga mga pakli',
'newpages-wiki_username' => 'Agnay hiton gumaramit:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Magburuhat:',
...
'listwiki_usersfrom' => 'Igpakita an mga nagamit nga nagtitikang ha:',
'listwiki_users-submit' => 'Pakit-a',
'listwiki_users-noresult' => 'Waray gumaramit nga nahiagian.',
'listwiki_users-blocked' => '(ginpugngan)',

# Special:Activewiki_users
'activewiki_users' => 'Taramdan hin mga gumaramit nga nanggigios',
'activewiki_users-hidebots' => 'Igtago an mga bot',
'activewiki_users-hidesysops' => 'Igtago an mga magdudumara',
'activewiki_users-noresult' => 'Waray gumaramit nga nahiagian.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Talaan han paghimo hin gumaramit',
'newwiki_userlogpagetext' => 'Ini an talaan han mga nagkahihimo nga mga gumaramit.',
...
# E-mail wiki_user
'emailwiki_user' => 'Ig-e-mail ini nga gumaramit',
'emailwiki_user-title-target' => 'Ig-E-mail ini nga {{HENERO:$1|gumaramit}}',
'emailwiki_user-title-notarget' => 'Gumaramit han e-mail',
'emailpage' => 'Gumaramit han e-mail',
'defemailsubject' => '{{SITENAME}} e-mail tikang kan gumaramit na hi "$1"',
'wiki_usermaildisabled' => 'Waray ginpagana an e-mail han gumaramit',
'wiki_usermaildisabledtext' => 'Diri ka makakapadangat hin e-mail ha iba nga mga gumaramit ha dinhi nga wiki',
'noemailtitle' => 'Waray e-mail address',
'nowikiemailtitle' => 'Waray gintutugutan nga e-mail',
'emailwiki_username' => 'Agnay hiton gumaramit:',
...
# wiki_user Messenger
'wiki_usermessage-summary' => 'Nabilin hin mensahe pansistema',
'wiki_usermessage-editor' => 'Mensahero han sistema',
...
'sp-contributions-wiki_username' => 'IP nga adres o nágámit:',
...
'ipadressorwiki_username' => 'IP address o agnay-hit-gumaramit:',
...
'ipb-disablewiki_usertalk' => 'Ayaw tugota ini nga gumaramit ha pagliwat han iya kalugaringon nga hiruhimangraw nga pakli samtang nakapugong hiya',
...
'blocklist-nowiki_usertalk' => 'diri nakakaliwat hin kalugaringong nga hiruhimangraw nga pakli',
...
'block-log-flags-nowiki_usertalk' => 'diri makakaliwat hit kalugaringon nga hiruhimangraw nga pakli',
...
'movewiki_userpage-warning' => "'''Pahimatngon:''' Tibalhin ka hin pakli hin gumaramit. Alayon pagtigaman nga an pakli là an mababalhin ngan an gumaramit in ''diri'' mababalyoan hin ngaran.",
...
'cant-move-wiki_user-page' => 'Diri ka gintutugotan pagbalhin hin mga pakli nga gumaramit (labot la tikang ha mga bahin-pakli).',
'cant-move-to-wiki_user-page' => 'Diri ka gintutugotan pagbalhin hin uska pakli pakada ha uska pakli hin gumaramit (labot la pakadto ha usa nga bahin-pakli han gumaramit).',
...
'tooltip-pt-wiki_userpage' => 'An imo pakli hin gumaramit',
...
'tooltip-t-emailwiki_user' => 'Padad-i hin e-mail ini nga nágámit',
...
'tooltip-ca-nstab-wiki_user' => 'Kitaa an pakli han gumaramit',
...
# Attribution
'sitewiki_user' => '{{SITENAME}} gumaramit $1',
'anonwiki_user' => '{{SITENAME}} waray nagpakilala nga gumaramit $1',
'othercontribs' => 'Ginbasihan ha binuhat ni $1.',
'others' => 'mga iba',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|gumaramit|mga gumaramit}} $1',
...
'pageinfo-firstwiki_user' => 'Naghimo han pakli',
'pageinfo-firsttime' => 'Adlaw han pagkahimo han pakli',
'pageinfo-lastwiki_user' => 'Giurhii nga nagliwat',
...
'specialpages-group-wiki_users' => 'Mga gumaramit ngan mga katungod',
...
'logentry-newwiki_users-newwiki_users' => '$1 in naghimo hin gumaramit nga akawnt',
'logentry-newwiki_users-create' => '$1 in naghimo hin gumaramit nga akawnt',
'logentry-newwiki_users-create2' => '$1 in naghimo hin gumaramit nga akawnt $3',
'logentry-newwiki_users-autocreate' => 'An akawnt nga $1 in lugaring nga nahimo',
'newwiki_userlog-byemail' => 'Ginpadangat an tigaman-pagsulod pinaagi han e-mail',
