...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'ایمیل کاربر' ),
	'Export'                    => array( 'درگیزگ' ),
	...
	'Listwiki_users'                 => array( 'لیست کاربر' ),
	'Lockdb'                    => array( 'کبلدب' ),
	'Log'                       => array( 'ورودان' ),
	...
	'Upload'                    => array( 'آپلود' ),
	'wiki_userlogin'                 => array( 'ورودکاربر' ),
	'wiki_userlogout'                => array( 'دربیگ کاربر' ),
	'wiki_userrights'                => array( 'حقوق کاربر' ),
	'Version'                   => array( 'نسخه' ),
...
'tog-enotifwiki_usertalkpages' => 'منآ ایمیل جن وهدی که صفحه ی گپ کاربر من عوض بیت',
...
'views' => 'چارگان',
'toolbox' => 'جعبه ابزار',
'wiki_userpage' => 'به گند صفحه کاربر',
...
اگه شی دلیل نهنت، شما شاید یک باگی ته نرم افزار در گهتگ. لطفا په مدیر گزارش دهیت،[[Special:Listwiki_users/sysop|administrator]]، ای URL یادداشت کینت.',
...
'titleprotected' => "ای عنوان محافظت بوتت چه سربیگ به وسیله  [[wiki_user:$1|$1]].
ای دلیل دییگ بیتت ''$2''.",
...
'wiki_userlogin' => 'ورود/شرکتن حساب',
'logout' => 'در بیگ',
'wiki_userlogout' => 'در بیگ',
...
'wiki_userexists' => 'وارد بیتگیت نام کاربری الان استفاده بیت.
...
'nosuchwiki_user' => 'هچ کاربری گون نام "$1" نیستن.
کاربری نام حرفش په هور و مزنی حساس انت.
وتی املايا چک کنیت یا [[Special:wiki_userLogin/signup|نوکین حسابی شرکنیت]].',
'nosuchwiki_usershort' => 'هچ کاربری گون نام  "$1"نیستن.
وتی املايا کنترل کنیت',
'nowiki_userspecified' => 'شما باید یک نام کاربری مشخص کنیت.',
...
'accmailtext' => "کلمه رمز په [[wiki_user talk:$1|$1]]  دیم دهگ بوت په $2.
...
اگه شما یک کاربر ناشناس ایت وی حس کنیت بی ربطین نظر مربوط شمی هست، لطفا [[Special:wiki_userLogin|وارد بیت ]] یا [[Special:wiki_userLogin/signup|حسابی شرکن]] دان چه هور بییگ گون ناسناسین کاربران پرهیز بیت.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'حساب کاربر "<nowiki>$1</nowiki>" ثبت نهنت. لطفا کنترل کنیت اگه شما لوٹیت ای صفحه یا شر/اصلاح کنیت.',
...
'wiki_usercssyoucanpreview' => "'''نکته:''' چه دکمه 'Show preview' په آزمایش کتن  CSS پیش چه ذخیره کتن استفاده کن",
'wiki_userjsyoucanpreview' => "'''نکته:''' چه دکمه 'Show preview' په آزمایش کتن  JS پیش چه ذخیره کتن استفاده کن",
'wiki_usercsspreview' => "''''بزان که شما فقط وتی CSS کاربری بازبینی کنین. هنگنت آیی ذخیره نه بوتت!''''",
'wiki_userjspreview' => "''''په یاد دار که شما فقط وتی کاربری  JavaScript بازبینی/آزمایش کنگیت، هنگت ذخیره نه بوتت!''''",
'wiki_userinvalidcssjstitle' => "'''هوژاری:''هچ جلدی نیست\"\$1\".
بزان که صفحات .css و .js چه عناوین گون هوردین حرف استفاده کننت، مثلا {{ns:wiki_user}}:Foo/vector.css بدل به په {{ns:wiki_user}}:Foo/Vector.css.",
...
طلف دگه سعی کنیت. اگر هنگت کار نکنت یک بری [[Special:wiki_userLogout|دربیت]] و پیدا وارد بیت.'''",
...
''' اگر شی یک قانونی تلاش اصلاحنت، دگه کوشش کنیت. اگر هنگت کار نکنت یک بری [[Special:wiki_userLogout|دربیت]] و دگه وارد بیت.'''",
...
شما تونیت برگردیت و یک پیشگین صفحه ای اصلاح کنیت، یا [[Special:wiki_userLogin|وارد بیت یان یک حسابی شرکنیت]].',
...
'undo-summary' => 'بازبینی برگردین $1 گون [[Special:مشارکتان/$2|$2]] ([[wiki_user talk:$2|گپ]] | [[Special:Contributions/$2|{{MediaWiki:Contribslink}}]])',

# Account creation failure
'cantcreateaccounttitle' => 'نه نونیت حساب شرکنت',
'cantcreateaccount-text' => "شرکتن حساب چی ای آدرس آی پی ('''$1''') محدود بوتت توسط [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(نام کاربری زورگ بیتت)',
...
'revdelete-hide-wiki_user' => 'پناه کن اصلاح کنوکء نام کاربری/آی پی',
...
'prefsnologintext' => 'شما بایدن  <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} وارد بیت]</span> په تنظیم کتن ترجیحات.',
...
# wiki_user rights
'wiki_userrights' => 'مدیریت حقوق کاربر',
'wiki_userrights-lookup-wiki_user' => 'مدیریت گروه کاربر',
'wiki_userrights-wiki_user-editname' => 'یک نام کاربری وارد کن',
'editwiki_usergroup' => 'اصلاح گروه کاربر',
'editingwiki_user' => "عوض کنت حقوق کاربر  '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'اصلاح گروه کاربر',
'savewiki_usergroups' => 'ذخیره گروه کاربر',
'wiki_userrights-groupsmember' => 'عضو انت:',
'wiki_userrights-groups-help' => 'شما شاید گروه ای کاربرء هست ته:
...
'wiki_userrights-no-interwiki' => 'شما را اجازت نیست دان حقوق کاربر ته دگ ویکی آن اصلاح کنیت.',
'wiki_userrights-nodatabase' => 'دیتابیس $1  موجود نهنت یا محلی نهنت.',
'wiki_userrights-nologin' => 'شما باید [[Special:wiki_userLogin|وارد بیت]]  گون حساب مدیریتی په مشخص کتن حقوق کاربر.',
'wiki_userrights-notallowed' => 'شمی حساب اجازت په مشخص کتن حقوق کاربر نیست.',
'wiki_userrights-changeable-col' => 'گروهانی که شما تونیت عوض کنیت',
'wiki_userrights-unchangeable-col' => 'گروهانی که شما نه نونیت عوض کنیت',

# Groups
'group' => 'گروه:',
'group-wiki_user' => 'کابران',
...
'grouppage-wiki_user' => '{{ns:project}}:کابران',
...
'right-move-rootwiki_userpages' => 'جاه په جاه کتن صفحات کاربری اصلی',
...
'right-hidewiki_user' => 'یک نام کاربری منع کن، آیی چه عام پناه کنگنت',
...
'right-editwiki_usercssjs' => 'دگر کابرانی فایلان  CSS  و JS اصلاح کن',
'right-editwiki_usercss' => 'دگر کابرانی فایلان CSS اصلاح کن',
'right-editwiki_userjs' => 'دگر کابرانی فایلان JS اصلاح کن',
...
'right-wiki_userrights' => 'اصلاح کل حقوق کاربری',
'right-wiki_userrights-interwiki' => 'اصلاح حقوق کابرانی کابران دگه ویکی انء',
...
'action-move-rootwiki_userpages' => 'جاه په جاه کتن صفحات کاربری اصلی',
...
'action-wiki_userrights' => 'اصلاح کل حقوق کاربر',
'action-wiki_userrights-interwiki' => 'اصلاح حقوق کاربری کاربران ته دگه ویکیء',
...
'newpageletter' => 'ن',
'boteditletter' => 'ب',
'number_of_watching_wiki_users_pageview' => '[$1 چارگنت {{PLURAL:$1|کاربر|کابران}}]',
...
'uploadnologintext' => 'شما بایدن [[Special:wiki_userLogin|واردبیت]] په آپلود کتن فایل.',
...
لطفا گون یک [[Special:Listwiki_users/sysop|مدیر]].تماس گریت.',
...
اگر مشکل ادامه داشت، گون [[Special:Listwiki_users/sysop|مدیر]]ء تماس گریت.',
...
'statistics-header-wiki_users' => 'آمار کاربر',
...
'statistics-wiki_users' => 'ثبت نامی [[Special:Listwiki_users|wiki_users]]',
'statistics-wiki_users-active' => 'فعالین کاربر',
'statistics-wiki_users-active-desc' => 'کاربرانی که ته پیشگین {{PLURAL:$1|روچ|$1 روچان}} کاری اش کتت',
...
'listwiki_users-editsonly' => 'فقط کاربرانی که اصلاحاتش هست پیش بدار',
'listwiki_users-creationsort' => 'ترتیب په اساس تاریح',
'wiki_usereditcount' => '$1 {{PLURAL:$1|اصلاح|اصلاحات}}',
'wiki_usercreated' => 'شربوتگ  $1 ته $2',
...
'listwiki_usersfrom' => 'پیشدار کابرانی که شروع بنت گون:',
'listwiki_users-submit' => 'پیش دار',
'listwiki_users-noresult' => 'هچ کابری در گیزگ نه بوت.',
'listwiki_users-blocked' => '(بند بیتگ)',

# Special:Activewiki_users
'activewiki_users' => 'لیست کاربران فعال',
'activewiki_users-count' => '$1 {{PLURAL:$1|اصلاح|اصلاح}} نوکین',
'activewiki_users-from' => 'پیشدار کاربرانی که شروع بنت گون :‌',
'activewiki_users-noresult' => 'هچ کاربری درگیزگ نه بیت',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'ورود شرکتن کاربر',
'newwiki_userlogpagetext' => '.شی یک ورودی چه شرکتن کاربر',
...
'mailnologintext' => 'شما بایدن [[Special:wiki_userLogin|وارد بیت]] و یک معتبرین آدرس ایمیلی داشته بیت ته وتی [[Special:Preferences|ترجیحات]] په دیم داتن ایمیل په دگه کاربران',
'emailwiki_user' => 'په ای کابر ایمیل دیم دی',
...
'wiki_usermailererror' => 'شی ایمیل حطا پیش داشت',
...
'emailwiki_userfooter' => 'این نامه الکترونیکی گون استفاده چه ویژگی «پست الکترونیکی به کاربر» {{SITENAME}} گون $1 په $2 دیم دهگ بوتت.',
...
'watchnologintext' => 'شما بایدن  [[Special:wiki_userLogin|وارد بیت]] په تغییر داتن وتی لیست چارگء',
...
'alreadyrolled' => 'نه تونیت ترینیت اهری اصلاح چه  [[:$1]] گون  [[wiki_user:$2|$2]] ([[wiki_user talk:$2|گپ]] | {{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]);
یکی دگه پیش تر صفحهء اصلاح کتت یا بری گردینت.

آهری اصلاح توسط [[wiki_user:$3|$3]] ([[wiki_user talk:$3|Talk]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "خلاصه اصلاح ات:\"''\$1''\".",
'revertpage' => 'ترینت اصلاحات توسط  [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|گپ کن]])په آهری بازبینی گون [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'مدیریت کاربرنی حق',
'sp-contributions-search' => 'گردگ په مشارکتان',
'sp-contributions-wiki_username' => 'آدرس آی پی یا نام کاربری',
...
'ipadressorwiki_username' => 'آدرس آي پی یا نام کاربری:',
'ipbexpiry' => 'وهد هلگ:',
'ipbreason' => 'دلیل:',
...
'ipbwatchwiki_user' => 'بچار ای کاربرء صفحات گپ و کاربری آ',
...
'unblocked' => '[[wiki_user:$1|$1]] رفع محدودیت بیت.',
...
'blocklist-nowiki_usertalk' => 'نه تونیت وتی صفحه گپءاصلاح کنت',
...
'autoblocker' => 'اتوماتیک کبلت په چی که شمی آدرس آی پی نوکی استفاده بوتت گون  "[[wiki_user:$1|$1]]".
...
'block-log-flags-nowiki_usertalk' => 'نه تونیت صفحه بحثء وتیء اصلاح کنیت',
...
'movenologintext' => 'شما بایدن یک ثبت نامی کاربری بیت و [[Special:wiki_userLogin|وارد بیت]]په جاه په جاه کتن یک صفحه.',
'movenotallowed' => 'شما را اجازت به جاه په جاه کتن صفحات نیست.',
'movenotallowedfile' => 'شما را اجارت په جاه په جاه کتن فایلان نیستن.',
'cant-move-wiki_user-page' => 'شما را اجازت نیستن که صفحات کاربر اصلیء جاه په جاه کنیت.',
'cant-move-to-wiki_user-page' => 'شمارء اجازت نیستن که یک صفحه ی په صفحه کاربری جاه په جاه کنیت( غیر چه زیر صفحه کاربر).',
...
'tooltip-pt-wiki_userpage' => 'شمی صفحات',
'tooltip-pt-anonwiki_userpage' => 'صفحه کاربر په آی پی که شما هنو اصلاح کنیت په داب',
...
'tooltip-t-emailwiki_user' => 'په ای کاربر یک ایمیل دیم دی',
...
'tooltip-ca-nstab-wiki_user' => 'چارگ صفحه کاربر',
...
'spambot_wiki_username' => 'اسپم پاک کنوک مدیا وی کی',
...
'exif-wiki_usercomment' => 'نظرات کاربر',
...
'confirmrecreate' => "کاربر [[wiki_user:$1|$1]] ([[wiki_user talk:$1|گپ]]) ای صفحهء حذف کتت بعد چه شی که شما اصلاح شروع کتت گون ای دلیل:
: ''$2''
...
'specialpages-group-wiki_users' => 'کابران و حقوق',
...
'newwiki_userlog-byemail' => 'کلمه رمز گون ایمیل دیم دهگ بوت',
