...
'tog-enotifwiki_usertalkpages' => 'Почтэм къэӀохун аккаунтым и напэкӀуэцӀ тепсэлъыхьыгъуэм и зэхъуэкӀыгъуэхэм',
...
'wiki_userpage' => 'ЦӀыхухэтым и напэкӀуэцӀым еплъын',
...
[[Special:Listwiki_users/sysop|Тхьэмадэм]] ар къыхуэӀоху, URL-ри игъусу.',
...
'titleprotected' => 'Апхуэдэ цӀэ зиӀэ напэкӀуэцӀ щӀыныр цӀыхухэт [[wiki_user:$1|$1]]-м триубыда.
Ар къызхэкӀар: "\'\'$2\'\'".',
...
Уихьэжьыфыну {{grammar:genitive|{{SITENAME}}}} зыкъумгъэцӀыху иэ [[Special:wiki_userLogin|зыкъегъэцӀыхун аргуэру]] уи цӀэмкӀэ иэ нэмыщӀымкӀэ.
...
'wiki_userlogin' => 'Ихьэн/зыхэтхэн',
'wiki_userloginnocreate' => 'Системэм зыкъегъэцӀыхуын',
'logout' => 'ИкӀыжын',
'wiki_userlogout' => 'ИкӀыжын',
...
'wiki_userexists' => 'ЦыхухэтыцӀэ иптхар пэмыкӀ гуэрэм къегъэсэбэп.
ПэмыкӀ цӀэ къыхэх.',
...
'nosuchwiki_user' => '"$1" цӀэ зезыхьэ цӀыхухэт щыӀэкъым.
ЦӀыхухэтыцӀэхэр гурышхъу щытхэ хьэрыф регистырымкӀэ.
ЦӀэр тэрэзу птхамэ еплъ иэ [[Special:wiki_userLogin/signup|аккаунт щӀэуэ щӀы]].',
'nosuchwiki_usershort' => 'ЦӀыхухэт "$1" щыӀэкъым.
ЦӀэр тэрэзу итхамэ еплъ.',
'nowiki_userspecified' => 'ЦӀыхухэтыцӀэр иптхэн хуэй.',
'login-wiki_userblocked' => 'Мы цӀыхухэтыр теубыдауэ щытщ. Ихьэныр хуадэкъым.',
...
'wiki_usernamehasherror' => 'ЦӀыхухэтыцӀэм дэмыгъэ зэтебза хэт хъунукъым',
...
'suspicious-wiki_userlogout' => 'Сеанс щыгъэтын узкӀэлъэӀуар гъэзэнщӀакъым, мыкорректнэ браузэрым иэ кэш зыщӀ проксим иригъэхьа хуэду ещхьщ.',
...
'accmailtext' => "ЦӀыхухэт [[wiki_user talk:$1|$1-м]] щхьэкӀэ дэмыгъэ зэхэдзыгъэншу парол зэхэгъувар $2 адресым егъэхьа.
...
Аноним цӀыхухэту ущытмэ, тхыгъэ къыпхуэкӀуауэ уигугъэмэ, [[Special:wiki_userLogin/signup|аккаунт щӀы]] иэ [[Special:wiki_userLogin|системэм зыкъегъэцӀыху]], япэкӀэ хэукъуэгъуэ пэмыкӀ цӀыхухэт анэнимхэм ям ухэмыхуэн щхьэкӀэ.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Аккаунт «<nowiki>$1</nowiki>» щыӀэкъым. У арэзыуэ ущыт мы напэкӀуэцӀыр быщӀыным иэ зэпхъуэкӀыным.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'ЦӀыхухэт «$1»-м и аккаунтым регистрациэ иӀэкъым.',
...
'wiki_usercssyoucanpreview' => "'''ДэӀэпыкъуэгъу псалъэ.''' Текъузэ «{{int:showpreview}}» уи CSS-теплъэм еплъын щхьэкӀэ итхэным ипэкӀэ.",
'wiki_userjsyoucanpreview' => "'''ДэӀэпыкъуэгъу псалъэ.''' Текъузэ «{{int:showpreview}}» уи JS-теплъэ щӀэм еплъыным щхьэкӀэ итхэным ипэкӀэ.",
'wiki_usercsspreview' => "'''Гу лъытэ, мыр япэ-еплъ къуэдейщ уи CSS-теплъэм, иджыри итхауэ щыткъым!'''",
'wiki_userjspreview' => "'''Гу лъытэ, мыр япэ-еплъ къуэдейщ уи javascript-теплъэм, иджыри итхауэ щыткъым!'''",
...
'''Иджыри итхауэ щыткъым!'''",
'wiki_userinvalidcssjstitle' => "'''Гу лъытэ:''' лэжьыгъэр зтеухуа «$1»-р къэгъуэтауэ щыткъым. Зыщумыгъэгъупшэ, лэжьыгъэ напэкӀуэцӀ .css, .js-хэм цӀэ яӀэн хуэйхэ, сэтыр хьэрыф нэхъ яхэмыту, мыбым хуэду «{{ns:wiki_user}}:Згуэрэ/vector.css», щытын хуэйхэкъым мыбым хуэду: «{{ns:wiki_user}}:Згуэрэ/Vector.css».",
...
Хэукъуэгъуэр иджыри зэ къыхэкӀмэ, системэм [[Special:wiki_userLogout|икӀи]] аргуэру зыкъегъэцӀыху.'''",
...
ЕтӀуанэ гъэтэрэзыгъуэри мыхъумэ, системэм [[Special:wiki_userLogout|икӀи]] аргуэру зыкъегъэцӀыху.'''",
...
Бгъэзэжу, напэкӀуэцӀ щыӀэр бгъэтэрэзыфынущ, [[Special:wiki_userLogin|системэмэ зыкъегъэцӀыхун иэ щӀэуэ аккаунт щӀын]].',
...
'undo-summary' => 'Гъэтэрэзыгъуэ хэхыжыныр $1 цӀыхухэт [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|тепсэлъыхьыгъуэ]])',

# Account creation failure
'cantcreateaccounttitle' => 'Аккаунтыр щӀыфынукъым',
'cantcreateaccount-text' => "Аккаунт щӀыныр мы IP-адресыкӀэ (<b>$1</b>) триубыдауэ щытщ [[wiki_user:$3|цӀыхухэт $3]].
...
'rev-deleted-wiki_user' => '(Ӏэдакъэм и цӀэр ихащ)',
'rev-deleted-event' => '(тхыгъэр ихащ)',
'rev-deleted-wiki_user-contribs' => '[цӀыхухэтым и цӀэр иэ и IP-адресыр ихахэ — гъэтэрэзыгъуэр напэкӀуэцӀ хэлъхьэм ихах]',
...
'revdelete-hide-wiki_user' => 'Ӏэдакъэм и цӀэр гъэпшкӀун',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|курыт версиэ $1-м ер гъэлъэгъуащ|курыт версиэхэр $1-м ер гъэлъэгъуащ}}, щӀахэщ $2 нэхъыбэу {{PLURAL:$2|цӀыхухэт|цӀыхухэтхэм}})',
...
'prefsnologintext' => 'ЦӀыхухэтым и зэгъэзэхуэгъуэхэм уелэжьын щхьэкӀэ системэм <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} зыкъебгъэцӀыхун хуэй]</span>',
...
'newwiki_userlogpage' => 'ЦӀыхухэтхэм я регистрациэ тхылъ',

# Special:ListGroupRights
'listgrouprights-members' => '(гупым и тхылъ)',

# E-mail wiki_user
'emailwiki_user' => 'Тхыгъэ хуэтхын',
...
'sp-contributions-wiki_username' => 'IP-адрес иэ хэтым и цIэр:',
...
'tooltip-pt-wiki_userpage' => 'Уи хэтыгъуэм и напэкӀуэцӀ',
...
'tooltip-t-emailwiki_user' => 'Мы хэтым и e-mail-м хуэтхын',
...
'tooltip-ca-nstab-wiki_user' => 'ЦӀыхухэтым и напэкӀуэцӀыр къэгъэлъэгъуэн',
