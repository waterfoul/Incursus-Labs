...
'tog-enotifwiki_usertalkpages' => '議新，遣函',
...
'youhavenewmessagesfromwiki_users' => '子有 $1 自 {{PLURAL:$3|another wiki_user|$3 簿戶也}} ($2)。',
'youhavenewmessagesmanywiki_users' => '子有 $1 自多簿戶 ( $2 )',
...
'wiki_userlogin' => '登簿、增簿',
'wiki_userloginnocreate' => '登簿',
'logout' => '去簿',
'wiki_userlogout' => '去簿',
'notloggedin' => '尚未登簿',
'nologin' => '無簿乎？往$1。',
...
'gotaccount' => '有簿矣哉？往$1。',
'gotaccountlink' => '登簿',
'wiki_userlogin-resetlink' => '君忘登簿所需爾？',
'createaccountmail' => '同郵',
'createaccountreason' => '因：',
'badretype' => '符節不合也。',
'wiki_userexists' => '簿名存矣，惠更之',
'loginerror' => '登簿誤然',
...
'nosuchwiki_user' => '查無此人。',
'nosuchwiki_usershort' => '查無"$1"，惠核之。',
'nowiki_userspecified' => '簿名須也',
'login-wiki_userblocked' => '此簿已被封。登無簿也。',
...
如簿誤增，爾可略之。',
'wiki_usernamehasherror' => '簿名無含切細符也',
'login-throttled' => '爾多試於此簿登中。
請候再試之。',
'loginlanguagelabel' => '語：$1',
'suspicious-wiki_userlogout' => '爾欲無離也，可由壞瀏覽器或快枝代理呈送之。',
...
'wiki_userpage-wiki_userdoesnotexist' => '「<nowiki>$1</nowiki>」之簿未增也。請建纂本頁前查之。',
'wiki_userpage-wiki_userdoesnotexist-view' => '「$1」之簿未增也。',
...
'wiki_usercssyoucanpreview' => "'''訣：'''CSS應先「{{int:showpreview}}」而後存。",
'wiki_userjsyoucanpreview' => "'''訣：'''JavaScript應先「{{int:showpreview}}」而後存。",
'wiki_usercsspreview' => "'''預覽簿CSS。'''
'''尚未儲焉！'''",
'wiki_userjspreview' => "'''預覽簿JavaScript。'''
'''尚未儲焉！'''",
'sitecsspreview' => "'''預覽此CSS。'''
'''尚未儲焉！'''",
'sitejspreview' => "'''預覽此JavaScript。'''
'''尚未儲焉！'''",
'wiki_userinvalidcssjstitle' => "'''警：'''\"\$1\"無此面版。自製者，全名務小寫，如{{ns:wiki_user}}:Foo/vector.css 而非{{ns:wiki_user}}:Foo/Vector.css",
'updated' => '（新）',
'note' => "'''註'''",
...
'rev-deleted-wiki_user' => '（此簿刪矣）',
'rev-deleted-event' => '（此誌刪矣）',
'rev-deleted-wiki_user-contribs' => '[簿名或IP地址已除 - 從貢藏纂]',
...
'revdelete-hide-wiki_user' => '簿、IP址以藏',
...
'diff-multi-manywiki_users' => '（$2多作未示之審有$1）',
...
# wiki_user rights
'wiki_userrights' => '秉治權任',
'wiki_userrights-lookup-wiki_user' => '司社',
'wiki_userrights-wiki_user-editname' => '簿名：',
'editwiki_usergroup' => '治社',
'editingwiki_user' => "正纂簿'''[[wiki_user:$1|$1]]''' （[[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]]） 之權",
'wiki_userrights-editwiki_usergroup' => '治社',
'savewiki_usergroups' => '定之',
'wiki_userrights-groupsmember' => '有員：',
'wiki_userrights-groupsmember-auto' => '固有員：',
'wiki_userrights-groups-help' => '足下可為者有二︰

*賦其權，此其一也；
*去其職，此其二也。

*而星號在前者，一旦賦予，不可去也，宜慎焉。',
'wiki_userrights-reason' => '因：',
'wiki_userrights-no-interwiki' => '爾無權改他山wiki之簿權也。',
'wiki_userrights-nodatabase' => '資料庫$1無存或非本地也。',
'wiki_userrights-nologin' => '爾以有秩乲簿[[Special:wiki_userLogin|登]]後以定簿之權也。',
'wiki_userrights-notallowed' => '爾之簿無權定簿之權也。',
'wiki_userrights-changeable-col' => '爾所管轄',
'wiki_userrights-unchangeable-col' => '非爾所轄',
...
'grouppage-wiki_user' => '{{ns:project}}:簿',
...
'right-move-rootwiki_userpages' => '遷根齋',
'right-movefile' => '遷檔',
...
'right-editwiki_usercssjs' => '纂他簿之CSS與JavaScript檔',
'right-editwiki_usercss' => '纂他簿之CSS檔',
'right-editwiki_userjs' => '纂他簿之JavaScript檔',
...
'right-wiki_userrights' => '纂簿權',
'right-wiki_userrights-interwiki' => '纂另wiki他簿之權',
...
'action-move-rootwiki_userpages' => '移根齋',
'action-movefile' => '移檔',
'action-upload' => '貢檔',
'action-reupload' => '蓋現檔',
...
'action-wiki_userrights' => '纂全權',
'action-wiki_userrights-interwiki' => '纂他wiki上之權',
...
'newpageletter' => '新',
'boteditletter' => '僕',
'number_of_watching_wiki_users_pageview' => '[放有$1哨]',
'rc_categories_any' => '任',
...
'statistics-header-wiki_users' => '有簿彙統',
...
'statistics-wiki_users' => '註[[Special:Listwiki_users|簿]]',
'statistics-wiki_users-active' => '活簿',
'statistics-wiki_users-active-desc' => '早$1日前更動之簿',
...
'listwiki_users' => '點簿',
'listwiki_users-editsonly' => '只示有纂之簿',
'listwiki_users-creationsort' => '按先後列之',
'wiki_usereditcount' => '$1纂',
'wiki_usercreated' => '建於$1$2',
'newpages' => '新灶',
'newpages-wiki_username' => '簿名：',
'ancientpages' => '陳年',
'move' => '遷',
'movethispage' => '遷此頁',
...
'listwiki_usersfrom' => '始簿：',
'listwiki_users-submit' => '見',
'listwiki_users-noresult' => '尋無簿。',
'listwiki_users-blocked' => '（已禁）',

# Special:Activewiki_users
'activewiki_users' => '躍簿',
'activewiki_users-intro' => '此乃為近$1天內之躍簿也。',
'activewiki_users-count' => '$3天內之$1易',
'activewiki_users-from' => '示簿始於：',
'activewiki_users-hidebots' => '藏僕',
'activewiki_users-hidesysops' => '藏有秩',
'activewiki_users-noresult' => '無簿矣。',

# Special:Log/newwiki_users
'newwiki_userlogpage' => '誌簿',
'newwiki_userlogpagetext' => '此為誌簿之記也',
...
'wiki_usermailererror' => '驛報有誤：',
'defemailsubject' => '{{SITENAME}}來書',
'wiki_usermaildisabled' => '無他人之郵',
'wiki_usermaildisabledtext' => '無發電郵於wiki上之他戶也',
'noemailtitle' => '無郵',
'noemailtext' => '此君無郵。',
...
'emailsent' => '書遣矣',
'emailsenttext' => '書遣矣',
'emailwiki_userfooter' => '此捎由$1給$2經{{SITENAME}}之「捎君」發矣。',

# wiki_user Messenger
'wiki_usermessage-summary' => '留系信。',
'wiki_usermessage-editor' => '系信',
...
'revertpage-nowiki_user' => '去（刪簿）之作為[[wiki_user:$1|$1]]之本耳',
...
'block-log-flags-nowiki_usertalk' => '禁己議',
...
'cant-see-hidden-wiki_user' => '簿禁或藏矣。
爾無藏之權，無視纂禁也。',
...
膾炙遷焉，禍生不測；戒慎行之。",
'movearticle' => '遷文：',
'movewiki_userpage-warning' => "'''警：'''爾將遷頁齋。注之遷齋後之簿名乃為''無''變也。",
'movenologin' => '未登簿',
'movenologintext' => '遷文須[[Special:wiki_userLogin|登簿]]。',
'movenotallowed' => '無准遷檔也。',
'cant-move-wiki_user-page' => '無動自齋（除字頁）。',
'cant-move-to-wiki_user-page' => '無動至齋（除字頁）。',
'newtitle' => '至新題：',
'move-watch' => '派哨至自與至之頁',
'movepagebtn' => '遷文',
'pagemovedsub' => '遷成矣',
...
'tooltip-pt-wiki_userpage' => '述平生、紹身家、銘字號',
'tooltip-pt-anonwiki_userpage' => '君IP之舍',
...
'tooltip-t-emailwiki_user' => '言未猶，書信捎',
...
'tooltip-ca-nstab-wiki_user' => '返齋寮',
...
'sitewiki_user' => '{{SITENAME}}有簿者$1',
'anonwiki_user' => '{{SITENAME}}有匿簿者$1',
'lastmodifiedatby' => '$1$2，$3新易此頁。',
'othercontribs' => '$1主撰',
'others' => '他',
'sitewiki_users' => '{{SITENAME}}有{{PLURAL:$2|簿|簿}}者$1',
'anonwiki_users' => '{{SITENAME}}有匿{{PLURAL:$2|簿|簿}}者$1',
'creditspage' => '頁贊',
'nocredits' => '本頁未有贊信也。',
...
'spambot_wiki_username' => 'MediaWiki清濫',
...
'specialpages-group-wiki_users' => '簿與權',
