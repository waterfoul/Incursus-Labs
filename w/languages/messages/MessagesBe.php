...
'tog-enotifwiki_usertalkpages' => 'Слаць эл.пошту пра мены ў маёй размоўнай старонцы',
...
Паведамце пра гэта, разам з праблемным URL, аднаму з [[Special:Listwiki_users/sysop|адміністратараў]].',
...
'titleprotected' => "Назва засцерагаецца ад стварэння; ахова пастаўлена ўдзельнікам: [[wiki_user:$1|$1]].
...
Можна працягваць працу на {{SITENAME}} ананімна, або можна [[Special:wiki_userLogin|ўвайсці ў сістэму ізноў]], пад тым самым або пад іншым удзельніцкім імем. Заўважце, што некаторыя старонкі могуць паказвацца так, быццам вы яшчэ не выйшлі; у такім разе трэба ачысціць кэш вашага браўзера.",
...
'wiki_userlogin' => 'Увайсці ў сістэму / стварыць рахунак',
'wiki_userloginnocreate' => 'Увайсці',
'logout' => 'Выйсці з сістэмы',
'wiki_userlogout' => 'Выйсці з сістэмы',
...
'wiki_userlogin-resetlink' => 'Забыліся даныя для ўваходу?',
'createaccountmail' => 'праз эл.пошту',
'createaccountreason' => 'Прычына:',
'badretype' => 'Уведзеныя паролі не аднолькавыя.',
'wiki_userexists' => 'Такое імя ўдзельніка ўжо занятае.
...
'nosuchwiki_user' => 'Няма ўдзельніка з імем "$1". Праверце правільнасць напісання або [[Special:wiki_userLogin/signup|стварыце новы рахунак]]. Вялікія і малыя літары ў такіх імёнах лічацца рознымі.',
'nosuchwiki_usershort' => 'Удзельніка з імем "$1" не існуе. Праверце яго напісанне.',
'nowiki_userspecified' => 'Вы мусіце вызначыць імя ўдзельніка.',
'login-wiki_userblocked' => 'Гэты карыстальнік заблакаваны. Лагін не дапускаецца.',
...
'wiki_usernamehasherror' => 'Імя карыстальніка не можа ўтрымліваць такія сімвалы',
...
'suspicious-wiki_userlogout' => 'Ваш запыт на выхад быў адмоўлены, паколькі ён выглядае як накіраваны са зламанага браўзера або кэшаванне проксі-сервераў.',

# E-mail sending
'php-mail-error-unknown' => 'Невядомая памылка ў функцыі PHP-пошты',
'wiki_user-mail-no-addy' => 'Паспрабаваў адправіць электронны ліст без адрасу электроннай пошты',
...
'passwordreset-emailtext-wiki_user' => 'Удзельнік $1 з праекту {{SITENAME}} запрасіў напамін пра ваш
...
Вы не зможаце дзеля гэтага карыстацца функцыяй ''{{:{{ns:mediawiki}}:emailwiki_user/be}}'', калі гэта вам забаронена, або калі вы не наставілі правільнага пацверджанага адрасу эл.пошты ў сваіх [[Special:Preferences|настаўленнях]].
...
'accmailtext' => "На адрас $2 быў адасланы згенераваны пароль для [[wiki_user talk:$1|$1]].
...
'anontalkpagetext' => "----''Гэта старонка размовы з ананімным удзельнікам, які або не мае свайго рахунку, або ім не карыстаўся. Таму дзеля яго ці яе ідэнтыфікацыі мы мусім выкарыстаць лічбавы Адрас IP. Такі адрас IP могуць дзяліць між сабою некалькі асоб. Калі вы ананімны ўдзельнік, і лічыце, што атрымліваеце няслушныя заўвагі,[[Special:wiki_userLogin/signup|стварыце рахунак]] або [[Special:wiki_userLogin|акажыцеся]], каб вас больш не блыталі з іншымі ананімнымі ўдзельнікамі.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Рахунак удзельніка "<nowiki>$1</nowiki>" не зарэгістраваны. Праверце, ці вы жадаеце стварыць або паправіць гэтую старонку.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Уліковы запіс удзельніка " $1 "не зарэгістраваны.',
...
'wiki_usercssyoucanpreview' => "'''Парада:''' Карыстайцеся кнопкай \"''{{int:showpreview}}''\" для выпрабоўвання новага коду CSS ''перад тым'', як яго запісваць.",
'wiki_userjsyoucanpreview' => "'''Парада:''' Карыстайцеся кнопкай \"''{{int:showpreview}}''\" для выпрабоўвання новага коду JS ''перад тым'', як яго запісваць.",
'wiki_usercsspreview' => "'''Памятайце, што гэта толькі папярэдні паказ вашага ўласнага CSS. Праўкі яшчэ не замацаваныя!'''",
'wiki_userjspreview' => "'''Памятайце, што гэта выпрабаванне/папярэдні паказ вашага ўласнага Яваскрыпту, які яшчэ не быў замацаваны!'''",
...
'''Праўкі яшчэ не замацаваныя!'''",
'wiki_userinvalidcssjstitle' => "'''Увага:''' Няма вокладкі з назвай \"\$1\". Памятайце, што свае старонкі .css і .js называюцца толькі малымі літарамі, такім чынам, напр., {{ns:wiki_user}}:Foo/vector.css, а не {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(абноўлена)',
'note' => "'''Заўвага:'''",
...
Паспрабуйце, калі ласка, ізноў. Калі і тады не атрымаецца, паспрабуйце [[Special:wiki_userLogout|выйсці з сістэмы]] і зайсці ізноў.'''",
...
'''Калі гэта нармальная спроба праўкі, паспрабуйце паўтарыць запісванне. Калі і гэта не дапаможа, паспрабуйце [[Special:wiki_userLogout|выйсці з сістэмы]] і ўвайсці ізноў.'''",
...
Вы можаце папрацаваць з існуючай старонкай, або [[Special:wiki_userLogin|увайсці ў сістэму, або завесці сабе рахунак]].',
...
'undo-summary' => 'Адкат версіі $1 аўтарства [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|размова]])',

# Account creation failure
'cantcreateaccounttitle' => 'Немагчыма стварыць рахунак',
'cantcreateaccount-text' => "Стварэнне рахункаў было забаронена для гэтага адрасу IP ('''$1''').

Забарона зроблена ўдзельнікам [[wiki_user:$3|$3]], з такім тлумачэннем: ''$2''",
...
'rev-deleted-wiki_user' => '(удзельнік выдалены)',
'rev-deleted-event' => '(сцёртае дзеянне з журналам)',
'rev-deleted-wiki_user-contribs' => '[імя ўдзельніка альбо IP-адрас выдалены — рэдагаванне скрытыя ад узносаў]',
...
'revdelete-hide-wiki_user' => 'Не паказваць ўдзельнага імя аўтара або яго адрас IP',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|не паказана $1 прамежкавая версія|не паказаны $1 прамежкавыя версіі|не паказаны $1 прамежкавых версій}}, зробленыя больш чым {{PLURAL:$2|$1 удзельнікам|$2 удзельнікамі}})',
...
'prefsnologintext' => 'Належыць <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} увайсці ў сістэму]</span>, каб мяняць свае настаўленні.',
...
# wiki_user rights
'wiki_userrights' => 'Распараджэнне правамі ўдзельніка',
'wiki_userrights-lookup-wiki_user' => 'Распараджацца групамі ўдзельнікаў',
'wiki_userrights-wiki_user-editname' => 'Увядзіце імя ўдзельніка:',
'editwiki_usergroup' => 'Правіць групы ўдзельнікаў',
'editingwiki_user' => "Змена праў удзельніка '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Распараджацца групамі ўдзельніка',
'savewiki_usergroups' => 'Захаваць групы ўдзельнікаў',
'wiki_userrights-groupsmember' => 'У групе:',
'wiki_userrights-groupsmember-auto' => 'Няяўны член:',
'wiki_userrights-groups-help' => 'Тут можна мяняць групы, да якіх належыць гэты ўдзельнік.
...
'wiki_userrights-no-interwiki' => 'Вам не дазволена мяняць дазволаў карыстальнікам на іншых Вікі-ах.',
'wiki_userrights-nodatabase' => 'Не знойдзена тут, або не існуе база даных $1.',
'wiki_userrights-nologin' => 'Належыць [[Special:wiki_userLogin|увайсці ў сістэму]] на рахунак адміністратара, каб прызначаць дазволы ўдзельнікам.',
'wiki_userrights-notallowed' => 'З вашага ўліковага запісу не дазволена дадаваць і выдаляць правы ўдзельнікаў.',
'wiki_userrights-changeable-col' => 'Групы, якія вам дазволена мяняць',
'wiki_userrights-unchangeable-col' => 'Групы, якія вам не дазволена мяняць',
...
'right-move-rootwiki_userpages' => 'Пераносіць каранёвыя старонкі ўдзельнікаў',
...
'right-hidewiki_user' => 'Забараняць імя ўдзельніка і рабіць яго нябачным',
...
'right-editwiki_usercssjs' => 'Правіць файлы CSS і JS іншых удзельнікаў',
'right-editwiki_usercss' => 'Правіць файлы CSS іншых удзельнікаў',
'right-editwiki_userjs' => 'Правіць файлы JS іншых удзельнікаў',
...
'right-wiki_userrights' => 'Правіць усе дазволы ўдзельнікаў',
'right-wiki_userrights-interwiki' => 'Правіць дазволы ўдзельнікаў на іншых вікі',
...
'action-move-rootwiki_userpages' => 'пераносіць каранёвыя старонкі ўдзельнікаў',
...
'action-wiki_userrights' => 'мяняць усе дазволы ўдзельніка',
'action-wiki_userrights-interwiki' => 'мяняць дазволы ўдзельнікаў на іншых вікі',
...
'newpageletter' => 'Н',
'boteditletter' => 'р',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|назіральнік|назіральнікаў}}]',
...
'uploadnologintext' => 'Каб укладваць файлы, трэба [[Special:wiki_userLogin|ўвайсці ў сістэму]].',
...
'upload-file-error-text' => 'Унутраная памылка пры спробе стварыць на серверы тымчасовы файл. Звярніцеся да аднаго з [[Special:Listwiki_users/sysop|сістэмных адміністратараў]].',
'upload-misc-error' => 'Нявызначаная памылка пры ўкладанні',
'upload-misc-error-text' => 'Нявызначаная памылка пры ўкладанні. Праверце правільнасць і даступнасць URL і паспрабуйце ізноў. Калі праблема трывалая, звярніцеся да аднаго з [[Special:Listwiki_users/sysop|сістэмных адміністратараў]].',
...
'statistics-header-wiki_users' => 'Статыстыка ўдзельніка',
...
'statistics-wiki_users-active-desc' => 'Удзельнікі, якія хоць нешта зрабілі за апошн{{PLURAL:$1|і дзень|ія $1 дзён}}',
...
'listwiki_users' => 'Усе ўдзельнікі',
'listwiki_users-editsonly' => 'Толькі ўдзельнікі, якія маюць праўкі',
'listwiki_users-creationsort' => 'У парадку датаў стварэння',
'wiki_usereditcount' => '$1 {{PLURAL:$1|праўка|праўкі}}',
'wiki_usercreated' => '	{{GENDER:$3|Зарэгістраваўся|Зарэгістравалася}} $1 в $2',
'newpages' => 'Новыя старонкі',
'newpages-wiki_username' => 'Імя ўдзельніка:',
...
'listwiki_usersfrom' => 'Паказаць удзельнікаў, пачаўшы з:',
'listwiki_users-submit' => 'Паказаць',
'listwiki_users-noresult' => 'Удзельнікі не знойдзеныя.',
'listwiki_users-blocked' => '(Заблакаваны)',

# Special:Activewiki_users
'activewiki_users' => 'Актыўныя ўдзельнікі',
'activewiki_users-intro' => 'Гэта пералік удзельнікаў, якія нешта рабілі за апошнія $1 {{PLURAL:$1|дзень|дзён}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|праўка|праўкі|правак}} за апошні{{PLURAL:$3| дзень|я $3 дзён}}',
'activewiki_users-from' => 'Паказ, пачынаючы з:',
'activewiki_users-hidebots' => 'Без робатаў',
'activewiki_users-hidesysops' => 'Без адміністратараў',
'activewiki_users-noresult' => 'Няма такіх удзельнікаў.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Журнал рэгістрацыі ўдзельнікаў',
'newwiki_userlogpagetext' => 'Гэта журнал рэгістрацыі новых удзельнікаў.',
...
'mailnologintext' => 'Трэба [[Special:wiki_userLogin|ўвайсці ў сістэму]] і мець пацверджаны адрас эл.пошты ў сваіх [[Special:Preferences|настáўленнях]], каб слаць эл.пошту іншым удзельнікам.',
'emailwiki_user' => 'Эл.пошта ўдзельніка',
...
'wiki_usermailererror' => "Паштовы аб'ект паведамляе пра памылку:",
'defemailsubject' => '{{SITENAME}} — Ліст ад $1',
'wiki_usermaildisabled' => 'Электронная пошта ўдзельніка не працуе',
'wiki_usermaildisabledtext' => 'Вы не можаце адпраўляць паведамленні электроннай пошты іншым карыстальнікам гэтай вікі',
...
'emailwiki_username' => 'Логін',
'emailwiki_usernamesubmit' => 'Адправіць',
...
'emailwiki_userfooter' => 'Гэты эл.ліст быў высланы ад $1 да $2 праз функцыю "{{:{{ns:mediawiki}}:emailwiki_user/be}}" пляцоўкі {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Пакінуць адмысловае паведамленне.',
'wiki_usermessage-editor' => 'Адмысловая дастаўка',
...
'watchnologintext' => 'Каб правіць свой спіс назіранага, трэба [[Special:wiki_userLogin|ўвайсці ў сістэму]].',
...
'alreadyrolled' => 'Немагчыма адкаціць апошнюю праўку ў [[:$1]], аўтарства [[wiki_user:$2|$2]] ([[wiki_user talk:$2|Talk]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]);
з таго часу нехта іншы правіў або адкатваў гэтую старонку.

Апошняя праўка старонкі была аўтарства [[wiki_user:$3|$3]] ([[wiki_user talk:$3|Talk]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Тлумачэнне праўкі было: \"''\$1''\".",
'revertpage' => 'Праўкі аўтарства [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|размова]]) адкочаныя; вернута апошняя версія аўтарства [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Праўкі (імя ўдзельніка выдалена) адкочаны да версіі [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'распараджэнне правамі ўдзельніка',
...
'sp-contributions-wiki_username' => 'Адрас IP або імя ўдзельніка:',
...
'ipadressorwiki_username' => 'IP-адрас ці імя ўдзельніка:',
'ipbexpiry' => 'Згасае:',
'ipbreason' => 'Прычына:',
...
'ipbwatchwiki_user' => 'Назіраць уласную і размоўную старонкі гэтага ўдзельніка',
'ipb-disablewiki_usertalk' => 'Забараніць гэтаму ўдзельніку рэдагаваць сваю старонку размоў падчас блакіроўкі',
...
'ipb-confirmhidewiki_user' => 'Вы намерваецеся заблакіраваць удзельніка і схаваць яго імя. Яно не будзе адлюстроўвацца ў спісах і журналах. Вы ўпэўнены, што жадаеце гэта зрабіць?',
...
'unblocked' => '[[wiki_user:$1|$1]] быў адблакаваны',
...
'blocklist-wiki_userblocks' => 'Схаваць блакіроўкі ўліковых запісаў',
...
'blocklist-nowiki_usertalk' => 'не мае дазволу правіць уласную старонку размоваў',
...
'autoblocker' => 'Аўтаматычны блок таму што вашым адрасам IP нядаўна карыстаўся "[[wiki_user:$1|$1]]". Блакаванне $1\'s патлумачана так: "\'\'\'$2\'\'\'"',
...
'block-log-flags-nowiki_usertalk' => 'нельга правіць уласную размову',
...
'unblock-hidewiki_user' => 'Вы не можаце разблакаваць гэтага ўдзельніка, бо яго імя было ўтоена.',
...
'cant-see-hidden-wiki_user' => 'Удзельнік, якога вы спрабуеце заблакіраваць, ужо заблакіраваны і схаваны. Паколькі ў вас няма дазволу на працу па схаванні ўдзельнікаў, вы не можаце прагледзець ці змяніць гэту блакіроўку.',
...
'movewiki_userpage-warning' => "'''Увага.''' Вы збіраецеся пераназваць старонку ўдзельніка. Калі ласка, звернеце ўвагу, што пераназвана будзе толькі старонка, удзельнік '''не''' будзе пераназваны.",
'movenologin' => 'Не зроблены ўваход у сістэму',
'movenologintext' => 'Вы павінны быць зарэгістраваным удзельнікам, і [[Special:wiki_userLogin|ўвайсці ў сістэму]], каб пераносіць старонкі.',
'movenotallowed' => 'Вам не дазволена пераносіць старонак.',
'movenotallowedfile' => 'Вы не маеце дазволу пераносіць файлы.',
'cant-move-wiki_user-page' => 'Вам не дазволена пераносіць старонак карыстальнікаў (не лічачы пад-старонак).',
'cant-move-to-wiki_user-page' => 'Вам не дазволена пераносіць старонку ў старонку карыстальніка (не лічачы пад-старонак карыстальніка).',
...
'tooltip-pt-wiki_userpage' => 'Ваша ўласная старонка',
'tooltip-pt-anonwiki_userpage' => 'Старонка ўдзельніка для таго IP, з якога вы зараз працуеце',
...
'tooltip-t-emailwiki_user' => 'Адаслаць удзельніку ліст эл.пошты',
...
'tooltip-ca-nstab-wiki_user' => 'Паказаць уласную старонку ўдзельніка',
...
'sitewiki_user' => 'удзельнік $1 з {{SITENAME}}',
'anonwiki_user' => 'ананімны ўдзельнік {{SITENAME}} - $1',
'lastmodifiedatby' => 'Апошняе змяненне старонкі адбылося $2, $1 аўтарства $3.',
'othercontribs' => 'На аснове працы $1.',
'others' => 'іншае',
'sitewiki_users' => '{{PLURAL:$2|удзельнік|удзельнікі}} з пляцоўкі {{SITENAME}} - $1',
'anonwiki_users' => 'ананімны{{PLURAL:$2| ўдзельнік|я ўдзельнікі}} {{SITENAME}} - $1',
...
'exif-wiki_usercomment' => 'Заўвагі карыстальніка',
...
'confirmemail_success' => 'Ваш адрас эл.пошты быў пацверджаны. Можаце [[Special:wiki_userLogin|ўваходзіць у сістэму]] і працаваць з вікі.',
...
'confirmrecreate' => "Удзельнік [[wiki_user:$1|$1]] ([[wiki_user talk:$1|размова]]) сцёр гэты артыкул пасля таго, як вы пачалі працу з ім, падаўшы прычыну:
: ''$2''
Пацвердзіце свой намер аднавіць гэты артыкул.",
'confirmrecreate-noreason' => 'Удзельнік [[wiki_user:$1|$1]] ([[wiki_user talk:$1|размовы]]) выдаліў гэтую старонку пасля таго, як вы пачалі яе рэдагаваць. Калі ласка, пацвердзіце, што вы сапраўды жадаеце аднавіць гэтую старонку.',
'recreate' => 'Аднавіць',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|размовы]])',
...
'specialpages-group-wiki_users' => 'Удзельнікі і дазволы',
...
'logentry-newwiki_users-newwiki_users' => '$1 стварыў уліковы запіс удзельніка',
'logentry-newwiki_users-create' => '$1 стварыў уліковы запіс удзельніка',
'logentry-newwiki_users-create2' => '$1 стварыў уліковы запіс удзельніка $3',
'logentry-newwiki_users-autocreate' => 'Аўтаматычна створаны ўліковы запіс $1',
'newwiki_userlog-byemail' => 'пароль адасланы эл.поштай',
