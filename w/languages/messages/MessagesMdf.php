...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'АдресТиись' ),
	'Export'                    => array( 'Вимс' ),
	...
	'Listwiki_users'                 => array( 'ЛувомТиихне' ),
	...
	'wiki_userlogin'                 => array( 'ТииньСувама' ),
	'wiki_userlogout'                => array( 'ТииньЛисема' ),
	'wiki_userrights'                => array( 'ТииньВидексонза' ),
...
'tog-enotifwiki_usertalkpages' => 'Кучемс электрононь сёрма монь тиить корхтама лопанц илякстоптомада меле',
...
'wiki_userpage' => 'Ваномс тиить лопанц',
...
'youhavenewmessagesfromwiki_users' => 'Тонь $1 {{PLURAL:$3|тага фкя тиить эзда|$3 тиихнень эзда}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Тонь $1 лама тиихнень эзда ($2).',
...
Пачфтть тянь колга [[Special:Listwiki_users/sysop|системонь вятиксонди]] URL адресть тяштезь.',
...
'titleprotected' => "[[wiki_user:$1|$1]] кардазь тя лемсь мархта лопа тиемать.
Туфталсь ''$2''.",
...
Тондейть ули кода ащемс {{SITENAME}}са апак содак эли [[Special:wiki_userLogin|сувак тага весть]] кода сяка эли иля тиись.
...
'wiki_userlogin' => 'Сувама / сёрматфтома',
'wiki_userloginnocreate' => 'Сувамс',
'logout' => 'Лисема',
'wiki_userlogout' => 'Лисема',
...
'nosuchwiki_user' => 'Тиись "$1" лемса аш.
Ванк, улема, тон сёрмадыть лемть аф лац.
Илякс тондейть эряви [[Special:wiki_userLogin/signup|сёрматфтомс одукс]].',
'nosuchwiki_usershort' => 'Тиись "$1" лемса аш. Ванк, улема, тон сёрмадыть лемть аф лац.',
'nowiki_userspecified' => 'Тиить лемсь эряви.',
'login-wiki_userblocked' => 'Тиись перяф. Сувама кардаф.',
...
'wiki_usernamehasherror' => 'Тиить лемозонза тяфтама тяшкст аф мярьговихть',
...
'suspicious-wiki_userlogout' => 'Вешфксце лисемс кардафоль сяс мес няеви тянь кучезь колаф интернетс вятиень эли ётка ёкамань сервер вельде.',

# E-mail sending
'php-mail-error-unknown' => 'Аф содаф эльбятькс PHP сёрмавятемань функциеса.',
'wiki_user-mail-no-addy' => 'Тяряфтыхть кучемс е-сёрма е-паргафтома',
...
'passwordreset-wiki_username' => 'Тиить лемоц',
...
'accmailtext' => "Апак арьсек тиф [[wiki_user talk:$1|$1]]нь сувама валоц кучфоль $2с.
...
Уляндяряйхть иля тиинь мяльполатксонза конатнень аф видекста лувозь тоннекс, тондейть пароль сай пингста [[Special:wiki_userLogin/signup|сёрматфтомс/сувамс]] иля лемфтома тиихнень марс аф шовореманкса.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Сёрматфтомась «<nowiki>$1</nowiki>» лемса аш. Арьсек лацкаста, афкукс тонь улендяряй мяльце тиемс эли полафтомс тя лопать.',
...
'wiki_usercssyoucanpreview' => "'''Мялень максома:''' Ванфтомада инголе нолдак тевс 'Васень няфтема' пунять тонь од CSS эли JS файлть варжаманкса.",
'wiki_userjsyoucanpreview' => "'''Мялень максома:''' Ванфтомада инголе нолдак тевс 'Васень няфтема' пунять тонь од CSS эли JS файлть варжаманкса.",
'wiki_usercsspreview' => "Киртть мяльсот тя аньцек тонь CSS файлцень васень няфтемац. Сон нинге изь ванфтов!'''",
'wiki_userjspreview' => "'''Киртть мяльсот тя аньцек тонь JavaScript файлть варжамась/васень няфтемась, сон нинге изь ванфтов!'''",
'wiki_userinvalidcssjstitle' => "'''Инголе мярьгома:''' Аш тема файл \"\$1\" мазопнеманкса. Киртть мяльсот .css эди .js лопас путови аньцек ёмла тяшкса коняксне, кепотьксонди {{ns:wiki_user}}:Foo/лем.css афи {{ns:wiki_user}}:Foo/Лем.css.",
'updated' => '(Одонзаф)',
'note' => "'''Шарфтк мяльце:'''",
...
Тик одукс.
Тага лисентьфтяряй - [[Special:wiki_userLogout|листь]] лопаста ди сувак тага весть.'''",
...
Тондейть ули кода мърдамс меки ди петнемс тиф ни лопать, эли [[Special:wiki_userLogin|сувамс эли сёрматфтомс одукс]].',
...
'undo-summary' => 'Валхтт петнемась $1 конань тизе [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Корхнема]])',

# Account creation failure
'cantcreateaccounttitle' => 'Аш кода сёрматфтомать тиемс',
'cantcreateaccount-text' => "Сёрматфтомась тя IP адреста ('''$1''') пякстазе [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(тиить лемоц нардаф)',
...
'revdelete-hide-wiki_user' => 'Кяшемс петнить лемонц/IP адресонц',
...
'prefsnologintext' => 'Тондейть эряви <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} сувамс]</span> тонь арафнематнень латцеманкса.',
...
# wiki_user rights
'wiki_userrights' => 'Тиинь видекснень вятема',
'wiki_userrights-lookup-wiki_user' => 'Тиихнень полгаснон вятемасна',
'wiki_userrights-wiki_user-editname' => 'Путт тиить лемонц:',
'editwiki_usergroup' => 'Полафтомс тиить полганзон',
'editingwiki_user' => "'''[[wiki_user:$1|$1]]'''-нь тиить видексонзон полафнема ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Полафтомс тиить полганзон',
'savewiki_usergroups' => 'Ванфтомс тиить полганзон',
'wiki_userrights-groupsmember' => 'Сувси полгас:',
'wiki_userrights-groups-help' => 'Тондейть ули кода полафнемс полгат конат эса ули тя тиись.
...
'wiki_userrights-reason' => 'Туфтал:',
'wiki_userrights-no-interwiki' => 'Тондейть аф мярьгови полафтомс тиихнень видекссна иля Викива.',
'wiki_userrights-nodatabase' => 'Датабаза $1 аш эли сон аф тястоконь.',
'wiki_userrights-nologin' => 'Тондейть эряви [[Special:wiki_userLogin|сувамс]] оцюнянь сёрматфтомать вельде тиихнень видексснон макссеманкса.',
'wiki_userrights-notallowed' => 'Тонь сёрматфтомацень вельде аф мярьгови макссемс видекст иля тиихненди.',
'wiki_userrights-changeable-col' => 'Полгатне конатнень тондейть ули кода полафтомс',
'wiki_userrights-unchangeable-col' => 'Полгатне, конатнень тондейть аш кода полафтомс',

# Groups
'group' => 'Полга:',
'group-wiki_user' => 'Тиихне',
...
'grouppage-wiki_user' => '{{ns:project}}:Тиихне',
...
'right-move-rootwiki_userpages' => 'Шашфтомс юронь тиинь лопатне',
...
'right-hidewiki_user' => 'Сёлгомс тиить лемоц, сонь кяшезь иля тиида',
...
'right-editwiki_usercssjs' => 'Петнемс иля тиихнень CSS ди JS файлснон',
'right-editwiki_usercss' => 'Петнемс иля тиихнень CSS файлснон',
'right-editwiki_userjs' => 'Петнемс иля тиихнень JS файлснон',
...
'right-wiki_userrights' => 'Петнемс сембе тиихнень видексснон',
'right-wiki_userrights-interwiki' => 'Петнемс тиихнень видекснон иля викить лопасонза',
...
'action-move-rootwiki_userpages' => 'шашфтомс юронь тиинь лопатне',
...
'action-wiki_userrights' => 'петнемс сембе тиихнень видексснон',
'action-wiki_userrights-interwiki' => 'петнемс тиихнень иля викистонь тиинь видексснон',
...
'newpageletter' => 'О',
'boteditletter' => 'р',
'number_of_watching_wiki_users_pageview' => '[$1 ваны {{PLURAL:$1|тии|тиихть}}]',
...
'uploadnologintext' => 'Тондейть эряви [[Special:wiki_userLogin|сувамс]] файл тонгоманкса.',
...
'upload-file-error-text' => 'Потмонь эльбятькс лиссь ёткопингонь файл серверса тиемста. Эряви сотомс [[Special:Listwiki_users/sysop|системонь вятиксть]] мархта.',
'upload-misc-error' => 'Аф содаф тонгодема эльбятькс',
'upload-misc-error-text' => 'Аф содаф эльбятькс лиссь тонгодембачк. Ванк кондясти ди сатови эли аф URL-сь эди тик сембе одукс. Лисендяряй стама эльбятькс тага весть, сотт [[Special:Listwiki_users/sysop|системонь вятиксть]] мархта.',
...
'statistics-header-wiki_users' => 'Тиить статистиксь',
...
'statistics-wiki_users' => 'Сёрматфтф [[Special:Listwiki_users|тиихне]]',
'statistics-wiki_users-active' => 'Покай тиихне',
'statistics-wiki_users-active-desc' => 'Тиихне конатне тисть мезеге ётай {{PLURAL:$1|шиня|$1 шиста}}',
...
'listwiki_users' => 'Тиихне',
'listwiki_users-editsonly' => 'Няфтемс аньцек петнематнень мархта тиихнень',
'wiki_usereditcount' => '$1 {{PLURAL:$1|петнема|петнемат}}',
'wiki_usercreated' => '{{GENDER:$3|Шкаф}} $1 шиста $2 пингста',
'newpages' => 'Од лопат',
'newpages-wiki_username' => 'Тиить лемоц:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Тиись:',
...
'listwiki_usersfrom' => 'Няфтемс тиихть ушедомс:',
'listwiki_users-submit' => 'Няфтемс',
'listwiki_users-noresult' => 'Тиихть исть мув.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Тиинь ушедоманзон лувомасна',
'newwiki_userlogpagetext' => 'Тя тиинь ушедоманзон лувомасна.',
...
'wiki_usermailererror' => 'Электрононь адрес эльбятькссь:',
...
'emailwiki_userfooter' => 'Тя электрононь сёрмась $1 кучезе $2-с "Email wiki_user" функциеть вельде {{SITENAME}}-са.',
...
'watchnologintext' => 'Тондейть эряви [[Special:wiki_userLogin|сувамс]] тонь мельгеваномацень петнеманкса.',
...
'alreadyrolled' => 'Аш кода меки кевордамс [[:$1]]нь мекольце петнемать, конань тись [[wiki_user:$2|$2]] ([[wiki_user talk:$2|Корхнема]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]);
иля тиись сонь петезе эли кевордазе ни.

Мекольце петнема  тизе [[wiki_user:$3|$3]] ([[wiki_user talk:$3|Корхнема]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Петнема лихтема ульсь: \"''\$1''\".",
'revertpage' => 'Петнематнень мърдафтозь [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Корхнема]]) сядынгольдень верзиес мърдафтозе [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'тиинь видекснень вятема',
'sp-contributions-search' => 'Вешендемс путкст',
'sp-contributions-wiki_username' => 'IP адрес эли тиить лемоц:',
...
'ipadressorwiki_username' => 'IP адрес эли тиить лемоц:',
'ipbexpiry' => 'Сирелгоды:',
'ipbreason' => 'Туфтал:',
...
'ipbwatchwiki_user' => 'Ваномс тя тиить лопанц ди сонь корхнема лопанц мельге.',
...
'unblocked' => '[[wiki_user:$1|$1]]-ть сёлгомац валхтф',
...
'blocklist-nowiki_usertalk' => 'аш кода петнемс эсь корхнема лопанц',
...
'contribslink' => 'путкс.',
'autoblocker' => 'Эслек сёлкф сяс мес тонь IP адресцень нолдась тевс "[[wiki_user:$1|$1]]". $1-нь сёлгомац туфтал: "$2"',
...
'block-log-flags-nowiki_usertalk' => 'аш кода петнемс эсь корхнема лопанц',
...
'movenologintext' => 'Эряви улемс сёрматфтф тиикс ди васенда [[Special:wiki_userLogin|сувамс]] од вастс лопатнень шашфтоманди.',
'movenotallowed' => 'Тон аф мярьговат шашфтомс лопат од вастс.',
'movenotallowedfile' => 'Тон аф мярьговат шашфтомс файлхт.',
'cant-move-wiki_user-page' => 'Тон аф мярговат шашфтомс тиинь лопаснон (синь сублопафтомост).',
'cant-move-to-wiki_user-page' => 'Тон аф мярьговат шашфтомс лопат тиинь лопас (тиинь сублопаданза башка).',
'newtitle' => 'Од лемс:',
...
'tooltip-pt-wiki_userpage' => 'Тонь тиинь лопаце',
'tooltip-pt-anonwiki_userpage' => 'Тиить лопанц IP потмоса, конань эса тон петнесак кода',
...
'tooltip-t-emailwiki_user' => 'Кучемс сёрма тя тиинди',
...
'tooltip-ca-nstab-wiki_user' => 'Няфтемс тиить лопанц',
...
'spambot_wiki_username' => 'MediaWiki-ть луднада аруяфтомась',
...
'exif-wiki_usercomment' => 'Тиить тяштьксонза',
...
'confirmrecreate' => "Тиись [[wiki_user:$1|$1]] ([[wiki_user talk:$1|корхнема]]) нардазе тя лопать мъзярда тон кармать петнемонза тя туфталонкса:
: ''$2''
...
'specialpages-group-wiki_users' => 'Тиихне ди видексне',
...
'newwiki_userlog-byemail' => 'сувама валце кучф электрононь сёрмаса',
