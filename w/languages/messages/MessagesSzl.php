...
'tog-enotifwiki_usertalkpages' => 'Wyślij e-brifa, kej zajta mojij godki bydźe pomjyńono',
...
'views' => 'Widok',
'toolbox' => 'Werkcojg',
'wiki_userpage' => 'Zajta sprowjorza',
...
'nstab-main' => 'Zajta',
'nstab-wiki_user' => '{{GENDER:{{BASEPAGENAME}}|Zajta używocza|Zajta używoczki}}',
'nstab-media' => 'Medja',
...
'wiki_userlogin' => 'Lůgowańy / Tworzyńy kůnta',
'wiki_userloginnocreate' => 'Zalůguj śe',
'logout' => 'Wyloguj',
'wiki_userlogout' => 'Uodloguj śe',
...
'wiki_userlogin-resetlink' => 'Zapomńoł żeś dane lo nalogowańo?',
...
'wiki_userexists' => 'Mjano użytkowńika, kere żeś wybroł, je zajynte. Wybjer, prosza, inksze mjano.',
...
'nosuchwiki_user' => 'Ńy ma sam użytkowńika uo mjańe "$1".
Sprowdź szrajbůng, abo [[Special:wiki_userLogin/signup|utwůrz nowe kůnto]].',
'nosuchwiki_usershort' => 'Ńy mo sam užytkowńika uo mjańe "$1".',
'nowiki_userspecified' => 'Podej mjano użytkowńika.',
'login-wiki_userblocked' => 'Tyn sprowjorz ma zawrzite sprowjyńa. Ńy możno sie zalgować.',
...
'wiki_usernamehasherror' => 'Nazwa sprowjorza ńy może mjyć buchsztaby "#".',
...
'passwordreset-wiki_username' => 'Mjano używacza:',
...
'wiki_userpage-wiki_userdoesnotexist' => 'Užytkowńik "<nowiki>$1</nowiki>" ńy je zareještrowany. Sprowdź eli na pewno chćoužeś stwořyć/pomjynić gynau ta zajta.',
'wiki_userpage-wiki_userdoesnotexist-view' => "Konto sprowjorza ''$1'' ńy istnieje.",
...
'wiki_usercssyoucanpreview' => "!'''Podpowjydź:''' Użyj knefla \"Podglůnd\", coby przetestować Twůj nowy arkusz stylůw CSS abo kod JavaScript przed jego zaszrajbowańym.",
'wiki_userjsyoucanpreview' => "!'''Podpowjydź:''' Użyj knefla \"Podglůnd\", coby przetestować Twůj nowy arkusz stylůw CSS abo kod JavaScript przed jego zaszrajbowańym.",
'wiki_usercsspreview' => "'''Pamjyntej, aže to je na raźe ino podglůnd Twojego arkuša stylůw CSS.'''
'''Ńic ješče ńy zostouo naškryflone!'''",
'wiki_userjspreview' => "'''Pamjyntej, aže to je na raźe ino podglůnd Twojego JavaScriptu - nic ješče ńy zostouo naškryflone!'''",
...
'wiki_userinvalidcssjstitle' => "'''Pozůr:''' Ńy mo skůrki uo mjańe \"\$1\". Pamjyntej, aže zajty užytkowńika zawjyrajůnce CSS i JavaScript powinny začynać śe mouům buchštabům, np. {{ns:wiki_user}}:Foo/vector.css.",
'updated' => '(Pomjyńano)',
'note' => "'''Pozůr:'''",
...
'rev-deleted-wiki_user' => '(užytkowńik wyćepany)',
...
'revdelete-hide-wiki_user' => 'Schrůń mjano użytkowńika/adres IP',
...
'diff-multi-manywiki_users' => '(Ńy pokozano {{PLURAL:$1|jydnyj wersyji postrzedńij|$1 wersyji postrzedńich}}, sprowjanej bez {{PLURAL:$2|jydnygo sprowjorza|$2 sprowjorzow}} .)',
...
'prefs-wiki_user-pages' => 'Zajty używaczy',
...
'prefs-files' => 'Pliki',
'youremail' => 'E-brif:',
'wiki_username' => 'Mjano użytkowńika:',
'uid' => 'ID užytkowńika:',
...
# wiki_user rights
'wiki_userrights' => 'Zařůndzańy prowami užytkowńikůw',
'wiki_userrights-lookup-wiki_user' => 'Zařůndzej prowami užytkownika',
'wiki_userrights-wiki_user-editname' => 'Wklepej sam nazwa užytkowńika:',
'editwiki_usergroup' => 'Sprowjej grupy užytkowńika',
'editingwiki_user' => "Zmjana uprawńyń užytkowńika '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Sprowjej grupy užytkowńika',
'savewiki_usergroups' => 'Zapisz',
'wiki_userrights-groupsmember' => 'Noležy do:',
'wiki_userrights-groups-help' => 'Možeš půmjyńać přinoležność tygo užytkowńika do podanych grup.
...
'wiki_userrights-reason' => 'Čymu:',
'wiki_userrights-no-interwiki' => 'Ńy moš dostympu do sprowjańo uprawńyń.',
'wiki_userrights-nodatabase' => 'Baza danych $1 ńy istńije abo ńy je lokalno.',
'wiki_userrights-nologin' => 'Muśiš [[Special:wiki_userLogin|zalůgować śe]] na kůnto admińistratora, coby nadować uprawńyńo užytkowńikům.',
'wiki_userrights-notallowed' => 'Ńy mosz dostympu do nadawańo uprawńyń używaczom.',
'wiki_userrights-changeable-col' => 'Grupy, kere možeš wybrać',
'wiki_userrights-unchangeable-col' => 'Grupy, kerych ńy možeš wybrać',

# Groups
'group' => 'Grupa:',
'group-wiki_user' => 'Używacze',
...
'group-wiki_user-member' => '{{GENDER:$1|używacz}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Sprowjorze',
...
'right-move-rootwiki_userpages' => 'Překludzańy zajtůw uod užytkowńikůw',
...
'right-hidewiki_user' => 'Zablokuj mjano użytkowńika i schrůń to przed publicznym dostympym',
...
'right-editwiki_usercssjs' => 'Sprowjej pliki CSS i JS inkšych užytkowńikůw',
'right-editwiki_usercss' => 'Sprowjej pliki CSS inkšych užytkowńikůw',
'right-editwiki_userjs' => 'Sprowjej pliki JS inkšych užytkowńikůw',
...
'right-wiki_userrights' => 'Sprowjej wšyjske uprawńyńo užytkowńikůw',
'right-wiki_userrights-interwiki' => 'Sprowjej uprawńyńo užytkowńikůw na zajtach inkšych Wiki',
...
'action-move-rootwiki_userpages' => 'Překludzańy zajtůw uod užytkowńikůw (nale bes jeich podzajtůw)',
...
'action-wiki_userrights' => 'sprowjańo uprowńyń wšyjstkich sprowjořy',
'action-wiki_userrights-interwiki' => 'sprowjańo uprowńyń sprowjořy na inkšych witrynach wiki',
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|dowajůncy pozůr užytkowńik|dowajůncych pozůr užytkowńikůw}}]',
...
'listfiles_wiki_user' => 'Užytkowńik',
...
'statistics-header-wiki_users' => 'Statystyka užytkowńikůw',
...
'statistics-wiki_users' => 'Zarejerowanych [[Special:Listwiki_users|użytkowńikůw]]',
'statistics-wiki_users-active' => 'Aktywnych użytkowńikůw',
'statistics-wiki_users-active-desc' => 'Użytkowńiki, kere bůły aktywne bez {{PLURAL:$1|uostatńi dźyń|uostatńich $1 dńi}}',
...
'listwiki_users' => 'Lista užytkowńikůw',
'listwiki_users-editsonly' => 'Pokoż yno użytkowńikůw kere majům sprowjyńa',
'wiki_usereditcount' => '$1 {{PLURAL:$1|sprowjyńe|sprowjyńa|sprowjyń}}',
'wiki_usercreated' => '{{GENDER:$3:Utworzono}} $1 uo $2',
'newpages' => 'Nowe zajty',
'newpages-wiki_username' => 'Mjano użytkowńika:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Užytkowńik:',
...
'listwiki_usersfrom' => 'Pokaž užytkowńikůw začynojůnc uod:',
'listwiki_users-submit' => 'Pokož',
'listwiki_users-noresult' => 'Ńy znejdźůno žodnygo užytkowńika.',

# Special:Activewiki_users
'activewiki_users-hidebots' => 'Schrůń boty',
'activewiki_users-hidesysops' => 'Schrůń adminy',
'activewiki_users-noresult' => 'Ńy sům używacze.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Nowe użytkowniki',
'newwiki_userlogpagetext' => 'To je rejer uostatńo utworzůnych kůnt użytkowńikůw',
...
'emailwiki_user' => 'Poślij tymu używoczowi e-brif',
...
'wiki_usermailererror' => 'Moduu uobsůgi počty zwrůćiu feler:',
'defemailsubject' => '{{SITENAME}} - e-brif uod używacza "$1"',
'wiki_usermaildisabled' => 'E-brif używacza ńy załůnczony',
...
'emailwiki_username' => 'Mjano używacza:',
'emailwiki_usernamesubmit' => 'Poślij',
...
'emailwiki_userfooter' => 'Wjadůmość e-brif zostoła wysłano s {{GRAMMAR:D.lp|{{SITENAME}}}} ku $2 bez $1 s użyćym „Wyślij e-brif ku tym użytkowńikowi”.',
...
'sp-contributions-wiki_userrights' => 'Zařůndzańy prowami užytkowńikůw',
'sp-contributions-search' => 'Šnupej za wkuodym',
'sp-contributions-wiki_username' => 'Adres IP abo mjano użytkowńika',
...
'ipadressorwiki_username' => 'Adres IP abo mjano użytkowńika',
'ipbexpiry' => 'Wygaso:',
'ipbreason' => 'Čymu:',
...
'ipbwatchwiki_user' => 'Dowej pozůr na zajta uosobisto i zajta godki tygo užytkowńika',
...
'blocklist-nowiki_usertalk' => 'ńy mogům sprowjać własnych zajtůw godki',
...
'block-log-flags-nowiki_usertalk' => 'ńy może sprowjać włosnyj zajty godki',
...
'cant-move-wiki_user-page' => 'Ńy mosz uprowńyń do przekludzańo zajtůw użytkowńikůw (wyjůntkym sům jejich podstrony).',
'cant-move-to-wiki_user-page' => 'Ńy mosz uprowńyń coby przekludźić zajta na plac kaj je zajta użytkowńika (wyjůntkym sům podzajty użytkowńika).',
'newtitle' => 'Nowy titel:',
...
'tooltip-pt-wiki_userpage' => 'Mojo perzůnalno zajta',
'tooltip-pt-anonwiki_userpage' => 'Zajta užytkowńika do adresu IP spod kerygo sprowjoš',
...
'tooltip-t-emailwiki_user' => 'Wyślij e-brif do tygo užytkowńika',
...
'tooltip-ca-nstab-wiki_user' => 'Ukoż perzůnalno zajta używocza',
...
'sitewiki_user' => 'Užytkowńik {{GRAMMAR:D.lp|{{SITENAME}}}} – $1',
'lastmodifiedatby' => 'Uostatńy sprowjyńy tej zajty: $2, $1 (autor půmjyńań: $3)',
'othercontribs' => 'Inkše autory: $1.',
'others' => 'inkśi',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|użytkowńik|użytkowńiki}} $1',
'creditspage' => 'Autořy',
...
'spambot_wiki_username' => 'MediaWiki – wyćepywańe spamu',
...
'exif-wiki_usercomment' => 'Kůmyntoř užytkowńika',
...
'specialpages-group-wiki_users' => 'Użytkowńiki i uprawńyńa',
...
'newwiki_userlog-byemail' => 'hasło uostało wysłane e-brifym',
