...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'АктивниКорисници' ),
	...
	'Emailwiki_user'                 => array( 'Пиши_е-пошта_на_корисникот' ),
	'Export'                    => array( 'Извоз' ),
	...
	'Listwiki_users'                 => array( 'СписокНаКорисници', 'СписокКорисници' ),
	...
	'wiki_userlogin'                 => array( 'Најавување' ),
	'wiki_userlogout'                => array( 'Одјавување' ),
	'wiki_userrights'                => array( 'КорисничкиПрава' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'БРОЈНАКОРИСНИЦИ', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'БРОЈНААКТИВНИКОРИСНИЦИ', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'КОРИСНИКНАНАРЕВИЗИЈА', 'REVISIONUSER' ),
...
'tog-enotifwiki_usertalkpages' => 'Испраќај ми е-пошта при промена на мојата страница за разговор',
...
'views' => 'Посети',
'toolbox' => 'Алатник',
'wiki_userpage' => 'Преглед на корисничката страница',
...
'youhavenewmessagesfromwiki_users' => 'Имате $1 од {{PLURAL:$3|еден корисник|$3 корисници}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Имате $1 од многу корисници ($2).',
...
Пријавете го ова на некој [[Special:Listwiki_users/sysop|администратор]], давајќи врска до URL адресата.',
...
'titleprotected' => "Овој наслов од страна на [[wiki_user:$1|$1]] е заштитен и не може да се создаде.
...
Можете да продолжите со користење на {{SITENAME}} анонимно или можете [[Special:wiki_userLogin|повторно да се најавите]] под исто или различно корисничко име.
...
'wiki_userlogin' => 'Најава / регистрација',
'wiki_userloginnocreate' => 'Најава',
'logout' => 'Одјава',
'wiki_userlogout' => 'Одјава',
...
'wiki_userlogin-resetlink' => 'Си ги заборавивте податоците за најава?',
'createaccountmail' => 'по е-пошта',
'createaccountreason' => 'Причина:',
'badretype' => 'Внесените лозинки не се совпаѓаат.',
'wiki_userexists' => 'Корисничкото име што го внесовте е зафатено.
Изберете друго име.',
...
'nosuchwiki_user' => 'Нема корисник со името „$1“.
Корисничките имиња разликуваат мали и големи букви.
Проверете да не сте направиле грешка во пишувањето, или [[Special:wiki_userLogin/signup|создајте нова корисничка сметка]].',
'nosuchwiki_usershort' => 'Нема корисник со името „$1“.
Проверете дали правилно сте напишале.',
'nowiki_userspecified' => 'Мора да наведете корисничко име.',
'login-wiki_userblocked' => 'Овој корисник е блокиран. Најавувањето не е дозволено.',
...
'wiki_usernamehasherror' => 'Корисничкото име не може да содржи тараба',
...
'suspicious-wiki_userlogout' => 'Вашето барање за одјава е одбиено бидејќи се чини дека е испратено од расипан прелистувач или кеширачки застапник (proxy).',

# E-mail sending
'php-mail-error-unknown' => 'Непозната грешка во функцијата mail() на PHP',
'wiki_user-mail-no-addy' => 'Се обидовте да испратите порака без да внесете адреса',
...
'passwordreset-emailtext-wiki_user' => 'Корисникот $1 на {{SITENAME}} побара да потсетник за вашите најавни податоци на {{SITENAME}}
...
'accmailtext' => "Случајно создадена лозинка за [[wiki_user talk:$1|$1]] е испратена на $2.
...
Ако сте анонимен корисник и сметате дека кон вас се упатени нерелевантни коментари, тогаш [[Special:wiki_userLogin/signup|создајте корисничка сметка]] или [[Special:wiki_userLogin|најавете се]] за да избегнете поистоветување со други анонимни корисници во иднина.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Корисничката сметка „<nowiki>$1</nowiki>“ не е регистрирана.
Ве молиме размислете дали навистина сакате да ја создадете/уредите оваа страница.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Корисничката сметка „$1“ не е регистрирана.',
...
'wiki_usercssyoucanpreview' => "'''Совет:''' Употребете го копчето „{{int:showpreview}}“ за да го испробате вашиот нов CSS пред да зачувате.",
'wiki_userjsyoucanpreview' => "'''Совет:''' Употребете го копчето „{{int:showpreview}}“ за да ја испробате вашата нова JavaScript  пред да зачувате.",
'wiki_usercsspreview' => "'''Запомнете дека ова е само преглед на вашиот кориснички CSS код, страницата сè уште не е зачувана!'''",
'wiki_userjspreview' => "'''Запомнете дека ова е само преглед на вашиот JavaScript код, страницата сè уште не е зачувана!'''",
...
'''Сè уште не е зачуван!'''",
'wiki_userinvalidcssjstitle' => "'''Предупредување:''' Нема руво „$1“.
Запомнете дека сопствените .css и .js страници имаат имиња со мали букви, пр. {{ns:wiki_user}}:Некој/vector.css наместо {{ns:wiki_user}}:Некој/Vector.css.",
'updated' => '(Подновено)',
'note' => "'''Напомена:'''",
...
Обидете се повторно.
Ако сè уште не функционира, обидете се да се [[Special:wiki_userLogout|одјавите]] и повторно да се најавите.",
...
Ако и ова не го реши проблемот, обидете се со [[Special:wiki_userLogout|одјавување]] и повторно најавување.",
...
Можете да се вратите назад и да уредувате постоечка страница или [[Special:wiki_userLogin|најавете се или создајте нова корисничка сметка]].',
...
'undo-summary' => 'Откажано уредувањето $1 на уредникот [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|разговор]])',

# Account creation failure
'cantcreateaccounttitle' => 'Не може да се создаде корисничка сметка',
'cantcreateaccount-text' => "Создавањето на корисничка сметка од оваа IP-адреса ('''$1''') е блокирано од страна на [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(избришано корисничко име)',
'rev-deleted-event' => '(избришан запис на дејство)',
'rev-deleted-wiki_user-contribs' => '[отстрането е корисничкото име или IP-адресата - уредувањето нема да се прикаже на списокот на придонеси]',
...
'revdelete-hide-wiki_user' => 'Скриј корисничко име/IP-адреса на авторот',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Не е прикажана една меѓувремена ревизија направена|Не се прикажани $1 меѓувремени ревизии направени}} од повеќе од $2 {{PLURAL:$2|корисник|корисници}})',
...
'prefsnologintext' => 'Мора да бидете <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} најавени]</span> за да ги менувате вашите кориснички нагодувања.',
...
'prefs-wiki_user-pages' => 'Кориснички страници',
...
# wiki_user rights
'wiki_userrights' => 'Раководење со кориснички права',
'wiki_userrights-lookup-wiki_user' => 'Раководење со кориснички групи',
'wiki_userrights-wiki_user-editname' => 'Внесете корисничко име:',
'editwiki_usergroup' => 'Уреди кориснички групи',
'editingwiki_user' => "Менување на корисничките права на корисникот '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Уреди ги корисничките групи',
'savewiki_usergroups' => 'Зачувај ги корисничките групи',
'wiki_userrights-groupsmember' => 'Член на:',
'wiki_userrights-groupsmember-auto' => 'Подразбран член на:',
'wiki_userrights-groups-help' => 'Можете да измените на кои групи припаѓа корисник:
...
'wiki_userrights-no-interwiki' => 'Немате дозвола за уредување на кориснички права на други викија.',
'wiki_userrights-nodatabase' => 'Базата на податоци $1 не постои или не е локална.',
'wiki_userrights-nologin' => 'Мора да сте [[Special:wiki_userLogin|најавени]] со администраторска корисничка сметка за да може да вршите промена на кориснички права.',
'wiki_userrights-notallowed' => 'Вашата корисничка сметка нема дозвола за додавање и отстранување на кориснички права.',
'wiki_userrights-changeable-col' => 'Групи кои може да ги промените',
'wiki_userrights-unchangeable-col' => 'Групи кои не може да ги промените',
...
'group-wiki_user-member' => 'корисник',
...
'right-move-rootwiki_userpages' => 'Преместување на основна корисничка страница',
...
'right-hidewiki_user' => 'Блокирање корисници, сокривање од јавноста',
...
'right-editwiki_usercssjs' => 'Уредување на CSS и JS податотеки на други корисници',
'right-editwiki_usercss' => 'Уредување на CSS податотеки на други корисници',
'right-editwiki_userjs' => 'Уредување на JS податотеки на други корисници',
...
'right-wiki_userrights' => 'Уредување на сите кориснички права',
'right-wiki_userrights-interwiki' => 'Уредување на кориснички права на корисници на други викија',
...
'action-move-rootwiki_userpages' => 'преместување на основна корисничка страница',
...
'action-wiki_userrights' => 'уредување на сите кориснички права',
'action-wiki_userrights-interwiki' => 'уредување на кориснички права на корисници на други викија',
...
'newpageletter' => 'Н',
'boteditletter' => 'б',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|корисник што набљудува|корисници што набљудуваат}}]',
...
'uploadnologintext' => 'Морате да [[Special:wiki_userLogin|се најавите]] за да можете да подигате податотеки.',
...
Молиме контактирајте некој [[Special:Listwiki_users/sysop|администратор]].',
...
Ако пак се појави проблем, обратете се кај некој [[Special:Listwiki_users/sysop|администратор]].',
...
'statistics-header-wiki_users' => 'Статистики за корисници',
...
'statistics-wiki_users' => 'Регистрирани [[Special:Listwiki_users|корисници]]',
'statistics-wiki_users-active' => 'Активни корисници',
'statistics-wiki_users-active-desc' => 'Корисници кои имаат извршено некое дејство {{PLURAL:$1|претходниот ден|во претходните $1 дена}}',
...
'listwiki_users' => 'Список на корисници',
'listwiki_users-editsonly' => 'Прикажи само корисници кои уредувале',
'listwiki_users-creationsort' => 'Подреди по датум на создавање',
'wiki_usereditcount' => '$1 {{PLURAL:$1|уредување|уредувања}}',
'wiki_usercreated' => '{{GENDER:$3|Создадена}} на $1 во $2 ч.',
...
# Special:Log
'speciallogwiki_userlabel' => 'Изведувач:',
...
'listwiki_usersfrom' => 'Прикажи корисници почнувајќи од:',
'listwiki_users-submit' => 'Прикажи',
'listwiki_users-noresult' => 'Не е пронајден корисник.',
'listwiki_users-blocked' => '(блокиран)',

# Special:Activewiki_users
'activewiki_users' => 'Список на активни корисници',
'activewiki_users-intro' => 'Ова е список на корисници кои биле на некој начин активни во последните $1 {{PLURAL:$1|ден|дена}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|дејство|дејства}} {{PLURAL:$3|денес|во последните $3 дена}}',
'activewiki_users-from' => 'Прикажи корисници почнувајќи од:',
'activewiki_users-hidebots' => 'Скриј ботови',
'activewiki_users-hidesysops' => 'Скриј администратори',
'activewiki_users-noresult' => 'Нема пронајдено корисници.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Дневник на регистрирања на корисници',
'newwiki_userlogpagetext' => 'Ова е дневник на регистрирани корисници.',
...
'mailnologintext' => 'Мора да сте [[Special:wiki_userLogin|најавени]] и да имате важечка е-поштенска адреса во вашите [[Special:Preferences|нагодувања]] за да може да праќате е-пошта до други корисници.',
'emailwiki_user' => 'Пиши е-пошта на корисникот',
'emailwiki_user-title-target' => 'Составување на е-пошта за {{GENDER:$1|корисникот}}',
'emailwiki_user-title-notarget' => 'Е-пошта за корисникот',
'emailpage' => 'Е-пошта',
...
'wiki_usermailererror' => 'Настана следната грешка при праќање е-пошта:',
'defemailsubject' => '{{SITENAME}} — писмо од корисникот „$1“',
'wiki_usermaildisabled' => 'Корисничката е-пошта е оневозможена',
'wiki_usermaildisabledtext' => 'Не можете да испратите е-порака до дрги корисници на ова вики',
...
'emailwiki_usernamesubmit' => 'Поднеси',
...
'emailwiki_userfooter' => 'Оваа е-порака беше пратена од $1 до $2 со помош на функцијата Е-пошта на {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Оставете системска порака.',
'wiki_usermessage-editor' => 'Системски гласник',
...
'watchnologintext' => 'Мора да сте [[Special:wiki_userLogin|најавени]] за да го менувате списокот на набљудувања.',
...
'alreadyrolled' => 'Не може да се отповика последното уредување на страницата „[[:$1]]“ извршено од  [[wiki_user:$2|$2]] ([[wiki_user talk:$2|разговор]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]);
некој друг веќе ја изменил или отповикал страницата.

Последното уредување го изврши [[wiki_user:$3|$3]] ([[wiki_user talk:$3|разговор]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Коментарот на уредувањето беше: „''$1''“.",
'revertpage' => 'Отстрането уредувањето на [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|разговор]]), вратено на последната верзија на [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Вратени уредувања на (избришано корисничко име) на последната ревизија од [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'раководење со кориснички права',
...
'sp-contributions-wiki_username' => 'IP-адреса или корисничко име:',
...
'ipadressorwiki_username' => 'IP-адреса или корисничко име:',
...
'ipbwatchwiki_user' => 'Набљудувај ја корисничката страница и страницата за разговор на овој корисник',
'ipb-disablewiki_usertalk' => 'Спречи го корисников да ја уредува неговата страница за разговор додека е блокиран',
...
'ipb-confirmhidewiki_user' => 'Сакате да блокирате корисник со можноста „скриј корисник“. Ова ќе го затаи името на корисникот во сите списоци и дневнички записи. Дали сте сигурни дека сакате да го направите тоа?',
...
'unblocked' => '[[wiki_user:$1|$1]] беше деблокиран',
...
'blocklist-wiki_userblocks' => 'Скриј блокирања на корис. сметки',
...
'blocklist-nowiki_usertalk' => 'без можност за уредување на својата страница за разговор',
...
'autoblocker' => 'Автоматски сте блокирани бидејќи вашата IP-адреса била скоро користена од „[[wiki_user:$1|$1]]“.
...
'block-log-flags-nowiki_usertalk' => 'без можност за уредување на својата страница за разговор',
...
'unblock-hidewiki_user' => 'Не можете да го одблокирате корисников бидејќи неговото корисничко име е скриено.',
...
'cant-see-hidden-wiki_user' => 'Корисникот кој се обидувате да го блокирате е веќе блокиран и сокриен. Бидејќи вие немате права за сокривање на корисник, не можете да ги видите или уредувате корисничките блокирања.',
...
'movewiki_userpage-warning' => "'''Предупредување:''' На пат сте да преместите корисничка страница. Имајте предвид дека само страницата ќе биде преместена, а самиот корисник ''нема'' да биде преименуван.",
'movenologin' => 'Не сте најавени',
'movenologintext' => 'Мора да бидете регистриран корисник и да сте [[Special:wiki_userLogin|најавени]] за да можете да преместувате страници.',
...
'cant-move-wiki_user-page' => 'Немате дозвола за преместување на основни кориснички страници (освен потстраници).',
'cant-move-to-wiki_user-page' => 'Немате дозвола за преместување на страница во ваша корисничка страница (освен во корисничка потстраница)',
...
'tooltip-pt-wiki_userpage' => 'Вашата корисничка страница',
'tooltip-pt-anonwiki_userpage' => 'Корисничка страница за IP-адресата од која уредувате',
...
'tooltip-t-emailwiki_user' => 'Испрати е-пошта на овој корисник',
...
'tooltip-ca-nstab-wiki_user' => 'Преглед на корисничката страница',
...
'anonwiki_user' => '{{SITENAME}} анонимен корисник $1',
'lastmodifiedatby' => 'Оваа страница е последен пат изменета на $1 во $2 ч. од $3.',
'othercontribs' => 'Засновано на работата на $1.',
'others' => 'други',
'sitewiki_users' => '{{PLURAL:$2|корисникот|корисниците}} на {{SITENAME}} $1',
'anonwiki_users' => '{{PLURAL:$2|анонимен корисник|анонимни корисници}} на {{SITENAME}} $1',
...
'spambot_wiki_username' => 'МедијаВики чистач на спам',
...
'pageinfo-firstwiki_user' => 'Создавач на страницата',
'pageinfo-firsttime' => 'Датум на создавање на страницата',
'pageinfo-lastwiki_user' => 'Последен уредник',
...
Сега можете да се [[Special:wiki_userLogin|најавите]]. Ви посакуваме пријатни мигови на викито!',
...
'confirmrecreate' => "Корисникот [[wiki_user:$1|$1]] ([[wiki_user talk:$1|разговор]]) ја избриша оваа страница откако вие почнавте со уредување заради:
: ''$2''
Потврдете дека навистина сакате повторно да ја создадете оваа страница.",
'confirmrecreate-noreason' => 'Корисникот [[wiki_user:$1|$1]] ([[wiki_user talk:$1|разговор]]) ја избриша страницава откако почнавте да ја уредувате.  Потврдете деак навистина сакате да ја пресоздадете страницата.',
...
'specialpages-group-wiki_users' => 'Корнисници и кориснички права',
...
'logentry-newwiki_users-newwiki_users' => 'Направена е корисничката сметка $1',
'logentry-newwiki_users-create' => 'Направена е корисничката сметка $1',
'logentry-newwiki_users-create2' => 'Направена е корисничката сметка $3; создавач: $1',
'logentry-newwiki_users-autocreate' => 'Сметката $1 е создадена автоматски',
'newwiki_userlog-byemail' => 'испратена лозинка по е-пошта',
