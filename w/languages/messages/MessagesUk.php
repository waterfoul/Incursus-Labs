...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Активні_дописувачі' ),
	...
	'Emailwiki_user'                 => array( 'Лист_користувачеві' ),
	...
	'Listwiki_users'                 => array( 'Список_користувачів' ),
	...
	'wiki_userlogin'                 => array( 'Вхід' ),
	'wiki_userlogout'                => array( 'Вихід' ),
	'wiki_userrights'                => array( 'Керування_правами_користувачів' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'КІЛЬКІСТЬ_КОРИСТУВАЧІВ', 'КОЛИЧЕСТВО_УЧАСТНИКОВ', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'КІЛЬКІСТЬ_АКТИВНИХ_КОРИСТУВАЧІВ', 'КОЛИЧЕСТВО_АКТИВНЫХ_УЧАСТНИКОВ', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'ВЕРСІЯ_КОРИСТУВАЧА', 'ВЕРСИЯ_УЧАСНИКА', 'REVISIONUSER' ),
...
'tog-enotifwiki_usertalkpages' => 'Повідомляти електронною поштою про зміну моєї сторінки обговорення',
...
'views' => 'Перегляди',
'toolbox' => 'Інструменти',
'wiki_userpage' => 'Переглянути сторінку користувача',
...
'youhavenewmessagesfromwiki_users' => 'Ви отримали $1 від {{PLURAL:$3|іншого дописувача|$3 інших дописувачів}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Ви отримали $1 від багатьох дописувачів ($2).',
...
'nstab-main' => 'Стаття',
'nstab-wiki_user' => 'Сторінка користувача',
...
Будь ласка, повідомте про це [[Special:Listwiki_users/sysop|адміністратора]], зазначивши URL.',
...
'titleprotected' => "Створення сторінки з такою назвою було заборонене користувачем [[wiki_user:$1|$1]].
...
Ви можете продовжувати використовувати {{grammar:accusative|{{SITENAME}}}} анонімно або знову [[Special:wiki_userLogin|ввійти до системи]] як той самий або інший користувач. Деякі сторінки можуть відображатися, ніби ви ще представлені системі під іменем, щоб уникнути цього, оновіть кеш браузера.",
...
'wiki_userlogin' => 'Вхід / реєстрація',
'wiki_userloginnocreate' => 'Увійти',
'logout' => 'Вихід із системи',
'wiki_userlogout' => 'Вихід із системи',
...
'wiki_userlogin-resetlink' => 'Забули дані, потрібні для входу?',
'createaccountmail' => 'електронною поштою',
'createaccountreason' => 'Причина:',
'badretype' => 'Уведені вами паролі не збігаються.',
'wiki_userexists' => "Уведене ім'я користувача вже існує.
...
'nosuchwiki_user' => 'Користувач з іменем «$1» не існує.
Імена користувачів регістрозалежні.
Перевірте правильність написання або скористайтеся формою нижче, щоб [[Special:wiki_userLogin/signup|зареєструвати нового користувача]].',
'nosuchwiki_usershort' => 'Користувач з іменем $1 не існує.
Перевірте правильність написання імені.',
'nowiki_userspecified' => "Ви повинні зазначити ім'я користувача.",
'login-wiki_userblocked' => 'Цей користувач заблокований. Вхід в систему не дозволений.',
...
'wiki_usernamehasherror' => "Ім'я користувача не може містити символу «решітка»",
...
'suspicious-wiki_userlogout' => 'Ваш запит на завершення сеанса відхилений, оскільки він схожий на запит, відправлений зіпсованим веб-оглядачем або кешуючим проксі-сервером.',

# E-mail sending
'php-mail-error-unknown' => 'Невідома помилка в PHP-mail() функції',
'wiki_user-mail-no-addy' => 'Спроба надсилання електронної пошти без зазначеної адреси електронної пошти.',
...
'passwordreset-wiki_username' => "Ім'я користувача:",
...
'passwordreset-emailtext-wiki_user' => "Користувач $1 з {{SITENAME}} попросив нагадати деталі Вашого облікового запису для {{SITENAME}} ($4). З Вашою електронною скринькою пов'язан{{PLURAL:$3|ий такий запис|і такі записи}}:
...
'accmailtext' => "Пароль для користувача [[wiki_user talk:$1|$1]], згенерований випадковим чином, надісланий на адресу $2.
...
Якщо ви — анонімний користувач і вважаєте, що отримали коментарі, адресовані не вам, будь ласка [[Special:wiki_userLogin/signup|зареєструйтесь]] або [[Special:wiki_userLogin|увійдіть до системи]], щоб у майбутньому уникнути можливої плутанини з іншими анонімними користувачами.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Користувач під назвою "<nowiki>$1</nowiki>" не зареєстрований. Переконайтеся, що ви хочете створити/редагувати цю сторінку.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Обліковий запис користувача „$1“ не зареєстровано.',
...
'wiki_usercssyoucanpreview' => "'''Підказка:''' використовуйте кнопку «{{int:showpreview}}», щоб протестувати ваш новий css-файл перед збереженням.",
'wiki_userjsyoucanpreview' => "'''Підказка:''' використовуйте кнопку «{{int:showpreview}}», щоб протестувати ваш новий код JavaScript перед збереженням.",
'wiki_usercsspreview' => "'''Пам'ятайте, що це лише попередній перегляд вашого css-файлу.'''
'''Його ще не збережено!'''",
'wiki_userjspreview' => "'''Пам'ятайте, що це тільки попередній перегляд вашого JavaScript-файлу і поки він ще не збережений!'''",
...
'''Його ще не збережено!'''",
'wiki_userinvalidcssjstitle' => "'''Увага:''' тема оформлення «$1» не знайдена.
Пам'ятайте, що користувацькі .css та .js сторінки повинні мати назву, що складається лише з малих літер, наприклад «{{ns:wiki_user}}:Хтось/vector.css», а не «{{ns:wiki_user}}:Хтось/Vector.css».",
'updated' => '(Оновлена)',
'note' => "'''Зауваження:'''",
...
Якщо помилка буде повторюватись, спробуйте [[Special:wiki_userLogout|вийти з системи]] і зайти знову.'''",
...
<strong>Якщо це доброякісна спроба редагування, будь ласка, спробуйте ще раз. Якщо не вийде знову, - спробуйте [[Special:wiki_userLogout|завершити сеанс роботи]] й ще раз ввійти до системи.</strong>",
...
Ви можете повернуться назад й змінити існуючу сторінку, [[Special:wiki_userLogin|ввійти в систему, або створити новий обліковий запис]].',
...
'undo-summary' => 'Скасування редагування № $1 користувача [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|обговорення]])',

# Account creation failure
'cantcreateaccounttitle' => 'Неможливо створити обліковий запис',
'cantcreateaccount-text' => "Створення облікових записів із цієї IP-адреси ('''$1''') було заблоковане [[wiki_user:$3|користувачем $3]].
...
'rev-deleted-wiki_user' => "(ім'я автора стерто)",
'rev-deleted-event' => '(запис журналу вилучений)',
'rev-deleted-wiki_user-contribs' => "[ім'я користувача або IP-адреса вилучені — редагування приховане у внеску]",
...
'revdelete-hide-wiki_user' => "Приховати ім'я автора",
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|не показана $1 проміжна я версія|не показані $1 проміжні версії|не показано $1 проміжних версій}}, зроблених більш, ніж {{PLURAL:$2|$1 користувачем|$2 користувачами}})',
...
'prefsnologintext' => 'Щоб змінити налаштування користувача, ви повинні <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} ввійти до системи]</span>.',
...
'prefs-wiki_user-pages' => 'Сторінки користувача',
...
'wiki_username' => "Ім'я користувача:",
...
# wiki_user rights
'wiki_userrights' => 'Управління правами користувачів',
'wiki_userrights-lookup-wiki_user' => 'Управління групами користувача',
'wiki_userrights-wiki_user-editname' => "Введіть ім'я користувача:",
'editwiki_usergroup' => 'Редагувати групи користувача',
'editingwiki_user' => "Зміна прав користувача '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Змінити групи користувача',
'savewiki_usergroups' => 'Зберегти групи користувача',
'wiki_userrights-groupsmember' => 'Член груп:',
'wiki_userrights-groupsmember-auto' => 'Неявний член:',
'wiki_userrights-groups-help' => 'Ви можете змінити групи, до яких належить цей користувач:
...
'wiki_userrights-reason' => 'Причина:',
'wiki_userrights-no-interwiki' => 'У вас нема дозволу змінювати права користувачів на інших вікі.',
'wiki_userrights-nodatabase' => 'База даних $1 не існує або не є локальною.',
'wiki_userrights-nologin' => 'Ви повинні [[Special:wiki_userLogin|ввійти до системи]] з обліковим записом адміністратора, щоб призначати права користувачам.',
'wiki_userrights-notallowed' => 'Ваш обліковий запис не дозволяє призначати або змінювати права користувачів.',
'wiki_userrights-changeable-col' => 'Групи, які ви можете змінити',
'wiki_userrights-unchangeable-col' => 'Групи, які ви не можете змінити',
'wiki_userrights-irreversible-marker' => '$1*',

# Groups
'group' => 'Група:',
'group-wiki_user' => 'Користувачі',
...
'group-wiki_user-member' => '{{GENDER:$1|користувач|користувачка}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Користувачі',
...
'right-move-rootwiki_userpages' => 'Перейменувати кореневі сторінки користувачів',
...
'right-hidewiki_user' => 'Блокування імені користувача і приховування його',
...
'right-editwiki_usercssjs' => 'Редагування CSS- і JS-файлів інших користувачів',
'right-editwiki_usercss' => 'Редагування CSS-файлів інших користувачів',
'right-editwiki_userjs' => 'Редагування JS-файлів інших користувачів',
...
'right-wiki_userrights' => 'Зміна всіх прав користувачів',
'right-wiki_userrights-interwiki' => 'Зміна прав користувачів у інших вікі',
...
'action-move-rootwiki_userpages' => 'перейменувати кореневі сторінки користувачів',
...
'action-wiki_userrights' => 'зміну всіх прав користувача',
'action-wiki_userrights-interwiki' => 'зміну прав користувачів у інших вікі',
...
'boteditletter' => 'б',
'unpatrolledletter' => '!',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|користувач спостерігає|користувачі спостерігають|користувачів спостерігають}}]',
...
'uploadnologintext' => 'Ви повинні [[Special:wiki_userLogin|ввійти до системи]], щоб завантажувати файли.',
...
'upload-file-error-text' => 'Сталася внутрішня помилка при спробі створити тимчасовий файл на сервері. Будь-ласка, зверніться до [[Special:Listwiki_users/sysop|адміністратора]].',
...
'listfiles_wiki_user' => 'Користувач',
...
'statistics-header-wiki_users' => 'Статистика користувачів',
...
'statistics-wiki_users' => 'Зареєстрованих [[Special:Listwiki_users|користувачів]]',
'statistics-wiki_users-active' => 'Активні користувачі',
'statistics-wiki_users-active-desc' => 'Користувачі, які здійснили якусь дію протягом {{PLURAL:$1|минулого дня|минулих $1 днів}}',
...
'listwiki_users' => 'Список користувачів',
'listwiki_users-editsonly' => 'Показати лише користувачів, які зробили принаймні одне редагування',
'listwiki_users-creationsort' => 'Сортувати за датою створення',
'wiki_usereditcount' => '$1 {{PLURAL:$1|редагування|редагування|редагувань}}',
'wiki_usercreated' => '{{GENDER:$3|Створено}} $1 о $2',
'newpages' => 'Нові сторінки',
'newpages-wiki_username' => "Ім'я користувача:",
...
# Special:Log
'speciallogwiki_userlabel' => 'Виконавець:',
...
'listwiki_usersfrom' => 'Показати користувачів, починаючи з:',
'listwiki_users-submit' => 'Показати',
'listwiki_users-noresult' => 'Не знайдено користувачів.',
'listwiki_users-blocked' => '({{GENDER:$1|заблокований|заблокована|заблокований}})',

# Special:Activewiki_users
'activewiki_users' => 'Список активних користувачів',
'activewiki_users-intro' => 'Це список користувачів, які здійснювали які-небудь дії за {{PLURAL:$1|останній $1 день|останні $1 дні|останні $1 днів}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|дія|дії|дій}} за {{PLURAL:$3|останній $3 день|останні $3 дні|останні $3 днів}}',
'activewiki_users-from' => 'Показувати користувачів, починаючи з:',
'activewiki_users-hidebots' => 'Приховати ботів',
'activewiki_users-hidesysops' => 'Приховати адміністраторів',
'activewiki_users-noresult' => 'Не знайдено користувачів.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Журнал нових користувачів',
'newwiki_userlogpagetext' => 'Список нещодавно зареєстрованих користувачів.',
...
'mailnologintext' => 'Ви повинні [[Special:wiki_userLogin|ввійти до системи]] і мати підтверджену адресу електронної пошти у ваших [[Special:Preferences|налаштуваннях]], щоб мати змогу надсилати електронну пошту іншим користувачам.',
'emailwiki_user' => 'Надіслати листа',
'emailwiki_user-title-target' => 'Надіслати електронного листа {{GENDER:$1|користувачеві|користувачці}}',
'emailwiki_user-title-notarget' => 'Надіслати електронного листа користувачеві',
...
'wiki_usermailererror' => 'При відправці повідомлення електронної пошти сталася помилка:',
'defemailsubject' => '{{SITENAME}} - електронний лист від користувача " $1 "',
'wiki_usermaildisabled' => 'Електронне листування між користувачами вимкнене',
'wiki_usermaildisabledtext' => 'Ви не можете надсилати електронні листи іншим користувачам цієї вікі',
...
'emailwiki_username' => "Ім'я користувача:",
'emailwiki_usernamesubmit' => 'Надіслати',
...
'emailwiki_userfooter' => 'Цей лист був надісланий користувачеві $2 від користувача $1 за допомогою функції «Надіслати листа» проекту {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Залишити системне повідомлення.',
'wiki_usermessage-editor' => 'Системний вісник',
...
'watchnologintext' => 'Ви повинні [[Special:wiki_userLogin|ввійти до системи]], щоб мати можливість змінювати список спостереження.',
...
'alreadyrolled' => 'Неможливо відкинути останні редагування [[:$1]], зроблені [[wiki_user:$2|$2]] ([[wiki_user talk:$2|обговорення]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]), оскільки хтось інший уже змінив чи відкинув редагування цієї статті.

Останні редагування зроблено [[wiki_user:$3|$3]] ([[wiki_user talk:$3|обговорення]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Пояснення редагування було: «''$1''».",
'revertpage' => 'Редагування користувача [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|обговорення]]) відкинуті до версії користувача [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => "Відкинуто редагування (ім'я користувача приховано) до зробленого [[wiki_user:$1|$1]]",
...
'sp-contributions-wiki_userrights' => 'управління правами користувача',
...
'sp-contributions-wiki_username' => "IP-адреса або ім'я користувача:",
...
'ipadressorwiki_username' => "IP-адреса або ім'я користувача:",
'ipbexpiry' => 'Термін:',
'ipbreason' => 'Причина:',
...
'ipbwatchwiki_user' => 'Додати до списку спостереження сторінку користувача і його обговорення',
'ipb-disablewiki_usertalk' => 'Заборонити користувачу редагувати свою сторінку обговорення під час блокування',
...
'ipb-confirmhidewiki_user' => "Ви збираєтеся заблокувати користувача з опцією приховання імені. Це вилучить його ім'я з усіх списків та журналів. Ви точно хочете це зробити?",
...
'unblocked' => '[[wiki_user:$1|$1]] розблокований',
...
'blocklist-wiki_userblocks' => 'Сховати блокування облікових записів',
...
'blocklist-nowiki_usertalk' => 'не може редагувати свою сторінку обговорення',
...
'autoblocker' => 'Доступ заблоковано автоматично, тому що ви використовуєте ту саму адресу, що й "[[wiki_user:$1|$1]]". Причина блокування $1: "$2".',
...
'block-log-flags-nowiki_usertalk' => 'не може редагувати власну сторінку обговорення',
...
'unblock-hidewiki_user' => "Ви не можете розблокувати цього користувача, оскільки його ім'я було приховано.",
...
'cant-see-hidden-wiki_user' => 'Користувача, якого ви хочете заблокувати, вже заблоковано та приховано. Оскільки у вас немає прав щодо приховання користувачів, ви не можете переглянути або змінити дане блокування.',
...
'movewiki_userpage-warning' => "'''Увага:''' Ви збираєтеся перейменувати сторінку користувача. Будь ласка, зверніть увагу, що  буде перейменовано тільки сторінку, але користувача '''не''' буде перейменовано.",
'movenologin' => 'Ви не ввійшли в систему',
'movenologintext' => 'Ви повинні [[Special:wiki_userLogin|ввійти до системи]], щоб перейменувати сторінку.',
'movenotallowed' => 'У вас нема дозволу перейменовувати сторінки.',
'movenotallowedfile' => 'У вас немає прав перейменовувати файли.',
'cant-move-wiki_user-page' => 'У вас нема дозволу перейменовувати сторінки користувачів.',
'cant-move-to-wiki_user-page' => 'У вас нема дозволу перейменовувати сторінки на сторінки простору «Користувач» (окрім підсторінок)',
'newtitle' => 'Нова назва:',
...
'tooltip-pt-wiki_userpage' => 'Ваша сторінка користувача',
'tooltip-pt-anonwiki_userpage' => 'Сторінка користувача для вашої IP-адреси',
...
'tooltip-t-emailwiki_user' => 'Надіслати листа цьому користувачеві',
...
'tooltip-ca-nstab-wiki_user' => 'Перегляд сторінки користувача',
...
'sitewiki_user' => 'Користувач {{grammar:genitive|{{SITENAME}}}} $1',
'anonwiki_user' => 'анонімний користувач {{grammar:genitive|{{SITENAME}}}} $1',
'lastmodifiedatby' => 'Остання зміна $2, $1 користувачем $3.',
'othercontribs' => 'Базується на праці $1.',
'others' => 'інші',
'sitewiki_users' => '{{PLURAL:$2|Користувач|Користувачі}} {{grammar:genitive|{{SITENAME}}}} $1',
'anonwiki_users' => '{{PLURAL:$2|анонімний користувач|анонімні користувачі}} {{grammar:genitive|{{SITENAME}}}} $1',
'creditspage' => 'Подяки',
...
'spambot_wiki_username' => 'Очистка спаму',
...
'pageinfo-firstwiki_user' => 'Створив сторінку',
'pageinfo-firsttime' => 'Дата створення сторінки',
'pageinfo-lastwiki_user' => 'Останній редактор',
...
'exif-wiki_usercomment' => 'Додатковий коментар',
...
'confirmrecreate' => "Користувач [[wiki_user:$1|$1]] ([[wiki_user talk:$1|обговорення]]) вилучив цю сторінку після того, як ви почали редагування і зазначив причиною:
: ''$2''
Будь ласка, підтвердьте, що ви дійсно бажаєте створити цю сторінку заново.",
'confirmrecreate-noreason' => 'Користувач [[wiki_user:$1|$1]] ([[wiki_user talk:$1|обг]]) вилучив цю сторінку після того, як ви її почали редагувати. Будь-ласка, підтвердіть, що ви дійсно хочете її відновити.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|обговорення]])',
'timezone-utc' => 'UTC',
...
'specialpages-group-wiki_users' => 'Користувачі і права',
...
'logentry-newwiki_users-newwiki_users' => 'Створено обліковий запис $1',
'logentry-newwiki_users-create' => '$1 — створено обліковий запис',
'logentry-newwiki_users-create2' => '$1 {{GENDER:$2|створив|створила}} обліковий запис {{GENDER:$4|користувача|користувачки}} $3',
'logentry-newwiki_users-autocreate' => '$1 — автоматично створений обліковий запис',
'newwiki_userlog-byemail' => 'пароль надісланий електронною поштою',
