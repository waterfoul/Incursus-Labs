...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Pengguna_aktif' ),
	...
	'Emailwiki_user'                 => array( 'E-mel_pengguna' ),
	...
	'Listwiki_users'                 => array( 'Senarai_pengguna' ),
...
'tog-enotifwiki_usertalkpages' => 'E-melkan saya apabila berlaku perubahan pada laman perbincangan saya',
...
'views' => 'Rupa',
'toolbox' => 'Alatan',
'wiki_userpage' => 'Lihat laman pengguna',
...
'youhavenewmessagesfromwiki_users' => 'Anda menerima $1 daripada {{PLURAL:$3|seorang|$3 orang}} pengguna lain ($2).',
'youhavenewmessagesmanywiki_users' => 'Anda menerima $1 daripada ramai pengguna ($2).',
...
'nstab-main' => 'Laman',
'nstab-wiki_user' => 'Laman pengguna',
...
'wiki_userlogin' => 'Log masuk / buka akaun',
'wiki_userloginnocreate' => 'Log masuk',
'logout' => 'Log keluar',
'wiki_userlogout' => 'Log keluar',
...
'wiki_userlogin-resetlink' => 'Lupa nama pengguna/kata laluan anda?',
'createaccountmail' => 'melalui e-mel',
'createaccountreason' => 'Sebab:',
'badretype' => 'Sila ulangi kata laluan dengan betul.',
'wiki_userexists' => 'Nama pengguna yang diisikan telah pun digunakan.
...
'nosuchwiki_user' => 'Pengguna "$1" tidak wujud. Nama pengguna adalah peka huruf besar. Sila semak ejaan anda, atau anda boleh [[Special:wiki_userLogin/signup|membuka akaun baru]].',
'nosuchwiki_usershort' => 'Pengguna "$1" tidak wujud. Sila semak ejaan anda.',
'nowiki_userspecified' => 'Sila nyatakan nama pengguna.',
'login-wiki_userblocked' => 'Pengguna ini disekat. Log masuk tidak dibenarkan.',
...
'wiki_usernamehasherror' => 'Nama pengguna tidak boleh memiliki aksara cincangan',
...
'suspicious-wiki_userlogout' => 'Permintaan anda untuk log keluar ditolak kerana ia kelihatan seperti dihantar oleh pelayar rosak atau proksi pengagregatan.',

# E-mail sending
'php-mail-error-unknown' => 'Ralat tak diketahui dalam fungsi mail() PHP',
'wiki_user-mail-no-addy' => 'E-eml cuba dihantar tanpa alamat e-mel',
...
'passwordreset-emailtext-wiki_user' => 'Pengguna $1 di {{SITENAME}} memohon peringatan butiran akaun anda untuk {{SITENAME}} ($4). {{PLURAL:$3|Akaun|Akaun-akaun}} pengguna yang berikut dikaitkan dengan alamat e-mel ini:
...
'wiki_userpage-wiki_userdoesnotexist' => 'Akaun pengguna "<nowiki>$1</nowiki>" tidak berdaftar. Sila pastikan sama ada anda mahu mencipta/menyunting laman ini.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Akaun pengguna "$1" tidak berdaftar.',
...
'wiki_usercssyoucanpreview' => "'''Petua:''' Gunakan butang \"{{int:showpreview}}\" untuk menguji CSS baru anda sebelum menyimpan.",
'wiki_userjsyoucanpreview' => "'''Petua:''' Gunakan butang \"{{int:showpreview}}\" untuk menguji JavaScript baru anda sebelum menyimpan.",
'wiki_usercsspreview' => "'''Ingat bahawa anda hanya sedang melihat pralihat CSS peribadi anda. Laman ini belum lagi disimpan!'''",
'wiki_userjspreview' => "'''Ingat bahawa anda hanya menguji/melihat pralihat JavaScript anda, ia belum lagi disimpan!'''",
...
'''Ia belum lagi disimpan!'''",
'wiki_userinvalidcssjstitle' => "'''Amaran:''' Rupa \"\$1\" tidak wujud. Ingat bahawa laman tempahan .css dan .js menggunakan tajuk berhuruf kecil, contohnya {{ns:wiki_user}}:Anu/vector.css tidak sama dengan {{ns:wiki_user}}:Anu/Vector.css.",
...
'rev-deleted-wiki_user' => '(nama pengguna dibuang)',
'rev-deleted-event' => '(entri dibuang)',
'rev-deleted-wiki_user-contribs' => '[nama pengguna atau alamat IP dibuang - suntingan disembunyikan daripada sumbangan]',
...
'diff-multi-manywiki_users' => '($1 {{PLURAL:$1|semakan pertengahan|semakan pertengahan}} oleh lebih daripada $2 {{PLURAL:$2|pengguna|pengguna}} tidak dipaparkan)',
...
'prefs-wiki_user-pages' => 'Laman pengguna',
...
# wiki_user rights
'wiki_userrights' => 'Pengurusan hak pengguna',
'wiki_userrights-lookup-wiki_user' => 'Urus kumpulan pengguna',
'wiki_userrights-wiki_user-editname' => 'Masukkan nama pengguna:',
'editwiki_usergroup' => 'Sunting Kumpulan Pengguna',
'editingwiki_user' => "Mengubah hak pengguna '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Ubah kumpulan pengguna',
'savewiki_usergroups' => 'Simpan Kumpulan Pengguna',
'wiki_userrights-groupsmember' => 'Ahli bagi:',
'wiki_userrights-groupsmember-auto' => 'Ahli automatik bagi:',
'wiki_userrights-groups-help' => 'Anda boleh mengubah keahlian kumpulan bagi pengguna ini:
...
'wiki_userrights-reason' => 'Sebab:',
'wiki_userrights-no-interwiki' => 'Anda tidak mempunyai keizinan untuk mengubah hak-hak pengguna di wiki lain.',
'wiki_userrights-nodatabase' => 'Pangkalan data $1 tiada atau bukan tempatan.',
'wiki_userrights-nologin' => 'Anda mesti [[Special:wiki_userLogin|log masuk]] dengan akaun pentadbir terlebih dahulu untuk memperuntukkan hak-hak pengguna.',
'wiki_userrights-notallowed' => 'Akuan anda tidak dibenarkan untuk menambah atau membuang hak pengguna.',
'wiki_userrights-changeable-col' => 'Kumpulan yang anda boleh ubah',
'wiki_userrights-unchangeable-col' => 'Kumpulan yang anda tak boleh ubah',
...
'right-move-rootwiki_userpages' => 'Memindahkan laman induk pengguna',
...
'right-hidewiki_user' => 'Menyekat sesebuah nama pengguna, menyembunyikannya daripada orang ramai',
...
'right-editwiki_usercssjs' => 'Menyunting fail CSS dan JavaScript pengguna lain',
'right-editwiki_usercss' => 'Menyunting fail CSS pengguna lain',
'right-editwiki_userjs' => 'Menyunting fail JavaScript pengguna lain',
...
'right-wiki_userrights' => 'Menyerahkan dan menarik balik sebarang hak pengguna',
'right-wiki_userrights-interwiki' => 'Menyerahkan dan menarik balik hak pengguna di wiki lain',
...
'action-move-rootwiki_userpages' => 'memindahkan laman induk pengguna',
...
'action-wiki_userrights' => 'mengubah semua hak pengguna',
'action-wiki_userrights-interwiki' => 'mengubah hak pengguna dari wiki lain',
...
'boteditletter' => 'b',
'unpatrolledletter' => '!',
'number_of_watching_wiki_users_pageview' => '[$1 pemantau]',
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Pengguna]] berdaftar',
'statistics-wiki_users-active' => 'Pengguna aktif',
'statistics-wiki_users-active-desc' => 'Pengguna yang aktif sejak {{PLURAL:$1|semalam|$1 hari lalu}}',
...
'listwiki_users' => 'Senarai pengguna',
'listwiki_users-editsonly' => 'Hanya papar pengguna yang telah membuat suntingan',
'listwiki_users-creationsort' => 'Susun mengikut tarikh penciptaan',
'wiki_usereditcount' => '$1 suntingan',
'wiki_usercreated' => '{{GENDER:$3|Dibuat}} pada $1, $2',
'newpages' => 'Laman baru',
...
# Special:Log
'speciallogwiki_userlabel' => 'Pelaku:',
...
'listwiki_usersfrom' => 'Tunjukkan pengguna bermula pada:',
'listwiki_users-submit' => 'Tunjukkan',
'listwiki_users-noresult' => 'Tiada pengguna dijumpai.',
'listwiki_users-blocked' => '(disekat)',

# Special:Activewiki_users
'activewiki_users' => 'Senarai pengguna aktif',
'activewiki_users-intro' => 'Yang berikut ialah senarai pengguna yang bergiat sejak {{PLURAL:$1|semalam|$1 hari lalu}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|suntingan|suntingan}} sejak {{PLURAL:$3|semalam|$3 hari lalu}}',
'activewiki_users-from' => 'Tunjukkan pengguna bermula pada:',
'activewiki_users-hidebots' => 'Sorokkan bot',
'activewiki_users-hidesysops' => 'Sorokkan pentadbir',
'activewiki_users-noresult' => 'Tiada pengguna dijumpai.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Log akaun baru',
'newwiki_userlogpagetext' => 'Yang berikut ialah log penciptaan pengguna.',
...
'emailwiki_user' => 'Kirim e-mel kepada pengguna ini',
'emailwiki_user-title-target' => 'E-mel {{GENDER:$1|pengguna}} ini',
'emailwiki_user-title-notarget' => 'E-mel pengguna',
...
'wiki_usermailererror' => 'Objek Mail memulangkan ralat:',
'defemailsubject' => 'E-mel {{SITENAME}} daripada pengguna "$1"',
'wiki_usermaildisabled' => 'E-mel pengguna telah dilumpuhkan',
'wiki_usermaildisabledtext' => 'Anda tidak boleh mengirim e-mel kepada pengguna lain di wiki ini',
...
'emailwiki_usernamesubmit' => 'Hantar',
...
'emailwiki_userfooter' => 'E-mel ini telah dikirim oleh $1 kepada $2 menggunakan alat "E-mel pengguna" di {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Meninggalkan pesanan sistem.',
'wiki_usermessage-editor' => 'Utusan sistem',
...
'revertpage-nowiki_user' => 'Membalikkan suntingan oleh (nama pengguna dibuang) kepada semakan terakhir oleh [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'pengurusan hak pengguna',
...
'ipbwatchwiki_user' => 'Pantau laman pengguna dan laman perbincangan bagi pengguna ini',
'ipb-disablewiki_usertalk' => 'Halang pengguna ini daripada menyunting laman perbincangan sendiri apabila disekat',
...
'ipb-confirmhidewiki_user' => 'Anda akan menyekat seorang pengguna yang menghidupkan "sorokkan pengguna". Ini akan menindaskan nama pengguna itu di semua senarai dan entri log. Pastikah anda mahu berbuat demikian?',
...
'blocklist-wiki_userblocks' => 'Sorokkan sekatan akaun',
...
'blocklist-nowiki_usertalk' => 'tidak boleh menyunting laman perbincangan sendiri',
...
'block-log-flags-nowiki_usertalk' => 'tidak boleh menyunting laman perbincangan sendiri',
...
'unblock-hidewiki_user' => 'Anda tidak boleh menyahsekat pengguna ini kerana nama penggunanya telah disorok.',
...
'cant-see-hidden-wiki_user' => 'Pengguna yang anda cuba sekat telahpun disekat dan tersorok.
...
'movewiki_userpage-warning' => "'''Amaran:''' Anda sudah hendak memindahkan suatu laman pengguna. Sila ambil perhatian bahawa hanya laman tersebut akan dipindahkan dan nama pengguna yang berkenaan ''tidak'' berubah.",
...
'cant-move-wiki_user-page' => 'Anda tidak mempunyai keizinan untuk memindahkan laman pengguna (tidak termasuk sublaman-sublamannya).',
'cant-move-to-wiki_user-page' => 'Anda tidak mempunyai keizinan untuk memindahkan sesebuah laman ke mana-mana laman pengguna (kecuali sebagai sublamannya sahaja).',
...
'tooltip-pt-wiki_userpage' => 'Laman pengguna anda',
'tooltip-pt-anonwiki_userpage' => 'Laman pengguna bagi alamat IP anda',
...
'tooltip-t-emailwiki_user' => 'Kirim e-mel kepada pengguna ini',
...
'tooltip-ca-nstab-wiki_user' => 'Lihat laman pengguna',
...
'anonwiki_user' => 'Pengguna {{SITENAME}} tanpa nama $1',
'lastmodifiedatby' => 'Laman ini diubah buat kali terakhir pada $2, $1 oleh $3.',
'othercontribs' => 'Berdasarkan karya $1.',
'others' => 'lain-lain',
'sitewiki_users' => '{{PLURAL:$2|Pengguna|Pengguna-pengguna}} {{SITENAME}}, $1',
'anonwiki_users' => '{{PLURAL:$2|Pengguna|Pengguna-pengguna}} {{SITENAME}} tanpa nama $1',
...
'spambot_wiki_username' => 'Pembersihan spam MediaWiki',
...
'pageinfo-lastwiki_user' => 'Penyunting terkini',
...
'exif-wiki_usercomment' => 'Komen pengguna',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|bincang]])',
...
'specialpages-group-wiki_users' => 'Pengguna dan hak',
...
'logentry-newwiki_users-newwiki_users' => 'Akaun pengguna $1 dibuka',
'logentry-newwiki_users-create' => 'Akaun pengguna $1 dibuka',
'logentry-newwiki_users-create2' => 'Akaun pengguna $3 dibuka oleh $1',
'logentry-newwiki_users-autocreate' => 'Akaun $1 dibuka secara automatik',
'newwiki_userlog-byemail' => 'kata laluan dihantar melalui e-mel',
