...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', '用户数', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', '活跃用户数', 'NUMBEROFACTIVEUSERS' ),
...
'tog-enotifwiki_usertalkpages' => '当我的讨论页更改时发送电子邮件通知我',
...
'youhavenewmessagesfromwiki_users' => '您有来自{{PLURAL:$3| 另一位用户| $3位用户}}的$1（$2）。',
'youhavenewmessagesmanywiki_users' => '您有来自多位用户的$1（$2）。',
...
'wiki_userlogin' => '登录/创建账户',
'wiki_userloginnocreate' => '登录',
'logout' => '退出',
'wiki_userlogout' => '退出',
'notloggedin' => '未登录',
'nologin' => '没有账户？$1。',
...
'gotaccountlink' => '登录',
'wiki_userlogin-resetlink' => '忘记了您的登录信息？',
'createaccountmail' => '通过电子邮件',
'createaccountreason' => '原因：',
'badretype' => '您所输入的密码并不相同。',
'wiki_userexists' => '用户名已存在。请使用其他名称。',
'loginerror' => '登录错误',
...
'nosuchwiki_user' => '找不到用户“$1”。用户名对大小写和繁简体是区分的。请检查您的拼写是否有错误，或者[[Special:wiki_userLogin/signup|注册]]。',
'nosuchwiki_usershort' => '找不到用户“$1”。请检查您的拼写是否有错误。',
'nowiki_userspecified' => '您需要指定一个用户名。',
'login-wiki_userblocked' => '该用户已被封禁，禁止登录。',
...
'wiki_usernamehasherror' => '用户名中不可包含哈希（hash）字符',
'login-throttled' => '您最近已经尝试多次登录。
请稍后重试。',
'login-abort-generic' => '登录失败 - 已终止',
'loginlanguagelabel' => '语言：$1',
'suspicious-wiki_userlogout' => '注销请求被拒绝，因为它似乎是由有设计缺陷的浏览器或缓存代理发出的。',

# E-mail sending
'php-mail-error-unknown' => '在 PHP 的 mail() 函数中的未知错误',
'wiki_user-mail-no-addy' => '尝试发送邮件而不附带电子邮件地址。',
...
'passwordreset-wiki_username' => '用户名：',
...
'passwordreset-emailtext-wiki_user' => '用户 $1 请求获取 {{SITENAME}} ($4)上您的账户的密码提示。{{PLURAL:$3|以下账户|此账户}}与该电子邮件地址关联：
...
'wiki_userpage-wiki_userdoesnotexist' => '用户账户"$1"尚未注册。
请在创建／编辑该页之前进行核对。',
'wiki_userpage-wiki_userdoesnotexist-view' => '用户账户“$1”未曾创建。',
...
'wiki_usercssyoucanpreview' => "'''提示：''' 在保存前请用“{{int:showpreview}}”按钮来测试您新的 CSS 。",
'wiki_userjsyoucanpreview' => "'''提示：''' 在保存前请用“{{int:showpreview}}”按钮来测试您新的 JavaScript 。",
'wiki_usercsspreview' => "'''记住您只是在预览您的个人 CSS。'''
'''还没有保存！'''",
'wiki_userjspreview' => "'''记住您只是在测试／预览您的个人 JavaScript。'''
'''还没有保存！'''",
'sitecsspreview' => "'''记住您现在只是预览此 CSS。'''
'''尚未保存！'''",
'sitejspreview' => "'''记住您现在只是预览此 JavaScript 代码。'''
'''尚未保存！'''",
'wiki_userinvalidcssjstitle' => "'''警告：''' 不存在皮肤\"\$1\"。注意自定义的 .css 和 .js 页要使用小写标题，例如，{{ns:wiki_user}}:Foo/vector.css 不同于 {{ns:wiki_user}}:Foo/Vector.css。",
'updated' => '（已更新）',
'note' => "'''注意：'''",
...
'rev-deleted-wiki_user' => '（用户名被删除）',
'rev-deleted-event' => '（日志条目被删除）',
'rev-deleted-wiki_user-contribs' => '[用户名或IP地址被删除 - 编辑在贡献中隐藏]',
...
'revdelete-hide-wiki_user' => '隐藏编辑者的用户名/IP地址',
...
'diff-multi-manywiki_users' => '（未显示超过$2个用户的$1个中间版本）',
...
# wiki_user rights
'wiki_userrights' => '用户权限管理',
'wiki_userrights-lookup-wiki_user' => '管理用户组',
'wiki_userrights-wiki_user-editname' => '输入用户名：',
'editwiki_usergroup' => '编辑用户组',
'editingwiki_user' => "更改用户'''[[wiki_user:$1|$1]]'''的用户权限$2",
'wiki_userrights-editwiki_usergroup' => '编辑用户组',
'savewiki_usergroups' => '保存用户组',
'wiki_userrights-groupsmember' => '用户组：',
'wiki_userrights-groupsmember-auto' => '自动用户组：',
'wiki_userrights-groups-help' => '您可以更改该用户的用户组：
* 选中的选项框表示该用户属于该用户组。
* 未选中的选项框表示该用户不属于该用户组。
* 星号（*）表示一旦添加该用户组后不能删除，反之亦然。',
'wiki_userrights-reason' => '原因：',
'wiki_userrights-no-interwiki' => '您并没有权限去编辑在其它wiki上的用户权限。',
'wiki_userrights-nodatabase' => '数据库$1不存在或并非为本地的。',
'wiki_userrights-nologin' => '您必须要以管理员帐户[[Special:wiki_userLogin|登录]]之后才可以指定用户权限。',
'wiki_userrights-notallowed' => '您的帐户无添加或删除用户权限的权限。',
'wiki_userrights-changeable-col' => '您可以更改的用户组',
'wiki_userrights-unchangeable-col' => '您不能更改的用户组',
...
'group-wiki_user-member' => '{{GENDER:$1|用户}}',
...
'grouppage-wiki_user' => '{{ns:project}}:用户',
...
'right-move-rootwiki_userpages' => '移动根用户页面',
'right-movefile' => '移动文件',
...
'right-editwiki_usercssjs' => '编辑其他用户的CSS和JavaScript文件',
'right-editwiki_usercss' => '编辑其他用户的CSS文件',
'right-editwiki_userjs' => '编辑其他用户的JavaScript文件',
...
'right-wiki_userrights' => '编辑所有用户的权限',
'right-wiki_userrights-interwiki' => '编辑其它wiki的用户的用户权限',
...
'action-move-rootwiki_userpages' => '移动根用户页面',
...
'action-wiki_userrights' => '编辑所有用户的权限',
'action-wiki_userrights-interwiki' => '编辑其它wiki的用户的用户权限',
...
'newpageletter' => '新',
'boteditletter' => '机',
'number_of_watching_wiki_users_pageview' => '[$1个关注用户]',
...
'statistics-header-wiki_users' => '用户统计',
...
'statistics-wiki_users' => '注册[[Special:Listwiki_users|用户]]',
'statistics-wiki_users-active' => '活跃用户',
'statistics-wiki_users-active-desc' => '在前$1天中操作过的用户',
...
'listwiki_users' => '用户列表',
'listwiki_users-editsonly' => '只显示有编辑的用户',
'listwiki_users-creationsort' => '按建立日期排序',
'wiki_usereditcount' => '$1次编辑',
'wiki_usercreated' => '$1 $2{{GENDER:$3|创建}}',
'newpages' => '新页面',
'newpages-wiki_username' => '用户名：',
'ancientpages' => '最早页面',
'move' => '移动',
'movethispage' => '移动本页',
...
'listwiki_usersfrom' => '给定显示用户条件：',
'listwiki_users-submit' => '显示',
'listwiki_users-noresult' => '找不到用户。',
'listwiki_users-blocked' => '（已封禁）',

# Special:Activewiki_users
'activewiki_users' => '活跃用户列表',
'activewiki_users-intro' => '这个列表列出了最近$1天进行过操作的用户。',
'activewiki_users-count' => '最近$3天内有$1次编辑',
'activewiki_users-from' => '显示用户开始于：',
'activewiki_users-hidebots' => '隐藏机器人',
'activewiki_users-hidesysops' => '隐藏管理员',
'activewiki_users-noresult' => '找不到用户。',

# Special:Log/newwiki_users
'newwiki_userlogpage' => '用户创建日志',
'newwiki_userlogpagetext' => '这是用户创建的日志。',
...
'emailwiki_user' => '电邮联系',
'emailwiki_user-title-target' => '邮件联系该{{GENDER:$1|用户}}',
'emailwiki_user-title-notarget' => '邮件联系',
'emailpage' => '电邮联系',
'emailpagetext' => '您可以使用下面的表单向该{{GENDER:$1|用户}}发送电子邮件消息。
您在[[Special:Preferences|个人设置]]中输入的电子邮件地址将显示为该邮件的“发件人”地址，所以收件人可以直接回复给您。',
'wiki_usermailererror' => 'Mail 对象返回错误：',
'defemailsubject' => '{{SITENAME}}来自用户“$1”的电子邮件',
'wiki_usermaildisabled' => '邮件发送功能已禁用',
'wiki_usermaildisabledtext' => '您不可以给这个 wiki 上的其他用户发送邮件',
...
'emailwiki_userfooter' => '本邮件由{{SITENAME}}的“电邮用户”功能从$1发送至$2。',

# wiki_user Messenger
'wiki_usermessage-summary' => '留下系统信息。',
'wiki_usermessage-editor' => '系统信息编辑器',
...
'revertpage-nowiki_user' => '恢复由（移除了的用户名）的编辑到[[wiki_user:$1|$1]]的最后一个修订版本',
...
'sp-contributions-wiki_userrights' => '用户权限管理',
...
'sp-contributions-wiki_username' => 'IP地址或用户名：',
...
'ipadressorwiki_username' => 'IP地址或用户名：',
'ipbexpiry' => '期限：',
'ipbreason' => '原因：',
...
'ipbwatchwiki_user' => '监视该用户的用户页面和讨论页面',
'ipb-disablewiki_usertalk' => '阻止用户在封禁期间编辑自己的讨论页面',
...
'ipb-confirmhidewiki_user' => '您即将在封禁用户的同时启用“隐藏账户”功能。这将从所有列表和日志记录中隐藏这个用户名。您确认这样做吗？',
...
'blocklist-wiki_userblocks' => '隐藏帐户封禁',
...
'emailblock' => '发送邮件已禁用',
'blocklist-nowiki_usertalk' => '不能编辑自己的讨论页面',
...
'block-log-flags-nowiki_usertalk' => '不能编辑自己的讨论页面',
...
'unblock-hidewiki_user' => '您无法取消封禁该用户，因为他们的用户名已被隐藏。',
...
'cant-see-hidden-wiki_user' => '您尝试封禁的用户已被封禁并隐藏。
...
'movearticle' => '移动页面：',
'movewiki_userpage-warning' => "'''警告：'''您将移动一个用户页面。请注意，只有该页面会被移动，该用户''不''会被更名。",
'movenologin' => '未登录',
'movenologintext' => '您必须是一名登记用户并且[[Special:wiki_userLogin|登录]]
后才可移动一个页面。',
'movenotallowed' => '您没有权限移动页面。',
'movenotallowedfile' => '您没有权限移动文件。',
'cant-move-wiki_user-page' => '您没有权限移动用户页面（子页面除外）。',
'cant-move-to-wiki_user-page' => '您没有权限移动页面至用户页面（用户子页面除外）。',
'newtitle' => '新标题：',
...
'tooltip-pt-wiki_userpage' => '您的用户页面',
'tooltip-pt-anonwiki_userpage' => '您用于编辑的 IP 地址的用户页面',
...
'sitewiki_user' => '{{SITENAME}}用户$1',
'anonwiki_user' => '{{SITENAME}}匿名用户$1',
'lastmodifiedatby' => '本页面被$3最后修改于$1 $2。',
'othercontribs' => '基于$1的工作。',
'others' => '其他',
'sitewiki_users' => '{{SITENAME}}{{PLURAL:$2|用户}}$1',
'anonwiki_users' => '{{SITENAME}}匿名{{PLURAL:$2|用户}}$1',
'creditspage' => '页面编辑名单',
...
'spambot_wiki_username' => 'MediaWiki垃圾链接清理器',
...
'pageinfo-firstwiki_user' => '页面创建者',
'pageinfo-firsttime' => '页面创建日期',
'pageinfo-lastwiki_user' => '最后编辑',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]]（[[{{ns:wiki_user_talk}}:$1|讨论]]）',
...
'specialpages-group-wiki_users' => '用户与权限',
...
'logentry-newwiki_users-newwiki_users' => '已创建用户帐户 $1',
'logentry-newwiki_users-create' => '创建用户帐户$1',
'logentry-newwiki_users-create2' => '创建用户帐户 $3 由 $1',
'logentry-newwiki_users-autocreate' => '账户$1被自动创建',
'newwiki_userlog-byemail' => '密码已用电子邮件发送',
