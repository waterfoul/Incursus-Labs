...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'സജീവ_ഉപയോക്താക്കൾ' ),
	...
	'Emailwiki_user'                 => array( 'ഉപയോക്തൃഇമെയിൽ' ),
	...
	'Listwiki_users'                 => array( 'ഉപയോക്താക്കളുടെ_പട്ടിക' ),
	...
	'wiki_userlogin'                 => array( 'പ്രവേശനം' ),
	'wiki_userlogout'                => array( 'പുറത്തുകടക്കൽ' ),
	'wiki_userrights'                => array( 'ഉപയോക്തൃഅവകാശങ്ങൾ', 'കാര്യനിർവാഹകസൃഷ്ടി', 'യന്ത്രസൃഷ്ടി' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'ഉപയോക്താക്കളുടെയെണ്ണം', 'അംഗങ്ങളുടെയെണ്ണം', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'സജീവോപയാക്താക്കളുടെയെണ്ണം', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'അവസാനംതിരുത്തിയയാൾ', 'REVISIONUSER' ),
...
'tog-enotifwiki_usertalkpages' => 'എന്റെ സം‌വാദം താളിനു മാറ്റം സംഭവിച്ചാൽ ഇമെയിൽ അയക്കുക',
...
'views' => 'ദർശനീയത',
'toolbox' => 'പണിസഞ്ചി',
'wiki_userpage' => 'ഉപയോക്താവിന്റെ താൾ കാണുക',
...
'youhavenewmessagesfromwiki_users' => 'താങ്കൾക്ക് {{PLURAL:$3|ഒരു ഉപയോക്താവ്|$3 ഉപയോക്താക്കൾ}} $1 ചേർത്തിട്ടുണ്ട് ($2).',
'youhavenewmessagesmanywiki_users' => 'താങ്കൾക്ക് പലർ $1 ചേർത്തിട്ടുണ്ട് ($2).',
...
ദയവായി താളിന്റെ യു.ആർ.എൽ സഹിതം ഒരു [[Special:Listwiki_users/sysop|കാര്യനിർവാഹകനെ]] ഇത് അറിയിക്കുക.',
...
'titleprotected' => "[[wiki_user:$1|$1]] എന്ന ഉപയോക്താവ് ഈ താൾ ഉണ്ടാക്കുന്നതു നിരോധിച്ചിരിക്കുന്നു.
...
അല്ലെങ്കിൽ  [[Special:wiki_userLogin|ലോഗിൻ സൗകര്യം ഉപയോഗിച്ച്]] വീണ്ടും ലോഗിൻ ചെയ്യാവുന്നതും ആണ്‌.
...
'wiki_userlogin' => 'പ്രവേശിക്കുക / അംഗത്വമെടുക്കുക',
'wiki_userloginnocreate' => 'പ്രവേശിക്കുക',
'logout' => 'ലോഗൗട്ട്',
'wiki_userlogout' => 'ലോഗൗട്ട്',
...
'wiki_userlogin-resetlink' => 'താങ്കളുടെ ലോഗിൻ വിവരങ്ങൾ മറന്നു പോയോ?',
'createaccountmail' => 'ഇമെയിൽ വഴി',
'createaccountreason' => 'കാരണം:',
'badretype' => 'താങ്കൾ നൽകിയ രഹസ്യവാക്കുകൾ സമമല്ല.',
'wiki_userexists' => 'നൽകിയ ഉപയോക്തൃനാമം മുമ്പേ നിലവിലുണ്ട്.
...
'nosuchwiki_user' => 'ഇതുവരെ "$1" എന്ന പേരിൽ ആരും അംഗത്വമെടുത്തിട്ടില്ല.
ദയവായി അക്ഷരപ്പിശകുകൾ പരിശോധിക്കുക, അല്ലെങ്കിൽ
പുതിയ [[Special:wiki_userLogin/signup|അംഗത്വമെടുക്കുക]].',
'nosuchwiki_usershort' => '"$1" എന്ന പേരിൽ ഒരു ഉപയോക്താവ് ഇല്ല. അക്ഷരങ്ങൾ ഒന്നു കൂടി പരിശോധിക്കുക.',
'nowiki_userspecified' => 'ഉപയോക്തൃനാമം നിർബന്ധമായും ചേർക്കണം.',
'login-wiki_userblocked' => 'ഈ ഉപയോക്താവ് തടയപ്പെട്ടിരിക്കുന്നു. പ്രവേശനം അനുവദിക്കുന്നില്ല.',
...
'wiki_usernamehasherror' => 'ഉപയോക്തൃനാമത്തിൽ ഹാഷ് ലിപികൾ ഉൾപ്പെടുത്തരുത്',
...
'suspicious-wiki_userlogout' => 'ലോഗൗട്ട് ചെയ്യാനുള്ള താങ്കളുടെ അഭ്യർത്ഥന നിരസിച്ചിരിക്കുന്നു, കാരണം അത് തകർന്ന ബ്രൗസറിൽ നിന്നോ കാഷിങ് പ്രോക്സിയിൽ നിന്നോ ഉണ്ടായതുപോലെ അനുഭവപ്പെടുന്നു.',

# E-mail sending
'php-mail-error-unknown' => 'പി.എച്ച്.പി.യുടെ main() ഫങ്ഷനിൽ അപരിചിതമായ പിഴവ്',
'wiki_user-mail-no-addy' => 'ഇമെയിൽ വിലാസം ഇല്ലാതെയാണ് ഇമെയിൽ അയയ്ക്കാൻ ശ്രമിച്ചത്',
...
'passwordreset-wiki_username' => 'ഉപയോക്തൃനാമം:',
...
'passwordreset-emailtext-wiki_user' => '{{SITENAME}} സംരംഭത്തിലെ ഉപയോക്താവായ $1 {{SITENAME}} സംരംഭത്തിലെ ($4) അംഗത്വവിവരങ്ങളെക്കുറിച്ചുള്ള ഓർമ്മക്കുറിപ്പ് അഭ്യർത്ഥിച്ചിരിക്കുന്നു. ഈ ഇമെയിൽ വിലാസവുമായി ബന്ധപ്പെട്ടിരിക്കുന്ന {{PLURAL:$3|അംഗത്വം|അംഗത്വങ്ങൾ}} താഴെക്കൊടുത്തിരിക്കുന്നു:
...
'accmailtext' => "[[wiki_user talk:$1|$1]] എന്ന ഉപയോക്താവിനുള്ള ക്രമരഹിതമായി നിർമ്മിച്ച രഹസ്യവാക്ക് $2 എന്ന വിലാസത്തിലേക്ക് അയച്ചിട്ടുണ്ട്.
...
താങ്കൾ ഈ സന്ദേശം ലഭിച്ച ഒരു അജ്ഞാത ഉപയോക്താവാണെങ്കിൽ, ഭാവിയിൽ ഇതര ഉപയോക്താക്കളുമായി ഉണ്ടായേക്കാവുന്ന ആശയക്കുഴപ്പം ഒഴിവാക്കാൻ ദയവായി [[Special:wiki_userLogin/signup|ഒരു അംഗത്വമെടുക്കുക]] അല്ലെങ്കിൽ  [[Special:wiki_userLogin|പ്രവേശിക്കുക]].
|}",
...
'wiki_userpage-wiki_userdoesnotexist' => '"<nowiki>$1</nowiki>" എന്ന ഉപയോക്താവ് അംഗത്വമെടുത്തിട്ടില്ല. ഈ താൾ സൃഷ്ടിക്കണമോ എന്നതു പരിശോധിക്കുക.',
'wiki_userpage-wiki_userdoesnotexist-view' => '"$1" എന്ന അം‌ഗത്വം നിലവിലില്ല.',
...
'wiki_usercssyoucanpreview' => "'''വഴികാട്ടി:''' താങ്കളുടെ പുതിയ CSS സേവ് ചെയ്യുന്നതിനു മുമ്പ് \"{{int:showpreview}}\" എന്ന ബട്ടൻ ഉപയോഗിച്ച് പരിശോധിക്കുക.",
'wiki_userjsyoucanpreview' => "'''വഴികാട്ടി:''' താങ്കളുടെ പുതിയ ജാവാസ്ക്രിപ്റ്റ് സേവ് ചെയ്യുന്നതിനു മുമ്പ് \"{{int:showpreview}}\" എന്ന ബട്ടൻ ഉപയോഗിച്ച് പരിശോധിക്കുക.",
'wiki_usercsspreview' => "'''താങ്കൾ താങ്കളുടെ സ്വന്തം സി.എസ്.എസ്. പ്രിവ്യൂ ചെയ്യുക മാത്രമേ ചെയ്യുന്നുള്ളൂ എന്ന കാര്യം ഓർമ്മിക്കുക.'''
'''ഇതു സേവ് ചെയ്തിട്ടില്ല!'''",
'wiki_userjspreview' => "'''താങ്കൾ താങ്കളുടെ സ്വന്തം ജാവസ്ക്രിപ്റ്റ് പ്രിവ്യൂ ചെയ്യുക മാത്രമേ ചെയ്യുന്നുള്ളൂ എന്ന കാര്യം ഓർമ്മിക്കുക. ഇതു സേവ് ചെയ്തിട്ടില്ല!'''",
...
'''ഇതു സേവ് ചെയ്തിട്ടില്ല!'''",
'wiki_userinvalidcssjstitle' => "'''മുന്നറിപ്പ്:''' \"\$1\" എന്ന പേരിൽ ഒരു ദൃശ്യരൂപം ഇല്ല. '''.css''' ഉം '''.js''' ഉം താളുകൾ ഇംഗ്ലീഷ് ചെറിയക്ഷര തലക്കെട്ട് ആണ്‌ ഉപയോഗിക്കുന്നതെന്നു ദയവായി ഓർക്കുക. ഉദാ: {{ns:wiki_user}}:Foo/Vector.css എന്നതിനു പകരം {{ns:wiki_user}}:Foo/vector.css എന്നാണു ഉപയോഗിക്കേണ്ടത്.",
...
എന്നിട്ടും ശരിയാവുന്നില്ലെങ്കിൽ [[Special:wiki_userLogout|ലോഗൗട്ട് ചെയ്തതിനു ശേഷം]] വീണ്ടും ലോഗിൻ ചെയ്തുനോക്കൂ.",
...
'''താങ്കളുടേതു ഉത്തരവാദിത്വത്തോടെയുള്ള തിരുത്തലെങ്കിൽ, ദയവായി വീണ്ടും ശ്രമിക്കൂ'''. എന്നിട്ടും ശരിയാവുന്നില്ലെങ്കിൽ [[Special:wiki_userLogout|ലോഗൗട്ട് ചെയ്തതിനു]] ശേഷം വീണ്ടും ലോഗിൻ ചെയ്യൂ.",
...
താങ്കൾ ദയവായി തിരിച്ചുചെന്ന് നിലവിലുള്ള ഒരു താൾ തിരുത്തുകയോ, അഥവാ [[Special:wiki_userLogin|ലോഗിൻ ചെയ്യുകയോ ഒരു അംഗത്വം സൃഷ്ടിക്കുകയോ]] ചെയ്യാൻ അഭ്യർത്ഥിക്കുന്നു.',
...
'undo-summary' => '[[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|സംവാദം]]) ചെയ്ത നാൾപ്പതിപ്പ് $1 നീക്കം ചെയ്യുന്നു',

# Account creation failure
'cantcreateaccounttitle' => 'അംഗത്വം സൃഷ്ടിക്കാൻ സാധിച്ചില്ല',
'cantcreateaccount-text' => "ഈ ഐ.പി. ('''$1''') വിലാസത്തിൽ നിന്നു അംഗത്വം സൃഷ്ടിക്കുന്നത് [[wiki_user:$3|$3]] നിരോധിച്ചിരിക്കുന്നു.
...
'rev-deleted-wiki_user' => '(ഉപയോക്തൃനാമം ഒഴിവാക്കിയിരിക്കുന്നു)',
'rev-deleted-event' => '(പ്രവൃത്തിയുടെ രേഖ ഒഴിവാക്കിയിരിക്കുന്നു)',
'rev-deleted-wiki_user-contribs' => '[ഉപയോക്തൃനാമം അഥവാ ഐ.പി. വിലാസം ഒഴിവാക്കപ്പെട്ടിരിക്കുന്നു - തിരുത്തൽ സേവനങ്ങളിൽ നിന്നും മറച്ചിരിക്കുന്നു]',
...
'revdelete-hide-wiki_user' => 'തിരുത്തുന്ന ആളുടെ ഉപയോക്തൃനാമം/ഐ.പി. വിലാസം മറയ്ക്കുക',
...
'diff-multi-manywiki_users' => '(ഇടയ്ക്ക് {{PLURAL:$2|ഒന്നിലധികം|$2 എണ്ണത്തിലധികം}} ഉപയോക്താക്കൾ ചെയ്തിട്ടുള്ള {{PLURAL:$1|ഒരു പതിപ്പ്|$1 പതിപ്പുകൾ}} പ്രദർശിപ്പിക്കുന്നില്ല.)',
...
'prefsnologintext' => 'ഉപയോക്തൃക്രമീകരണങ്ങൾ മാറ്റാൻ താങ്കൾ <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} ലോഗിൻ]</span> ചെയ്തിരിക്കണം.',
...
'prefs-wiki_user-pages' => 'ഉപയോക്തൃതാളുകൾ',
'prefs-personal' => 'അഹം',
...
# wiki_user rights
'wiki_userrights' => 'ഉപയോക്തൃ അവകാശ പരിപാലനം',
'wiki_userrights-lookup-wiki_user' => 'ഉപയോക്തൃസംഘങ്ങളെ പരിപാലിക്കുക',
'wiki_userrights-wiki_user-editname' => 'ഒരു ഉപയോക്തൃനാമം ടൈപ്പു ചെയ്യുക:',
'editwiki_usergroup' => 'ഉപയോക്തൃസംഘങ്ങൾ തിരുത്തുക',
'editingwiki_user' => "'''[[wiki_user:$1|$1]]''' എന്ന ഉപയോക്താവിന്റെ ഉപയോക്തൃ അവകാശങ്ങൾ തിരുത്തുന്നു $2",
'wiki_userrights-editwiki_usergroup' => 'ഉപയോക്തൃസമൂഹത്തിലെ അംഗത്വം തിരുത്തുക',
'savewiki_usergroups' => 'ഉപയോക്തൃസംഘങ്ങൾ സേവ് ചെയ്യുക',
'wiki_userrights-groupsmember' => 'അംഗത്വമുള്ളത്:',
'wiki_userrights-groupsmember-auto' => 'അന്തർലീനമായ അംഗത്വം:',
'wiki_userrights-groups-help' => 'ഈ ഉപയോക്താവ് ഉൾപ്പെട്ടിട്ടുള്ള സംഘങ്ങൾ താങ്കൾക്ക് മാറ്റാവുന്നതാണ്:
...
'wiki_userrights-reason' => 'കാരണം:',
'wiki_userrights-no-interwiki' => 'മറ്റ് വിക്കികളിലെ ഉപയോക്തൃ അവകാശങ്ങൾ തിരുത്തുവാൻ താങ്കൾക്ക് അനുമതിയില്ല.',
'wiki_userrights-nodatabase' => '$1 എന്ന ഡാറ്റാബേസ് നിലവിലില്ല അല്ലെങ്കിൽ പ്രാദേശികമല്ല.',
'wiki_userrights-nologin' => 'ഉപയോക്താക്കൾക്ക് അവകാശങ്ങൾ കൊടുക്കണമെങ്കിൽ താങ്കൾ കാര്യനിർവാഹക അംഗത്വം ഉപയോഗിച്ച് [[Special:wiki_userLogin|പ്രവേശിച്ചിരിക്കണം]].',
'wiki_userrights-notallowed' => 'ഉപയോക്താക്കൾക്ക് അവകാശങ്ങൾ കൊടുക്കാനും എടുത്തുകളയാനുമുള്ള അനുമതി താങ്കളുടെ അംഗത്വത്തിനില്ല.',
'wiki_userrights-changeable-col' => 'താങ്കൾക്ക് മാറ്റാവുന്ന സംഘങ്ങൾ',
'wiki_userrights-unchangeable-col' => 'താങ്കൾക്ക് മാറ്റാനാവാത്ത സംഘങ്ങൾ',

# Groups
'group' => 'സംഘം:',
'group-wiki_user' => 'ഉപയോക്താക്കൾ',
...
'group-wiki_user-member' => '{{GENDER:$1|ഉപയോക്താവ്}}',
...
'grouppage-wiki_user' => '{{ns:project}}:ഉപയോക്താക്കൾ',
...
'right-move-rootwiki_userpages' => 'അടിസ്ഥാന ഉപയോക്തൃതാൾ മാറ്റുക',
...
'right-hidewiki_user' => 'ഒരു ഉപയോക്തൃനാമത്തെ തടയുക, പരസ്യമായി കാണപ്പെടുന്നതിൽ നിന്നും മറയ്ക്കുന്നു',
...
'right-editwiki_usercssjs' => 'മറ്റ് ഉപയോക്താക്കളുടെ CSS, JS പ്രമാണങ്ങൾ തിരുത്തുക',
'right-editwiki_usercss' => 'മറ്റ് ഉപയോക്താക്കളുടെ CSS പ്രമാണങ്ങൾ തിരുത്തുക',
'right-editwiki_userjs' => 'മറ്റ് ഉപയോക്താക്കളുടെ JS പ്രമാണങ്ങൾ തിരുത്തുക',
...
'right-wiki_userrights' => 'എല്ലാ ഉപയോക്തൃ അവകാശങ്ങളും തിരുത്തുക',
'right-wiki_userrights-interwiki' => 'മറ്റുള്ള വിക്കികളിൽ ഉപയോക്താക്കളുടെ അവകാശങ്ങൾ തിരുത്തുക',
...
'action-move-rootwiki_userpages' => 'ഉപയോക്താവിന്റെ അടിസ്ഥാന താൾ മാറ്റുക',
...
'action-wiki_userrights' => 'എല്ലാ ഉപയോക്തൃ അവകാശങ്ങളും തിരുത്തുക',
'action-wiki_userrights-interwiki' => 'മറ്റു വിക്കികളിൽ നിന്നുള്ള ഉപയോക്താക്കളുടെ ഉപയോക്തൃ അവകാശങ്ങൾ തിരുത്തുക',
...
'newpageletter' => '(പു.)',
'boteditletter' => '(യ.)',
'number_of_watching_wiki_users_pageview' => '[{{PLURAL:$1|ഒരു ഉപയോക്താവ്|$1 ഉപയോക്താക്കൾ}} ഈ താൾ ശ്രദ്ധിക്കുന്നുണ്ട്]',
...
'uploadnologintext' => 'പ്രമാണങ്ങൾ അപ്‌ലോഡ് ചെയ്യാൻ താങ്കൾ [[Special:wiki_userLogin|ലോഗിൻ]] ചെയ്തിരിക്കണം',
...
'upload-file-error-text' => 'സെർവറിൽ ഒരു താൽക്കാലിക പ്രമാണം ഉണ്ടാക്കുവാൻ ശ്രമിക്കുമ്പോൾ ആന്തരികമായി പ്രശ്നമുണ്ടായി. ദയവായി [[Special:Listwiki_users/sysop|കാര്യനിർവാഹകരിലൊരാളെ]] സമീപിക്കുക.',
...
തുടർന്നും പ്രശ്നം അവശേഷിക്കുകയാണെങ്കിൽ [[Special:Listwiki_users/sysop|കാര്യനി‌ർവാഹകരിലൊരാളെ]] സമീപിക്കുക.',
...
'listfiles_name' => 'പേര്',
'listfiles_wiki_user' => 'ഉപയോക്താവ്',
...
'statistics-header-wiki_users' => 'ഉപയോക്താക്കളുടെ സ്ഥിതിവിവരക്കണക്കുകൾ',
...
'statistics-wiki_users' => 'അംഗത്വമെടുത്തിട്ടുള്ള [[Special:Listwiki_users|ഉപയോക്താക്കൾ]]',
'statistics-wiki_users-active' => 'സജീവ ഉപയോക്താക്കൾ',
'statistics-wiki_users-active-desc' => 'കഴിഞ്ഞ {{PLURAL:$1|ദിവസം|$1 ദിവസങ്ങൾക്കുള്ളിൽ}} പ്രവർത്തിച്ചിട്ടുള്ള ഉപയോക്താക്കൾ',
...
'listwiki_users' => 'ഉപയോക്താക്കളുടെ പട്ടിക',
'listwiki_users-editsonly' => 'തിരുത്തലുകൾ ചെയ്തിട്ടുള്ള ഉപയോക്താക്കളെ മാത്രം കാണിക്കുക',
'listwiki_users-creationsort' => 'സൃഷ്ടിക്കപ്പെട്ട തീയതി അനുസരിച്ച് ക്രമീകരിക്കുക',
'wiki_usereditcount' => '{{PLURAL:$1|ഒരു തിരുത്തൽ|$1 തിരുത്തലുകൾ}}',
'wiki_usercreated' => '$1 $2-നു {{GENDER:$3|സൃഷ്ടിച്ചത്}}',
'newpages' => 'പുതിയ താളുകൾ',
'newpages-wiki_username' => 'ഉപയോക്തൃനാമം:',
...
# Special:Log
'speciallogwiki_userlabel' => 'നടപ്പിലാക്കിയയാൾ:',
...
'listwiki_usersfrom' => 'ഇങ്ങനെ തുടങ്ങുന്ന ഉപയോക്താക്കളെ പ്രദർശിപ്പിക്കുക:',
'listwiki_users-submit' => 'പ്രദർശിപ്പിക്കുക',
'listwiki_users-noresult' => 'ഈ സംഘത്തിൽ ഉൾപ്പെടുന്ന ഉപയോക്താക്കൾ ആരും ഇല്ല.',
'listwiki_users-blocked' => '(തടയപ്പെട്ടു)',

# Special:Activewiki_users
'activewiki_users' => 'സജീവ ഉപയോക്താക്കളുടെ പട്ടിക',
'activewiki_users-intro' => 'ഇത് കഴിഞ്ഞ {{PLURAL:$1|ദിവസം|$1 ദിവസങ്ങളിൽ}} ഏതെങ്കിലും വിധത്തിലുള്ള പ്രവർത്തനങ്ങൾ ചെയ്ത ഉപയോക്താക്കളുടെ പട്ടികയാണ്.',
'activewiki_users-count' => 'കഴിഞ്ഞ {{PLURAL:$3|ഒരു ദിവസം|$3 ദിവസങ്ങളിൽ}} {{PLURAL:$1|ഒരു പ്രവൃത്തി|$1 പ്രവൃത്തികൾ}}',
'activewiki_users-from' => 'ഇങ്ങനെ തുടങ്ങുന്ന ഉപയോക്താക്കളെ കാട്ടുക:',
'activewiki_users-hidebots' => 'യന്ത്രങ്ങളെ മറയ്ക്കുക',
'activewiki_users-hidesysops' => 'കാര്യനിർവാഹകരെ മറയ്ക്കുക',
'activewiki_users-noresult' => 'ഉപയോക്താക്കളില്ല',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'ഉപയോക്തൃ സൃഷ്ടിയുടെ രേഖ',
'newwiki_userlogpagetext' => 'പുതിയതായി അംഗത്വമെടുത്ത ഉപയോക്താക്കളുടെ പട്ടിക താഴെ കാണാം.',
...
'mailnologintext' => 'മറ്റ് ഉപയോക്താക്കൾക്കു ഇമെയിലയക്കുവാൻ താങ്കൾ [[Special:wiki_userLogin|ലോഗിൻ]] ചെയ്തിരിക്കുകയും, സാധുവായ ഒരു ഇമെയിൽ വിലാസം താങ്കളുടെ [[Special:Preferences|ക്രമീകരണങ്ങൾ]] താളിൽ സജ്ജീകരിച്ചിരിക്കുകയും വേണം.',
'emailwiki_user' => 'ഈ ഉപയോക്താവിനു ഇമെയിൽ അയക്കുക',
'emailwiki_user-title-target' => 'ഈ {{GENDER:$1|ഉപയോക്താവിന്}} ഇമെയിൽ അയയ്ക്കുക',
'emailwiki_user-title-notarget' => 'ഉപയോക്താവിന് ഇമെയിൽ അയക്കുക',
...
'wiki_usermailererror' => 'മെയിലുണ്ടായ പിഴവ് തിരിച്ചയച്ചിരിക്കുന്നു:',
'defemailsubject' => '"$1" എന്ന ഉപയോക്താവ് അയച്ച {{SITENAME}} ഇമെയിൽ',
'wiki_usermaildisabled' => 'ഉപയോക്തൃ ഇമെയിൽ പ്രവർത്തനരഹിതമാക്കിയിരിക്കുന്നു',
'wiki_usermaildisabledtext' => 'ഈ വിക്കിയിലെ മറ്റുപയോക്താക്കൾക്ക് ഇമെയിൽ അയയ്ക്കാൻ താങ്കൾക്ക് കഴിയില്ല',
...
'emailwiki_username' => 'ഉപയോക്തൃനാമം:',
'emailwiki_usernamesubmit' => 'സമർപ്പിക്കുക',
...
'emailwiki_userfooter' => 'ഈ ഇമെയിൽ {{SITENAME}} സംരംഭത്തിലെ "ഉപയോക്താവിന്‌ ഇമെയിൽ അയയ്ക്കുക" എന്ന സൌകര്യം ഉപയോഗിച്ച് $1 എന്ന ഉപയോക്താവ് $2 എന്ന ഉപയോക്താവിന് അയച്ചതാണ്.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'വ്യവസ്ഥാസന്ദേശം ഉപേക്ഷിക്കുക.',
'wiki_usermessage-editor' => 'വ്യവസ്ഥാസന്ദേശകൻ',
...
'watchnologintext' => 'ശ്രദ്ധിക്കുന്ന താളിന്റെ പട്ടിക തിരുത്തുവാൻ താങ്കൾ [[Special:wiki_userLogin|ലോഗിൻ]] ചെയ്തിരിക്കണം.',
...
'alreadyrolled' => '[[:$1]] എന്ന താളിൽ [[wiki_user:$2|$2]] ([[wiki_user talk:$2|സംവാദം]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]) നടത്തിയ തിരുത്തലുകൾ മുൻപ്രാപനം ചെയ്യാൻ സാധിക്കുന്നതല്ല. മറ്റാരോ താൾ തിരുത്തുകയോ മുൻപ്രാപനം ചെയ്യുകയോ ചെയ്തിരിക്കുന്നു.

താളിലെ അവസാന തിരുത്തൽ ചെയ്തിരിക്കുന്നത് [[wiki_user:$3|$3]] ([[wiki_user talk:$3|സംവാദം]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]) ആണ്.',
'editcomment' => "തിരുത്തലിന്റെ ചുരുക്കം: \"''\$1''\" എന്നായിരുന്നു.",
'revertpage' => '[[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|സംവാദം]]) നടത്തിയ തിരുത്തലുകൾ നീക്കം ചെയ്തിരിക്കുന്നു; നിലവിലുള്ള പതിപ്പ് [[wiki_user:$1|$1]] സൃഷ്ടിച്ചതാണ്',
'revertpage-nowiki_user' => '(ഉപയോക്തൃനാമം നീക്കിയിരിക്കുന്നു) നടത്തിയ തിരുത്തലുകൾ [[wiki_user:$1|$1]] സൃഷ്ടിച്ച അവസാന പതിപ്പിലേയ്ക്ക് മുൻപ്രാപനം ചെയ്തിരിക്കുന്നു',
...
'sp-contributions-wiki_userrights' => 'ഉപയോക്തൃ അവകാശങ്ങളുടെ പരിപാലനം',
...
'sp-contributions-wiki_username' => 'ഐ.പി. വിലാസം അഥവാ ഉപയോക്തൃനാമം:',
...
'ipadressorwiki_username' => 'ഐ.പി. വിലാസം അല്ലെങ്കിൽ ഉപയോക്തൃനാമം:',
'ipbexpiry' => 'കാലാവധി:',
'ipbreason' => 'കാരണം:',
...
'ipbwatchwiki_user' => 'ഈ ഉപയോക്താവിന്റെ താളും സംവാദം താളും ശ്രദ്ധിക്കുക',
'ipb-disablewiki_usertalk' => 'തടയപ്പെട്ടിരിക്കുമ്പോൾ സ്വന്തം സംവാദം താൾ തിരുത്തുന്നതിൽ നിന്നും ഈ ഉപയോക്താവിനെ തടയുക',
...
'ipb-confirmhidewiki_user' => 'താങ്കൾ "ഉപയോക്താവിനെ മറച്ചുകൊണ്ട്" ഒരു തടയൽ ചെയ്യാൻ പോവുകയാണ്. ഇത് എല്ലാ പട്ടികകളിൽ നിന്നും രേഖകളിൽ നിന്നും ഉപയോക്താവിന്റെ പേര് മറച്ച് വെയ്ക്കും. ഇപ്രകാരം വേണമെന്ന് തീർച്ചയാണോ?',
...
'unblocked' => '[[wiki_user:$1|$1]] എന്ന ഉപയോക്താവിനുണ്ടായിരുന്ന തടയൽ നീക്കിയിരിക്കുന്നു',
...
'blocklist-wiki_userblocks' => 'അംഗത്വ തടയലുകൾ മറയ്ക്കുക',
...
'blocklist-nowiki_usertalk' => 'സ്വന്തം സം‌വാദ താളിൽ തിരുത്താൻ സാധിക്കില്ല',
...
'autoblocker' => 'താങ്കളുടെ ഐ.പി. വിലാസം "[[wiki_user:$1|$1]]" എന്ന ഉപയോക്താവ് ഈ അടുത്ത് ഉപയോഗിക്കുകയും പ്രസ്തുത ഉപയോക്താവിനെ വിക്കിയിൽ നിന്നു തടയുകയും ചെയ്തിട്ടുള്ളതാണ്‌. അതിനാൽ താങ്കളും യാന്ത്രികമായി തടയപ്പെട്ടിരിക്കുന്നു. $1 എന്ന ഉപയോക്താവിന്റെ തടയലിനു സൂചിപ്പിക്കപ്പെട്ട കാരണം "$2" എന്നാണ്‌.',
...
'block-log-flags-nowiki_usertalk' => 'സ്വന്തം സംവാദം താളിൽ തിരുത്താനനുവാദമില്ല',
...
'unblock-hidewiki_user' => 'ഉപയോക്തൃനാമം മറയ്ക്കപ്പെട്ടിരിക്കുന്നതിനാൽ ഈ ഉപയോക്താവിന്റെ തടയൽ നീക്കാൻ താങ്കൾക്കാവില്ല.',
...
'cant-see-hidden-wiki_user' => 'താങ്കൾ തടയാൻ ശ്രമിക്കുന്ന ഉപയോക്താവ് മുമ്പേ തടയപ്പെടുകയും മറയ്ക്കപ്പെടുകയും ചെയ്യപ്പെട്ടതാണ്. താങ്കൾക്ക് ഉപയോക്താവിനെ മറയ്ക്കാനുള്ള അവകാശം ഇല്ലെങ്കിൽ, ഉപയോക്താവിനെതിരെ ഉള്ള തടയൽ കാണാനോ തിരുത്താനോ കഴിയുന്നതല്ല.',
...
'movewiki_userpage-warning' => "'''മുന്നറിയിപ്പ്:''' ഉപയോക്താവിനുള്ള താളാണ് താങ്കൾ മാറ്റാൻ പോകുന്നത്. താൾ മാത്രമേ മാറുകയുള്ളു എന്നും ഉപയോക്താവിന്റെ പേര് ''മാറുകയില്ലെന്നും'' ദയവായി ഓർക്കുക.",
'movenologin' => 'ലോഗിൻ ചെയ്തിട്ടില്ല',
'movenologintext' => 'തലക്കെട്ടു മാറ്റാനുള്ള അനുമതി കൈവരിക്കാൻ താങ്കൾ ഒരു രജിസ്റ്റേർഡ് ഉപയോക്താവായിരിക്കുകയും [[Special:wiki_userLogin|ലോഗിൻ ചെയ്തിരിക്കുകയും]] ചെയ്യേണ്ടത് അത്യന്താപേക്ഷിതമാണ്‌.',
...
'cant-move-wiki_user-page' => 'ഉപയോക്താവിനുള്ള താളുകളുടെ തലക്കെട്ട് മാറ്റാനുള്ള അനുമതി താങ്കൾക്കില്ല (ഉപതാളുകൾ ഉൾപ്പെടുന്നില്ല).',
'cant-move-to-wiki_user-page' => 'ഉപയോക്താവിനുള്ള താളിന്റെ തലക്കെട്ടു മാറ്റാനുള്ള അനുമതി താങ്കൾക്കില്ല (ഉപയോക്താവിനുള്ള ഉപതാളുകൾ ഒഴിച്ച്).',
...
'tooltip-pt-wiki_userpage' => 'താങ്കളുടെ ഉപയോക്തൃതാൾ',
'tooltip-pt-anonwiki_userpage' => 'താങ്കളുടെ ഐ.പി. വിലാസത്തിന്റെ ഉപയോക്തൃതാൾ',
...
'tooltip-t-emailwiki_user' => 'ഈ ഉപയോക്താവിനു ഇമെയിൽ അയക്കുക',
...
'tooltip-ca-nstab-wiki_user' => 'ഉപയോക്താവിന്റെ താൾ കാണുക',
...
'sitewiki_user' => '{{SITENAME}} ഉപയോക്താവ് $1',
'anonwiki_user' => '{{SITENAME}} പദ്ധതിയിലെ അജ്ഞാത ഉപയോക്താവ് $1',
'lastmodifiedatby' => '$2, $1 നു $3 ആണ്‌ ഈ താൾ അവസാനം പുതുക്കിയത്.',
'othercontribs' => '$1 നടത്തിയ സൃഷ്ടിയെ അധികരിച്ച്.',
'others' => 'മറ്റുള്ളവർ',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|ഉപയോക്താവ്‌|ഉപയോക്താക്കൾ}} $1',
'anonwiki_users' => '{{SITENAME}} പദ്ധതിയിലെ അജ്ഞാത {{PLURAL:$2|ഉപയോക്താവ്|ഉപയോക്താക്കൾ}} $1',
...
'spambot_wiki_username' => 'മീഡിയാവിക്കിയിലെ പാഴെഴുത്ത് ശുദ്ധീകരണം',
...
'pageinfo-firstwiki_user' => 'താളിന്റെ നിർമ്മാതാവ്',
'pageinfo-firsttime' => 'താൾ നിർമ്മിച്ച ദിവസം',
'pageinfo-lastwiki_user' => 'ഏറ്റവും പുതിയ രചയിതാവ്',
...
'exif-wiki_usercomment' => 'ഉപയോക്താവിന്റെ കുറിപ്പുകൾ',
...
'confirmemail_success' => 'താങ്കളുടെ ഇ-മെയിൽ വിലാസം സ്ഥിരീകരിക്കപ്പെട്ടിരിക്കുന്നു. താങ്കൾക്ക് ഇനി [[Special:wiki_userLogin|ലോഗിൻ ചെയ്ത്]] വിക്കി ആസ്വദിക്കാം.',
...
'confirmrecreate' => "താങ്കൾ ഈ താൾ തിരുത്താൻ തുടങ്ങിയതിനുശേഷം [[wiki_user:$1|$1]] ([[wiki_user talk:$1|talk]]) എന്ന ഉപയോക്താവ് ഇങ്ങനെ ഒരു കാരണം നൽകി ഈ താൾ നീക്കം ചെയ്തു:
: ''$2''
ദയവായി താൾ പുനഃസൃഷ്ടിക്കേണ്ടതുണ്ടോ എന്ന് സ്ഥിരീകരിക്കുക.",
'confirmrecreate-noreason' => 'താങ്കൾ തിരുത്താനാരംഭിച്ചതിനു ശേഷം, ഉപയോക്താവ് [[wiki_user:$1|$1]] ([[wiki_user talk:$1|സംവാദം]]) ഈ താൾ മായ്ച്ചിരിക്കുന്നു. ഈ താൾ പുനഃസൃഷ്ടിക്കണം എന്നത് സ്ഥിരീകരിക്കുക.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|സംവാദം]])',
...
'specialpages-group-wiki_users' => 'ഉപയോക്താക്കളും അവകാശങ്ങളും',
...
'logentry-newwiki_users-newwiki_users' => '$1 എന്ന ഉപയോക്തൃ അംഗത്വം സൃഷ്ടിക്കപ്പെട്ടിരിക്കുന്നു',
'logentry-newwiki_users-create' => '$1 എന്ന ഉപയോക്തൃ അംഗത്വം സൃഷ്ടിക്കപ്പെട്ടിരിക്കുന്നു',
'logentry-newwiki_users-create2' => '$3 എന്ന ഉപയോക്തൃ അംഗത്വം $1 സൃഷ്ടിച്ചിരിക്കുന്നു',
'logentry-newwiki_users-autocreate' => '$1 എന്ന അംഗത്വം സ്വയം സൃഷ്ടിക്കപ്പെട്ടിരിക്കുന്നു',
'newwiki_userlog-byemail' => 'രഹസ്യവാക്ക് ഇ-മെയിൽ വഴി അയച്ചിരിക്കുന്നു',
