...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'טעטיגע_באניצער' ),
	...
	'Emailwiki_user'                 => array( 'שיקן_אן_ע-פאסט_צום_באניצער' ),
	...
	'Listwiki_users'                 => array( 'ליסטע_פון_באניצערס' ),
	...
	'wiki_userlogin'                 => array( 'באניצער_איינלאגירן' ),
	'wiki_userlogout'                => array( 'ארויסלאגירן' ),
	'wiki_userrights'                => array( 'באניצער_רעכטן' ),
...
'tog-enotifwiki_usertalkpages' => 'שיקט מיר ע-פאסט ווען עס ווערט געענדערט מיין באניצער רעדן בלאט',
...
'wiki_userpage' => 'זען באַניצער בלאַט',
...
'youhavenewmessagesfromwiki_users' => 'איר האט $1 פון {{PLURAL:$3|אן אנדער באניצער|$3 באניצער}} ($2).',
'youhavenewmessagesmanywiki_users' => 'איר האט $1 פון אסאך באניצער ($2).',
...
זייט אזוי גוט מודיע זיין צו א [[Special:Listwiki_users/sysop|סיסאפ]],   מערקן אן דעם URL.',
...
'titleprotected' => 'דער טיטל איז געשיצט פון ווערן געשאפֿן דורך  [[wiki_user:$1|$1]].
די אורזאך איז  \'\'$2".',
...
איר קענט ממשיך זיין ניצן {{SITENAME}} אַנאנים, אדער איר קענט  [[Special:wiki_userLogin|צוריק אריינלאגירן]] מיט דעם זעלבן אדער אן אנדער באַניצער נאָמען. באמערקט אז געוויסע בלעטער קענען זיך ווייטער ארויסשטעלן אזוי ווי ווען איר זענט אריינלאגירט, ביז איר וועט אויסליידיגן דעם בלעטערער זאפאס.",
...
'wiki_userlogin' => 'ארײַנלאָגירן / זיך אײַנשרײַבן',
'wiki_userloginnocreate' => 'אַרײַנלאגירן',
'logout' => 'אַרױסלאָגירן',
'wiki_userlogout' => 'אַרױסלאָגירן',
...
'wiki_userlogin-resetlink' => 'פארגעסן אײַערע אַרײַנלאָגירן פרטים?',
'createaccountmail' => 'דורך ע-פאסט',
'createaccountreason' => 'אורזאַך:',
'badretype' => 'די פאסווערטער וואס איר האט אריינגעלייגט זענען נישט אייניג.',
'wiki_userexists' => 'דער באַניצער נאָמען איז שוין געניצט. 
...
'nosuchwiki_user' => 'נישטא קיין באניצער מיטן נאמען  "$1".

קוקט איבער אײַער אויסלייג, אדער [[Special:wiki_userLogin/signup|שאַפֿט א נײַע קאנטע]].',
'nosuchwiki_usershort' => 'נישטאָ קיין באַניצער מיטן נאָמען "$1". 
ביטע באַשטעטיקט דעם אויסלייג.',
'nowiki_userspecified' => 'איר ברויכט ספעציפֿיצירן א באַניצער-נאָמען.',
'login-wiki_userblocked' => 'דער באַניצער איז בלאקירט. ארײַנלאגירן נישט ערלויבט.',
...
'wiki_usernamehasherror' => 'באַניצער נאמען טאָר נישט אַנטהאַלטן קיין לייטער סימבאל',
...
'suspicious-wiki_userlogout' => ' אײַער בקשה אַרויסלאָגירן זיך איז אפגעלייגט געווארן ווייַל אייגנטלעך איז זי געשיקט דורך אַ צעבראכענעם בלעטערער אָדער א פראקסי מיט א זאפאס.',

# E-mail sending
'php-mail-error-unknown' => 'אומבאַקאַנט טעות אין()mail פֿונקציע פֿון PHP.',
'wiki_user-mail-no-addy' => 'געפרוווט צו שיקן ע-פּאָסט אָן אַן ע-פּאָסט אַדרעס.',
...
'passwordreset-wiki_username' => 'באַניצער נאָמען:',
...
'passwordreset-emailtext-wiki_user' => 'באניצער $1 אויף  {{SITENAME}} האט געבעטן א דערמאנונג פון אייערע קאנטע פרטים פאר {{SITENAME}} ($4). 
...
'accmailtext' => 'א צופֿעליק פאַסווארט פֿאַר [[wiki_user talk:$1|$1]] איז געשיקט געוואָרן צו $2.
...
'wiki_userpage-wiki_userdoesnotexist' => 'באניצער קאנטע "$1" איז נישט אײַנגעשריבן. 
קוקט איבער צי איר ווילט שאפֿן/רעדאקטירן דעם בלאט.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'באניצער קאנטע "$1" איז נישט איינגעשריבן.',
...
'wiki_usercssyoucanpreview' => "'''טיפ:''' נוצט דאס {{int:showpreview}} קנעפל אויספרובירן אייער CSS בעפארן אויפהיטן.",
'wiki_userjsyoucanpreview' => "'''טיפ:''' נוצט דאס {{int:showpreview}} קנעפל אויספרובירן אייער  JavaScript בעפארן אויפהיטן.",
'wiki_usercsspreview' => "'''געדענקט אז איר טוט בלויז פאראויס זען אייער באניצער CSS.'''
'''ער איז דערווייל נאכנישט אויפֿגעהיטן!'''",
'wiki_userjspreview' => "'''געדענקט אַז איר טוט בלויז אויספרואוון\\פֿאראויסזען אייער באַניצער JavaScript.'''
...
'''ער איז דערווײַל נאכנישט אויפֿגעהיטן!'''",
'wiki_userinvalidcssjstitle' => "'''ווארענונג:''' סאיז נישטא קיין סקין \"\$1\". גדענקט אז קאסטעם .css און .js בלעטער נוצען לאוער קעיס טיטול, e.g. {{ns:wiki_user}}:Foo/vector.css ווי אנדערשט צו {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(דערהיינטיגט)',
'note' => "'''באמערקונג:'''",
...
'session_fail_preview' => "'''אנטשולדיגט! מען האט נישט געקענט פראצעסירן אייער ענדערונג צוליב א פארלוסט פון סעסיע דאטע. ביטע פרובירט נאכאמאל. אויב ס'ארבעט נאך אלס ניט, פרובירט [[Special:wiki_userLogout|ארויסלאגירן]] און זיך צוריק אריינלאגירן.",
...
'''אױב דאַס איז אַ כשרע רעדאַקציע פרוּװ, פּרובירט נאָכאַמאָל. אױב דאָס גײט נאָכאַלץ ניט, פּרובירט [[Special:wiki_userLogout|ארױסלאָגירן]] און װידער אַרײַנלאָגירן. '''",
...
איר קענט צוריקגיין און ענדערן דעם עקזיסטירנדן בלאט, אדער [[Special:wiki_userLogin|לאגירט זיך אריין אדער שאפט א קאנטע]].',
...
'undo-summary' => 'זיי מבטל רי-ווערסיע $1 פון [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|רעדן]])',

# Account creation failure
'cantcreateaccounttitle' => 'מען קען נישט באשאפֿן קאנטע',
'cantcreateaccount-text' => 'שאפֿן קאנטעס פון דעם IP אדרעס (<b>$1</b>) איז געווארן בלאקירט דורך [[wiki_user:$3|$3]]. די סיבה געגעבן פֿון $3 איז "$2".',
...
'rev-deleted-wiki_user' => '(באנוצער נאמען אראפגענומען)',
'rev-deleted-event' => '(לאגירן אקציע אראפגענומען)',
'rev-deleted-wiki_user-contribs' => '[באַניצער נאָמען אָדער IP אַדרעס אראפגענומען - רעדאַקטירונג פֿאַרבאָרגן פֿון בייַשטייַערונגען]',
...
'revdelete-hide-wiki_user' => "באַהאַלטן רעדאַקטאר'ס באניצער-נאמען/IP-אַדרעס",
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|איין מיטלסטע ווערסיע |$1 מיטלסטע ווערסיעס}} פֿון מער ווי {{PLURAL:$2|איין באַניצער|$2 באַניצער}} נישט געוויזן.)',
...
'prefsnologintext' => 'איר דארפט זיין  <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} אריינלאגירט]</span> כדי צו ענדערן באניצער פרעפֿערענצן.',
...
'prefs-wiki_user-pages' => 'באניצער בלעטער',
...
# wiki_user rights
'wiki_userrights' => 'באנוצער רעכטן פארוואלטערשאפט',
'wiki_userrights-lookup-wiki_user' => 'פֿאַרוואַלטן באניצער גרופעס',
'wiki_userrights-wiki_user-editname' => 'לייגט אריין א באנוצער-נאמען:',
'editwiki_usergroup' => 'רעדאַגירן באַניצער גרופּעס',
'editingwiki_user' => "ענדערן באַניצער רעכטן פון באַניצער '''[[wiki_user:$1|$1]]'''   $2",
'wiki_userrights-editwiki_usergroup' => 'רעדאַקטירן באַניצער גרופעס',
'savewiki_usergroups' => 'אָפהיטן באַניצער גרופעס',
'wiki_userrights-groupsmember' => 'מיטגליד פון:',
'wiki_userrights-groupsmember-auto' => 'אויטאמטישער מיטגליד פֿון:',
'wiki_userrights-groups-help' => 'איר מעגט ענדערן די גרופעס צו וועמען דער באַניצער געהערט:
...
'wiki_userrights-reason' => 'אורזאַך:',
'wiki_userrights-no-interwiki' => 'איר האט נישט קיין ערלויבניש צו רעדאַקטירן באַניצער רעכטן אויף אַנדערע וויקיס.',
'wiki_userrights-nodatabase' => 'דאַטנבאַזע $1 אדער עקזיסטירט נישט אדער איז נישט ארטיק.',
'wiki_userrights-nologin' => 'איר דאַרפֿט [[Special:wiki_userLogin| אַרײַנלאגירן]] מיט א סיסאפ קאנטע צו באַשטימען באַניצער רעכטן.',
'wiki_userrights-notallowed' => 'אײַער קאנטע האט נישט קיין ערלויבניש צוצולייגן אדער אוועקנעמען באַניצער רעכטן.',
'wiki_userrights-changeable-col' => 'גרופעס איר קענט ענדערן',
'wiki_userrights-unchangeable-col' => 'גרופעס איר קענט נישט ענדערן',

# Groups
'group' => 'גרופע:',
'group-wiki_user' => 'באניצערס',
...
'group-wiki_user-member' => '{{GENDER:$1|באַניצער|באַניצערין}}',
...
'grouppage-wiki_user' => '{{ns:project}}:אײַנגעשריבענער באניצער',
...
'right-move-rootwiki_userpages' => 'באַוועגן באַניצער הויפטבלעטער',
...
'right-hidewiki_user' => 'בלאקירן באַניצער־נאָמען און פֿאַרבארגן אים',
...
'right-editwiki_usercssjs' => 'רעדאַקטירן אַנדערע באַניצערס CSS און JS טעקעס',
'right-editwiki_usercss' => 'רעדאַקטירן אַנדערע באַניצערס CSS טעקעס',
'right-editwiki_userjs' => 'רעדאַקטירן אַנדערע באַניצערס JS טעקעס',
...
'right-wiki_userrights' => 'רעדאַקטירן אלע באַניצער רעכטן',
'right-wiki_userrights-interwiki' => 'רעדאַקטירן באַניצער רעכטן פֿון באַניצער אויף אנדערע וויקיס',
...
'action-move-rootwiki_userpages' => 'באַוועגן באַניצער הויפטבלעטער',
...
'action-wiki_userrights' => 'רעדאַקטירן אלע באַניצער רעכטן',
'action-wiki_userrights-interwiki' => 'רעדאַקטירן רעכטן פון באַניצער אויף אַנדערע וויקיס',
...
'newpageletter' => 'נ',
'boteditletter' => 'ב',
'number_of_watching_wiki_users_pageview' => '[{{PLURAL:$1|איין באַניצער פאַסט|$1 באַניצערס פאַסן}} אויף]',
...
'uploadnologintext' => 'איר מוזט זײַן [[Special:wiki_userLogin| אַרײַנלאָָגירט]] כדי ארויפֿצולאָדן טעקעס',
...
ביטע פֿארבינדט זיך מיט א [[Special:Listwiki_users/sysop|סיסאפ]].',
...
ווען דער פראבלעם בלייבט ווייטער, קאנטאקטירט  א [[Special:Listwiki_users/sysop|סיסאפ]].',
...
'statistics-header-wiki_users' => 'באניצער סטאטיסטיק',
...
'statistics-wiki_users' => 'איינגעשריבענע [[Special:Listwiki_users|באניצערס]]',
'statistics-wiki_users-active' => 'טעטיקע באניצערס',
'statistics-wiki_users-active-desc' => 'באניצערס וואס האבן דורכגעפירט א פעולה אין די לעצטע {{PLURAL:$1|טאג|$1 טעג}}',
...
'listwiki_users' => 'באַניצער ליסטע',
'listwiki_users-editsonly' => 'ווייזן נאר באניצערס מיט רעדאקטירונגען',
'listwiki_users-creationsort' => 'סארטירן לויט דער שאַפן דאַטע',
'wiki_usereditcount' => '{{PLURAL:$1|רעדאַקטירונג|$1 רעדאַקטירונגען}}',
'wiki_usercreated' => '{{GENDER:$3|געשאַפֿן}} אום $2, $1',
'newpages' => 'נייע בלעטער',
'newpages-wiki_username' => 'באַניצער נאָמען:',
...
# Special:Log
'speciallogwiki_userlabel' => 'אויספֿירער:',
...
'listwiki_usersfrom' => 'ווײַזן באניצער אנהייבנדיג פון:',
'listwiki_users-submit' => 'ווײַז',
'listwiki_users-noresult' => 'קיין באניצער נישט געטראפֿן.',
'listwiki_users-blocked' => '(בלאקירט)',

# Special:Activewiki_users
'activewiki_users' => 'ליסטע פֿון אַקטיווע באַניצער',
'activewiki_users-intro' => 'דאָס איז א ליסטע פֿון באַניצער וואָס זענען געווען אַקטיוו אינערהאָלב  $1 {{PLURAL:$1|דעם לעצטן טאָג|די לעצטע $1 טעג}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|פעולה|פעולות}} אין  {{PLURAL:$3|דעם לעצטן טאָג|די לעצטע $3 טעג}}',
'activewiki_users-from' => 'ווײַזן באַניצער אָנהייבנדיג פון:',
'activewiki_users-hidebots' => 'באַהאַלטן באטן',
'activewiki_users-hidesysops' => 'באַהאַלטן סיסאפן',
'activewiki_users-noresult' => 'קיין באניצער נישט געטראפֿן.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'נייע באַניצערס לאָג-בוך',
'newwiki_userlogpagetext' => 'דאס איז א לאג פון באַניצערס אײַנשרײַבונגען.',
...
'mailnologintext' => 'איר ברויכט זײַן [[Special:wiki_userLogin|אַרײַנלאגירט]] און האָבן א גילטיגן ע־פאסט אַדרעס אין אײַער [[Special:Preferences|פרעפֿערענצן]] צו שיקן ע־פאסט צו אַנדערע באַניצער.',
'emailwiki_user' => 'שיקן ע-פאסט צו דעם באַניצער',
'emailwiki_user-title-target' => 'שיקן {{GENDER:$1|דעם באניצער|די באניצערין}} ע־פאסט',
'emailwiki_user-title-notarget' => 'שיקן א באניצער ע־פאסט',
...
'wiki_usermailererror' => 'בליצבריוו האט צוריקגעשיקט א טעות:',
'defemailsubject' => 'ע-פאסט פון באַניצער "$1" {{SITENAME}}',
'wiki_usermaildisabled' => 'באַניצער ע־פאסט אומאַקטיוויזירט',
'wiki_usermaildisabledtext' => 'איר קענט נישט שיקן ע־פאסט צו אנדערע באַניצערס אויף דער דאָזיקער וויקי',
...
'emailwiki_username' => 'באַניצער נאָמען:',
'emailwiki_usernamesubmit' => 'אײַנגעבן',
...
'emailwiki_userfooter' => 'דער בליצבריוו איז געשיקט געווארן דורך$1 צו $2 מיט דער  "שיקן בליצבריוו"  פֿונקציע בײַ {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'איבערלאזן סיסטעם אָנזאָג',
'wiki_usermessage-editor' => 'סיסטעם שליח',
'wiki_usermessage-template' => 'MediaWiki:באניצער־מעלדונג',
...
'watchnologintext' => 'איר דארפֿט זיין [[Special:wiki_userLogin|אריינגלאגירט]] צו מאדיפֿיצירן אייער אויפפַּאסונג־ליסטע.',
...
[[wiki_user:$2|$2]] ([[wiki_user talk:$2|רעדן]]{{int:pipe-separator}} [[Special:Contributions/$2|{{int:contribslink}}]]);
אן אנדערער האט שוין געענדערט אדער צוריקגעדרייט דעם בלאט.

די לעצטע ענדערונג צום בלאַט איז געווען פון [[wiki_user:$3|$3]] ([[wiki_user talk:$3|רעדן]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "קורץ ווארט איז געווען: \"'''\$1'''\".",
'revertpage' => 'רעדאַקטירונגען פֿון  [[Special:Contributions/$2|$2]] צוריקגענומען ([[wiki_user talk:$2|רעדן]])  צו דער לעצטער ווערסיע פֿון [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'צוריקגעשטעלט רעדאַקטירונגען פֿון (באַניצער־נאָמען אַראָפגענומען) צו לעצטער רעוויזיע פֿון [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'באַניצער רעכטן פֿאַרוואַלטונג',
...
'sp-contributions-wiki_username' => 'באניצער נאמען אדער IP אדרעס:',
...
'ipadressorwiki_username' => 'IP אדרעס אדער באַניצער נאמען:',
'ipbexpiry' => 'אויסגיין:',
'ipbreason' => 'אורזאַך:',
...
'ipbwatchwiki_user' => 'אויפֿפאַסן דעם באַניצערס באַניצער און רעדן בלעטער',
...
'ipb-confirmhidewiki_user' => 'איר האלט ביי בלאקירן א באניצער וואס האט "באהאלטן באניצער" סטאטוס. דאס וועט פארשטעקן דעם באניצערס נאמען אין אלע ליסטעס און לאגביכער. צי זענט איר זיכער אז איר ווילט דאס טאקע טון?',
...
'unblocked' => '[[wiki_user:$1|$1]] איז געווארן באַפֿרייט פון זײַן בלאק',
...
'blocklist-wiki_userblocks' => 'באהאלטן קאנטע בלאקן',
...
'blocklist-nowiki_usertalk' => 'קען נישט רעדאַקטירן דעם אייגענעם רעדן בלאַט',
...
'autoblocker' => 'דו ביסט געבלאקט אטאמאטיק ווייל דו טיילסט זיך די IP אדרעס מיט [[wiki_user:$1|$1]]. דער סיבה וואס איז אנגעבען געווארן  [[wiki_user:$1|$1]] איז: "$2".',
...
'block-log-flags-nowiki_usertalk' => 'ענדערן אייגן שמועס בלאט בלאקירט',
...
'unblock-hidewiki_user' => 'איר קענט נישט אומבלאקירן דעם באניצער, ווײַל זײַן באַניצער נאָמען איז פֿאַרבארגן.',
...
'movewiki_userpage-warning' => "'''ווארענונג:''' איר האלט ביי באוועגן א באניצער בלאט. ביטע באמערקט אז נאר דער בלאט ווערט באוועגט אבער דער באניצער נאמען ווערט ''נישט'' געענדערט.",
'movenologin' => 'איר זענט נישט אַריינלאָגירט',
'movenologintext' => 'איר דארפֿט זיך אײַנשרײַבן און זײַן  [[Special:wiki_userLogin|אַרײַנלאגירט]] צו באַוועגן א בלאַט.',
'movenotallowed' => 'איר זענט נישט דערלויבט צו באוועגן בלעטער.',
'movenotallowedfile' => 'איר האט נישט קיין רשות צו באוועגן טעקעס.',
'cant-move-wiki_user-page' => 'איר זענט נישט דערלויבט צו באַוועגן באַניצער בלעטער (אחוץ אונטערבלעטער).',
'cant-move-to-wiki_user-page' => 'איר זענט נישט דערלויבט צו באַוועגן א בלאַט צו א באַניצער בלאַט (אַחוץ צו א באַניצער אונטערבלאַט).',
...
'tooltip-pt-wiki_userpage' => 'אייער באניצער בלאט',
'tooltip-pt-anonwiki_userpage' => 'באַניצער בלאַט פון דעם IP אַדרעס',
...
'tooltip-t-emailwiki_user' => 'שיקן א בליצבריוו צו דעם בַאניצער',
...
'tooltip-ca-nstab-wiki_user' => 'זעט דעם באניצער בלאט',
...
'sitewiki_user' => 'באַניצער {{SITENAME}} $1',
'anonwiki_user' => '{{SITENAME}} אַנאנימער באַניצער $1',
'lastmodifiedatby' => 'די לעצטע ענדערונג פֿון דעם בלאַט איז געווען $2, $1 דורך $3.',
'othercontribs' => 'באזירט אויף ארבעט פון $1.',
'others' => 'אנדערע',
'sitewiki_users' => '{{PLURAL:$2|באַניצער| באַניצערס}} {{SITENAME}} $1',
'anonwiki_users' => '{{SITENAME}} {{PLURAL:$2| אַנאנימער באַניצער|אַנאנימע באַניצער}} $1',
'creditspage' => 'בלאט קרעדיטס',
'nocredits' => 'נישט פאראן קיין אינפארמאציע פאר דעם בלאט.',

# Spam protection
'spamprotectiontitle' => 'ספעם באשיצונג פילטער',
'spambot_wiki_username' => 'מעדיעוויקי ספאם פוצן',
...
'pageinfo-firstwiki_user' => 'בלאט שאפער',
'pageinfo-firsttime' => 'דאטע פון שאפן בלאט',
'pageinfo-lastwiki_user' => 'לעצטער רעדאקטירער',
...
'exif-wiki_usercomment' => 'באנוצער קאמענטורן',
...
איר קענט איצט [[Special:wiki_userLogin|אַרײַנלאגירן]] און הנאה האָבן פֿון דער וויקי.',
...
'confirmrecreate' => "באנוצער [[wiki_user:$1|$1]] ([[wiki_user talk:$1|רעדן]]) האט אויסגעמעקט דעם בלאט נאכדעם וואס איר האט אנגעהויבן דאס צו ענדערן, אלס אנגעבליכער סיבה:
:'''$2'''
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|רעדן]])',
...
'specialpages-group-wiki_users' => 'באַניצערס און רעכטן',
...
'logentry-newwiki_users-newwiki_users' => 'באניצער קאנטע $1 געשאפן געווארן',
'logentry-newwiki_users-create' => 'באניצער קאנטע $1 געשאפן געווארן',
'logentry-newwiki_users-create2' => 'באניצער קאנטע $1 געשאפן געווארן דורך $3',
'logentry-newwiki_users-autocreate' => 'קאנטע $1 באשאפן אויטאמאטיש',
'newwiki_userlog-byemail' => 'פאַסווארט געשיקט דורך ע-פאסט',
