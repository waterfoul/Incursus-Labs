...
$specialPageAliases = array(
	...
	'Listwiki_users'                 => array( 'KävutajidenNimikirjutez' ),
...
'tog-enotifwiki_usertalkpages' => "Oigeta minei e-počt, konz minun lodulehtpol' toižetase",
...
'views' => 'Kacundad',
'toolbox' => 'Azegišt',
'wiki_userpage' => "Kacu kävutajan lehtpol'",
...
'nstab-main' => 'Lehtpol’',
'nstab-wiki_user' => "Kävutajan lehtpol'",
...
'wiki_userlogin' => 'Kirjutadas / Sada registracii',
'wiki_userloginnocreate' => 'Kirjutagatoiš sistemha',
'logout' => 'Lähtta',
'wiki_userlogout' => 'Lähtta',
...
'wiki_userlogin-resetlink' => 'Unohtid-ik andmused tulendan täht?',
'createaccountmail' => 'e-počtaiči',
'createaccountreason' => 'Sü:',
'badretype' => 'Teil kirjutadud peitsanad ei kožugoi toine toižhe.',
'wiki_userexists' => 'Kirjutadud kävutajan nimi om jo kävutamižes.
...
'nosuchwiki_user' => 'Ei ole kävutajad "$1"-nimenke.
...
'nosuchwiki_usershort' => 'Ei ole kävutajad "$1"-nimenke.
Kodvgat teiden oigedkirjutamine.',
'nowiki_userspecified' => 'Pidab kirjutada kävutajan nimi.',
'login-wiki_userblocked' => "Nece kävutai om blokiruidud. Tulend sistemha om kel'tud.",
...
'wiki_usernamehasherror' => 'Kävutajan nimes ei voi olda mugošt znamad.',
...
'passwordreset-wiki_username' => 'Kävutajan nimi:',
...
'wiki_userpage-wiki_userdoesnotexist' => "Kävutajan nimed «<nowiki>$1</nowiki>» ei ole. Todeks-ik tahtoit säta vai toižetada nece lehtpol'?",
'wiki_userpage-wiki_userdoesnotexist-view' => '"$1"-kävutai ei ole registriruidud.',
'blocked-notice-logextract' => "Nece kävutai om nügüd' blokiruidud.
Alemba om anttud jälgmäine kirjutuz blokiruindaiglehtesespäi:",
'wiki_usercssyoucanpreview' => "'''Nevond:''' Kävutagat «{{int:showpreview}}» 'Ozutada ezikacund'-kingitim, miše kodvda teiden uz' CSS edel mušthopanendad.",
'wiki_userjsyoucanpreview' => "'''Nevond:''' Kävutagat \"{{int:showpreview}}\" 'Ozutada ezikacund'-kingitim, miše kodvda teiden uz' JS edel mušthopanendad.",
'wiki_usercsspreview' => "'''Muštkat, miše nece om vaiše teiden CSS-failan ezikacund, se ei ole völ kirjutadud muštho!'''",
'wiki_userjspreview' => "'''Muštkat, miše nece om vaiše teiden JavaScript-failan ezikacund, se ei ole völ kirjutadud muštho!'''",
...
'rev-deleted-wiki_user' => '(avtoran nimi om čutud poiš)',
'rev-deleted-event' => '(kirjutez om čutud poiš)',
'rev-deleted-wiki_user-contribs' => '[kävutajannimi vai IP-adres om hätud poiš - redaktiruidad ei nägu tondlehtpolel]',
...
'revdelete-hide-wiki_user' => 'Peitta avtoran nimi/IP',
...
'diff-multi' => "({{PLURAL:$1|üks' keskmäine versii ei ole|$1 keskmäšt versijad ei olgoi}} {{PLURAL:$2|one wiki_user|$2 wiki_users}} ozutadud)",
...
# wiki_user rights
'wiki_userrights' => 'Kävutajiden oiktusiden ohjandamine',
'wiki_userrights-lookup-wiki_user' => 'Kävutajiden gruppiden ohjendamine',
'wiki_userrights-wiki_user-editname' => 'Kävutajan nimi:',
'editwiki_usergroup' => 'Redaktiruida kävutajiden gruppad',
'wiki_userrights-editwiki_usergroup' => 'Toižetada kävutajan gruppad',
'savewiki_usergroups' => 'Kirjutada muštho kävutajan gruppad',
'wiki_userrights-groupsmember' => 'Kävutai om neniden gruppiden ühtnii:',
'wiki_userrights-groupsmember-auto' => 'Virtualine ühtnii:',
'wiki_userrights-reason' => 'Sü:',
'wiki_userrights-no-interwiki' => 'Teile ei sa toižetada toižiden wikiden kävutajiden oiktusid.',
'wiki_userrights-nodatabase' => 'Andmusiden $1-bazad ei ole vai se ei ole lokaline.',
'wiki_userrights-nologin' => 'Teile pidab [[Special:wiki_userLogin|kirjutadas sistemha]] administratoran oiktusidenke, miše antta oiktusid kävutajile.',
'wiki_userrights-notallowed' => 'Teiden kävutajan registracijanke ei sa antta oiktusid toižile kävutajile da heitta toižiden kävutajiden oiktusid.',
'wiki_userrights-changeable-col' => 'Gruppad, kudambad teile sab toižetada',
'wiki_userrights-unchangeable-col' => 'Gruppad, kudambid teile ei sa toižetada',
'wiki_userrights-irreversible-marker' => '$1*',

# Groups
'group' => 'Grupp:',
'group-wiki_user' => 'Kävutajad',
...
'group-wiki_user-member' => '{{GENDER:$1|kävutai}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Kävutajad',
...
'right-move-rootwiki_userpages' => "Udesnimitada kävutajiden jur'lehtpoled",
...
'right-hidewiki_user' => "Kävutajan nimen kel'dand da sen peitand",
...
'right-editwiki_usercssjs' => 'Redaktiruida toižiden kävutajiden CSS- da JS-failad',
'right-editwiki_usercss' => 'Redaktiruida toižiden kävutajiden CSS-failad',
'right-editwiki_userjs' => 'Redaktiruida toižiden kävutajiden JS-failad',
...
'right-wiki_userrights' => 'Redaktiruida kaikiden kävutajiden oiktused',
'right-wiki_userrights-interwiki' => 'Toižetada toižiden wiki-saitoiden kävutajiden oiktused',
...
'action-move-rootwiki_userpages' => "udesnimitada kävutajiden jur'lehtpoled",
...
'action-wiki_userrights' => 'redaktiruida kaik kävutajan oiktused',
'action-wiki_userrights-interwiki' => 'redaktiruida kävutajiden oiktused toižiš wikiš',
...
'newpageletter' => 'U',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|kaclii kävutai|kaclijad kävutajad}}]',
...
'statistics-header-wiki_users' => 'Kävutajiden statistik',
...
'statistics-wiki_users' => 'Registriruidud [[Special:Listwiki_users|kävutajad]]',
'statistics-wiki_users-active' => 'Activižed kävutajad',
'statistics-wiki_users-active-desc' => "Kävutajad, kudambad ozutiba aktivižut {{PLURAL:$1|jäl’gmäižen päivän|$1 jäl'gmäižil päivil}}",
...
'listwiki_users' => 'Kävutajiden nimikirjutez',
'listwiki_users-editsonly' => 'Ozutada vaiše kävutajid, kudambil om redakcijoid',
'listwiki_users-creationsort' => 'Järgeta sündumiždatan mödhe',
'wiki_usereditcount' => '$1 {{PLURAL:$1|redakcii|redakcijad}}',
'wiki_usercreated' => '{{GENDER:$3|registriruihe}} $1 aigal $2',
'newpages' => 'Uded lehtpoled',
'newpages-wiki_username' => 'Kävutai:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Kävutai:',
...
'listwiki_usersfrom' => 'Ozutada kävutajid augotaden kävutajaspäi:',
'listwiki_users-submit' => 'Ozutada',
'listwiki_users-noresult' => 'Kävutajad ei olgoi löutud.',
'listwiki_users-blocked' => '(blokiruidud)',

# Special:Activewiki_users
'activewiki_users' => 'Aktivižiden kävutajiden nimikirjutez',
'activewiki_users-from' => 'Oyutada kävutajid, augotaden necišpäi:',
'activewiki_users-hidebots' => 'Peitta botid',
'activewiki_users-hidesysops' => 'Peitta administratorid',
'activewiki_users-noresult' => 'Kävutajad ei olgoi löutud.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Kävutajiden registracijan aigkirj',
'newwiki_userlogpagetext' => 'Tantoi registriruidud kävutajiden nimikirjutez.',
...
'emailwiki_user' => 'Oigeta e-kirjeine necile kävutajale',
'emailpage' => 'Kirjeine kävutajale',
'wiki_usermailererror' => 'Počtan adresat pörduti tedotusen petuses:',
'defemailsubject' => '$1-kävutajan počt {{SITENAME}}-saitalpäi',
'wiki_usermaildisabled' => 'Kävutajan e-počt ei ole kävutamižes',
...
'emailwiki_username' => 'Kävutajan nimi:',
'emailwiki_usernamesubmit' => 'Oigeta',
...
# wiki_user Messenger
'wiki_usermessage-summary' => 'Jätta sistemtedotuz',
'wiki_usermessage-editor' => 'Sisteman tedotai',
...
'sp-contributions-wiki_userrights' => 'kävutajiden oiktusiden ohjandamine',
'sp-contributions-blocked-notice' => "Nece kävutai om nügüd' blokiruidud.
Alemba om anttud jälgmäine kirjutuz blokiruindaiglehtesespäi:",
'sp-contributions-search' => 'Ectä tond',
'sp-contributions-wiki_username' => 'IP-adres vai kävutajan nimi:',
...
'ipadressorwiki_username' => 'IP-adres vai kävutajan nimi:',
...
'ipbwatchwiki_user' => "Kacelta necen kävutajan personališt lehtpol't da lodulehtpol't",
...
'blocklist-nowiki_usertalk' => "ei sa redaktiruida ičeze lodulehtpol't",
...
'block-log-flags-nowiki_usertalk' => "ei voi redaktiruida ičeze lodulehtpol't",
...
'cant-move-wiki_user-page' => 'Teile ei sa udesnimitada kävutajiden pälehtpolid.',
'newtitle' => "Uz' nimi:",
...
'tooltip-pt-wiki_userpage' => "Teiden kävutajan lehtpol'",
'tooltip-pt-anonwiki_userpage' => "Kähutajan lehtpol' minun IP-n täht",
...
'tooltip-t-emailwiki_user' => 'Oigeta e-počt necile kävutajale',
...
'tooltip-ca-nstab-wiki_user' => "Kacta kävutajan lehtpol'he",
...
# Attribution
'sitewiki_user' => '{{SITENAME}}-saitan kävutai $1',
'anonwiki_user' => '{{GRAMMAR:genitive|{{SITENAME}}}} anonimine kävutai $1',
'lastmodifiedatby' => "Necidä lehtpol't toižeti jäl'gmäižen kerdan $2, $1 časul $3.",
'othercontribs' => 'Aluz - tö, kudamban tegi $1.',
'others' => 'toižed',
'sitewiki_users' => '{{SITENAME}}-saitan {{PLURAL:$2|kävutai|kävutajad}} $1',
...
'spambot_wiki_username' => 'MediaWikid puhtastadas spamaspäi',
...
'exif-wiki_usercomment' => 'Kävutajan homaičendad',
...
'specialpages-group-wiki_users' => 'Kävutajad da oiktused',
...
'newwiki_userlog-byemail' => 'peisana om oigetud e-počtadme',
