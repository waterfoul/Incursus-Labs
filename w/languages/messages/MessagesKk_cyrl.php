...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'ҚАТЫСУШЫСАНЫ', 'NUMBEROFUSERS' ),
...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'Хат_жіберу' ),
	...
	'Listwiki_users'                 => array( 'Қатысушылар', 'Қатысушы_тізімі' ),
	...
	'wiki_userlogin'                 => array( 'Қатысушы_кіруі' ),
	'wiki_userlogout'                => array( 'Қатысушы_шығуы' ),
	'wiki_userrights'                => array( 'Қатысушы_құқықтары' ),
...
'tog-enotifwiki_usertalkpages' => 'Талқылауым өзгергенде маған хат жібер',
...
'views' => 'Көрініс',
'toolbox' => 'Құралдар',
'wiki_userpage' => 'Қатысушы бетін қарау',
...
Бұл туралы нақты URL жайына аңғартпа жасап, [[Special:Listwiki_users/sysop|әкімшіге]] баяндаңыз.',
...
'titleprotected' => "Бұл тақырып аты бастаудан [[{{ns:wiki_user}}:$1|$1]] қорғады.
...
Жүйеге кірместен де {{SITENAME}} жобасын пайдалана аласыз, немесе баяғы не өзге қатысушы ретінде жүйеге [[Special:wiki_userLogin|қайта кіруіңізге]] болады.
...
'wiki_userlogin' => 'Кіру / Тіркелу',
'wiki_userloginnocreate' => 'Кіру',
'logout' => 'Шығу',
'wiki_userlogout' => 'Шығу',
...
'wiki_userlogin-resetlink' => 'Қатысушы атын не құпия сөзді ұмыттыңыз ба?',
'createaccountmail' => 'Е-поштамен',
'createaccountreason' => 'Себебі:',
'badretype' => 'Енгізген құпия сөздеріңіз бір-біріне сәйкес емес.',
'wiki_userexists' => 'Енгізген қатысушы атыңыз әлдеқашан пайдалануда.
...
'nosuchwiki_user' => '«$1» деген қатысушы тіркелмеген.
Емлеңізді тексеріңіз, немесе жаңа тіркелгі жасаңыз.',
'nosuchwiki_usershort' => 'Мында «$1» деп аталған қатысушы жоқ.
Емлеңізді тексеріңіз.',
'nowiki_userspecified' => 'Қатысушы атын келтіруіңіз жөн.',
'login-wiki_userblocked' => 'Бұл қатысушы бұғатталған. Жүйеге кiру рұқсат етiлмеген.',
...
'wiki_usernamehasherror' => 'Қатысушы есіміне тор белгі нышаны енгізілмейді.',
...
'suspicious-wiki_userlogout' => 'Сіздің жүйеден шығу сұранымыңыз қабылданбады, өйткені, бұл жарамсыз браузер немесе кэштеуші проксидің сұранымына ұқсайды.',

# E-mail sending
'php-mail-error-unknown' => 'Mail() PHP-функциясындағы белгісіз қате.',
'wiki_user-mail-no-addy' => 'Е-пошта есімінсіз хабарлама жіберуге талпынды.',
...
'passwordreset-wiki_username' => 'Қатысушы аты:',
...
Егер сіз тіркелгісіз қатысушы болсаңыз және сізге қатыссыз мәндемелер жіберілгенін сезсеңіз, басқа тіркелгісіз қатысушылармен араластырмауы үшін [[{{#special:wiki_userlogin}}|тіркеліңіз не кіріңіз]].''",
...
'wiki_userpage-wiki_userdoesnotexist' => '«<nowiki>$1</nowiki>» қатысушы тіркелгісі жазып алынбаған. Бұл бетті бастау/өңдеу талабыңызды тексеріп шығыңыз.',
'wiki_userpage-wiki_userdoesnotexist-view' => '«$1» қатысушы есімі тіркелмеген.',
...
'wiki_usercssyoucanpreview' => "'''Кеңес:''' Жаңа CSS файлын сақтау алдында «Қарап шығу» батырмасын қолданып сынақтаңыз.",
'wiki_userjsyoucanpreview' => "'''Ақыл-кеңес:''' Жаңа JS файлын сақтау алдында «Қарап шығу» батырмасын қолданып сынақтаңыз.",
'wiki_usercsspreview' => "'''Мынау CSS мәтінін тек қарап шығу екенін ұмытпаңыз, ол әлі сақталған жоқ!'''",
'wiki_userjspreview' => "'''Мынау JavaScript қатысушы бағдарламасын тексеру/қарап шығу екенін ұмытпаңыз, ол әлі сақталған жоқ!'''",
'wiki_userinvalidcssjstitle' => "'''Құлақтандыру:''' Осы арада «$1» деген еш мәнер жоқ.
Қатысушының .css және .js файл атауы кіші әріпппен жазылу тиісті екенін ұмытпаңыз, мысалға {{ns:wiki_user}}:Foo/vector.css дегенді {{ns:wiki_user}}:Foo/Vector.css дегенмен салыстырып қараңыз.",
'updated' => '(Жаңартылған)',
'note' => "'''Аңғартпа:'''",
...
Кері қайтып бар бетті өңдеуіңізге болады, немесе [[Special:wiki_userLogin|кіруіңізге не тіркелуіңізге]] болады.',
...
'undo-summary' => '[[{{#special:Contributions}}/$2|$2]] ([[{{ns:wiki_user_talk}}:$2|талқылауы]]) істеген нөмір $1 түзетуін жоққа шығарды',

# Account creation failure
'cantcreateaccounttitle' => 'Жаңа тіркелгі жасалмады',
'cantcreateaccount-text' => "Бұл IP мекенжайдан ('''$1''') жаңа тіркелгі жасауын [[{{ns:wiki_user}}:$3|$3]] бұғаттаған.
...
'rev-deleted-wiki_user' => '(қатысушы аты аласталды)',
'rev-deleted-event' => '(журнал жазбасы аласталды)',
'rev-deleted-wiki_user-contribs' => '[Қатысушы аты немесе IP-мекенжайы жойылған — өңдемелері қатысушы үлесі бетінен жасырылған]',
...
'revdelete-hide-wiki_user' => 'Өңдеуші атын (IP мекенжайын) жасыр',
...
'prefsnologintext' => 'Пайдаланушылық бапталымдарыңызды қою үшін [[{{#special:wiki_userlogin}}|кіруіңіз]] жөн.',
...
# wiki_user rights
'wiki_userrights' => 'Қатысушы құқықтарын реттеу',
'wiki_userrights-lookup-wiki_user' => 'Қатысушы топтарын реттеу',
'wiki_userrights-wiki_user-editname' => 'Қатысушы атын енгізіңіз:',
'editwiki_usergroup' => 'Қатысушы топтарын өңдеу',
'editingwiki_user' => "Қатысушы құқықтарын өзгерту: '''[[{{ns:wiki_user}}:$1|$1]]''' ([[{{ns:wiki_user_talk}}:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[{{#special:Contributions}}/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Қатысушы топтарын өңдеу',
'savewiki_usergroups' => 'Қатысушы топтарын сақтау',
'wiki_userrights-groupsmember' => 'Мүшелігі:',
'wiki_userrights-groups-help' => 'Бұл қатысушы кіретін топтарды реттей аласыз.
...
'wiki_userrights-reason' => 'Себебі:',
'wiki_userrights-no-interwiki' => 'Басқа уикилердегі пайдаланушы құқықтарын өңдеуге рұқсатыңыз жоқ.',
'wiki_userrights-nodatabase' => '$1 дерекқоры жоқ не жергілікті емес.',
'wiki_userrights-nologin' => 'Қатысушы құқықтарын тағайындау үшін әкімші тіркелгісімен [[{{#special:wiki_userlogin}}|кіруіңіз]] жөн.',
'wiki_userrights-notallowed' => 'Қатысушы құқықтарын тағайындау үшін тіркелгіңізде рұқсат жоқ.',
'wiki_userrights-changeable-col' => 'Өзгерте алатын топтар',
'wiki_userrights-unchangeable-col' => 'Өзгерте алмайтын топтар',

# Groups
'group' => 'Топ:',
'group-wiki_user' => 'Қатысушылар',
...
'group-wiki_user-member' => 'қатысушы',
...
'grouppage-wiki_user' => '{{ns:project}}:Қатысушылар',
...
'right-move-rootwiki_userpages' => 'қатысушы бетін ауыстыру',
...
'right-hidewiki_user' => 'Баршадан жасырып, қатысушы атын бұғаттау',
...
'right-editwiki_usercssjs' => 'Басқа қатысушылардың CSS және JS файлдарын өңдеу',
'right-editwiki_usercss' => 'Басқа қатысушылардың CSS файлдарын өңдеу',
'right-editwiki_userjs' => 'Басқа қатысушылардың JS файлдарын өңдеу',
...
'right-wiki_userrights' => 'Қатысушылардың барлық құқықтарын өңдеу',
'right-wiki_userrights-interwiki' => 'Басқа үикилердегі қатысушылардың құқықтарын өңдеу',
...
'action-wiki_userrights' => 'Қатысушылардың барлық құқықтарын өзгерту',
'action-wiki_userrights-interwiki' => 'Басқа уикилердегі қатысушылардың құқықтарын өзгерту',
...
'newpageletter' => 'Ж',
'boteditletter' => 'б',
'number_of_watching_wiki_users_pageview' => '[бақылаған $1 қатысушы]',
...
'uploadnologintext' => 'Файлдарды жүктеу үшін  [[Special:wiki_userLogin|кіруіңіз]] жөн.',
...
'statistics-header-wiki_users' => 'Қатысушы санағы',
...
'statistics-wiki_users' => 'Тіркелген қатысушылар [[Special:Listwiki_users|(тізім)]]',
...
'listwiki_users' => 'Қатысушы тізімі',
'newpages' => 'Ең жаңа беттер',
'newpages-wiki_username' => 'Қатысушы аты:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Қатысушы:',
...
'listwiki_usersfrom' => 'Мына қатысушыдан бастап көрсету:',
'listwiki_users-submit' => 'Көрсет',
'listwiki_users-noresult' => 'Қатысушы табылған жоқ.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Тіркелу журналы',
'newwiki_userlogpagetext' => 'Бұл қатысушы тіркелгі жасау журналы',
...
'mailnologintext' => 'Басқа қатысушыға хат жөнелту үшін [[{{#special:wiki_userlogin}}|кіруіңіз]] жөн, және [[{{#special:Preferences}}|бапталымдарыңызда]] жарамды е-пошта мекенжайы болуы жөн.',
'emailwiki_user' => 'Қатысушыға хат жазу',
...
'wiki_usermailererror' => 'Mail нысаны қате қайтарды:',
...
'emailwiki_usernamesubmit' => 'Жіберу',
'emailfrom' => 'Кімнен',
'emailto' => 'Кімге',
...
'watchnologintext' => 'Бақылау тізіміңізді өзгерту үшін [[{{#special:wiki_userlogin}}|кіруіңіз]] жөн.',
...
'alreadyrolled' => '[[{{ns:wiki_user}}:$2|$2]] ([[{{ns:wiki_user_talk}}:$2|талқылауы]]) істеген [[:$1]] соңғы өңдемесі шегіндірілмеді;
басқа біреу бұл бетті алдақашан өңдеген не шегіндірген.

соңғы өңдемесін [[{{ns:wiki_user}}:$3|$3]] ([[{{ns:wiki_user_talk}}:$3|талқылауы]]) істеген.',
'editcomment' => "Болған өңдеме мәндемесі: «''$1''».",
'revertpage' => '[[{{#special:Contributions}}/$2|$2]] ([[{{ns:wiki_user_talk}}:$2|талқылауы]]) өңдемелерінен [[{{ns:wiki_user}}:$1|$1]] соңғы нұсқасына қайтарды',
...
'sp-contributions-wiki_userrights' => 'Қатысушы құқықтарын реттеу',
'sp-contributions-search' => 'Үлес үшін іздеу',
'sp-contributions-wiki_username' => 'IP-мекенжайы немесе қатысушы аты:',
...
'ipadressorwiki_username' => 'IP-мекенжайы немесе қатысушы аты:',
...
'ipbwatchwiki_user' => 'Бұл қатысушының жеке және талқылау беттерін бақылау',
...
'unblocked' => '[[wiki_user:$1|$1]] бұғаттауы өшірілді',
...
'contribslink' => 'үлесі',
'autoblocker' => 'IP мекенжайыңызды жуықта «[[{{ns:wiki_user}}:1|$1]]» пайдаланған, сондықтан өзбұғатталған.
...
'movenologintext' => 'Бетті жылжыту үшін тіркелген болуыңыз және [[{{#special:wiki_userLogin}}|кіруіңіз]] жөн.',
...
'tooltip-pt-wiki_userpage' => 'Жеке бетіңіз',
'tooltip-pt-anonwiki_userpage' => 'Бұл IP мекенжайдың жеке беті',
...
'tooltip-t-emailwiki_user' => 'Осы қатысушыға хат жөнелту',
...
'tooltip-ca-nstab-wiki_user' => 'Қатысушы бетін қарау',
...
'spambot_wiki_username' => 'MediaWiki spam cleanup',
...
'exif-wiki_usercomment' => 'Қатысушының мәндемелері',
...
'confirmrecreate' => "Бұл бетті өңдеуіңізді бастағанда [[{{ns:wiki_user}}:$1|$1]] ([[{{ns:wiki_user_talk}}:$1|талқылауы]]) осы бетті жойды, келтірген себебі:
: ''$2''
...
'specialpages-group-wiki_users' => 'Қатысушылар және олардың құқықтары',
...
'logentry-newwiki_users-newwiki_users' => '$1 жаңадан аккаунт тіркеді',
'logentry-newwiki_users-create' => '$1 жаңадан аккаунт тіркеді',
'logentry-newwiki_users-create2' => '$1 $3 деген аккаунт тіркеді',
'logentry-newwiki_users-autocreate' => '$1 аккаунты автоматты түрде тіркелді',
'newwiki_userlog-byemail' => 'Құпия сөз e-mail арқылы жіберілді',
