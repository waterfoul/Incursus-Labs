...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Aktivİstifadəçilər' ),
...
'tog-enotifwiki_usertalkpages' => 'Müzakirə səhifəm redaktə olunsa, mənə e-məktub göndər',
...
'wiki_userpage' => 'İstifadəçi səhifəsini göstər',
...
'nstab-main' => 'Məqalə',
'nstab-wiki_user' => 'İstifadəçi səhifəsi',
...
'wiki_userlogin' => 'Daxil ol və ya istifadəçi yarat',
'wiki_userloginnocreate' => 'Daxil ol',
'logout' => 'Çıxış',
'wiki_userlogout' => 'Çıxış',
...
'wiki_userlogin-resetlink' => 'Daxilolma məlumatlarınızı unutmusunuz?',
'createaccountmail' => 'e-məktub ilə',
'createaccountreason' => 'Səbəb:',
'badretype' => 'Daxil etdiyiniz parol uyğun gəlmir.',
'wiki_userexists' => 'Daxil edilmiş ad artıq istifadədədir.
...
'nosuchwiki_user' => '"$1" adlı istifadəçi mövcud deyil.
...
'nosuchwiki_usershort' => '"$1" adında istifadəçi mövcud deyil.
Düzgün yazdığına əmin ol.',
'nowiki_userspecified' => 'İstifadəçi adı daxil etməlisiniz.',
'login-wiki_userblocked' => 'Bu istifadəçi bloklanıb. Sistemə giriş üçün icazə verilmir.',
...
'wiki_usernamehasherror' => 'İstifadəçi adında "diyez" simvolunun istifadəsi mümkün deyil',
...
'suspicious-wiki_userlogout' => 'Sizin çıxış üçün cəhdiniz uğursuz alındı. Bu, brouzerin yaxud proksi-keşləmənin düzgün işləməməsindən qaynaqlanır.',
...
'passwordreset-wiki_username' => 'İstifadəçi adı:',
...
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} baxa],
və ya səhifəni [{{fullurl:{{FULLPAGENAME}}|action=edit}} redaktə]</span> edə bilərsiniz.',
'wiki_userpage-wiki_userdoesnotexist' => '"<nowiki>$1</nowiki>" istifadəçi adı qeydiyyata alınmayıb.
Əgər siz bu səhifəni yaratmaq/redaktə etmək istəyirsinizsə, xahiş edirik bunu yoxlayın.',
'wiki_userpage-wiki_userdoesnotexist-view' => '"$1" istifadəçi hesabı qeydiyyatda deyil',
'blocked-notice-logextract' => 'Bu istifadəçi hal-hazırda bloklanmışdır.
Bloklama qeydlərinin sonuncusu aşağıda göstərilmişdir:',
'wiki_usercssyoucanpreview' => "'''İpucu:''' Qeyd etmədən əvvəl \"{{int:showpreview}}\"ə klikləyərək yeni CSSinizi yoxlayın.",
'wiki_userjsyoucanpreview' => "'''İpucu:''' Qeyd etmədən əvvəl \"{{int:showpreview}}\"ə klikləyərək yeni JavaScriptinizi yoxlayın.",
'wiki_usercsspreview' => "''Xatırladırıq ki, siz yalnız CSS-də sınaq göstərişi etmisiniz.'''
'''Bu hələ yaddaşda saxlanılmayıb!'''",
'wiki_userjspreview' => "''Xatırladırıq ki, siz yalnız JavaScript-də test/sınaq göstərişi etmisiniz.'''
'''Bu hələ yaddaşda saxlanılmayıb!'''",
...
'rev-deleted-wiki_user' => '(İstifadəçi adı silindi)',
'rev-deleted-event' => '(qeyd silindi)',
'rev-deleted-wiki_user-contribs' => '[istifadəçi adı və ya IP ünvanı silindi - dəyişiklik fəaliyyətlərdən çıxarıldı]',
...
'revdelete-hide-wiki_user' => 'Redaktə müəllifinin istifadəçi adını/IP ünvanını gizlə',
...
'diff-multi-manywiki_users' => '({{PLURAL:$2|Bir istifadəçi|$2 istifadəçi}} tərəfindən edilən {{PLURAL:$1|bir ara redaktə|$1 ara redaktə}} göstərilmir)',
...
# wiki_user rights
'wiki_userrights' => 'İstifadəçi hüququ idarəsi',
'wiki_userrights-lookup-wiki_user' => 'İstifadəçi qruplarını idarə et',
'wiki_userrights-wiki_user-editname' => 'İstifadəçi adınızı yazın:',
'editwiki_usergroup' => 'İstifadəçi qruplarını redaktə et',
'editingwiki_user' => "İstifadəçi '''[[wiki_user:$1|$1]]''' $2 üçün istifadəçi hüquqları dəyişdirilir",
'wiki_userrights-editwiki_usergroup' => 'İstifadəçi qruplarını redaktə et',
'savewiki_usergroups' => 'İstifadəçi qrupunu qeyd et',
'wiki_userrights-groupsmember' => 'Daxil olduğu qruplar:',
'wiki_userrights-groupsmember-auto' => 'Güman edilən üzv:',
'wiki_userrights-reason' => 'Səbəb:',
'wiki_userrights-no-interwiki' => 'Sizə başqa vikilayihələrdəki istifadəçilərin statusunu dəyişməyə icazə verilməyib',
'wiki_userrights-nodatabase' => '$1 verilənlər bazası ya mövcud deyil, ya da lokal deyil.',
'wiki_userrights-nologin' => 'Siz istifadəçilərin hüquqlarını dəyişmək üçün sistemə idarəçi olaraq [[Special:wiki_userLogin|daxil olmalısınız]].',
'wiki_userrights-notallowed' => 'Sizin istifadəçi hesabınıza digər istifadəçilərə hüquqlar vermək və ya almağa icazə verilməyib.',
'wiki_userrights-changeable-col' => 'Dəyişdirə bildiyiniz qruplar',
'wiki_userrights-unchangeable-col' => 'Dəyişdirə bilmədiyiniz qruplar',
'wiki_userrights-irreversible-marker' => '$1*',

# Groups
'group' => 'Qrup:',
'group-wiki_user' => 'İstifadəçilər',
...
'group-wiki_user-member' => '{{GENDER:$1|istifadəçi}}',
...
'grouppage-wiki_user' => '{{ns:project}}:İstifadəçilər',
...
'right-move-rootwiki_userpages' => 'əsas istifadəçi səhifələrinin adını dəyişmək',
...
'right-hidewiki_user' => 'İstifadəçi adına qadağa qoy və adın görünməsinin qarşısını al',
...
'right-editwiki_usercssjs' => 'Digər istifadəçilərin CSS və JavaScript fayllarını redaktə',
'right-editwiki_usercss' => 'Digər istifadəçilərin CSS faylını redaktə',
'right-editwiki_userjs' => 'Digər istifadəçilərin JavaScript faylını redaktə',
...
'right-wiki_userrights' => 'Bütün istifadəçi hüquqlarının redaktə edilməsi',
'right-wiki_userrights-interwiki' => 'Digər vikilərdəki istifadəçilərin istifadəçi hüquqlarını dəyişdir',
...
'action-move-rootwiki_userpages' => 'əsas istifadəçi səhifələrinin adını dəyişmək',
...
'action-wiki_userrights' => 'Bütün istifadəçi hüquqlarını redaktə et',
'action-wiki_userrights-interwiki' => 'Digər vikilərdəki istifadəçilərin istifadəçi hüquqlarını dəyişdir',
...
'newpageletter' => 'Y',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 izləyən istifadəçi]',
...
'listfiles_name' => 'Ad',
'listfiles_wiki_user' => 'İstifadəçi',
'listfiles_size' => 'Həcm',
...
'statistics-header-wiki_users' => 'İstifadəçi statistika',
...
'statistics-wiki_users' => 'Qeydiyyatdan keçmiş [[Special:Listwiki_users|istifadəçilər]]',
'statistics-wiki_users-active' => 'Aktiv istifadəçilər',
'statistics-wiki_users-active-desc' => 'Son {{PLURAL:$1|gün|$1 gündə}} iş görən istifadəçilər',
...
'listwiki_users' => 'İstifadəçi siyahısı',
'listwiki_users-editsonly' => 'Yalnız redaktələri olan istifadəçiləri göstər',
'listwiki_users-creationsort' => 'Yaranma tarixinə görə sırala',
'wiki_usereditcount' => '$1 {{PLURAL:$1|redaktə}}',
'wiki_usercreated' => 'Saat $2, $1 tarixində {{GENDER:$3|qeydiyyatdan keçib}}',
'newpages' => 'Yeni səhifələr',
'newpages-wiki_username' => 'İstifadəçi adı:',
...
# Special:Log
'speciallogwiki_userlabel' => 'İcraçı:',
...
'listwiki_users-submit' => 'Göstər',
'listwiki_users-noresult' => 'İstifadəçi tapılmadı.',
'listwiki_users-blocked' => '(bloklandı)',

# Special:Activewiki_users
'activewiki_users' => 'Aktiv istifadəçilərin siyahısı',
'activewiki_users-count' => '$1 {{PLURAL:$1|edit|redaktə}} son {{PLURAL:$3|day|$3 gün}}',
'activewiki_users-hidebots' => 'Botları gizlə',
'activewiki_users-hidesysops' => 'İdarəçiləri gizlə',
'activewiki_users-noresult' => 'İstifadəçi tapılmadı.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Yeni istifadəçilərin qeydiyyatı',
'newwiki_userlogpagetext' => 'Yeni qeydiyyatdan keçmiş istifadəçilərin siyahısı.',
...
'emailwiki_user' => 'İstifadəçiyə e-məktub yolla',
'emailpage' => 'İstifadəçiyə e-məktub yolla',
'wiki_usermailererror' => 'Elektron poçtla məlumat göndərilən zaman xəta baş vermişdir:',
'defemailsubject' => '"$1" adlı istifadəçidən {{SITENAME}} e-məktubu',
'wiki_usermaildisabled' => 'İstifadəçi e-maili işləmir',
...
'emailwiki_username' => 'İstifadəçi adı:',
'emailwiki_usernamesubmit' => 'Göndər',
...
# wiki_user Messenger
'wiki_usermessage-summary' => 'Sistem mesajı qoyun.',
'wiki_usermessage-editor' => 'Sistem məlumatları',
'wiki_usermessage-template' => 'MediaWiki:İstifadəçi müzakirəsi',
...
'revertpage-nowiki_user' => '(istifadəçi adı çıxarılmış) tərəfindən edilən dəyişikliklər [[wiki_user:$1|$1]] tərəfindən edilən son dəyişikliyə geri alındı',
...
'sp-contributions-wiki_userrights' => 'istifadəçi hüquqları idarəsi',
...
'sp-contributions-wiki_username' => 'IP-ünvanı və ya istifadəçi adı:',
...
'ipadressorwiki_username' => 'IP-ünvanı və ya istifadəçi adı',
...
'ipbwatchwiki_user' => 'Bu istifadəçinin müzakirə və istifadəçi səhifəsini izlə',
'ipb-disablewiki_usertalk' => 'Bu istifadəçi bloklu olarkən öz müzakirə səhifəsində redaktə etməsini əngəllə',
...
'ipb-confirmhidewiki_user' => 'İstifadəçini bloklamaq və redaktə siyahısından onun adını silmək üzərəsiniz. Bunu etmək istədiyinizdən əminsinizmi?',
...
'blocklist-wiki_userblocks' => 'Hesab bloklarını gizlət',
...
'blocklist-nowiki_usertalk' => 'Müzakirə səhifəsini redaktə edə bilməz.',
...
'block-log-flags-nowiki_usertalk' => 'Müzakirə səhifəsini redaktə edə bilməz.',
...
'unblock-hidewiki_user' => 'İstifadəçi adı gizli olduğu üçün, bi bloku götürə bilməzsiniz.',
...
'cant-move-wiki_user-page' => 'İstifadəçi səhifələrinin adını dəyişə bilməzsiniz (başlıqlardan başqa).',
...
'tooltip-pt-wiki_userpage' => 'İstifadəçi səhifəniz',
...
'tooltip-t-emailwiki_user' => 'Bu istifadəçiyə e-məktub yolla',
...
'tooltip-ca-nstab-wiki_user' => 'İstifadəçi səhifəsinə bax',
...
'sitewiki_user' => '{{SITENAME}} istifadəçisi $1',
'anonwiki_user' => '{{SITENAME}} anonim istifadəçisi $1',
'othercontribs' => '$1-in işinə əsaslanıb.',
'others' => 'digərləri',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|wiki_user|istifadəçi}} $1',
'anonwiki_users' => '{{SITENAME}} anonim {{PLURAL:$2|wiki_user|istifadəçi}} $1',
'creditspage' => 'Səhifə kreditleri',

# Spam protection
'spamprotectiontitle' => 'Spam qoruma süzgəci',
'spambot_wiki_username' => 'MediaViki spam təmizləməsi',
...
'pageinfo-firstwiki_user' => 'Səhifəni yaradan',
'pageinfo-firsttime' => 'Səhifənin yaranma tarixi',
'pageinfo-lastwiki_user' => 'Sonuncu redaktor',
...
'exif-wiki_usercomment' => 'İstifadəçi şərhi',
...
'specialpages-group-wiki_users' => 'İstifadəçilər və hüquqlar',
...
'logentry-newwiki_users-newwiki_users' => '$1istifadəçi hesabını yaratdı',
'logentry-newwiki_users-create' => '$1 istifadəçi hesabı yaratdı',
'logentry-newwiki_users-create2' => '$1 $3 üçün istifadəçi hesabı yaratdı',
'logentry-newwiki_users-autocreate' => '$1 hesabı avtomatik yaradıldı',
'newwiki_userlog-byemail' => 'parol e-maillə göndərildi',
