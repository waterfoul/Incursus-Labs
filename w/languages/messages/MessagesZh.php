...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( '电邮用户', '電郵用戶' ),
	...
	'Listwiki_users'                 => array( '用户列表', '用戶列表' ),
	'Log'                       => array( '日志', '日誌' ),
	...
	'wiki_userlogin'                 => array( '用户登录', '用戶登錄', '用戶登入', '用户登入' ),
	'wiki_userlogout'                => array( '用户登出', '用戶登出' ),
	'wiki_userrights'                => array( '用户权限', '用戶權限' ),
