...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'LankideEmaila' ),
	...
	'Listwiki_users'                 => array( 'LankideZerrenda' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'LANKIDEKOPURU', 'NUMBEROFUSERS' ),
...
'tog-enotifwiki_usertalkpages' => 'Nire eztabaida orrialdea aldatzen denean e-posta jaso',
...
'views' => 'Ikustaldiak',
'toolbox' => 'Tresnak',
'wiki_userpage' => 'Lankide orrialdea ikusi',
...
'nstab-wiki_user' => 'Erabiltzaile orrialdea',
...
'wiki_userlogin' => 'Saioa hasi / kontua sortu',
'wiki_userloginnocreate' => 'Saioa hasi',
'logout' => 'Saioa itxi',
'wiki_userlogout' => 'Saioa itxi',
...
'wiki_userlogin-resetlink' => 'Saioa hasteko datuak ahaztu dituzu?',
'createaccountmail' => 'e-postaz',
'createaccountreason' => 'Arrazoia:',
'badretype' => 'Idatzitako pasahitzak ez dira berdinak.',
'wiki_userexists' => 'Aukeratutako erabiltzaile izena hartuta dago.
...
'nosuchwiki_user' => 'Ez dago "$1" izena duen lankiderik.
Lankide izenak zehatza izan behar du.
Egiaztatu ondo idatzi duzun, edo [[Special:wiki_userLogin/signup|kontu berria sor ezazu]].',
'nosuchwiki_usershort' => 'Ez dago "$1" izena duen erabiltzailerik. Egiaztatu ongi idatzi duzula.',
'nowiki_userspecified' => 'Erabiltzaile izena zehaztu beharra daukazu.',
'login-wiki_userblocked' => 'Erabiltzailea blokeatua dago. Ezin du saioa hasi.',
...
'wiki_usernamehasherror' => 'Erabiltzaile-izenak ezin du kuxin-karaktererik eduki',
'login-throttled' => 'Saioa hasteko saiakera gehiegi egin berri dituzu.
Berriro saiatu aurretik itxaron ezazu, mesedez.',
'loginlanguagelabel' => 'Hizkuntza: $1',
'suspicious-wiki_userlogout' => 'Saioa amaitzeko egin duzun eskaria ukatu da. Izan ere, ematen du eskari hori gaizki dabilen nabigatzaile edo cache proxy batek bidali duela.',
...
'passwordreset-wiki_username' => 'Lankide izena:',
...
'wiki_userpage-wiki_userdoesnotexist' => '"<nowiki>$1</nowiki>" lankidea ez dago erregistatuta. Mesedez, konprobatu orri hau editatu/sortu nahi duzun.',
'wiki_userpage-wiki_userdoesnotexist-view' => '"$1" erabiltzaile-kontua ez dago erregistraturik.',
...
'wiki_usercssyoucanpreview' => "'''Laguntza:''' Zure CSS berria gorde aurretik probatzeko \"{{int:showpreview}}\" botoia erabili.",
'wiki_userjsyoucanpreview' => "'''Laguntza:''' Zure JS berria gorde aurretik probatzeko \"{{int:showpreview}}\" botoia erabili.",
'wiki_usercsspreview' => "'''Ez ahaztu zure CSS kodea aurreikusten zabiltzala.'''
'''Oraindik gorde gabe dago!'''",
'wiki_userjspreview' => "'''Gogoratu zure JavaScript kodea probatu/aurreikusten zabiltzala, oraindik ez da gorde!'''",
...
'wiki_userinvalidcssjstitle' => "'''Oharra:''' Ez da \"\$1\" itxura existitzen. Kontuan izan .css eta .js fitxategi pertsonalizatuen izenak letra xehez idatzi behar direla; adibidez, {{ns:wiki_user}}:Adibide/vector.css, eta ez {{ns:wiki_user}}:Adibide/Vector.css.",
'updated' => '(Eguneratua)',
'note' => "'''Oharra:'''",
...
'rev-deleted-wiki_user' => '(erabiltzailea ezabatu da)',
'rev-deleted-event' => '(log ekintza ezabatu da)',
'rev-deleted-wiki_user-contribs' => '[lankide izena edo Ip helbidea ezabatua - aldatu ezkutapena ekarpenetatik]',
...
'revdelete-hide-wiki_user' => 'Egilearen erabiltzaile izena/IPa ezkutatu',
...
'prefs-wiki_user-pages' => 'Erabiltzaile orrialdeak',
...
'youremail' => 'E-posta:',
'wiki_username' => 'Erabiltzaile izena:',
...
# wiki_user rights
'wiki_userrights' => 'Erabiltzaile baimenen kudeaketa',
'wiki_userrights-lookup-wiki_user' => 'Erabiltzaile taldeak kudeatu',
'wiki_userrights-wiki_user-editname' => 'Erabiltzaile izena idatzi:',
'editwiki_usergroup' => 'Erabiltzaile taldeak editatu',
'editingwiki_user' => "'''[[wiki_user:$1|$1]]''' $2 lankidearen erabiltzaile-eskubideak aldatzen",
'wiki_userrights-editwiki_usergroup' => 'Erabiltzaile taldeak editatu',
'savewiki_usergroups' => 'Erabiltzaile taldeak gorde',
'wiki_userrights-groupsmember' => 'Partaide da hemen:',
'wiki_userrights-groupsmember-auto' => 'Honen kide inplizitua:',
'wiki_userrights-groups-help' => 'Lankide hau dagoen taldeak aldatu dituzu:
...
'wiki_userrights-reason' => 'Arrazoia:',
'wiki_userrights-no-interwiki' => 'Ez duzu beste wikietan erabiltzaile eskumenak aldatzeko baimenik.',
'wiki_userrights-nodatabase' => '$1 datubasea ez da existitzen edo ez dago lokalki.',
'wiki_userrights-nologin' => 'Administratzaile kontu batekin [[Special:wiki_userLogin|hasi behar duzu saioa]] erabiltzaile eskubideak esleitzeko.',
'wiki_userrights-notallowed' => 'Zure kontuak ez du baimenik erabiltzaile eskumenak aldatzeko.',
'wiki_userrights-changeable-col' => 'Alda ditzakezun taldeak',
'wiki_userrights-unchangeable-col' => 'Aldatu ezin ditzakezun taldeak',

# Groups
'group' => 'Taldea:',
'group-wiki_user' => 'Erabiltzaileak',
...
'group-wiki_user-member' => '{{GENDER:$1|lankidea}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Lankideak',
...
'right-move-rootwiki_userpages' => 'Erro-lankidearen orriak mugitu',
...
'right-hidewiki_user' => 'Erabiltzaile izen bat blokeatu, publikotik izkutatuz',
...
'right-editwiki_usercssjs' => 'Beste lankideen CSS eta JS fitxategiak aldatu',
'right-editwiki_usercss' => 'Beste lankideen CSS fitxategiak aldatu',
'right-editwiki_userjs' => 'Beste lankideen JS fitxategiak aldatu',
...
'right-wiki_userrights' => 'Erabiltzaile guztien eskumenak aldatu',
'right-wiki_userrights-interwiki' => 'Beste wiki batzuetan erabiltzaileen eskumenak aldatu',
...
'action-move-rootwiki_userpages' => 'mugitu lankidearen oinarri orrialdeak',
...
'action-wiki_userrights' => 'lankide guztien eskumenak aldatu',
'action-wiki_userrights-interwiki' => 'beste wikietako lankideen lankide-eskumenak aldatu',
...
'newpageletter' => 'B',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|lankide|lankide}} jarraitzen]',
...
'listfiles_wiki_user' => 'Erabiltzailea',
...
'filehist-wiki_user' => 'Erabiltzailea',
...
'statistics-header-wiki_users' => 'Erabiltzaile estatistikak',
...
'statistics-wiki_users' => 'Izen-emandako [[Special:Listwiki_users|lankideak]]',
'statistics-wiki_users-active' => 'Lankide aktiboak',
'statistics-wiki_users-active-desc' => 'Aurreko {{PLURAL:$1|egunean|egunetan}} jardueraren bat gauzatu duten erabiltzaileak',
...
'listwiki_users' => 'Erabiltzaileen zerrenda',
'listwiki_users-editsonly' => 'Aldaketak egin dituzten erabiltzaileak soilik erakutsi',
'listwiki_users-creationsort' => 'Sorrera dataren arabera sailkatu',
'wiki_usereditcount' => '{{PLURAL:$1|aldaketa $1|$1 aldaketa}}',
'wiki_usercreated' => '$2-(e)tan $1-(a)n {{GENDER:$3|sortua}},',
'newpages' => 'Orrialde berriak',
'newpages-wiki_username' => 'Erabiltzaile izena:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Egilea:',
...
'listwiki_usersfrom' => 'Hemendik aurrerako erabiltzaileak bistaratu:',
'listwiki_users-submit' => 'Erakutsi',
'listwiki_users-noresult' => 'Ez da erabiltzailerik aurkitu.',
'listwiki_users-blocked' => '(blokeatua)',

# Special:Activewiki_users
'activewiki_users' => 'Lankide aktiboen zerrenda',
'activewiki_users-count' => '{{PLURAL:$1|Aldaketa berri bat|$1 aldaketa berri}} azken {{PLURAL:$3|egunean|$3 egunetan}}',
'activewiki_users-from' => 'Bilatu honela hasten diren lankideak:',
'activewiki_users-hidebots' => 'Ezkutatu bot-ak',
'activewiki_users-hidesysops' => 'Ezkutatu administratzaileak',
'activewiki_users-noresult' => 'Ez da lankiderik aurkitu.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Erabiltzaile erregistroa',
'newwiki_userlogpagetext' => 'Hau azken erabiltzaileen sorreren erregistroa da.',
...
'emailwiki_user' => 'Erabiltzaile honi e-posta bidali',
'emailwiki_user-title-notarget' => 'Erabiltzaileari e-maila bidali',
...
'wiki_usermailererror' => 'Mail objektuak errore hau itzuli du:',
'defemailsubject' => '{{SITENAME}} e-posta "$1" lankideak',
'wiki_usermaildisabled' => 'Erabiltzailearen e-maila desaktibatuta',
'wiki_usermaildisabledtext' => 'Wiki honetan ezin diezu beste erabiltzaileei posta elektronikorik bidali',
...
'emailwiki_username' => 'Lankide izena:',
'emailwiki_usernamesubmit' => 'Bidali',
...
'emailwiki_userfooter' => 'E-posta hau $1(e)k bidali dio $2(r)i {{SITENAME}}ko "E-posta bidali" funtzioa erabiliz.',

# wiki_user Messenger
'wiki_usermessage-editor' => 'Sistemako mezularia',
...
'sp-contributions-wiki_userrights' => 'erabiltzaile-baimenen kudeaketa',
...
'sp-contributions-wiki_username' => 'IP helbidea edo erabiltzaile izena:',
...
'ipadressorwiki_username' => 'IP Helbidea edo erabiltzaile izena',
...
'ipbwatchwiki_user' => 'Erabiltzaile honen erabiltzaile eta eztabaida orrialdeak jarraitu',
...
'blocklist-nowiki_usertalk' => 'zure buruaren eztabaida orrialdea ezin duzu aldatu',
...
'block-log-flags-nowiki_usertalk' => 'ezin da aldatu norbere eztabaida-orria',
...
'movewiki_userpage-warning' => "'''Oharra:''' Lankide orrialde bat mugitzera zoaz. Kontutan izan orrialde bakarrik mugituko duzula eta '''ez''' duzula lankide izena aldatuko.",
...
'cant-move-wiki_user-page' => 'Ez duzu lankide orrialdeak mugitzeko eskumenik (azpiorrialdeetatik at).',
'cant-move-to-wiki_user-page' => 'Ez duzu orrialde bat lankide orrialde batera mugitzeko eskumenik (lankide azpiorrialde batera izan ezik).',
...
'tooltip-pt-wiki_userpage' => 'Nire lankide orria',
'tooltip-pt-anonwiki_userpage' => 'Zure IParen lankide orrialdea',
...
'tooltip-t-emailwiki_user' => 'Lankide honi e-posta mezua bidali',
...
'tooltip-ca-nstab-wiki_user' => 'Lankide orrialdea ikusi',
...
'sitewiki_user' => '{{SITENAME}}(e)ko $1 erabiltzailea',
'anonwiki_user' => '{{SITENAME}}-(e)ko $1 erabiltzaile anonimoa',
'lastmodifiedatby' => 'Orrialdearen azken aldaketa: $2, $1. Nork: $3.',
'othercontribs' => '$1(r)en lanean oinarrituta.',
'others' => 'besteak',
'sitewiki_users' => '{{SITENAME}}(e)ko $1 {{PLURAL:$2|erabiltzailea|erabiltzaileak}}',
'anonwiki_users' => '{{SITENAME}}-(e)ko $1 {{PLURAL:$2|erabiltzaile}} anonimoak',
...
'spambot_wiki_username' => 'MediaWikiren spam garbiketa',
...
'pageinfo-firstwiki_user' => 'Orriaren sortzailea',
'pageinfo-firsttime' => 'Orriaren sortze data',
'pageinfo-lastwiki_user' => 'Azken editorea',
...
'exif-wiki_usercomment' => 'Erabiltzailearen iruzkinak',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|eztabaida]])',
...
'specialpages-group-wiki_users' => 'Erabiltzaileak eta eskumenak',
...
'logentry-newwiki_users-newwiki_users' => '$1 wikilariak erabiltzaile kontu bat sortu du',
'logentry-newwiki_users-create' => '$1 wikilariak erabiltzaile kontu bat sortu du',
'logentry-newwiki_users-create2' => '$1 wikilariak $3 erabiltzaile kontu bat sortu du',
'newwiki_userlog-byemail' => 'pasahitza e-postaz bidali da',
