...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'БРОЙПОТРЕБИТЕЛИ', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'БРОЙАКТИВНИПОТРЕБИТЕЛИ', 'NUMBEROFACTIVEUSERS' ),
...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Активни_потребители' ),
	...
	'Emailwiki_user'                 => array( 'Писмо_на_потребител' ),
	...
	'Listwiki_users'                 => array( 'Потребители' ),
	...
	'wiki_userlogin'                 => array( 'Регистриране_или_влизане' ),
	'wiki_userlogout'                => array( 'Излизане' ),
	'wiki_userrights'                => array( 'Потребителски_права' ),
...
'tog-enotifwiki_usertalkpages' => 'Уведомяване по е-пощата при промяна на беседата ми',
...
'views' => 'Прегледи',
'toolbox' => 'Инструменти',
'wiki_userpage' => 'Потребителска страница',
...
'youhavenewmessagesfromwiki_users' => 'Имате $1 от {{PLURAL:$3|друг потребител|$3 потребители}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Имате $1 от много потребители ($2).',
...
Моля, докладвайте на [[Special:Listwiki_users/sysop|администратор]] за проблема, като предоставите уеб адреса за връзка.',
...
'titleprotected' => "Тази страница е била защитена срещу създаване от [[wiki_user:$1|$1]].
...
Можете да продължите да използвате {{SITENAME}} анонимно или да [[Special:wiki_userLogin|влезете отново]] като друг потребител.
...
'wiki_userlogin' => 'Влизане / създаване на сметка',
'wiki_userloginnocreate' => 'Влизане',
'logout' => 'Излизане',
'wiki_userlogout' => 'Излизане',
...
'wiki_userlogin-resetlink' => 'Забравени данни за влизане в системата?',
'createaccountmail' => 'с писмо по електронната поща',
'createaccountreason' => 'Причина:',
'badretype' => 'Въведените пароли не съвпадат.',
'wiki_userexists' => 'Въведеното потребителско име вече се използва.
Изберете друго име.',
...
'nosuchwiki_user' => 'Не съществува потребител с име „$1“.
Потребителските имена са чувствителни на малки и главни букви.
Проверете изписването или [[Special:wiki_userLogin/signup|създайте нова сметка]].',
'nosuchwiki_usershort' => 'Не съществува потребител с името „$1“. Проверете изписването.',
'nowiki_userspecified' => 'Необходимо е да се посочи потребителско име.',
'login-wiki_userblocked' => 'Този потребител е блокиран. Не се позволява влизане.',
...
'wiki_usernamehasherror' => 'Потребителското име не може да съдържа хеш символи',
...
'suspicious-wiki_userlogout' => 'Заявката ви за излизане от системата беше отхвърлена, тъй като изглежда е била изпратена погрешка от браузъра или кеширащото прокси.',

# E-mail sending
'php-mail-error-unknown' => 'Неизвестна грешка в mail() функцията на PHP',
'wiki_user-mail-no-addy' => 'Опитвате се да изпратите е-писмо без да е посочен адрес за електронна поща.',
...
'passwordreset-wiki_username' => 'Потребителско име:',
...
старата си парола.',
'passwordreset-emailtext-wiki_user' => 'Потребител $1 от {{SITENAME}} поиска напомняне за данните от сметката в {{SITENAME}}
...
'accmailtext' => "Случайно генерирана парола за [[wiki_user talk:$1|$1]] беше изпратена на $2.
...
''Ако сте анонимен потребител и мислите, че тези неуместни коментари са отправени към вас, [[Special:wiki_userLogin/signup|регистрирайте се]] или [[Special:wiki_userLogin|влезте в системата]], за да избегнете евентуално бъдещо объркване с други анонимни потребители.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Няма регистрирана потребителска сметка за „<nowiki>$1</nowiki>“. Изисква се потвърждение, че желаете да създадете/редактирате тази страница?',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Не е регистрирана потребителска сметка на име „$1“.',
...
'wiki_usercssyoucanpreview' => "'''Съвет:''' Използвайте бутона „{{int:showpreview}}“, за да изпробвате новия код на CSS преди съхранението.",
'wiki_userjsyoucanpreview' => "'''Съвет:''' Използвайте бутона „{{int:showpreview}}“, за да изпробвате новия код на Джаваскрипт преди съхранението.",
'wiki_usercsspreview' => "'''Не забравяйте, че това е само предварителен преглед на кода на CSS. Страницата все още не е съхранена!'''",
'wiki_userjspreview' => "'''Не забравяйте, че това е само изпробване/предварителен преглед на кода на Джаваскрипт. Страницата все още не е съхранена!'''",
...
'''Той все още не е съхранен!'''",
'wiki_userinvalidcssjstitle' => "'''Внимание:''' Не съществува облик „$1“. Необходимо е да се знае, че имената на потребителските ви страници за CSS и Джаваскрипт трябва да се състоят от малки букви, например: „{{ns:wiki_user}}:Иван/vector.css“ (а не „{{ns:wiki_user}}:Иван/Vector.css“).",
'updated' => '(обновена)',
'note' => "'''Забележка:'''",
...
'session_fail_preview' => "'''За съжаление редакцията ви не успя да бъде обработена поради загуба на данните за текущата сесия. Опитайте отново. Ако все още не работи, опитайте да [[Special:wiki_userLogout|излезете]] и да влезете отново.'''",
...
'''Опитайте отново. Ако все още не сработва, пробвайте да [[Special:wiki_userLogout|излезете]] и влезете отново.'''",
...
'nocreatetext' => 'Създаването на нови страници в {{SITENAME}} е ограничено. Можете да се върнете назад и да редактирате някоя от съществуващите страници, [[Special:wiki_userLogin|да се регистрирате или да създадете нова потребителска сметка]].',
...
'undo-summary' => 'Премахната редакция $1 на [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|беседа]])',

# Account creation failure
'cantcreateaccounttitle' => 'Невъзможно е да бъде създадена потребителска сметка.',
'cantcreateaccount-text' => "[[wiki_user:$3|Потребител:$3]] е блокирал(а) създаването на сметки от този IP-адрес ('''$1''').
...
'rev-deleted-wiki_user' => '(името на автора е изтрито)',
'rev-deleted-event' => '(записът е изтрит)',
'rev-deleted-wiki_user-contribs' => '[потребителското име или IP адрес са премахнати - редакцията е скрита от приносите]',
...
'revdelete-hide-wiki_user' => 'Скриване на името/IP-адреса на автора',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Не е показана една междинна версия|Не са показани $1 междинни версии}} от повече от $2 {{PLURAL:$2|потребител|потребителя}})',
...
'prefsnologintext' => 'Необходимо е <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} да влезете]</span>, за да може да променяте потребителските си настройки.',
...
'prefs-wiki_user-pages' => 'Потребителски страници',
...
'youremail' => 'Е-поща:',
'wiki_username' => 'Потребителско име:',
...
# wiki_user rights
'wiki_userrights' => 'Управление на потребителските права',
'wiki_userrights-lookup-wiki_user' => 'Управляване на потребителските групи',
'wiki_userrights-wiki_user-editname' => 'Потребителско име:',
'editwiki_usergroup' => 'Редактиране на потребителските групи',
'editingwiki_user' => "Промяна на потребителските права на потребител '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Редактиране на потребителските групи',
'savewiki_usergroups' => 'Съхраняване на потребителските групи',
'wiki_userrights-groupsmember' => 'Член на:',
'wiki_userrights-groupsmember-auto' => 'Подразбиращ се член на:',
'wiki_userrights-groups-help' => 'Може да променяте групите, в които е потребителят:
...
'wiki_userrights-no-interwiki' => 'Нямате права да редактирате потребителските групи на други уикита.',
'wiki_userrights-nodatabase' => 'Базата данни $1 не съществува или не е на локалния сървър.',
'wiki_userrights-nologin' => 'За управление на потребителските права е необходимо [[Special:wiki_userLogin|влизане]] с администраторска сметка.',
'wiki_userrights-notallowed' => 'Текущата сметка няма права да добавя или премахва потребителски права.',
'wiki_userrights-changeable-col' => 'Групи, които можете да променяте',
'wiki_userrights-unchangeable-col' => 'Групи, които не можете да променяте',

# Groups
'group' => 'Потребителска група:',
'group-wiki_user' => 'Потребители',
...
'group-wiki_user-member' => '{{GENDER:$1|потребител}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Потребители',
...
'right-move-rootwiki_userpages' => 'Преместване на основни потребителски страници',
...
'right-hidewiki_user' => 'блокиране и скриване на потребителско име',
...
'right-editwiki_usercssjs' => 'редактиране на CSS и JS файловете на други потребители',
'right-editwiki_usercss' => 'редактиране на CSS файловете на други потребители',
'right-editwiki_userjs' => 'редактиране на JS файловете на други потребители',
...
'right-wiki_userrights' => 'редактиране на потребителските права',
'right-wiki_userrights-interwiki' => 'редактиране на потребителски права на потребители в други уикита',
...
'action-move-rootwiki_userpages' => 'преместване на основни потребителски страници',
...
'action-wiki_userrights' => 'редактиране на всички потребителски права',
'action-wiki_userrights-interwiki' => 'редактиране на потребителските права на потребители от други уикита',
...
'newpageletter' => 'Н',
'boteditletter' => 'б',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|наблюдаващ потребител|наблюдаващи потребители}}]',
...
'uploadnologintext' => 'Необходимо е да [[Special:wiki_userLogin|влезете]], за да може да качвате файлове.',
...
'upload-file-error-text' => 'Вътрешна грешка при опит да се създаде временен файл на сървъра. Обърнете се към [[Special:Listwiki_users/sysop|администратор]].',
'upload-misc-error' => 'Неизвестна грешка при качване',
'upload-misc-error-text' => 'Неизвестна грешка при качване. Убедете се, че адресът е верен и опитайте отново. Ако отново имате проблем, обърнете се към [[Special:Listwiki_users/sysop|администратор]].',
...
'listfiles_wiki_user' => 'Потребител',
...
'statistics-header-wiki_users' => 'Потребители',
...
'statistics-wiki_users' => 'Регистрирани [[Special:Listwiki_users|потребители]]',
'statistics-wiki_users-active' => 'Активни потребители',
'statistics-wiki_users-active-desc' => 'Потребители, направили редакция през {{PLURAL:$1|последния ден|последните $1 дни}}',
...
'listwiki_users' => 'Списък на потребителите',
'listwiki_users-editsonly' => 'Показване само на потребители с редакции',
'listwiki_users-creationsort' => 'Сортиране по дата на създаване',
'wiki_usereditcount' => '$1 {{PLURAL:$1|редакция|редакции}}',
'wiki_usercreated' => '{{GENDER:$3|Създаден}} на $1 в $2',
'newpages' => 'Нови страници',
'newpages-wiki_username' => 'Потребител:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Изпълнител:',
...
'listwiki_usersfrom' => 'Показване на потребителите, започвайки от:',
'listwiki_users-submit' => 'Показване',
'listwiki_users-noresult' => 'Няма намерени потребители.',
'listwiki_users-blocked' => '(блокиран)',

# Special:Activewiki_users
'activewiki_users' => 'Списък на активните потребители',
'activewiki_users-intro' => 'Това е списък на потребителите, които са демонстрирали някаква активност през {{PLURAL:$1|последния|последните}} $1 {{PLURAL:$1|ден|дни}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|редакция|редакции}} за {{PLURAL:$3|последния ден|последните $3 дни}}',
'activewiki_users-from' => 'Показване на потребителите, започвайки от:',
'activewiki_users-hidebots' => 'Скриване на ботовете',
'activewiki_users-hidesysops' => 'Скриване на администраторите',
'activewiki_users-noresult' => 'Няма намерени потребители.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Дневник на регистрациите',
'newwiki_userlogpagetext' => 'В този дневник се записват регистрациите на потребители.',
...
'mailnologintext' => 'Необходимо е да [[Special:wiki_userLogin|влезете]] и да посочите валидна електронна поща в [[Special:Preferences|настройките]] си, за да може да пращате писма на други потребители.',
'emailwiki_user' => 'Писмо до потребителя',
...
'wiki_usermailererror' => 'Пощенският обект даде грешка:',
'defemailsubject' => 'Писмо от потребител $1 в {{SITENAME}}',
'wiki_usermaildisabled' => 'Потребителят не е разрешил да получава електронна поща',
'wiki_usermaildisabledtext' => 'Не можете да изпращате електронна поща на други потребители от това уики',
...
'emailwiki_username' => 'Потребителско име:',
'emailwiki_usernamesubmit' => 'Изпращане',
...
'emailwiki_userfooter' => 'Това писмо беше изпратено от $1 на $2 чрез функцията „Изпращане на писмо до потребителя“ на {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Оставяне на системно съобщение.',
'wiki_usermessage-editor' => 'Системни съобщения',
...
'watchnologintext' => 'Необходимо е да [[Special:wiki_userLogin|влезете]], за да може да променяте списъка си за наблюдение.',
...
'alreadyrolled' => 'Редакцията на [[:$1]], направена от [[wiki_user:$2|$2]] ([[wiki_user talk:$2|Беседа]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]), не може да бъде отменена. Някой друг вече е редактирал страницата или е отменил промените.

Последната редакция е на [[wiki_user:$3|$3]] ([[wiki_user talk:$3|Беседа]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Резюмето на редакцията беше: „''$1''“.",
'revertpage' => 'Премахване на [[Special:Contributions/$2|редакции на $2]] ([[wiki_user talk:$2|беседа]]); възвръщане към последната версия на [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Премахнати редакции на (отстранено потребителско име) и връщане към последната версия на [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'управление на потребителските права',
...
'sp-contributions-wiki_username' => 'IP-адрес или потребителско име:',
...
'ipadressorwiki_username' => 'IP-адрес или потребител:',
'ipbexpiry' => 'Срок:',
'ipbreason' => 'Причина:',
...
'ipbwatchwiki_user' => 'Наблюдаване на потребителската страница и беседата на този потребител',
'ipb-disablewiki_usertalk' => 'Спиране на възможността този потребител да редактира беседата си докато е блокиран',
...
'ipb-confirmhidewiki_user' => 'На път сте да блокирате потребител, който е "скрит потребител". Това действие ще заличи потребителското име от всички списъци и дневници. Наистина ли желаете да направите това?',
...
'unblocked' => '[[wiki_user:$1|$1]] беше отблокиран.',
...
'blocklist-wiki_userblocks' => 'Скриване на блокирани потребителски сметки',
...
'blocklist-nowiki_usertalk' => 'забрана за редактиране на личната беседа',
...
'autoblocker' => 'Бяхте блокиран автоматично, тъй като неотдавна IP-адресът ви е бил ползван от блокирания в момента потребител [[wiki_user:$1|$1]]. Причината за неговото блокиране е: „$2“.',
...
'block-log-flags-nowiki_usertalk' => 'забрана за редактиране на личната беседа',
...
'unblock-hidewiki_user' => 'Не можете да отблокирате този потребител, тъй като потребителското му име е скрито.',
...
'cant-see-hidden-wiki_user' => 'Потребителят, който опитвате да блокирате, вече е блокиран и скрит. Тъй като нямате права да скривате потребители, не можете да видите или редактирате блокирането на потребителя.',
...
'movewiki_userpage-warning' => "'''Внимание:''' Предприели сте опит да преместите потребителска страница. Забележете, че от преместването на страницата '''няма''' да последва преименуване на потребителя.",
'movenologin' => 'Не сте влезли',
'movenologintext' => 'Необходимо е да [[Special:wiki_userLogin|влезете]], за да може да премествате страници.',
'movenotallowed' => 'Нямате права за преместване на страници.',
'movenotallowedfile' => 'Нямате права да премествате файлове.',
'cant-move-wiki_user-page' => 'Нямате нужните права на достъп, за да местите потребителски страници (можете да местите само подстраници).',
'cant-move-to-wiki_user-page' => 'Нямате нужните права на достъп, за да извършвате преместване на страници върху потребителски страници (можете да местите само върху подстраници от потребителското пространство).',
...
'tooltip-pt-wiki_userpage' => 'Вашата потребителска страница',
'tooltip-pt-anonwiki_userpage' => 'Потребителската страница за адреса, от който редактирате',
...
'tooltip-t-emailwiki_user' => 'Изпращане на писмо до потребителя',
...
'tooltip-ca-nstab-wiki_user' => 'Преглед на потребителската страница',
...
'sitewiki_user' => 'потребител на {{SITENAME}} $1',
'anonwiki_user' => 'Анонимен потребител на {{SITENAME}} $1',
'lastmodifiedatby' => 'Последната промяна на страницата е извършена от $3 на $2, $1.',
'othercontribs' => 'Основаващо се върху работа на $1.',
'others' => 'други',
'sitewiki_users' => '{{PLURAL:$2|потребителят|потребителите}} на {{SITENAME}} $1',
'anonwiki_users' => '{{PLURAL:$2|Анонимен потребител|Анонимни потребители}} на {{SITENAME}} $1',
...
'spambot_wiki_username' => 'Спамочистач',
...
'pageinfo-lastwiki_user' => 'Последeн редактор',
...
'exif-wiki_usercomment' => 'Допълнителни коментари',
...
'confirmrecreate' => "Потребителят [[wiki_user:$1|$1]] ([[wiki_user talk:$1|беседа]]) е изтрил страницата, откакто сте започнали да я редактирате, като е посочил следното обяснение:
: ''$2''
Потвърдете, че наистина желаете да създадете страницата отново.",
'confirmrecreate-noreason' => 'Потребител [[wiki_user:$1|$1]] ([[wiki_user talk:$1|беседа]]) изтри тази страница след като сте започнали да я редактирате.  Необходимо е потвърждение, че наистина желаете да създадете страницата отново.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|беседа]])',
...
'specialpages-group-wiki_users' => 'Потребители и права',
...
'logentry-newwiki_users-newwiki_users' => 'Потребителската сметка $1 беше създадена',
'logentry-newwiki_users-create' => 'Потребителската сметка $1 беше създадена',
'logentry-newwiki_users-create2' => '$1 създаде потребителска сметка $3',
'logentry-newwiki_users-autocreate' => 'Сметката $1 беше създадена автоматично',
'newwiki_userlog-byemail' => 'паролата е изпратена по е-поща',
