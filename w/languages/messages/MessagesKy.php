...
'tog-enotifwiki_usertalkpages' => 'Талкуулоо барагым өзгөртүлгөндө мага эл. почта аркылуу билдирүү',
...
'views' => 'Көрсөтүүлөр',
'toolbox' => 'Аспаптар',
'wiki_userpage' => 'Катышуучунун барагын кароо',
...
'youhavenewmessagesmanywiki_users' => 'Көп колдонуучулардан сиз $1 алдыңыз ($2).',
...
'wiki_userlogin' => 'Кирүү / Каттоо',
'wiki_userloginnocreate' => 'Кирүү',
'logout' => 'Сеансты аяктоо',
'wiki_userlogout' => 'Сеансты аяктоо',
...
'wiki_userlogin-resetlink' => 'Кирүүчү маалыматарыңызды унутуп калдыңызбы?',
'createaccountmail' => 'Электрондук дарек боюнча',
'createaccountreason' => 'Себеби:',
'badretype' => 'Сиз киргизген сырсөздөр дал келишпейт',
'wiki_userexists' => 'Сиз тандаган катышуучунун аты бош эмес.
Башка атты тандаңыз.',
...
'nowiki_userspecified' => 'Сиз катышуучу атын көрсөтүшүңүз керек.',
'login-wiki_userblocked' => 'Бул катышуучу бөгөттөлгөн. Системага кирүүгө уруксат жок.',
...
'passwordreset-wiki_username' => 'Катышуучу аты:',
...
'wiki_userpage-wiki_userdoesnotexist' => '"$1" Мындай катышуучу катталган эмес. Ушул баракты түзүүнү же оңдогонду каалганыңыз анык болсун',
'updated' => '(Жаңыртылды)',
'note' => "'''Эскертүү:'''",
...
# Revision deletion
'rev-deleted-wiki_user' => '(катышуучу аты өчүрүлдү)',
...
'revdelete-hide-wiki_user' => 'Редактордун катышуучу атын/IP-дарегин жашыруу',
...
'prefs-wiki_user-pages' => 'Катышуучунун барактары',
...
'wiki_username' => 'Колдонуучунун аты:',
...
# wiki_user rights
'wiki_userrights' => 'Катышуучулардын укуктарын башкаруу',
'wiki_userrights-lookup-wiki_user' => 'Катышуучу топторун башкаруу',
'wiki_userrights-wiki_user-editname' => 'Катышуучу атыңызды киргизиңиз:',
'editwiki_usergroup' => 'Катышуучу топторун оңдоо',
'wiki_userrights-editwiki_usergroup' => 'Катышуучу топторун оңдоо',
'savewiki_usergroups' => 'Катышуучу топторун сактоо',
'wiki_userrights-groupsmember' => 'Топтордо турат:',
'wiki_userrights-reason' => 'Себеп:',
'wiki_userrights-changeable-col' => 'Сиз өзгөртө алган топтор',
'wiki_userrights-unchangeable-col' => 'Сиз өзгөртө албаган топтор',

# Groups
'group' => 'Топ:',
'group-wiki_user' => 'Катышуучулар',
...
'group-wiki_user-member' => '{{GENDER:$1|катышуучу}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Катышуучулар',
...
'right-move-rootwiki_userpages' => 'катышуучулардын түпкү барактарынын атын өзгөртүү',
...
'right-wiki_userrights' => 'Бүт катышуучулардын укуктарын оңдоо',
...
'action-wiki_userrights' => 'бүт катышуучулардын укуктарын оңдоо',
...
'statistics-header-wiki_users' => 'Коолдонуучулардын статистикасы',
...
'listwiki_users' => 'Катышуучулар тизмеси',
'wiki_usercreated' => "$1 күнү $2'да {{GENDER:$3|катталды}}.",
'newpages' => 'Жаңы барактар',
'newpages-wiki_username' => 'Катышуучунун аты:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Аткаруучу:',
...
'listwiki_users-submit' => 'Көрсөтүү',
'listwiki_users-noresult' => 'Катышуучу табылган жок.',
'listwiki_users-blocked' => '(блокировкаланды)',

# Special:Activewiki_users
'activewiki_users' => 'Активдүү катышуучулардын тизмеси',
'activewiki_users-hidebots' => 'Ботторду жашыруу',
'activewiki_users-hidesysops' => 'Администраторлорду жашыруу',
'activewiki_users-noresult' => 'Катышуучулар табылган жок.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Катышуучулардын каттоо журналы',
...
# E-mail wiki_user
'emailwiki_user' => 'Бул катышуучуга кат жиберүү',
'emailwiki_username' => 'Катышуучунун аты:',
'emailwiki_usernamesubmit' => 'Жөнөтүү',
'emailfrom' => '- дан',
'emailto' => 'Кимге:',
'emailsubject' => 'Тема:',
...
'sp-contributions-wiki_username' => 'IP-дарек же катышуучунун аты:',
...
'ipadressorwiki_username' => 'IP-дарек же катышуучу аты:',
'ipbreason' => 'Себеп:',
...
'tooltip-pt-wiki_userpage' => 'Катышуучу барагыңыз',
...
'tooltip-t-emailwiki_user' => 'Бул катышуучуга кат жиберүү',
...
'tooltip-ca-nstab-wiki_user' => 'Катышуучунун барагын көрсөтүү',
...
# Attribution
'others' => 'башкалар',
'anonwiki_users' => '{{SITENAME}} анонимдик {{PLURAL:$2|катышуучу}} $1',
...
'pageinfo-firstwiki_user' => 'Барактын жаратуучусу',
'pageinfo-lastwiki_user' => 'Акыркы редактор',
...
'exif-wiki_usercomment' => 'Колдонуучунун комментарийи',
...
'logentry-newwiki_users-newwiki_users' => '$1 эсеп жазуусу жаратылды',
'logentry-newwiki_users-create' => '$1 эсеп жазуусу жаратылды',
'logentry-newwiki_users-create2' => '$1 эсеп жазуусун жаратты',
'logentry-newwiki_users-autocreate' => 'Автоматтуу түрдө $1 эсеп жазуусу жаратылды',
'newwiki_userlog-byemail' => 'сырсөз эл. почта аркылуу жөнөтүлдү',
