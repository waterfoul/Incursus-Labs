...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'BRUKARTAL', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'AKTIVEBRUKARAR', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'VERSJONSBRUKAR', 'REVISIONUSER' ),
...
$specialPageAliases = array(
	...
	'Listwiki_users'                 => array( 'Brukarliste' ),
...
'tog-enotifwiki_usertalkpages' => 'Send e-post når brukarsida mi vert endra',
...
'youhavenewmessagesfromwiki_users' => 'Du har $1 frå {{PLURAL:$3|ein annan brukar| $3 brukarar}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Du har $1 frå mange brukarar ($2).',
...
'wiki_userlogin' => 'Lag brukarkonto / logg inn',
...
'wiki_userlogin-resetlink' => 'Har du gløymd påloggingsopplysingane dine?',
'createaccountmail' => 'over e-post',
'createaccountreason' => 'Årsak:',
'badretype' => 'Passorda du skreiv inn er ikkje like.',
'wiki_userexists' => 'Brukarnamnet er alt i bruk. Vel eit anna brukarnamn.',
...
'nosuchwiki_user' => 'Det finst ikkje nokon brukar med brukarnamnet «$1».
...
'nosuchwiki_usershort' => 'Det finst ikkje nokon brukar med brukarnamnet «$1». Sjekk at du har skrive rett.',
'nowiki_userspecified' => 'Du må oppgje eit brukarnamn.',
'login-wiki_userblocked' => 'Denne brukaren er blokkert. Innlogging er ikkje tillate.',
...
'wiki_usernamehasherror' => 'Brukarnamn kan ikkje innehalda nummerteikn.',
...
'suspicious-wiki_userlogout' => 'Førespurnaden din om å logge ut vart nekta fordi han såg ut til å vere sendt av ein øydelagt nettlesar eller mellomtenar.',

# E-mail sending
'php-mail-error-unknown' => 'Ukjend feil i PHPs mail()-funksjon',
'wiki_user-mail-no-addy' => '↓Prøvde å senda e-post utan e-postadresse',
...
'passwordreset-wiki_username' => 'Brukarnamn:',
...
'passwordreset-emailtext-wiki_user' => 'Brukaren $1 på {{SITENAME}} bad om ei påminning for kontodetaljane dine for {{SITENAME}} ($4). {{PLURAL:$3|Den fylgjande brukarkontoen|Dei fylgjande brukarkontoane}} er assosierte med denne e-postadressa:
...
'wiki_userpage-wiki_userdoesnotexist' => 'Brukarkontoen «<nowiki>$1</nowiki>» finst ikkje. Vil du verkeleg opprette/endre denne sida?',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Brukarkontoen «$1» er ikkje oppretta.',
...
'wiki_usercssyoucanpreview' => "'''Tips:''' Bruk «{{int:showpreview}}»-knappen for å teste den nye CSS- eller JavaScript-koden din før du lagrar.",
'wiki_userjsyoucanpreview' => "''Tips:''' Bruk «{{int:showpreview}}»-knappen for å teste den nye CSS- eller JavaScript-koden din før du lagrar.",
'wiki_usercsspreview' => "'''Hugs at dette berre er ei førehandsvising av din eigen CSS og at han ikkje er lagra enno!'''",
'wiki_userjspreview' => "'''Hugs at du berre testar ditt eige JavaScript, det har ikkje vorte lagra enno!!'''",
...
'wiki_userinvalidcssjstitle' => "'''Åtvaring:''' Det finst ikkje noka sidedrakt som heiter «$1». Hugs på at vanlege .css- og .js-sider brukar titlar med små bokstavar, til dømes {{ns:wiki_user}}:Døme/vector.css, og ikkje {{ns:wiki_user}}:Døme/Vector.css.",
'updated' => '(Oppdatert)',
'note' => "'''Merk:'''",
...
'rev-deleted-wiki_user' => '(brukarnamnet er fjerna)',
'rev-deleted-event' => '(fjerna loggoppføring)',
'rev-deleted-wiki_user-contribs' => '[brukarnamn eller IP-adresse fjerna - endringa er gøymd frå bidraga]',
...
'revdelete-hide-wiki_user' => 'Gøym brukarnamn/IP-adresse',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Ein mellomversjon|$1 mellomversjonar}} av meir enn $2 {{PLURAL:$2|brukar|brukarar}}  er ikkje {{PLURAL:$1|vist|viste}})',
...
'prefs-wiki_user-pages' => 'Brukarsider',
...
# wiki_user rights
'wiki_userrights' => 'Administrering av brukartilgang',
'wiki_userrights-lookup-wiki_user' => 'Administrer brukargrupper',
'wiki_userrights-wiki_user-editname' => 'Skriv inn brukarnamn:',
'editwiki_usergroup' => 'Endre brukargrupper',
'editingwiki_user' => "Endrar brukarrettane til brukaren '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Endre brukargrupper',
'savewiki_usergroups' => 'Lagre brukargrupper',
'wiki_userrights-groupsmember' => 'Medlem av:',
'wiki_userrights-groupsmember-auto' => 'Implisitt medlem av:',
'wiki_userrights-groups-help' => 'Du kan endre kva for grupper denne brukaren er medlem av.
...
'wiki_userrights-no-interwiki' => 'Du har ikkje tilgang til å endre brukartilgangar på andre wikiar.',
'wiki_userrights-nodatabase' => 'Databasen $1 finst ikkje eller er ikkje lokal.',
'wiki_userrights-nologin' => 'Du må [[Special:wiki_userLogin|logge inn]] med ein administrator- og/eller byråkratkonto for å endre brukartilgangar.',
'wiki_userrights-notallowed' => 'Kontoen din har ikkje løyve til å leggja til eller fjerna brukarrettar.',
'wiki_userrights-changeable-col' => 'Grupper du kan endre',
'wiki_userrights-unchangeable-col' => 'Grupper du ikkje kan endre',

# Groups
'group' => 'Gruppe:',
'group-wiki_user' => 'Brukarar',
...
'group-wiki_user-member' => '{{GENDER:$1|brukar}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Brukarar',
...
'right-move-rootwiki_userpages' => 'Flytte hovudbrukarsider',
...
'right-hidewiki_user' => 'Blokkere eit brukarnamn og skjule det frå ålmenta.',
...
'right-editwiki_usercssjs' => 'Endre andre brukarar sine CSS- og JS-filer',
'right-editwiki_usercss' => 'Endre andre brukarar sine CSS-filer',
'right-editwiki_userjs' => 'Endre andre brukarar sine JS-filer',
...
'right-wiki_userrights' => 'Endre alle brukarrettar',
'right-wiki_userrights-interwiki' => 'Endre rettar for brukarar på andre wikiar',
...
'action-move-rootwiki_userpages' => 'flytte hovudbrukarsider',
...
'action-wiki_userrights' => 'endre alle brukarrettar',
'action-wiki_userrights-interwiki' => 'endre brukarrettar for brukarar på andre wikiar',
...
'newpageletter' => 'n',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[{{PLURAL:$1|Éin brukar|$1 brukarar}} overvakar]',
...
'fileexists-thumbnail-yes' => 'Fila ser ut til å vere eit bilete med redwiki_usert storleik. [[$1|thumb]]
...
Det ser ut til å vere eit bilte med redwiki_usert storleik''(miniatyrbilete)''.
...
'statistics-header-wiki_users' => 'Brukarstatistikk',
...
'statistics-wiki_users' => 'Registrerte [[Special:Listwiki_users|brukarar]]',
'statistics-wiki_users-active' => 'Aktive brukarar',
'statistics-wiki_users-active-desc' => 'Brukarar som har utført handlingar {{PLURAL:$1|i dag|dei siste $1 dagane}}',
...
'listwiki_users' => 'Brukarliste',
'listwiki_users-editsonly' => 'Vis berre brukarar med endringar',
'listwiki_users-creationsort' => 'Sorter etter opprettingsdato',
'wiki_usereditcount' => '{{PLURAL:$1|éi endring|$1 endringar}}',
'wiki_usercreated' => '{{GENDER:$3|Oppretta}} den $1 $2',
'newpages' => 'Nye sider',
'newpages-wiki_username' => 'Brukarnamn:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Utøvar:',
...
'listwiki_usersfrom' => 'Vis brukarnamna frå og med:',
'listwiki_users-submit' => 'Vis',
'listwiki_users-noresult' => 'Ingen brukarnamn vart funne.',
'listwiki_users-blocked' => '(konto blokkert)',

# Special:Activewiki_users
'activewiki_users' => 'Liste over aktive brukarar',
'activewiki_users-intro' => 'Dette er ei liste over brukarar som har hatt ei eller anna form for aktivitet innanfor {{PLURAL:$1|den siste dagen|dei siste dagane}}.',
'activewiki_users-count' => '{{PLURAL:$1|Éi handling|$1 handlingar}} {{PLURAL:$3|det siste døgeret|dei siste $3 døgra}}',
'activewiki_users-from' => 'Vis brukarar frå og med:',
'activewiki_users-hidebots' => 'Skjul botar',
'activewiki_users-hidesysops' => 'Skjul administratorar',
'activewiki_users-noresult' => 'Ingen brukarar funne.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Brukaropprettingslogg',
'newwiki_userlogpagetext' => 'Dette er ein logg over oppretta brukarkontoar.',
...
'emailwiki_user' => 'Send e-post åt denne brukaren',
'emailwiki_user-title-target' => 'Send epost åt {{GENDER:$1|brukaren}}',
'emailwiki_user-title-notarget' => 'Send e-post åt brukar',
...
'wiki_usermailererror' => 'E-post systemet gav feilmelding:',
'defemailsubject' => '{{SITENAME}} epost frå brukar "$1"',
'wiki_usermaildisabled' => 'Brukare-post slegen av',
'wiki_usermaildisabledtext' => 'Du kan ikkje senda e-postar til andre brukarar på wikien',
...
'emailwiki_userfooter' => 'E-posten vart sendt av $1 til $2 via «Send e-post»-funksjonen på {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Lèt att ei systemmelding.',
'wiki_usermessage-editor' => 'Systembodbringar',
...
'revertpage-nowiki_user' => 'Tilbakestilte endringar av (brukarnamn fjerna) til den siste versjonen av [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'administrering av brukartilgang',
...
'sp-contributions-wiki_username' => 'IP-adresse eller brukarnamn:',
...
'ipadressorwiki_username' => 'IP-adresse eller brukarnamn',
...
'ipbwatchwiki_user' => 'Overvak brukarsida og diskusjonssida til brukaren',
'ipb-disablewiki_usertalk' => 'Hindra brukaren i å endra eiga diskusjonsside medan blokkeringa gjeld',
...
'ipb-confirmhidewiki_user' => 'Du er i ferd med å blokkere ein brukar med "skjult brukar" aktivert. Brukarens namn vil verte skjult i alle lister og loggoppføringar. Er du sikker på at du vil gjere dette?',
...
'blocklist-wiki_userblocks' => 'Gøym kontoblokkeringar',
...
'blocklist-nowiki_usertalk' => 'kan ikkje endre si eiga diskusjonsside',
...
'block-log-flags-nowiki_usertalk' => 'kan ikkje endre eiga diskusjonsside',
...
'unblock-hidewiki_user' => 'Du kan ikkje heve blokkeringa av denne brukaren, av di brukarnamnet har blitt gøymd.',
...
'cant-see-hidden-wiki_user' => 'Brukaren du prøver å blokkera har allereie vorte blokkert og skjult. Sidan du ikkje har rett til å skjula brukarar, kan du ikkje sjå eller endra blokkeringa til brukaren.',
...
'movewiki_userpage-warning' => "'''Åtvaring:''' Du er i ferd med å flytta ei brukarside. Merk at berre sida vert flytt og at brukarnamnet '''ikkje''' vert endra.",
...
'cant-move-wiki_user-page' => 'Du har ikkje løyve til å flytte brukarsider (bortsett frå undersider).',
'cant-move-to-wiki_user-page' => 'Du har ikkje løyve til å flytte brukarsider (bortsett frå undersider).',
...
'tooltip-pt-wiki_userpage' => 'Brukarsida di',
'tooltip-pt-anonwiki_userpage' => 'Brukarsida for ip-adressa du endrar under',
...
'tooltip-t-emailwiki_user' => 'Send ein e-post til denne brukaren',
...
'tooltip-ca-nstab-wiki_user' => 'Vis brukarsida',
...
'sitewiki_user' => '{{SITENAME}}-brukaren $1',
'anonwiki_user' => '{{SITENAME}} anonym brukar $1',
'lastmodifiedatby' => 'Sida vart sist endra den $1 kl. $2 av $3.',
'othercontribs' => 'Basert på arbeid av $1.',
'others' => 'andre',
'sitewiki_users' => '{{SITENAME}}-{{PLURAL:$2|brukaren|brukarane}} $1',
'anonwiki_users' => '{{PLURAL:$2|den anonyme brukaren|dei anonyme brukararane}} $1 på {{SITENAME}}',
...
'spambot_wiki_username' => 'MediaWiki si spamopprydding',
...
'pageinfo-firstwiki_user' => 'Sideopprettar',
'pageinfo-firsttime' => 'Dato for opprettinga av sida',
'pageinfo-lastwiki_user' => 'Siste forfattaren',
...
'exif-wiki_usercomment' => 'Brukarkommentarar',
...
'exif-flash-redeye-1' => 'redwiki_usering av raude auge',
...
'specialpages-group-wiki_users' => 'Brukarar og brukartilgangar',
...
'logentry-newwiki_users-newwiki_users' => 'Brukarkontoen $1 vart oppretta',
'logentry-newwiki_users-create' => 'Brukarkontoen $1 vart oppretta',
'logentry-newwiki_users-create2' => 'Brukarkontoen $3 vart oppretta av $1',
'logentry-newwiki_users-autocreate' => 'Kontoen $1 vart oppretta av seg sjølv',
'newwiki_userlog-byemail' => 'passordet er sendt på e-post',
