...
'tog-enotifwiki_usertalkpages' => 'Bie Annerengen an mien Benutser-Diskussionssiede E-Mails seende.',
...
'wiki_userlogin' => 'Anmäldje / Benutserkonto moakje',
'wiki_userloginnocreate' => 'Anmäldje',
'logout' => 'Oumäldje',
'wiki_userlogout' => 'Oumäldje',
...
'wiki_userexists' => 'Dissen Benutsernoome is al ferroat. Wääl jädden n uur.',
...
'nosuchwiki_user' => 'Die Benutsernoome "$1" bestoant nit.
...
'nosuchwiki_usershort' => 'Die Benutsernooome "$1" bestoant nit. Uurpröif ju Skrieuwwiese.',
'nowiki_userspecified' => 'Reek jädden n Benutsernoome an.',
'login-wiki_userblocked' => 'Dissen Benutser is speerd. Anmäldenge nit ferlööwed.',
...
'wiki_usernamehasherror' => 'Benutsernoomen duuren neen Ruuten-Teekene änthoolde',
...
'suspicious-wiki_userlogout' => 'Dien Oumälde-Anfroage wuud ferwäigerd, deer ju fermoudelk fon n defekten Browser of n Cache-Proxy soand wuud.',

# E-mail sending
'php-mail-error-unknown' => 'Uunbekoanden Failer mäd ju Funktion mail() fon PHP',
'wiki_user-mail-no-addy' => 'Fersoachte ne E-Mail sunner Angoawe fon ne E-Mail-Adresse tou ferseenden',
...
'passwordreset-wiki_username' => 'Benutsernoome:',
...
'wiki_userpage-wiki_userdoesnotexist' => 'Dät Benutserkonto „<nowiki>$1</nowiki>“ is nit deer. Pröif, of du disse Siede wuddelk moakje/beoarbaidje wolt.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Benutserkonto „$1“ bestoant nit.',
...
'wiki_usercssyoucanpreview' => "'''Tipp:''' Benutse dän  „{{int:showpreview}}“-Knoop, uum dien näi CSS foar dät Spiekerjen tou tästjen.",
'wiki_userjsyoucanpreview' => "'''Tipp:''' Benutse dän „{{int:showpreview}}“-Knoop, uum dien näi JavaScript foar dät Spiekerjen tou tästjen.",
'wiki_usercsspreview' => "== Foarbekiek fon dien Benutser-CSS ==
...
'wiki_userjspreview' => "== Foarskau fon dien Benutser-CSS ==
...
'wiki_userinvalidcssjstitle' => "'''Woarskauenge:''' Deer existiert neen Skin \"\$1\". Betoank jädden, dät benutserspezifiske .css- un .js-Sieden män n Littek-Bouksteeuwe anfange mouten, also t.B. ''{{ns:wiki_user}}:Mustermann/vector.css'', nit ''{{ns:wiki_user}}:Mustermann/Vector.css''.",
'updated' => '(Annerd)',
'note' => "'''Waiwiesenge:'''",
...
'rev-deleted-wiki_user' => '(Benutsernoome wächhoald)',
'rev-deleted-event' => '(Logbouk-Aktion wächhoald)',
'rev-deleted-wiki_user-contribs' => '[Benutsernoome of IP-Adrässe wächhoald - Beoarbaidenge uut Biedreege ferstat.]',
...
'revdelete-hide-wiki_user' => 'Benutsernoome/ju IP fon dän Beoarbaider ferstopje',
...
'diff-multi-manywiki_users' => ' ({{PLURAL:$1|Ne deertwiske lääsende Version|$1 deertwiske lääsende Versione}} fon moor as {{PLURAL:$2|Benutser|$2 Benutsere}} nit wiesd)',
...
# wiki_user rights
'wiki_userrights' => 'Benutsergjuchteferwaltenge',
'wiki_userrights-lookup-wiki_user' => 'Ferwaltede Gruppentouheeregaid',
'wiki_userrights-wiki_user-editname' => 'Benutsernoome anreeke:',
'editwiki_usergroup' => 'Beoarbaidede Benutsergjuchte',
'editingwiki_user' => "Uur Benutsergjuchte fon '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Beoarbaidje Gruppentouheeregaid fon dän Benutser',
'savewiki_usergroups' => 'Spiekerje Gruppentouheeregaid',
'wiki_userrights-groupsmember' => 'Meeglid fon:',
'wiki_userrights-groupsmember-auto' => 'Automatisk Meeglid fon:',
'wiki_userrights-groups-help' => 'Du koast ju Gruppentouheeregaid foar dissen Benutser annerje:
...
'wiki_userrights-reason' => 'Gruund:',
'wiki_userrights-no-interwiki' => 'Du hääst neen Begjuchtigenge, do Benutsergjuchte in uur Wikis tou annerjen.',
'wiki_userrights-nodatabase' => 'Ju Doatenboank $1 is nit deer of nit lokoal.',
'wiki_userrights-nologin' => 'Du moast die mäd n Administrator-Benutserkonto [[Special:wiki_userLogin|anmäldje]], uum Benutsergjuchte tou annerjen.',
'wiki_userrights-notallowed' => 'Du hääst neen Begjuchtigenge, uum Benutsergjuchte tou reeken of ientouluuken.',
'wiki_userrights-changeable-col' => 'Gruppentouheeregaid, ju du annerje koast',
'wiki_userrights-unchangeable-col' => 'Gruppentouheeregaid, ju du nit annerje koast',

# Groups
'group' => 'Gruppe:',
'group-wiki_user' => 'Benutsere',
...
'group-wiki_user-member' => '{{GENDER:$1|Benutser|Benutserske}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Benutsere',
...
'right-move-rootwiki_userpages' => 'Haud-Benutsersieden ferskuuwe',
...
'right-hidewiki_user' => 'Speer un ferbiergje n Benutsernoome',
...
'right-editwiki_usercssjs' => 'Beoarbaidjen fon CSS- un JS-Doatäie fon uur Benutsere',
'right-editwiki_usercss' => 'Beoarbaidjen fon CSS-Doatäie fon uur Benutsere',
'right-editwiki_userjs' => 'Beoarbaidjen fon JS-Doatäie fon uur Benutsere',
...
'right-wiki_userrights' => 'Benutsergjuchte beoarbaidje',
'right-wiki_userrights-interwiki' => 'Benutsergjuchte in uur Wikis beoarbaidje',
...
'action-move-rootwiki_userpages' => 'Haud-Benutsersieden ferskuuwe',
...
'action-wiki_userrights' => 'Benutsergjuchte tou annerjen',
'action-wiki_userrights-interwiki' => 'do Gjuchte fon Benutsere in uur Wikis annerje',
...
'newpageletter' => 'Näi',
'boteditletter' => 'B',
'number_of_watching_wiki_users_pageview' => '[$1 beooboachtjende {{PLURAL:$1|Benutser|Benutsere}}]',
...
'statistics-header-wiki_users' => 'Benutserstatistik',
...
'statistics-wiki_users' => 'Registrierde [[Special:Listwiki_users|Benutsere]]',
'statistics-wiki_users-active' => 'Aktive Benutsere',
'statistics-wiki_users-active-desc' => 'Benutsere mäd Beoarbaidengen {{PLURAL:$1|in do lääste 24 Uuren|in do fergeene $1 Deege}}',
...
'listwiki_users' => 'Benutser-Lieste',
'listwiki_users-editsonly' => 'Wies bloot Benutsere mäd Biedraage',
'listwiki_users-creationsort' => 'Ätter dän Moakdoatum sortierje',
'wiki_usereditcount' => '$1 {{PLURAL:$1|Beoarbaidenge|Beoarbaidengen}}',
'wiki_usercreated' => '{{GENDER:$3|Moaked}} ap n $1 uum $2 Uure',
'newpages' => 'Näie Sieden',
'newpages-wiki_username' => 'Benutsernoome:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Uutfierenden Benutser:',
...
'listwiki_usersfrom' => 'Wies Benutsere fon:',
'listwiki_users-submit' => 'Wies',
'listwiki_users-noresult' => 'Naan Benutser fuunen.',
'listwiki_users-blocked' => '(speerd)',

# Special:Activewiki_users
'activewiki_users' => 'Lieste fon aktive Benutsere',
'activewiki_users-intro' => 'Dit is ne Lieste fon Benutsere, do binne {{PLURAL:$1|dän lääste Dai|do lääste $1 Deege}} Aktivitäte apwiese.',
'activewiki_users-count' => '$1 {{PLURAL:$1|Beoarbaidenge|Beoarbaidengen}} in do {{PLURAL:$3|lääste 24 Uuren|fergeene $3 Deege}}',
'activewiki_users-from' => 'Wies Benutsere ounfangend mäd:',
'activewiki_users-hidebots' => 'Bots fersteete',
'activewiki_users-hidesysops' => 'Administratore fersteete',
'activewiki_users-noresult' => 'Neen Benutsere fuunen.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Näianmäldengs-Logbouk',
'newwiki_userlogpagetext' => 'Dit is dät Logbouk fon näi anmäldede Benutsere.',
...
'emailwiki_user' => 'Seende E-Mail an dissen Benutser',
...
'wiki_usermailererror' => 'Dät Mail-Objekt roat n Failer tourääch:',
'defemailsubject' => '{{SITENAME}}-E-Mail',
'wiki_usermaildisabled' => 'E-Mail-Ämfangst deaktivierd',
'wiki_usermaildisabledtext' => 'Du koast in dissen Wiki neen E-Mails an uur Benutsere seende',
...
'emailwiki_username' => 'Benutsernoome:',
'emailwiki_usernamesubmit' => 'Fääre',
...
'emailwiki_userfooter' => 'Disse E-Mail wuude fon „Benutzer:$1“ an „Benutzer:$2“ mäd Hälpe fon ju „E-Mail an dissen Benutser“-Funktion fon {{SITENAME}} fersoand.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Systemättergjucht spiekerd.',
...
'revertpage-nowiki_user' => 'Annerengen fon (Benutsernoome wächhoald) touräächtroald un lääste Version fon [[wiki_user:$1|$1]] wier häärstoald',
...
'sp-contributions-wiki_userrights' => 'Benutsergjuchteferwaltenge',
...
'sp-contributions-wiki_username' => 'IP-Adrässe af Benutsernoome:',
...
'ipadressorwiki_username' => 'IP-Adresse of Benutsernoome:',
...
'ipbwatchwiki_user' => 'Benutser(diskussions)siede beooboachtje',
'ipb-disablewiki_usertalk' => 'Dissen Benutser deeran hinderje sien oaine Diskussionssiede tou beoarbaidjen, soloange hie speerd is',
...
'ipb-confirmhidewiki_user' => 'Du bäst tougong n Benutser in dän Modus "Benutser fersteete" tou speeren. Dät fiert deertou, dät die Benutsernoome in aal Liesten un Logbouke unnerdrukt wäd. Moatest dät wuudelk dwo?',
...
'blocklist-wiki_userblocks' => 'Benutserspeeren fersteete',
...
'blocklist-nowiki_usertalk' => 'duur oaine Diskussionssiede nit beoarbaidje',
...
'block-log-flags-nowiki_usertalk' => 'duur oaine Diskussionssiede nit beoarbaidje',
...
'unblock-hidewiki_user' => 'Disssen Benutser kon nit speerd wäide, deer sin Benutsernoome ferstat wuude.',
...
'cant-see-hidden-wiki_user' => 'Die Benutser, dän du fersäkst tou speeren, wuud al speerd un ferstat. Deer du dät „hidewiki_user“-Gjucht nit hääst, koast du ju Benutserspeere nit sjo un nit beoarbaidje.',
...
'movewiki_userpage-warning' => "'''Woarskauenge:''' Du bäst tougong, ne Benutserssiede tou ferskuuwen. Betoank, dät deertruch bloot ju Benutsersiede ferskäuwen, man '''nit''' die Benutser uumenaamd wäd.",
...
'cant-move-wiki_user-page' => 'Du hääst neen Begjuchtigenge, Benutserhaudsieden tou ferskuuwen.',
'cant-move-to-wiki_user-page' => 'Du hääst nit ju  Begjuchtigenge, Sieden ap ne Benutsersiede tou ferskuuwen (mäd Uutnoame fon Benutserunnersieden).',
...
'tooltip-pt-wiki_userpage' => 'Dien Benutsersiede',
'tooltip-pt-anonwiki_userpage' => 'Benutsersiede fon ju IP-Adresse fon ju uut du Annerengen truchfierst',
...
'tooltip-t-emailwiki_user' => 'Een E-Mail an dissen Benutser seende',
...
'tooltip-ca-nstab-wiki_user' => 'Benutsersiede anwiese',
...
'sitewiki_user' => '{{SITENAME}}-Benutser $1',
'anonwiki_user' => 'Anonymen {{SITENAME}}-Benutser $1',
'lastmodifiedatby' => 'Disse Siede wuude toulääst annerd uum $2, $1 fon $3.',
'othercontribs' => 'Basierd ap ju Oarbaid fon $1.',
'others' => 'uur',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|Benutser|Benutsere}} $1',
'anonwiki_users' => '{{PLURAL:$2|anonymen|anonyme}} {{SITENAME}}-{{PLURAL:$2|Benutser|Benutsere}} $1',
...
'spambot_wiki_username' => 'MediaWiki Spam-Süüwerenge',
...
'exif-wiki_usercomment' => 'Benutserkommentoare',
...
'specialpages-group-wiki_users' => 'Benutsere un Gjuchte',
...
'newwiki_userlog-byemail' => 'dät Paaswoud wuud uur E-Mail fersoand',
