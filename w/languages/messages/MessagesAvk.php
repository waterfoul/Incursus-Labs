...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'FavesikEmailMane' ),
	...
	'Listwiki_users'                 => array( 'Favesikeem' ),
...
'tog-enotifwiki_usertalkpages' => 'Moi da betara va jinafu favesikbu pu jin staksar !',
...
'wiki_userlogin' => 'Va int dogluyá / pataredú',
'wiki_userloginnocreate' => 'Dogluyara',
'logout' => 'Dimgluyá',
'wiki_userlogout' => 'Dimgluyara',
...
'wiki_userlogin-resetlink' => 'Rinafa "login" pinta vulkuna ?',
'createaccountmail' => 'kan e-mail',
'createaccountreason' => 'Lazava :',
'badretype' => 'Toloy suteyen remravlem tid menuxaf.',
'wiki_userexists' => 'Favesikyolt suteyen ixam zo faver.
...
'nosuchwiki_user' => '« $1 » favesik me krulder.
Sutera va favesikyolt gotir eltaykoranhafa.
Ageltal va rinaf suteks oke [[Special:wiki_userLogin/signup|pataredura]].',
'nosuchwiki_usershort' => 'Me tir favesik digis va « $1 » yolt. Va sutekaks ageltal.',
'nowiki_userspecified' => 'Va favesikyolt gobazel !',
'login-wiki_userblocked' => 'Bat webesik tir elekayan. Dogluyara menovena.',
...
'passwordreset-wiki_username' => 'Favesikyolt :',
...
'wiki_userpage-wiki_userdoesnotexist' => '"<nowiki>$1</nowiki>" favesikpata me tir vuesteyena. Vay stujel ede va batu bu roredul ike robetal.',
...
'wiki_usercssyoucanpreview' => "'''Astuce :''' utilisez le bouton '''Prévisualisation''' pour tester votre nouvelle feuille css/js avant de l'enregistrer.",
'wiki_userjsyoucanpreview' => "'''Astuce :''' utilisez le bouton '''Prévisualisation''' pour tester votre nouvelle feuille css/js avant de l'enregistrer.",
'wiki_usercsspreview' => "'''Rappelez-vous que vous êtes en train de prévisualiser votre propre feuille css et qu'elle n'a pas encore été enregistrée !'''",
...
'rev-deleted-wiki_user' => '(tiolteyen favesikyolt)',
...
'revdelete-hide-wiki_user' => 'Palsera va sutes favesikyolt iku IP mane',
...
# wiki_user rights
'wiki_userrights' => 'Pofera va favesikrokeem',
'wiki_userrights-lookup-wiki_user' => 'Pofera va favesikeem',
'wiki_userrights-wiki_user-editname' => 'Va favesikyolt bazel',
'editwiki_usergroup' => 'Betara va favesikeem lospa',
'editingwiki_user' => "Betara va rokeem ke '''[[wiki_user:$1|$1]]''' favesik ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Betara va favesiklospa',
'savewiki_usergroups' => 'Giwara va favesiklospa',
'wiki_userrights-groupsmember' => 'Bewik ke',
'wiki_userrights-reason' => 'Elekaradanda :',
'wiki_userrights-no-interwiki' => 'Va favesikroka koe ari wiki me robetal.',
'wiki_userrights-nodatabase' => '$1 origak me krulder oke me tir lizukaf.',
'wiki_userrights-nologin' => 'Ta tentura va favesikroka gotil [[Special:wiki_userLogin|dogluyan]] kan ristusikpata.',
'wiki_userrights-notallowed' => 'Rinafa pata va favesikroka me ronoloplekur oke ronosular.',
'wiki_userrights-changeable-col' => 'Yona rinon robetana lospa',
'wiki_userrights-unchangeable-col' => 'Yona rinon merobetana lospa',

# Groups
'group' => 'Lospa :',
'group-wiki_user' => 'Favesikeem',
...
'group-wiki_user-member' => '{{GENDER:$1|favesik}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Favesikeem',
...
'right-move-rootwiki_userpages' => 'Arrundara va zaefu favesikbu',
...
'right-hidewiki_user' => 'Elekara va favesikyolt, palseson dolge saneg',
...
'right-editwiki_usercssjs' => 'Betara va CSS ik JS iyeltak ke ar favesik',
'right-editwiki_usercss' => 'Betara va CSS iyeltak ke ar favesik',
'right-editwiki_userjs' => 'Betara va JS iyeltak ke ar favesik',
...
'right-wiki_userrights' => 'Betara va favesikrokeem',
'right-wiki_userrights-interwiki' => "Betara va favesikrokeem koe aro 'wiki' xo",
...
'action-move-rootwiki_userpages' => 'Arrundara va zaefu favesikbu',
...
'newpageletter' => 'W',
'boteditletter' => 's',
'number_of_watching_wiki_users_pageview' => '[$1 nedis {{PLURAL:$1|favesik|favesik}}]',
...
'listwiki_users' => 'Pakesikeem',
'listwiki_users-editsonly' => 'Va yon betayas favesik anton nedir',
'wiki_usereditcount' => '$1 {{PLURAL:$1|betara|betara}}',
'wiki_usercreated' => '{{GENDER:$3|Reduyun}} ba $1 ba $2',
'newpages' => 'Warzaf bueem',
'newpages-wiki_username' => 'Favesikyolt :',
...
# Special:Log
'speciallogwiki_userlabel' => 'Favesik:',
...
'listwiki_usersfrom' => 'Fintara va favesikeem male :',
'listwiki_users-submit' => 'Nedira',
'listwiki_users-noresult' => 'Mek trasiyin favesik.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Buredura "log"',
...
'emailwiki_user' => 'Staksara va bat favesik',
...
'wiki_usermailererror' => 'E-mail rokla :',
...
'sp-contributions-wiki_userrights' => 'Pofera va favesikrokeem',
'sp-contributions-search' => 'Aneyara va webeks',
'sp-contributions-wiki_username' => 'IP mane ok favesikyolt :',
...
'ipadressorwiki_username' => 'IP mane ok favesikyolt',
...
'cant-move-wiki_user-page' => 'Rin va favesikbu (rade volveybu) me ronovarrundal.',
'cant-move-to-wiki_user-page' => 'Rin va bu ika favesikbu (rade favesikafu volveybu) me ronovarrundal.',
...
'tooltip-pt-wiki_userpage' => 'Jinafu favesikbu',
...
'tooltip-t-emailwiki_user' => 'Staksara pu bat favesik',
...
'tooltip-ca-nstab-wiki_user' => 'Wira va favesikbu',
...
'spambot_wiki_username' => 'Tucuara va MediaWiki "spam"
...
'exif-wiki_usercomment' => 'Favesikaf sebuks',
...
'specialpages-group-wiki_users' => 'Favesikeem is rokeem',
...
'newwiki_userlog-byemail' => 'remravlem staksayan kan e-mail',
