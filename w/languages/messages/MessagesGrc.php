...
'tog-enotifwiki_usertalkpages' => 'Ἄγγειλόν μοι ὅτε ἡ δέλτος μου διαλέξεως χρωμένου μεταβάλληται',
...
'wiki_userpage' => 'Ὁρᾶν δέλτον χρωμένου',
...
'nstab-main' => 'Χρῆμα',
'nstab-wiki_user' => 'Δέλτος χρωμένου',
...
Κατάγγειλον τόδε [[Special:Listwiki_users/sysop|έπιτρόπῳ]] τινί, δοὺς τῷδε σημείωμα τι περιέχον τὴν URL.',
...
'titleprotected' => 'Ἡ ποίησις τῆσδε τῆς ἐπιγραφῆς πεφύλακται ὑπὸ τοῦ [[wiki_user:$1|$1]].
...
Ἔξεστί σοι χρῆσθαι τῷ {{SITENAME}} ἀνωνύμως, ἢ ἔξεστί σοι [[Special:wiki_userLogin|συνδεῖσθαι πάλιν]] ὡς ὁ αὐτὸς ἢ ὡς ἄλλος χρώμενος.
...
'wiki_userlogin' => 'Συνδεῖσθαι/λογισμὸν ποιεῖν',
'wiki_userloginnocreate' => 'Συνδεῖσθαι',
'logout' => 'Ἐξέρχεσθαι',
'wiki_userlogout' => 'Ἐξέρχεσθαι',
...
'wiki_userexists' => 'Τὸ εἰσηγμένον ὄνομα ἤδη κεχρησμένον ἐστίν.
...
'nosuchwiki_user' => 'Οὐκ ἐστὶ χρώμενος ὀνόματι "$1".
Τὰ γράμματα τῶν ὀνομάτων χρωμένων διακρίνονται εἰς κεφαλαῖα καὶ μικρά.
Σκόπει τὴν τῶν γραμμάτων ἀκριβείαν ἢ [[Special:wiki_userLogin/signup|λογισμὸν νέον ποίει]].',
'nosuchwiki_usershort' => 'Οὐκ ἐστὶ χρώμενος ἔχων τὸ ὄνομα "$1".
Ἔλεγξον τὴν ὀρθογραφίαν σου.',
'nowiki_userspecified' => 'Ὄνομα χρωμένου καθοριστέον ὑποχρεωτικώς.',
...
'passwordreset-wiki_username' => 'Ὄνομα χρωμένου:',
...
'accmailtext' => "Τὸ τυχαίως παρηγμένον σύνθημα διὰ τὸν/τὴν [[wiki_user talk:$1|$1]] ἐστάλη τῷ $2.
...
'wiki_usercssyoucanpreview' => "'''Βουλή:''' Χρῆσον τῷ κομβίῳ 'Δεικνύναι προθεώρησιν' ἵνα δοκιμάσῃς τὴν νέαν σου CSS πρὸ τοῦ καταγράφειν.",
'wiki_userjsyoucanpreview' => "'''Βουλή:''' Χρῆσον τῷ κομβίῳ 'Δεικνύναι προθεώρησιν' ἵνα δοκιμάσῃς τὴν νέαν σου JS πρὸ τοῦ καταγράφειν.",
'wiki_userinvalidcssjstitle' => "'''Προσοχή:''' Οὐχ ὑφίσταται ''skin'' \"\$1\". Μέμνησο: αἱ προσηρμοσμέναι δέλτοι .css καὶ .js χρῶνται ἐπώνυμον τι ἔχον πεζὰ γράμματα, π.χ. {{ns:wiki_user}}:Foo/vector.css ἐν ἀντίθεσει πρὸς τὸν {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(Ἐνημερωθέν)',
'note' => "'''Ἐπισήμανσις:'''",
...
Πείρασον πάλιν.
Εἰ μὴ δύνατος ἐστὶ παρὰ ταῦτα, πείρασον [[Special:wiki_userLogout|ἀποσυνδεῖσθαι]] καὶ ἐν συνεχείᾳ ἐπανασυνδεῖσθαι.'''",
...
Ἐᾷ σε δέλτον ἢδη οὖσαν μεταβάλλειν ἢ [[Special:wiki_userLogin|συνδεῖσθαι ἢ λογισμὸν ποιεῖν]].",
...
'undo-summary' => 'Ἀναίρεσις μεταγραφῆς $1 ὑπὸ τὸν/τὴν [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Διάλεξις]])',
...
'rev-deleted-wiki_user' => '(ὄνομα χρωμένου ἀφελόμενον)',
...
'revdelete-hide-wiki_user' => 'Κρύπτειν μεταγραφέως ὄνομα/IP-διεύθυνσιν',
...
'prefsnologintext' => 'Δεῖ σε <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} συνδεδεμένος εἶναι]</span> πρὸ τοῦ καθορίσειν τὰς ἐσοῦ προαιρέσεις χρωμένου.',
...
# wiki_user rights
'wiki_userrights' => 'Διαχείρισις δικαιωμάτων χρωμένου',
'wiki_userrights-lookup-wiki_user' => 'Χειρίζεσθαι ὁμάδας χρωμένου',
'wiki_userrights-wiki_user-editname' => 'Εἰσάγειν ὄνομἀ τι χρωμένου:',
'editwiki_usergroup' => 'Μεταγράφειν ὁμάδας χρωμένου',
'editingwiki_user' => "Ἀλλἀττειν τὰ δικαιώματα τοῦ χρωμένου '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Μεταγράφειν ὁμάδας χρωμένου',
'savewiki_usergroups' => 'Σῴζειν ὁμάδας χρωμένου',
'wiki_userrights-groupsmember' => 'Μέλος τοῦ:',
'wiki_userrights-reason' => 'Αἰτία:',
'wiki_userrights-no-interwiki' => 'Οὐ κατέχεις τὴν ἄδειαν μεταγραφῆς τῶν δικαιωμάτων χρωμένου ἐν ἄλλοις βίκι.',
'wiki_userrights-nodatabase' => 'Ἡ βάσις δεδομένων $1 οὐχ ὑπάρχει ἢ οὐκ ἔστι τοπική.',
'wiki_userrights-nologin' => 'Δεῖ σε [[Special:wiki_userLogin|συνδεῖσθαι]] μετὰ ἐπιτρόπου λογισμοῦ τινὸς πρὸ τοῦ μεταγράφειν τὰ δικαιώματα χρωμένου.',
'wiki_userrights-notallowed' => 'Ὁ λογισμός σου οὐκ ἔχει ἄδειαν τοῦ ὁρίσειν δικαιώματα χρωμένων.',
'wiki_userrights-changeable-col' => 'Μεταβλητέαι ὁμάδες',
'wiki_userrights-unchangeable-col' => 'Μὴ μεταβλητέαι ὁμάδες',

# Groups
'group' => 'Ὁμάς:',
'group-wiki_user' => 'Χρώμενοι',
...
'group-wiki_user-member' => '{{GENDER:$1|Χρώμενος}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Χρώμενοι',
...
'right-move-rootwiki_userpages' => 'Κινεῖν τὰς δέλτους βάσεως τοῦ χρωμένου',
...
'right-hidewiki_user' => 'Φράττειν ὄνομα χρωμένου διὰ τοῦ ἀποκρύπτειν τόδε ὑπὸ τοῦ κοινοῦ',
...
'right-editwiki_usercssjs' => 'Μεταγράφειν ἑτέρων χρωμένων CSS- καὶ JS-ἀρχεῖα',
'right-editwiki_usercss' => 'Μεταγράφειν ἑτέρων χρωμένων CSS-ἀρχεῖα',
'right-editwiki_userjs' => 'Μεταγράφειν ἑτέρων χρωμένων JS-ἀρχεῖα',
...
'right-wiki_userrights' => 'Μεταγράφειν ἅπαντα τοῦ χρωμένου δικαιώματα',
'right-wiki_userrights-interwiki' => 'Μεταγράφειν τὰ δικαιώματα χρωμένων ἐν ἄλλοις βίκι',
...
'action-move-rootwiki_userpages' => 'κινεῖν τὰς ῥιζικὰς δέλτους χρωμένου',
...
'action-wiki_userrights' => 'μεταγράφειν ἅπαντα τα δικαιώματα χρωμένου',
'action-wiki_userrights-interwiki' => 'μεταγράφειν τα δικαιώματα χρωμένου ἑτέρων βικι-χρωμένων',
...
'newpageletter' => 'Ν',
'boteditletter' => 'αὐτ',
'number_of_watching_wiki_users_pageview' => '[$1 ἐφορᾶν {{PLURAL:$1|χρώμενον|χρωμένους}}]',
...
'uploadnologintext' => 'Δεῖ σε εἶναι [[Special:wiki_userLogin|συνδεδεμένος]] πρὸ τοῦ ἐπιφορτίζειν ἀρχεῖα τινά.',
...
'statistics-header-wiki_users' => 'Χρωμένου στατιστικά',
...
'statistics-wiki_users' => 'Ἐγγεγραμμένοι [[Special:Listwiki_users|χρώμενοι]]',
'statistics-wiki_users-active' => 'Ἐνεργοὶ χρώμενοι <small>(χρώμενοι οἳ have edited or performed an action διάφορον τῆς ποιήσεως λογισμοῦ ἐν τῷ παρελθόντι μηνί)</small>',
'statistics-wiki_users-active-desc' => 'Χρώμενοι δραστήριοι ἐν τῷ παρελθόντι μηνί {{PLURAL:$1|ἡμέρα|$1 ἡμέραι}}',
...
'listwiki_users' => 'Κατάλογος πάντων τῶν χρωμένων',
'listwiki_users-editsonly' => 'Δεικνύναι μόνον μεταγράψαντας χρωμένους',
'listwiki_users-creationsort' => 'Ταξινόμησις κατὰ χρονολογίαν ποιήσεως',
'wiki_usereditcount' => '$1 {{PLURAL:$1|μεταγραφή|μεταγραφαί}}',
'wiki_usercreated' => 'Ποιηθεῖσα τῇ $1 ὥρᾳ $2',
'newpages' => 'Δέλτοι νέαι',
'newpages-wiki_username' => 'Ὄνομα χρωμένου:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Χρώμενος:',
...
'listwiki_usersfrom' => 'Δεικνύναι χρωμένους (γραμμαὶ ἐκκινουμέναι ἐκ/ἐξ):',
'listwiki_users-submit' => 'Ἐμφανίζειν',
'listwiki_users-noresult' => 'Οὐδεὶς χρώμενος εὑρεθείς.',
'listwiki_users-blocked' => '(πεφραγμένος)',

# Special:Activewiki_users
'activewiki_users' => 'Κατάλογος ἐνεργῶν χρωμένων',
'activewiki_users-count' => '$1 {{PLURAL:$1|μεταγραφή|μεταγραφαὶ}} κατὰ {{PLURAL:$3|τὴν πρόσφατον ἡμέραν|τὰς προσφάτους $3 ἡμέρας}}',
'activewiki_users-from' => 'Δεικνύειν χρωμένους ἐκκινήσει ἐκ:',
'activewiki_users-hidebots' => 'Κρύπτειν αὐτόματα',
'activewiki_users-hidesysops' => 'Κρύπτειν ἐπιτρόπους',
'activewiki_users-noresult' => 'Οὐδεὶς χρώμενος εὑρέθη.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Κατάλογος ποιήσεων λογισμῶν.',
'newwiki_userlogpagetext' => 'Ὅδε ἐστὶν κατάλογος τις τῶν ποιήσεων λογισμῶν.',
...
'emailwiki_user' => 'Ἠλεκτρονικὴν ἐπιστολὴν τῷδε τῷ χρωμένῳ πέμπειν',
...
'wiki_usermailererror' => 'Τὸ ἠλ-ταχυδρομεῖον ἐπέστρεψεν σφάλμα:',
...
'emailwiki_username' => 'Ὄνομα χρωμένου:',
'emailwiki_usernamesubmit' => 'Ὑποβάλλειν',
...
'emailwiki_userfooter' => 'Ἥδε ἡ ἐπιστολὴ ἐστάλη ὑπὸ τοῦ/τῆς $1 εἰς τὸν/τὴν $2 κατὰ τὴν τέλεσιν "Ἁποστολὴ ἠλ-μηνύματος" ἐς τὸ {{SITENAME}}.',
...
'watchnologintext' => 'Δεῖ σε [[Special:wiki_userLogin|συνδεῖσθαι]] πρὸ τοῦ μεταβάλλειν τὴν ἐφοροδιαλογήν σου.',
...
'revertpage' => 'Ἐπαναφέρειν μεταγραφὰς ὑπὸ [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Talk]]) εἰς τὴν ἐσχάτην ἔκδοσιν ὑπὸ [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'Διαχείρισις δικαιωμάτων χρωμένου',
'sp-contributions-search' => 'Ζητεῖν ἐράνους',
'sp-contributions-wiki_username' => 'IP-διεύθυνσις ἢ ὄνομα χρωμένου:',
...
'ipadressorwiki_username' => 'Διεύθυνσις IP ἢ ὄνομα χρωμένου:',
'ipbexpiry' => 'Λῆξις:',
'ipbreason' => 'Αἰτία:',
...
'ipbwatchwiki_user' => 'Ἐφορᾶν τοῦδε τοῦ χρωμένου τὰς δέλτους χρωμένου καὶ διαλέξεως',
...
'unblocked' => '[[wiki_user:$1|$1]] ἀποπεφραγμέν-ος/-η',
...
'blocklist-nowiki_usertalk' => 'ἀδύνατον τὸ μεταγράφειν τὴν ἑαυτὴν δέλτον διαλέξεως',
...
'block-log-flags-nowiki_usertalk' => 'μὴ δυναμένη ἡ μεταγραφή τῆς δέλτου σου ἐστίν',
...
'movenologintext' => 'Δεῖ σε εἶναι ἐγγεγραμμένος χρώμενός τε καὶ [[Special:wiki_userLogin|συνδεδεμένος]] ἵνα μετακινήσῃς δέλτον τινά.',
'movenotallowed' => 'Οὐκ ἔξεστί σοι δέλτους μετακινήσειν.',
'movenotallowedfile' => 'Οὐκ ἔξεστί σοι ἀρχεῖα μετακινήσειν.',
'cant-move-wiki_user-page' => 'Οὐκ ἔξεστί σοι μετακινεῖν δέλτους χρωμένων (πλὴν ὑποδέλτων).',
'cant-move-to-wiki_user-page' => 'Οὐκ ἔξεστί σοι μετακινήσειν δέλτον τινὰ πρὸς δέλτον χρωμένου (πλὴν μόνον πρὸς ὑποδέλτον χρωμένου).',
...
'tooltip-pt-wiki_userpage' => 'Ἡ δέλτος χρωμένου σου',
'tooltip-pt-anonwiki_userpage' => 'Ἡ δέλτος χρωμένου περὶ τοῦ ip ὅνπερ μεταγράφεις ὡς',
...
'tooltip-t-emailwiki_user' => 'Ἠλεκτρονικὴν ἐπιστολὴν τῷδε τῷ χρωμένῳ πέμπειν',
...
'tooltip-ca-nstab-wiki_user' => 'Δέλτος χρωμένου ὁρᾶν',
...
'sitewiki_user' => 'Χρώμενος τῷ {{SITENAME}} $1',
'anonwiki_user' => 'ἀνώνυμος χρώμενος $1 τοῦ {{SITENAME}}',
'lastmodifiedatby' => 'Ἥδε ἡ δἐλτος ἠλλάχθη ὑστάτως $2, $1 ἐκ τοῦ $3.',
'othercontribs' => 'Βεβασισμένον τῷ ἔργῳ τοῦ/τῶν $1.',
'others' => 'ἄλλοι',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|χρωμένου|χρωμένων}} τῷ $1',
'anonwiki_users' => '{{PLURAL:$2|ἀνώνυμος χρώμενος|ἀνώνυμοι χρώμενοι}} $1 τοῦ {{SITENAME}}',
...
'spambot_wiki_username' => 'Κάθαρσις τῶν ἀνεπιθυμήτων ἀγγελιῶν τῆς MediaWiki',
...
'exif-wiki_usercomment' => 'Σχόλια χρωμένου',
...
Ἔξεστί σοι [[Special:wiki_userLogin|συνδεῖσθαι]] καὶ χρῆσθαι τῷ βίκι.',
...
'specialpages-group-wiki_users' => 'Χρώμενοι καὶ δικαιώματα',
...
'newwiki_userlog-byemail' => 'σύνθημα ἀπεσταλμένον μέσῳ ἠλ-ταχυδρομείου',
