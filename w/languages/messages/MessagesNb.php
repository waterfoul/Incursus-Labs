...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Aktive_brukere' ),
	...
	'Listwiki_users'                 => array( 'Brukerliste' ),
	...
	'wiki_userrights'                => array( 'Brukerrettigheter' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'ANTALLBRUKERE', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'ANTALLAKTIVEBRUKERE', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'REVISJONSBRUKER', 'REVISIONUSER' ),
...
'tog-enotifwiki_usertalkpages' => 'Send meg en e-post når brukerdiskusjonssiden min endres',
...
'youhavenewmessagesfromwiki_users' => 'Du har $1 fra {{PLURAL:$3|en annen bruker| $3 brukere}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Du har $1 fra mange brukere ($2).',
...
Vennligst rapporter dette til en [[Special:Listwiki_users/sysop|administrator]], oppgi da nettadressen.',
...
'titleprotected' => "Denne tittelen har blitt låst for oppretting av [[wiki_user:$1|$1]].
...
Du kan fortsette å bruke {{SITENAME}} anonymt, eller [[Special:wiki_userLogin|logge inn igjen]] som samme eller en annen bruker.
...
'wiki_userlogin' => 'Logg inn eller opprett en konto',
'wiki_userloginnocreate' => 'Logg inn',
'logout' => 'Logg ut',
'wiki_userlogout' => 'Logg ut',
...
'wiki_userlogin-resetlink' => 'Har du glemt påloggingsdetaljene dine?',
'createaccountmail' => 'per e-post',
'createaccountreason' => 'Årsak:',
'badretype' => 'Passordene samsvarte ikke.',
'wiki_userexists' => 'Brukernavnet er allerede i bruk.
...
'nosuchwiki_user' => 'Det eksisterer ingen bruker ved navn «$1».
Merk at det skilles mellom store og små bokstaver.
Sjekk stavemåten eller [[Special:wiki_userLogin/signup|opprett en ny konto]].',
'nosuchwiki_usershort' => 'Det finnes ingen bruker ved navn «$1». Kontroller stavemåten.',
'nowiki_userspecified' => 'Du må oppgi et brukernavn.',
'login-wiki_userblocked' => 'Brukeren er blokkert. Innlogging er ikke tillatt.',
...
'wiki_usernamehasherror' => 'Brukernavn kan ikke inneholde nummertegn.',
...
'suspicious-wiki_userlogout' => 'Din forespørsel om å logge ut ble nektet fordi den så ut til å ha bli sendt av en ødelagt nettleser eller en mellomtjener.',

# E-mail sending
'php-mail-error-unknown' => 'Ukjent feil i PHPs mail()-funksjon',
'wiki_user-mail-no-addy' => 'Forsøkte å sende e-post uten e-postadresse',
...
'passwordreset-wiki_username' => 'Brukernavn:',
...
passord.',
'passwordreset-emailtext-wiki_user' => 'Brukeren $1 på {{SITENAME}} ba om en påminnelse om kontodetaljene dine for {{SITENAME}}
...
'accmailtext' => 'Et tilfeldig passord for [[wiki_user talk:$1|$1]] har blitt sendt til $2.
...
Hvis du er en uregistrert bruker og synes at du har fått irrelevante kommentarer på en slik side, [[Special:wiki_userLogin/signup|opprett en konto]] eller [[Special:wiki_userLogin|logg inn]] så vi unngår fremtidige forvekslinger med andre uregistrerte brukere.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Brukerkontoen «$1» er ikke registrert.
Sjekk om du ønsker å opprette/redigere denne siden.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Kontoen «$1» er ikke registrert.',
...
'wiki_usercssyoucanpreview' => "'''Tips:''' Bruk «{{int:showpreview}}»-knappen for å teste din nye CSS før du lagrer.",
'wiki_userjsyoucanpreview' => "'''Tips:''' Bruk «{{int:showpreview}}»-knappen for å teste ditt nye JS før du lagrer.",
'wiki_usercsspreview' => "'''Husk at dette bare er en forhåndsvisning av din bruker-CSS og at den ikke er lagret!'''",
'wiki_userjspreview' => "'''Husk at dette bare er en test eller forhåndsvisning av ditt bruker-JavaScript, og det ikke er lagret!'''",
...
'''Den har ikke blitt lagret ennå!'''",
'wiki_userinvalidcssjstitle' => "'''Advarsel:''' Det finnes ikke noe utseende ved navn «$1». Husk at .css- og .js-sider bruker titler i små bokstaver, for eksempel {{ns:wiki_user}}:Eksempel/vector.css, ikke {{ns:wiki_user}}:Eksempel/Vector.css",
'updated' => '(Oppdatert)',
'note' => "'''Merk:'''",
...
Prøv igjen.
Om det fortsetter å gå galt, prøv å [[Special:wiki_userLogout|logge ut]] og så inn igjen.'''",
...
'''Om dette er et legitimt redigeringsforsøk, prøv igjen. Om det da ikke fungerer, prøv å [[Special:wiki_userLogout|logge ut]] og logge inn igjen.'''",
...
'nocreatetext' => '{{SITENAME}} har begrensede muligheter for oppretting av nye sider. Du kan gå tilbake og redigere en eksisterende side, eller [[Special:wiki_userLogin|logge inn eller opprette en ny konto]].',
...
'undo-summary' => 'Fjerner revisjon $1 av [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|diskusjon]])',

# Account creation failure
'cantcreateaccounttitle' => 'Kan ikke opprette konto',
'cantcreateaccount-text' => "Kontooppretting fra denne IP-adressen ('''$1''') har blitt blokkert av [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(brukernavn fjernet)',
'rev-deleted-event' => '(fjernet loggoppføring)',
'rev-deleted-wiki_user-contribs' => '[brukernavn eller IP-adresse fjernet – redigeringen vises ikke blant bidragene]',
...
'revdelete-hide-wiki_user' => 'Skjul bidragsyters brukernavn eller IP',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Én mellomrevisjon|$1 mellomrevisjoner}} av mer enn $2 {{PLURAL:$2|bruker|brukere}} vises ikke)',
...
'prefsnologintext' => 'Du må være <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} logget inn]</span> for å endre brukerinnstillingene.',
...
'prefs-wiki_user-pages' => 'Brukersider',
...
# wiki_user rights
'wiki_userrights' => 'Brukerrettighetskontroll',
'wiki_userrights-lookup-wiki_user' => 'Ordne brukergrupper',
'wiki_userrights-wiki_user-editname' => 'Skriv inn et brukernavn:',
'editwiki_usergroup' => 'Endre brukergrupper',
'editingwiki_user' => "Endrer brukerrettighetene til '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Rediger brukergrupper',
'savewiki_usergroups' => 'Lagre brukergrupper',
'wiki_userrights-groupsmember' => 'Medlem av:',
'wiki_userrights-groupsmember-auto' => 'Implisitt medlem av:',
'wiki_userrights-groups-help' => 'Du kan endre hvilke grupper denne brukeren er medlem av.
...
'wiki_userrights-reason' => 'Årsak:',
'wiki_userrights-no-interwiki' => 'Du har ikke tillatelse til å endre brukerrettigheter på andre wikier.',
'wiki_userrights-nodatabase' => 'Databasen $1 finnes ikke, eller er ikke lokal.',
'wiki_userrights-nologin' => 'Du må [[Special:wiki_userLogin|logge inn]] med en administratorkonto for å endre brukerrettigheter.',
'wiki_userrights-notallowed' => 'Kontoen din har ikke tillatelse til å legge til eller fjerne brukerrettigheter.',
'wiki_userrights-changeable-col' => 'Grupper du kan endre',
'wiki_userrights-unchangeable-col' => 'Grupper du ikke kan endre',
'wiki_userrights-irreversible-marker' => '$1 *',

# Groups
'group' => 'Gruppe:',
'group-wiki_user' => 'Brukere',
...
'group-wiki_user-member' => '!{{GENDER:$1|bruker}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Brukere',
...
'right-move-rootwiki_userpages' => 'Flytte hovedbrukersider',
...
'right-hidewiki_user' => 'Blokkere et brukernavn og skjule det fra det offentlige',
...
'right-editwiki_usercssjs' => 'Redigere andre brukeres CSS- og JS-filer',
'right-editwiki_usercss' => 'Redigere andre brukeres CSS-filer',
'right-editwiki_userjs' => 'Redigere andre brukeres JS-filer',
...
'right-wiki_userrights' => 'Redigere alle brukerrettigheter',
'right-wiki_userrights-interwiki' => 'Redigere rettigheter for brukere på andre wikier',
...
'action-move-rootwiki_userpages' => 'flytte hovedbrukersider',
...
'action-wiki_userrights' => 'redigere alle brukerrettigheter',
'action-wiki_userrights-interwiki' => 'endre brukerrettigheter for brukere på andre wikier',
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 overvåkende {{PLURAL:$1|bruker|brukere}}]',
...
'uploadnologintext' => 'Du må være [[Special:wiki_userLogin|logget inn]] for å kunne laste opp filer.',
...
'fileexists-thumbnail-yes' => 'Filen ser ut til å være et bilde av redwiki_usert størrelse. [[$1|thumb]]
...
Det virker som om det er et bilde av redwiki_usert størrelse ''(miniatyrbilde)''.
...
'upload-file-error-text' => 'En intern feil oppsto under forsøk på å lage en midlertidig fil på tjeneren. Vennligst kontakt en [[Special:Listwiki_users/sysop|administrator]].',
...
Om problemet fortsetter, kontakt en [[Special:Listwiki_users/sysop|administrator]].',
...
'statistics-header-wiki_users' => 'Brukerstatistikk',
...
'statistics-wiki_users' => 'Registrerte [[Special:Listwiki_users|brukere]]',
'statistics-wiki_users-active' => 'Aktive brukere',
'statistics-wiki_users-active-desc' => 'Brukere som har utført handlinger {{PLURAL:$1|det siste døgnet|de siste $1 dagene}}',
...
'listwiki_users' => 'Brukerliste',
'listwiki_users-editsonly' => 'Vis bare brukere med redigeringer',
'listwiki_users-creationsort' => 'Sorter etter opprettelsesdato',
'wiki_usereditcount' => '{{PLURAL:$1|én redigering|$1 redigeringer}}',
'wiki_usercreated' => '{{GENDER:$3|Opprettet}} $2 $1',
'newpages' => 'Nye sider',
'newpages-wiki_username' => 'Brukernavn:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Utøver:',
...
'listwiki_usersfrom' => 'Vis brukere fra og med:',
'listwiki_users-submit' => 'Vis',
'listwiki_users-noresult' => 'Ingen brukere funnet.',
'listwiki_users-blocked' => '(konto blokkert)',

# Special:Activewiki_users
'activewiki_users' => 'Liste over aktive brukere',
'activewiki_users-intro' => 'Dette er en liste over brukere som har hatt en eller annen form for aktivitet innenfor {{PLURAL:$1|den siste dagen|de siste dagene}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|endring|endringer}} {{PLURAL:$3|det siste døgnet|de siste $3 dagene}}',
'activewiki_users-from' => 'Vis brukere fra og med:',
'activewiki_users-hidebots' => 'Skjul roboter',
'activewiki_users-hidesysops' => 'Skjul administratorer',
'activewiki_users-noresult' => 'Ingen brukere funnet.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Brukeropprettelseslogg',
'newwiki_userlogpagetext' => 'Dette er en logg over brukeropprettelser.',
...
'mailnologintext' => 'Du må være [[Special:wiki_userLogin|logget inn]] og ha en gyldig e-postadresse satt i [[Special:Preferences|brukerinnstillingene]] for å sende e-post til andre brukere.',
'emailwiki_user' => 'E-post til denne brukeren',
'emailwiki_user-title-target' => 'Send epost til denne {{GENDER:$1|brukeren}}',
'emailwiki_user-title-notarget' => 'E-post til bruker',
...
'wiki_usermailererror' => 'E-postobjekt returnerte feilen:',
'defemailsubject' => 'E-post fra {{SITENAME}}-brukeren «$1»',
'wiki_usermaildisabled' => 'Brukerepost deaktivert',
'wiki_usermaildisabledtext' => 'Du kan ikke sende epost til andre brukere på denne wikien',
...
'emailwiki_userfooter' => 'E-posten ble sendt av $1 til $2 via «Send e-post»-funksjonen på {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Etterlater en systembeskjed.',
'wiki_usermessage-editor' => 'Systembudbringer',
...
'watchnologintext' => 'Du må være [[Special:wiki_userLogin|logget inn]] for å kunne endre overvåkningslisten.',
...
'alreadyrolled' => 'Kan ikke fjerne den siste redigeringen på [[$1]] av [[wiki_user:$2|$2]] ([[wiki_user talk:$2|diskusjon]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]); en annen har allerede redigert siden eller fjernet redigeringen.

Den siste redigeringen ble foretatt av [[wiki_user:$3|$3]] ([[wiki_user talk:$3|diskusjon]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Redigeringskommentaren var: «''$1''»",
'revertpage' => 'Tilbakestilte endring av [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|diskusjon]]) til siste versjon av [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Tilbakestilte endringer av (fjernet brukernavn) til siste versjon av [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'brukerrettighetskontroll',
...
'sp-contributions-wiki_username' => 'IP-adresse eller brukernavn:',
...
'ipadressorwiki_username' => 'IP-adresse eller brukernavn',
'ipbexpiry' => 'Varighet:',
'ipbreason' => 'Årsak:',
...
'ipbwatchwiki_user' => 'Overvåk brukerens brukerside og diskusjonsside',
'ipb-disablewiki_usertalk' => 'Hindre denne brukeren i å redigere sin egen diskusjonsside mens han/hun er blokkert',
...
'ipb-confirmhidewiki_user' => 'Du er i ferd med å blokkere en bruker med «skjul bruker» aktivert. Dette vil skjule brukerens navn i alle lister og loggoppføringer. Er du sikker på at du vil gjøre dette?',
...
'unblocked' => '[[wiki_user:$1|$1]] ble avblokkert',
...
'blocklist-wiki_userblocks' => 'Skjul kontoblokkeringer',
...
'blocklist-nowiki_usertalk' => 'kan ikke redigere sin egen diskusjonsside',
...
'autoblocker' => 'Du ble automatisk blokkert fordi du deler IP-adresse med «[[wiki_user:$1|$1]]». Grunnen som ble gitt til at «$1» ble blokkert var: «$2».',
...
'block-log-flags-nowiki_usertalk' => 'kan ikke redigere egen diskusjonsside',
...
'unblock-hidewiki_user' => 'Du kan ikke løfte blokkeringen av denne brukeren siden dens brukernavn har blitt skjult.',
...
'cant-see-hidden-wiki_user' => 'Brukeren du prøver å blokkere har allerede blitt blokkert og skjult. Ettersom du ikke har rett til å skjule brukere (hidewiki_user), kan du ikke se eller endre brukerens blokkering.',
...
'movewiki_userpage-warning' => "'''Advarsel:''' Du er i ferd med å flytte en brukerside. Merk at kun siden vil bli flyttet; brukernavnet vil ''ikke'' bli endret.",
'movenologin' => 'Ikke logget inn',
'movenologintext' => 'Du må være registrert bruker og være [[Special:wiki_userLogin|logget på]] for å flytte en side.',
'movenotallowed' => 'Du har ikke tillatelse til å flytte sider.',
'movenotallowedfile' => 'Du har ikke tillatelse til å flytte filer.',
'cant-move-wiki_user-page' => 'Du har ikke tillatelse til å flytte brukersider (bortsett fra undersider).',
'cant-move-to-wiki_user-page' => 'Du har ikke tillatelse til å flytte brukersider (bortsett fra undersider).',
...
'tooltip-pt-wiki_userpage' => 'Din brukerside',
'tooltip-pt-anonwiki_userpage' => 'Brukersiden for IP-adressen du redigerer fra',
...
'tooltip-t-emailwiki_user' => 'Send en e-post til denne brukeren',
...
'tooltip-ca-nstab-wiki_user' => 'Vis brukersiden',
...
'anonwiki_user' => '{{SITENAME}}s anonyme bruker $1',
'lastmodifiedatby' => 'Denne siden ble sist redigert $1 kl. $2 av $3.',
'othercontribs' => 'Basert på arbeid av $1.',
'others' => 'andre',
'sitewiki_users' => '{{SITENAME}}-{{PLURAL:$2|bruker|brukere}} $1',
'anonwiki_users' => '{{SITENAME}}s {{PLURAL:$2|anonyme bruker|anonyme brukere}} $1',
...
'spambot_wiki_username' => 'MediaWikis spamopprydning',
...
'pageinfo-firstwiki_user' => 'Sideoppretter',
'pageinfo-firsttime' => 'Dato for opprettelse av siden',
'pageinfo-lastwiki_user' => 'Siste forfatter',
...
'exif-wiki_usercomment' => 'Brukerkommentarer',
...
'exif-exposureprogram-7' => 'Portrettmodus (for nærbilder med ufokwiki_usert bakgrunn)',
'exif-exposureprogram-8' => 'Landskapsmodus (for landskapsbilder med fokwiki_usert bakgrunn)',
...
'exif-flash-redeye-1' => 'røde-øyne-redwiki_usering',
...
'confirmrecreate' => '«[[wiki_user:$1|$1]]» ([[wiki_user talk:$1|diskusjon]]) slettet siden etter at du begynte å redigere den, med begrunnelsen «$2». Vennligst bekreft at du vil gjenopprette siden.',
'confirmrecreate-noreason' => 'Brukeren [[wiki_user:$1|$1]] ([[wiki_user talk:$1|diskusjon]]) slettet denne siden etter at du begynte å redigere. Bekreft at du virkelig ønsker å gjenopprette denne siden.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|diskusjon]])',
...
'specialpages-group-wiki_users' => 'Brukere og rettigheter',
...
'logentry-newwiki_users-newwiki_users' => 'Kontoen $1 ble opprettet',
'logentry-newwiki_users-create' => 'Kontoen $1 ble opprettet',
'logentry-newwiki_users-create2' => 'Kontoen $3 ble opprettet av $1',
'logentry-newwiki_users-autocreate' => 'Konto $1 ble opprettet automatisk',
'newwiki_userlog-byemail' => 'passord sendt på e-post',
