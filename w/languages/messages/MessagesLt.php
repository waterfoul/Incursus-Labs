...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'Rašyti_laišką' ),
	...
	'Listwiki_users'                 => array( 'Naudotojų_sąrašas' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'NAUDOTOJŲSKAIČIUS', 'NUMBEROFUSERS' ),
...
'tog-enotifwiki_usertalkpages' => 'Siųsti man laišką, kai pakeičiamas mano naudotojo aptarimo puslapis',
...
'views' => 'Žiūrėti',
'toolbox' => 'Įrankiai',
'wiki_userpage' => 'Rodyti naudotojo puslapį',
...
'youhavenewmessagesfromwiki_users' => 'Jūs gavote $1 nuo {{PLURAL:$3|kito vartotojo|$3 vartotojų}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Jūs turite $1 iš daugelio vartotojų ( $2 ) .',
...
'nstab-main' => 'Puslapis',
'nstab-wiki_user' => 'Naudotojo puslapis',
...
'wiki_userlogin' => 'Prisijungti / sukurti paskyrą',
'wiki_userloginnocreate' => 'Prisijungti',
'logout' => 'Atsijungti',
'wiki_userlogout' => 'Atsijungti',
...
'wiki_userlogin-resetlink' => 'Pamiršote savo prisijungimo duomenis?',
'createaccountmail' => 'el. paštu',
'createaccountreason' => 'Priežastis:',
'badretype' => 'Įvesti slaptažodžiai nesutampa.',
'wiki_userexists' => 'Įvestasis naudotojo vardas jau naudojamas.
...
'nosuchwiki_user' => 'Nėra jokio naudotojo, turinčio vardą „$1“.
...
'nosuchwiki_usershort' => 'Nėra jokio naudotojo, pavadinto „$1“. Patikrinkite rašybą.',
'nowiki_userspecified' => 'Jums reikia nurodyti naudotojo vardą.',
'login-wiki_userblocked' => 'Šis naudotojas yra užblokuotas. Prisijungti neleidžiama.',
...
'wiki_usernamehasherror' => 'Naudotojo vardas negali turėti grotelių simbolio',
...
'suspicious-wiki_userlogout' => 'Jūsų prašymas atsijungti buvo atmestas, nes, atrodo, jį klaidingai išsiuntė naršyklė arba spartinantysis tarpinis serveris.',

# E-mail sending
'php-mail-error-unknown' => 'Nežinoma klaida PHP mail() funkcijoje',
'wiki_user-mail-no-addy' => 'Bandyta išsiųsti elektroninį laišką be el. pašto adreso.',
...
'passwordreset-wiki_username' => 'Naudotojo vardas:',
...
'passwordreset-emailtext-wiki_user' => 'Vartotojo $1 d. {{sitename}} prašoma informacija priminimas jūsų sąskaitos {{sitename}}! N! ( $4 ). Šis vartotojas {{PLURAL:$3| sąskaita | sąskaitas}}, susijusių su šiuo e-pašto adresą:! N! N! $2 ! N! N! {{PLURAL:$3| Šis laikinas slaptažodis | Šie laikini slaptažodžiai }} baigsis {{PLURAL:$5| vieną dieną | $5 dienų}} slaptažodis.! N! Jūs turėtumėte prisijungti ir pasirinkti naują. Jei kažkas padarė tai! N! prašymu, arba jūs prisiminėte savo pirminį slaptažodį, ir jums nebereikia! N! nori ją pakeisti, galite ignoruoti šį pranešimą ir toliau naudotis savo senuoju! N! slaptažodį.',
...
'wiki_userpage-wiki_userdoesnotexist' => 'Naudotojo paskyra „<nowiki>$1</nowiki>“ yra neužregistruota. Prašom patikrinti, ar jūs norite kurti/redaguoti šį puslapį.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Naudotojo paskyra „$1“ neužregistruota.',
...
'wiki_usercssyoucanpreview' => "'''Patarimas:''' Naudokite „{{int:showpreview}}“ mygtuką, kad išmėgintumėte savo naująjį CSS prieš išsaugant.",
'wiki_userjsyoucanpreview' => "'''Patarimas:''' Naudokite „{{int:showpreview}}“ mygtuką, kad išmėgintumėte savo naująjį JS prieš išsaugant.",
'wiki_usercsspreview' => "'''Nepamirškite, kad jūs tik peržiūrit savo naudotojo CSS, jis dar nebuvo išsaugotas!'''",
'wiki_userjspreview' => "'''Nepamirškite, kad jūs tik testuojat/peržiūrit savo naudotojo JavaScript, jis dar nebuvo išsaugotas!'''",
...
'wiki_userinvalidcssjstitle' => "'''Dėmesio:''' Nėra jokios išvaizdos „$1“. Nepamirškite, kad savo .css ir .js puslapiai naudoja pavadinimą mažosiomis raidėmis, pvz., {{ns:wiki_user}}:Foo/vector.css, o ne {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(Atnaujinta)',
'note' => "'''Pastaba:'''",
...
'rev-deleted-wiki_user' => '(naudotojo vardas pašalintas)',
'rev-deleted-event' => '(įrašas pašalintas)',
'rev-deleted-wiki_user-contribs' => '[vardas arba IP adresas pašalintas - redagavimas paslėptas nuo prisidėjimų]',
...
'revdelete-hide-wiki_user' => 'Slėpti redagavusiojo naudotojo vardą ar IP adresą',
...
'diff-multi-manywiki_users' => '(daugiau nei $2 {{PLURAL:$2|naudotojo|naudotojų|naudotojų}} $1 {{PLURAL:$1|tarpinis keitimas nėra rodomas|tarpiniai keitimai nėra rodomi|tarpinių keitimų nėra rodoma}})',
...
'prefs-wiki_user-pages' => 'Naudotojo puslapiai',
...
'youremail' => 'El. paštas:',
'wiki_username' => 'Naudotojo vardas:',
'uid' => 'Naudotojo ID:',
...
# wiki_user rights
'wiki_userrights' => 'Naudotojų teisių valdymas',
'wiki_userrights-lookup-wiki_user' => 'Tvarkyti naudotojo grupes',
'wiki_userrights-wiki_user-editname' => 'Įveskite naudotojo vardą:',
'editwiki_usergroup' => 'Redaguoti naudotojo grupes',
'editingwiki_user' => "Taisomos naudotojo '''[[wiki_user:$1|$1]]''' $2
teisės",
'wiki_userrights-editwiki_usergroup' => 'Redaguoti naudotojų grupes',
'savewiki_usergroups' => 'Saugoti naudotojų grupes',
'wiki_userrights-groupsmember' => 'Narys:',
'wiki_userrights-groupsmember-auto' => 'Narys automatiškai:',
'wiki_userrights-groups-help' => 'Jūs galite pakeisti grupes, kuriose yra šis naudotojas:
...
'wiki_userrights-reason' => 'Priežastis:',
'wiki_userrights-no-interwiki' => 'Jūs neturite leidimo keisti naudotojų teises kituose projektuose.',
'wiki_userrights-nodatabase' => 'Duomenų bazė $1 neegzistuoja arba yra ne vietinė.',
'wiki_userrights-nologin' => 'Jūs privalote [[Special:wiki_userLogin|prisijungti]] kaip administratorius, kad galėtumėte priskirti naudotojų teises.',
'wiki_userrights-notallowed' => 'Jūsų paskyra neturi teisių priskirti ar panaikinti naudotojų teises.',
'wiki_userrights-changeable-col' => 'Grupės, kurias galite keisti',
'wiki_userrights-unchangeable-col' => 'Grupės, kurių negalite keisti',

# Groups
'group' => 'Grupė:',
'group-wiki_user' => 'Naudotojai',
...
'group-wiki_user-member' => '{{GENDER:$1|naudotojas|naudotoja}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Naudotojai',
...
'right-move-rootwiki_userpages' => 'Perkelti šakninius naudotojo puslapius',
...
'right-hidewiki_user' => 'Blokuoti naudotojo vardą, paslepiant jį nuo viešinimo',
...
'right-editwiki_usercssjs' => 'Redaguoti kitų naudotojų CSS ir JS failus',
'right-editwiki_usercss' => 'Redaguoti kitų naudotojų CSS failus',
'right-editwiki_userjs' => 'Redaguoti kitų naudotojų JS failus',
...
'right-wiki_userrights' => 'Redaguoti visų naudotojų teises',
'right-wiki_userrights-interwiki' => 'Keisti naudotojų teises kitose wiki svetainėse',
...
'action-move-rootwiki_userpages' => 'perkelti pagrindinius naudotojų puslapius',
...
'action-wiki_userrights' => 'keisti visų naudotojų teises',
'action-wiki_userrights-interwiki' => 'keisti naudotojų teises kitose wiki svetainėse',
...
'newpageletter' => 'N',
'boteditletter' => 'R',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|stebintis naudotojas|stebintys naudotojai|stebinčių naudotojų}}]',
...
'listfiles_wiki_user' => 'Naudotojas',
...
'statistics-header-wiki_users' => 'Naudotojų statistika',
...
'statistics-wiki_users' => 'Registruotų [[Special:Listwiki_users|naudotojų]]',
'statistics-wiki_users-active' => 'Aktyvių naudotojų',
'statistics-wiki_users-active-desc' => 'Naudotojai, kurie per {{PLURAL:$1|paskutinę dieną|paskutines $1 dienų}} padarė keitimų',
...
'listwiki_users' => 'Naudotojų sąrašas',
'listwiki_users-editsonly' => 'Rodyti tik keitimus atlikusius naudotojus',
'listwiki_users-creationsort' => 'Rodyti pagal paskyros sukūrimo datą',
'wiki_usereditcount' => '$1 {{PLURAL:$1|keitimas|keitimai|keitimų}}',
'wiki_usercreated' => '{{GENDER:$3|Naudotojo|Naudotojos|Naudotojo}} $3 paskyra sukurta $1 $2',
'newpages' => 'Naujausi puslapiai',
'newpages-wiki_username' => 'Naudotojo vardas:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Naudotojas:',
...
'listwiki_usersfrom' => 'Rodyti naudotojus pradedant nuo:',
'listwiki_users-submit' => 'Rodyti',
'listwiki_users-noresult' => 'Nerasta jokių naudotojų.',
'listwiki_users-blocked' => '(užblokuotas)',

# Special:Activewiki_users
'activewiki_users' => 'Aktyvių naudotojų sąrašas',
'activewiki_users-intro' => 'Tai naudotojų sąrašas, kurie ką nors padarė per $1 {{PLURAL:$1|paskutinę dieną|paskutines dienas|paskutinių dienų}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|keitimas|keitimai|keitimų}} per $3 {{PLURAL:$3|paskutinę dieną|paskutines dienas|paskutinių dienų}}',
'activewiki_users-from' => 'Rodyti naudotojus, pradedant:',
'activewiki_users-hidebots' => 'Slėpti robotus',
'activewiki_users-hidesysops' => 'Slėpti administratorius',
'activewiki_users-noresult' => 'Nerasta jokių naudotojų.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Prisiregistravę naudotojai',
'newwiki_userlogpagetext' => 'Tai naudotojų kūrimo sąrašas.',
...
'emailwiki_user' => 'Rašyti laišką šiam naudotojui',
'emailwiki_user-title-notarget' => 'El. pašto vartotojas',
...
'wiki_usermailererror' => 'Pašto objektas grąžino klaidą:',
'defemailsubject' => '{{SITENAME}} el. pašto iš vartotojo " $1 "',
'wiki_usermaildisabled' => 'Naudotojo elektroninis paštas išjungtas',
'wiki_usermaildisabledtext' => 'Jūs negalite siūlsti el. laiško kitiems šio wiki projekto naudotojams.',
...
'emailwiki_username' => 'Naudotojo vardas:',
'emailwiki_usernamesubmit' => 'Pateikti',
...
'emailwiki_userfooter' => 'Šis elektroninis laiškas buvo išsiųstas naudotojo $1 naudotojui $2 naudojant „Rašyti elektroninį laišką“ funkciją projekte {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Paliekamas sistemos pranešimas.',
'wiki_usermessage-editor' => 'Sistemos pranešėjas',
...
'revertpage-nowiki_user' => 'Atmesti (naudotojo vardas pašalintas) pakeitimai, grąžinta prieš tai buvusi [[wiki_user:$1|$1]] versija',
...
'sp-contributions-wiki_userrights' => 'naudotojų teisių valdymas',
...
'sp-contributions-wiki_username' => 'IP adresas arba naudotojo vardas:',
...
'ipadressorwiki_username' => 'IP adresas arba naudotojo vardas',
...
'ipbwatchwiki_user' => 'Stebėti šio naudotojo puslapį ir jo aptarimų puslapį',
'ipb-disablewiki_usertalk' => 'Neleisti redaguoti savo naudotojo aptarimo puslapio',
...
'ipb-confirmhidewiki_user' => 'Jūs ruošiatės užblokuoti naudotoją, pasirinkę „slėpti naudotoją“ nustatymą. Tai paslėps naudotojo vardą visuose sąrašuose ir žurnalo įrašuose. Ar tikrai norite tai padaryti?',
...
'blocklist-wiki_userblocks' => 'Slėpti paskyrų blokavimus',
...
'blocklist-nowiki_usertalk' => 'negali redaguoti savo aptarimų puslapio',
...
'block-log-flags-nowiki_usertalk' => 'negali redaguoti savo naudotojo aptarimo puslapio',
...
'unblock-hidewiki_user' => 'Jūs negalite atblokuoti šio naudotojo, nes jo vardas buvo paslėptas.',
...
'cant-see-hidden-wiki_user' => 'Naudotojas, kurį bandote užblokuoti, jau yra užblokuotas arba paslėptas.
Kadangi jūs neturi hidewiki_user teisės, jūs negalite pamatyti arba pakeisti naudotojo blokavimo.',
...
'movewiki_userpage-warning' => "'''Dėmesio:''' Jūs ruošiatės perkelti naudotojo puslapį. Atkreipkite dėmesį, kad bus perkeltas tik puslapis, naudotojas ''nebus'' pervadintas.",
...
'cant-move-wiki_user-page' => 'Jūs neturite teisės perkelti naudotojų puslapių (išskyrus popuslapius).',
'cant-move-to-wiki_user-page' => 'Jūs neturite teisių perkelti puslapį į naudotojo puslapį (išskyrus į naudotojo popuslapį).',
...
'tooltip-pt-wiki_userpage' => 'Jūsų naudotojo puslapis',
'tooltip-pt-anonwiki_userpage' => 'Naudotojo puslapis jūsų IP adresui',
...
'tooltip-t-emailwiki_user' => 'Siųsti laišką šiam naudotojui',
...
'tooltip-ca-nstab-wiki_user' => 'Rodyti naudotojo puslapį',
...
'sitewiki_user' => '{{SITENAME}} {{GENDER:$2|naudotojas|naudotoja}} $1',
'anonwiki_user' => '{{SITENAME}} anoniminis naudotojas $1',
'lastmodifiedatby' => 'Šį puslapį paskutinį kartą redagavo $3 $2, $1.',
'othercontribs' => 'Paremta $1 darbu.',
'others' => 'kiti',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|naudotojas|naudotojai}} $1',
'anonwiki_users' => '{{SITENAME}} {{PLURAL:$2|anoniminis naudotojas|anoniminiai naudotojai}} $1',
...
'spambot_wiki_username' => 'MediaWiki reklamų šalinimas',
...
'pageinfo-firstwiki_user' => 'Puslapio kūrėjas',
'pageinfo-firsttime' => 'Puslapio sukūrimo data',
'pageinfo-lastwiki_user' => 'Paskutinis redaktorius',
...
'exif-wiki_usercomment' => 'Naudotojo komentarai',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|aptarimas]])',
...
'specialpages-group-wiki_users' => 'Naudotojai ir teisės',
...
'logentry-newwiki_users-newwiki_users' => '$1 sukūrė naudotojo paskyrą',
'logentry-newwiki_users-create' => '$1 sukūrė naudotojo paskyrą',
'logentry-newwiki_users-create2' => '$1 sukūrė naudotojo paskyrą $3',
'logentry-newwiki_users-autocreate' => 'Paskyra $1 buvo sukurta automatiškai',
'newwiki_userlog-byemail' => 'slaptažodis nusiųstas elektroniniu paštu',
