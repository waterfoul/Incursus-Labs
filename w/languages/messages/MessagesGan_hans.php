...
'tog-enotifwiki_usertalkpages' => '偶对话框𠮶页面一有改动发email到偶',
...
'gotaccount' => "有喽帐户？ '''$1'''.",
'gotaccountlink' => '登入',
'wiki_userlogin-resetlink' => '𫍧记汝𠮶登录信息？',
'createaccountmail' => '通过email',
'createaccountreason' => '原因:',
'badretype' => '倷输𠮶密码伓合。',
'wiki_userexists' => '汝输𠮶用户名系人家𠮶，拣过只啰！',
'loginerror' => '登入错误',
...
'nosuchwiki_user' => '个首冇叫"$1"𠮶用户。望吖倷𠮶拼写，要伓建过只新帐户。',
'nosuchwiki_usershort' => '个首冇叫"$1"𠮶用户。请望吖倷𠮶拼写。',
'nowiki_userspecified' => '倷要指正一只用户名。',
...
'wiki_usercssyoucanpreview' => "'''提示:''' 存到前请用'望吖起'来测吖倷𠮶新CSS 。",
'wiki_userjsyoucanpreview' => "'''提示:''' 存到前请用'望吖起'来测吖倷𠮶新JS 。",
'wiki_usercsspreview' => "'''注意倷单系到预览倷个人𠮶 CSS，内容哈冇保存！'''",
'wiki_userjspreview' => "'''注意倷单系到测试／预览倷个人𠮶 JavaScript，内容哈冇保存！'''",
'wiki_userinvalidcssjstitle' => "'''警告:''' 冇\"\$1\"𠮶皮肤。请记到自定义𠮶 .css 同 .js 页要用小写。就话，{{ns:wiki_user}}:Foo/vector.css 伓等同 {{ns:wiki_user}}:Foo/Vector.css。",
'updated' => '（更新正喽）',
'note' => "'''注意:'''",
...
'revdelete-hide-wiki_user' => '弆到编者𠮶用户名/IP',
...
'wiki_userrights-lookup-wiki_user' => '管理用户群',
'wiki_userrights-wiki_user-editname' => '输入用户名:',
'editwiki_usergroup' => '编辑用户群',
'editingwiki_user' => "眼下编辑嘚用户𠮶权限 '''[[wiki_user:$1|$1]]''' （[[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]]）",
'wiki_userrights-editwiki_usergroup' => '编辑用户群',
'savewiki_usergroups' => '存储用户群',
'wiki_userrights-groupsmember' => '归到:',
'wiki_userrights-reason' => '原因:',
'wiki_userrights-no-interwiki' => '倷冇得权改吥别𠮶wiki网站上个只用户𠮶权利。',
'wiki_userrights-nodatabase' => '冇得个只数据库 $1 或系冇在本地。',
...
'newpageletter' => '新',
'boteditletter' => '机',
'number_of_watching_wiki_users_pageview' => '[$1只监视用户]',
...
'statistics-header-wiki_users' => '用户数据',
...
'statistics-wiki_users' => '注册过𠮶[[Special:Listwiki_users|用户]]',
'statistics-wiki_users-active' => '活跃用户',
'statistics-wiki_users-active-desc' => '头$1日操作过𠮶用户',
...
'listwiki_users' => '用户列表',
'wiki_usercreated' => '到$1𠮶$2{{GENDER:$3|建立}}',
'newpages' => '新页面',
...
'listwiki_usersfrom' => '显示啖样用户条件:',
'listwiki_users-submit' => '显示',
'listwiki_users-noresult' => '寻伓到用户。',

# Special:Log/newwiki_users
'newwiki_userlogpage' => '新开户𠮶人名单',
...
'tooltip-pt-wiki_userpage' => '偶𠮶用户页',
'tooltip-pt-anonwiki_userpage' => '倷编辑本站用𠮶IP对应𠮶用户页',
...
'tooltip-t-emailwiki_user' => '发封邮件到个只用户',
...
'tooltip-ca-nstab-wiki_user' => '望吖用户页',
...
'others' => '别𠮶',
'sitewiki_users' => '{{SITENAME}}用户$1',
'anonwiki_users' => '{{SITENAME}}匿名{{PLURAL:$2|用户|用户}}$1',
'creditspage' => '页面感谢',
'nocredits' => '个页冇致谢名单。',
...
'spambot_wiki_username' => 'MediaWiki 广告清除',
