...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'MannaEmail' ),
	...
	'Listwiki_users'                 => array( 'Utilizzatura', 'ListaUtilizzatura' ),
...
'tog-enotifwiki_usertalkpages' => 'Mànnimi nu missaggiu email quannu la mè pàggina di discussioni è canciata',
...
'views' => 'Vìsiti',
'toolbox' => 'Strummenta',
'wiki_userpage' => 'Visualizza la pàggina utenti',
...
'nstab-main' => 'artìculu',
'nstab-wiki_user' => "Pàggina d'utenti",
...
'yourname' => "Lu tò nomu d'utenti (''wiki_user name'')",
...
'wiki_userlogin' => 'Riggìstrati o trasi',
'wiki_userloginnocreate' => 'Trasi',
'logout' => 'Nesci',
'wiki_userlogout' => 'Nesci',
...
'wiki_userlogin-resetlink' => "T'ascurdasti li dittagli pâ trasuta?",
'createaccountmail' => 'via e-mail',
'createaccountreason' => 'Mutivu:',
'badretype' => "La ''password'' chi mittisti nun è bona.",
'wiki_userexists' => 'Lu nomu utenti nzeritu è già usatu. Ti prijamu pirciò di vuliri scègghiri nu nomu utenti diversu.',
'loginerror' => "Erruri nta l'accessu",
'createaccounterror' => "Mpussibbili di criari l'account $1",
'nocookiesnew' => 'Lu nomu utenti pi tràsiri fu criatu, ma nun hai effittuatu lu log in. {{SITENAME}} usa li cookies pi gistiri li log in. Lu tò browser havi li cookies disabbilitati. Abbìlita li cookies, appoi effèttua lu login cu li tò wiki_username e password novi.',
'nocookieslogin' => '{{SITENAME}} usa li cookies pi gistiri lu log in. Lu tò browser havi li cookies disabbilitati. Abbìlita li cookies, appoi effèttua lu login cu li tò wiki_username e password.',
...
'nosuchwiki_user' => 'Nun è riggistratu nuddu utenti di nomu "$1".
...
'nosuchwiki_usershort' => 'Nun c\'è nuddu utenti di nomu "$1". Cuntrolla l\'ortugrafìa.',
'nowiki_userspecified' => 'È nicissariu spicificari un nomu utenti.',
'login-wiki_userblocked' => "St'utilizzaturi è bluccatu. Nun è pussibbili di tràsiri",
...
'wiki_usernamehasherror' => "Lu nomu di l'utenti nun pò cuntèniri caràttiri hash",
...
'suspicious-wiki_userlogout' => 'La tò dumanna di discunnissioni fu niàta prichì pari ca veni di nu browser nun funziunanti o nu proxy di caching.',
...
'wiki_userpage-wiki_userdoesnotexist' => 'L\'account "<nowiki>$1</nowiki>" nun currispunni a n\'utenti riggistratu. Virificari si si voli criari o canciari sta pàggina.',
...
'wiki_usercssyoucanpreview' => "'''Suggirimentu:''' Usa lu tastu 'Visualizza antiprima' pi pruvari li novi css/js prima di sarvàrili.",
'wiki_userjsyoucanpreview' => "'''Suggirimentu:''' Usa lu tastu 'Visualizza antiprima' pi pruvari li novi css/js prima di sarvàrili.",
'wiki_usercsspreview' => "'''Arricorda ca stai sulu visualizzannu n'antiprima dû tò CSS pirsunali.'''
'''Nun hà ancora statu sarvatu!'''",
'wiki_userjspreview' => "'''Arricorda ca stai sulu tistanno/vidennu 'n antiprima lu tò javascript pirsunali, nun hà statu ancora sarvatu!'''",
'wiki_userinvalidcssjstitle' => "'''Accura:''' Nun esisti arcuna skin cu nomu \"\$1\". S'arricorda ca li pàggini pi li .css e .js pirsunalizzati hannu la nizziali dû tìtulu minùscula, p'asempiu {{ns:wiki_user}}:Asempiu/vector.js e nun {{ns:wiki_user}}:Asempiu/Vector.css.",
'updated' => '(Aggiurnatu)',
'note' => "'''Accura:'''",
...
'rev-deleted-wiki_user' => '(nomu utenti rimussu)',
...
'revdelete-hide-wiki_user' => "Ammuccia lu nomu o lu ndirizzu IP di l'auturi",
...
# wiki_user rights
'wiki_userrights' => 'Gistioni dî dritti utenti',
'wiki_userrights-lookup-wiki_user' => "Gistisci li gruppi di l'utenti",
'wiki_userrights-wiki_user-editname' => "Trasi nu nomu d'utenti:",
'editwiki_usergroup' => 'Cancia gruppi utenti',
'editingwiki_user' => "Canciamentu dî dritti di l'utenti '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => "Cancia li gruppi di l'utenti",
'savewiki_usergroups' => 'Sarva gruppi utenti',
'wiki_userrights-groupsmember' => 'Membru di:',
'wiki_userrights-groups-help' => "È pussibili canciari li gruppi cui è assegnatu l'utenti.
...
'wiki_userrights-no-interwiki' => "Nun si disponi di li pirmessi nicissari pi canciari li diritti di l'utenti ni autri siti.",
'wiki_userrights-nodatabase' => 'Lu database $1 nu esisti o nun è lu database locali.',
'wiki_userrights-nologin' => "Pi assignari li diritti di l'utenti è nicissariu [[Special:wiki_userLogin|trasiri]] comu amministraturi.",
'wiki_userrights-notallowed' => "L'utenti nun disponi dê pirmessi nicissari pi assignari diritti all'utenti.",
'wiki_userrights-changeable-col' => 'Gruppi canciabili',
'wiki_userrights-unchangeable-col' => 'Gruppi nun canciabili',
...
'right-move-rootwiki_userpages' => "Canciari li pàggini di l'utilizzaturi dâ ràdica",
...
'right-hidewiki_user' => "Blocca nu nomu d'utilizzaturi, ammucciannulu ô pùbblicu",
...
'right-editwiki_usercssjs' => 'Cancia li file CSS e JS di àutri utilizzatura',
'right-editwiki_usercss' => 'Cancia li file CSS di àutri utilizzatura',
'right-editwiki_userjs' => 'Cancia li file JS di àutri utilizzatura',
...
'right-wiki_userrights' => "Cancia tutti li diritta di l'utilizzaturi",
'right-wiki_userrights-interwiki' => "Cancia li diritti di l'utilizzatura di àutri wiki",
...
'action-move-rootwiki_userpages' => 'spustari li pàggini di utilizzaturi dâ ràdica',
...
'action-wiki_userrights' => "canciari tutti li diritti di l'utilizzaturi",
'action-wiki_userrights-interwiki' => "cancia li diritti di l'utenti supra a àutri wiki",
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[ossirvata di {{PLURAL:$1|nu utenti|$1 utenti}}]',
...
'statistics-header-wiki_users' => "Li statìstichi di l'utilizzatura",
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Utilizzatura]] riggistrati',
'statistics-wiki_users-active' => 'Utilizzatura attivi',
'statistics-wiki_users-active-desc' => "Utilizzatura chi fìciru n'azzioni {{PLURAL:$1|ni l'ultimu ionnu|nî l'ultimi $1 ionna}}",
...
'listwiki_users' => 'Lista di utilizzatura',
'listwiki_users-editsonly' => 'Ammustra sulu utenti cu cuntribbuti',
'listwiki_users-creationsort' => 'Ordina pi data di criazioni',
'wiki_usereditcount' => '$1 {{PLURAL:$1|cuntribbutu|cuntribbuti}}',
'wiki_usercreated' => '{{GENDER:$3|Criatu/a}} lu $1 ê $2',
'newpages' => 'pàggini cchiù ricenti',
'newpages-wiki_username' => 'Utenti:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Utenti:',
...
'listwiki_usersfrom' => "Ammustra l'utenti a pàrtiri di:",
'listwiki_users-submit' => 'Ammustra',
'listwiki_users-noresult' => "Nuddu utenti attruvatu. Virificari l'usu di caràttiri maiùsculi/minùsculi.",
'listwiki_users-blocked' => '(bloccatu)',

# Special:Activewiki_users
'activewiki_users' => 'Lista dî utenti attivi',
'activewiki_users-count' => "$1 {{PLURAL:$1|canciamentu|canciamenti}} nti {{PLURAL:$3|l'ùrtimu jornu| nti l'ùrtimi $3 jorna}}",
'activewiki_users-from' => 'Ammustra li utenti a pàrtiri da:',
'activewiki_users-hidebots' => 'Bot ammucciati',
'activewiki_users-hidesysops' => 'Amministratura ammucciati',
'activewiki_users-noresult' => 'Nussun utenti truvatu.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Novi utenti',
'newwiki_userlogpagetext' => 'Di sècutu vènunu elincati li criazzioni di cunti novi (account).',
...
'emailwiki_user' => "Manna n'imail a stu utenti",
...
'wiki_usermailererror' => "L'uggettu mail hà ristituitu l'erruri:",
...
'emailwiki_userfooter' => 'Sta e-mail fu mannata di $1 a $2 attraversu la funzionu "Manna nu missàggiu e-mail a l\'utenti" supra {{SITENAME}}.',
...
'sp-contributions-wiki_userrights' => 'gistioni dî dritti utenti',
'sp-contributions-search' => 'Ricerca cuntribbuti',
'sp-contributions-wiki_username' => 'Nnirizzu IP o nomu utenti:',
...
'ipadressorwiki_username' => 'Ndirizzu IP o nomu utenti:',
...
'ipbwatchwiki_user' => "Talìa li pàggini e li discussioni utenti di st'utenti",
'ipb-disablewiki_usertalk' => 'Nun pirmettiri a stu utilizzaturi di canciari la sò pàggina di discussioni na mentri ca è bluccatu',
...
'blocklist-nowiki_usertalk' => 'nun pò mudificari la sò pròpia pàggina di discussioni',
...
'block-log-flags-nowiki_usertalk' => 'nun pò mudificari la sò pròpia pàggina di discussioni',
...
'cant-move-wiki_user-page' => 'Nun aviti lu pirmissu nicissàriu pi spustari li pàggini utenti.',
'cant-move-to-wiki_user-page' => 'Nun aviti li pirmessi nicessàrii pô spustamentu dâ pàggina supra na pàggina utenti (cu eccizzioni di na suttapàggina utenti).',
...
'tooltip-pt-wiki_userpage' => 'La tò pàggina utenti',
'tooltip-pt-anonwiki_userpage' => 'La pàggina utenti di stu ndirizzu IP',
...
'tooltip-t-emailwiki_user' => 'Manna un missaggiu e-mail a stu utenti',
...
'tooltip-ca-nstab-wiki_user' => 'Vidi la pàggina utenti',
...
'spambot_wiki_username' => 'MediaWiki - sistema di rimuzzioni spam',
...
'exif-wiki_usercomment' => "Noti di l'utenti",
...
'exif-xyresolution-i' => '$1 punti pi pwiki_useri (dpi)',
...
'exif-focalplaneresolutionunit-2' => 'pwiki_useri',
...
'logentry-newwiki_users-create' => '$1 criau na utenza',
'newwiki_userlog-byemail' => 'password mannata via mail',
