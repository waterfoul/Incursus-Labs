...
$specialPageAliases = array(
	...
	'wiki_userlogin'                 => array( '用戶登錄' ),
	'wiki_userlogout'                => array( '用戶登出' ),
...
'tog-enotifwiki_usertalkpages' => '當我的對話頁更改時發電子郵件給我',
...
'youhavenewmessagesfromwiki_users' => '你有來自{{PLURAL:$3| 另一位用戶| $3位用戶}}的$1 ( $2 )。',
'youhavenewmessagesmanywiki_users' => '你有來自多位用戶的$1（ $2 ）。',
...
請記錄下URL地址，並向[[Special:Listwiki_users/sysop|管理員]]報告',
...
'titleprotected' => "這個標題已經被[[wiki_user:$1|$1]]保護以防止建立。理由是''$2''。",
...
您可以以匿名方式繼續使用{{SITENAME}}，或以相同或不同用戶身份[[Special:wiki_userLogin|登入]]。
...
'gotaccount' => '已經擁有帳號？$1。',
'gotaccountlink' => '登入',
'wiki_userlogin-resetlink' => '忘記了你的登錄信息？',
'createaccountmail' => '通過電郵',
'createaccountreason' => '理由：',
'badretype' => '您所輸入的密碼並不相同。',
'wiki_userexists' => '!您所輸入的用戶名稱已經存在，請另選一個名稱。',
'loginerror' => '登入錯誤',
...
'nosuchwiki_user' => '找不到用戶 "$1"。
用戶名稱是有大小寫區分的。
檢查您的拼寫，或者用下面的表格[[Special:wiki_userLogin/signup|建立一個新賬號]]。',
'nosuchwiki_usershort' => '沒有一個名為「$1」的用戶。請檢查您輸入的文字是否有錯誤。',
'nowiki_userspecified' => '{{GENDER:|你|妳|你}}需要指定一個用戶名。',
'login-wiki_userblocked' => '這位用戶已被封鎖。不容許登入。',
...
'wiki_usernamehasherror' => '用戶名稱不可以包含切細字元',
'login-throttled' => '您已經嘗試多次的登入動作。
請稍等多一會再試。',
'login-abort-generic' => '登入錯誤 - 中止',
'loginlanguagelabel' => '語言：$1',
'suspicious-wiki_userlogout' => '您登出的要求已經被拒絕，因為它可能是由已損壞的瀏覽器或者快取代理傳送。',

# E-mail sending
'php-mail-error-unknown' => '在 PHP 的 mail() 參數中的未知錯誤',
'wiki_user-mail-no-addy' => '嘗試不帶電郵地址發送電郵。',
...
'passwordreset-wiki_username' => '用戶名：',
...
'passwordreset-emailtext-wiki_user' => '用戶$1要求發出一個在{{SITENAME}}（$4）的帳戶信息提示。該用戶{{PLURAL:$3|是|是}}與以下
電郵地址有關：
...
'accmailtitle' => '密碼已寄出',
'accmailtext' => "'[[wiki_user talk:$1|$1]]'的隨機產生密碼已經寄到 $2。
...
'anontalkpagetext' => "---- ''這是一個還未建立賬號的匿名用戶的對話頁。我們因此只能用IP地址來與他／她聯絡。該IP地址可能由幾名用戶共享。如果您是一名匿名用戶並認為本頁上的評語與您無關，請[[Special:wiki_userLogin/signup|創建新賬號]]或[[Special:wiki_userLogin|登入]]以避免在未來於其他匿名用戶混淆。''",
...
'wiki_userpage-wiki_userdoesnotexist' => '用戶「$1」尚未註冊。
請在建立／編輯這個頁面前先檢查一下。',
'wiki_userpage-wiki_userdoesnotexist-view' => '未曾建立用戶名「$1」。',
...
'wiki_usercssyoucanpreview' => "'''提示:''' 在保存前請用「{{int:showpreview}}」按鈕來測試您新的 CSS 。",
'wiki_userjsyoucanpreview' => "'''提示:''' 在保存前請用「{{int:showpreview}}」按鈕來測試您新的 JavaScript 。",
'wiki_usercsspreview' => "'''記住您只是在預覽您的個人 CSS。'''
'''還沒有儲存﹗'''",
'wiki_userjspreview' => "'''記住您只是在測試／預覽您的個人 JavaScript。'''
'''還沒有儲存﹗'''",
'sitecsspreview' => "'''記住你現在只是預覽此 CSS。'''
'''還沒有儲存！'''",
'sitejspreview' => "'''記住你現在只是預覽此 JavaScript 代碼。'''
'''還沒有儲存！'''",
'wiki_userinvalidcssjstitle' => "'''警告:''' 不存在面板「$1」。
注意自訂的 .css 和 .js 頁要使用小寫標題，例如，{{ns:wiki_user}}:Foo/vector.css 不同於 {{ns:wiki_user}}:Foo/Vector.css。",
'updated' => '（已更新）',
'note' => "'''注意:'''",
...
請再試一次。
如果仍然失敗，請[[Special:wiki_userLogout|登出]]後重新登入。",
'session_fail_preview_html' => "'''抱歉！部份資料已遺失，我們無法處理您的編輯。'''

''由於{{SITENAME}}已經開放原始 HTML 碼，預覽已經隱藏以預防 JavaScript 的攻擊。''

'''如果這個編輯過程沒有問題，請再試一次。如果仍然有問題，請[[Special:wiki_userLogout|登出]]後再重新登入一次。'''",
...
'nocreatetext' => '{{SITENAME}}限制了創建新頁面的功能。{{GENDER:|你|妳|你}}可以返回並編輯已有的頁面，或者[[Special:wiki_userLogin|登錄或創建新賬戶]]。',
...
'undo-summary' => '取消由[[Special:Contributions/$2|$2]] （[[wiki_user talk:$2|對話]]）所作出的修訂 $1',

# Account creation failure
'cantcreateaccounttitle' => '無法建立帳號',
'cantcreateaccount-text' => "從這個 IP 位址 （<b>$1</b>） 建立帳號已經被 [[wiki_user:$3|$3]] 禁止。
...
'rev-deleted-wiki_user' => '（用戶名已移除）',
'rev-deleted-event' => '（日誌已除）',
'rev-deleted-wiki_user-contribs' => '[用戶名或IP地址已移除 - 從貢獻中隱藏編輯]',
...
'revdelete-hide-wiki_user' => '隱藏編輯者的用戶名/IP地址',
...
'diff-multi-manywiki_users' => '（由多於$2名用戶作出的{{PLURAL:$1|一個中途修訂版本|$1個中途修訂版本}} 未被顯示）',
...
'prefs-edits' => '編輯次數：',
'prefsnologin' => '還未登入',
'prefsnologintext' => '您必須先<span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} 登入]</span>才能設置個人參數。',
'changepassword' => '更改密碼',
'prefs-skin' => '外觀',
'skin-preview' => '預覽',
'datedefault' => '預設值',
...
# wiki_user rights
'wiki_userrights' => '用戶權限管理',
'wiki_userrights-lookup-wiki_user' => '管理用戶群組',
'wiki_userrights-wiki_user-editname' => '輸入用戶名:',
'editwiki_usergroup' => '編輯用戶群組',
'editingwiki_user' => "更改用戶'''[[wiki_user:$1|$1]]''' 的用戶權限 $2",
'wiki_userrights-editwiki_usergroup' => '編輯用戶群組',
'savewiki_usergroups' => '保存用戶群組',
'wiki_userrights-groupsmember' => '屬於：',
'wiki_userrights-groupsmember-auto' => '固有屬於：',
'wiki_userrights-groups-help' => '您可以改動這位用戶所屬的群組：
* 已剔選的核取方塊代表該用戶屬於該群組。
* 未剔選的核取方塊代表該用戶不是屬於該群組。
* 有 * 項目表示一旦您加入該群組之後便不能移除它，反之亦然。',
'wiki_userrights-reason' => '原因：',
'wiki_userrights-no-interwiki' => '您並沒有權限去編輯在其它wiki上的用戶權限。',
'wiki_userrights-nodatabase' => '資料庫$1不存在或並非為本地的。',
'wiki_userrights-nologin' => '您必須要以操作員賬戶[[Special:wiki_userLogin|登入]]之後才可以指定用戶權限。',
'wiki_userrights-notallowed' => '您的賬戶無權限來添加或刪除用戶權限。',
'wiki_userrights-changeable-col' => '您可以更改的群組',
'wiki_userrights-unchangeable-col' => '您不可以更改的群組',
...
'group-wiki_user-member' => '{{GENDER:$1|用戶}}',
...
'grouppage-wiki_user' => '{{ns:project}}:用戶',
...
'right-move-rootwiki_userpages' => '移動根用戶頁面',
'right-movefile' => '移動檔案',
...
'right-hidewiki_user' => '封鎖用戶名，對公眾隱藏',
...
'right-editwiki_usercssjs' => '編輯其他用戶的CSS和JavaScript檔案',
'right-editwiki_usercss' => '編輯其他用戶的CSS檔案',
'right-editwiki_userjs' => '編輯其他用戶的JavaScript檔案',
...
'right-wiki_userrights' => '編輯所有用戶的權限',
'right-wiki_userrights-interwiki' => '編輯在其它wiki上的用戶權限',
...
'action-move-rootwiki_userpages' => '移動根用戶頁面',
...
'action-wiki_userrights' => '編輯所有的權限',
'action-wiki_userrights-interwiki' => '編輯在其它wiki上用戶的權限',
...
'newpageletter' => '新',
'boteditletter' => '機',
'number_of_watching_wiki_users_pageview' => '[$1位用戶在監視]',
...
'uploadnologin' => '未登入',
'uploadnologintext' => '您必須先[[Special:wiki_userLogin|登入]]
才能上載檔案。',
...
'upload-file-error-text' => '當試圖在伺服器上創建臨時檔案時發生內部錯誤。請與[[Special:Listwiki_users/sysop|管理員]]聯繫。',
'upload-misc-error' => '未知的上傳錯誤',
'upload-misc-error-text' => '在上傳時發生未知的錯誤。請驗証使用了正確並可訪問的 URL，然後進行重試。如果問題仍然存在，請與[[Special:Listwiki_users/sysop|管理員]]聯繫。',
...
'statistics-header-wiki_users' => '用戶統計',
...
'statistics-wiki_users' => '已註冊[[Special:Listwiki_users|用戶]]',
'statistics-wiki_users-active' => '活躍用戶',
'statistics-wiki_users-active-desc' => '在前$1天中操作過的用戶',
...
'listwiki_users' => '用戶列表',
'listwiki_users-editsonly' => '只顯示有編輯的用戶',
'listwiki_users-creationsort' => '按建立日期排序',
'wiki_usereditcount' => '$1 次編輯',
'wiki_usercreated' => '$1 $2{{GENDER:$3|創建}}',
'newpages' => '最新頁面',
...
'listwiki_usersfrom' => '給定顯示用戶條件:',
'listwiki_users-submit' => '顯示',
'listwiki_users-noresult' => '找不到用戶。',
'listwiki_users-blocked' => '（已封禁）',

# Special:Activewiki_users
'activewiki_users' => '活躍用戶列表',
'activewiki_users-intro' => '這個是在最近$1天之內有一些動作的用戶列表。',
'activewiki_users-count' => '最近$3天內有$1次編輯',
'activewiki_users-from' => '顯示用戶開始於：',
'activewiki_users-hidebots' => '隱藏機器人',
'activewiki_users-hidesysops' => '隱藏管理員',
'activewiki_users-noresult' => '找不到用戶。',

# Special:Log/newwiki_users
'newwiki_userlogpage' => '新進用戶名冊',
'newwiki_userlogpagetext' => '這是一個最近被創建用戶的新日誌',
...
# E-mail wiki_user
'mailnologin' => '無電郵地址',
'mailnologintext' => '您必須先[[Special:wiki_userLogin|登入]]
並在[[Special:Preferences|偏好設定]]
中有一個有效的 e-mail 地址才可以電郵其他用戶。',
'emailwiki_user' => 'E-mail該用戶',
'emailwiki_user-title-target' => '電郵這位{{GENDER:$1|用戶}}',
'emailwiki_user-title-notarget' => 'E-mail用戶',
'emailpage' => 'E-mail用戶',
'emailpagetext' => '您可以用下面的表格去寄一封電郵給這位{{Gender:$1|用戶}}。
您在[[Special:Preferences|您的參數設置]]中所輸入的電子郵件地址將出現在郵件「發件人」一欄中，這樣該用戶就可以回覆您。',
'wiki_usermailererror' => '目標郵件地址返回錯誤：',
'defemailsubject' => '{{SITENAME}}來自用戶「$1」的電子郵件',
'wiki_usermaildisabled' => '用戶電郵已停用',
'wiki_usermaildisabledtext' => '您不可以發送電郵到這個wiki上的其他用戶',
...
'emailwiki_username' => '用戶名：',
'emailwiki_usernamesubmit' => '提交',
...
'emailwiki_userfooter' => '這封電郵是由$1寄給$2經{{SITENAME}}的「電郵用戶」功能發出的。',

# wiki_user Messenger
'wiki_usermessage-summary' => '給系統消息。',
'wiki_usermessage-editor' => '系統界面',
...
'watchnologin' => '未登入',
'watchnologintext' => '您必須先[[Special:wiki_userLogin|登入]]，才能更改您的監視列表。',
'addwatch' => '加至監視列表',
...
'alreadyrolled' => '無法回退由[[wiki_user:$2|$2]]（[[wiki_user talk:$2|討論]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]在[[:$1]]上的編輯；其他人已經編輯或者回退了該頁。

該頁最後的編輯者是[[wiki_user:$3|$3]]（[[wiki_user talk:$3|討論]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]）。',
'editcomment' => "編輯摘要: \"''\$1''\"。",
'revertpage' => '已恢復由[[Special:Contributions/$2|$2]]（[[wiki_user talk:$2|對話]]）的編輯至[[wiki_user:$1|$1]]的最後一個修訂版本',
'revertpage-nowiki_user' => '恢復由（移除了的用戶名）的編輯到[[wiki_user:$1|$1]]的最後一個修訂版本',
...
'ipbwatchwiki_user' => '監視這位用戶的用戶頁面以及其對話頁面',
'ipb-disablewiki_usertalk' => '禁止被封禁用戶編輯自己的討論頁',
...
'ipb-confirmhidewiki_user' => '你要封禁用戶並隱藏其用戶名，這會隱藏在所有列表及日誌中涉及此用戶之用戶名。你確定要這樣做嗎？',
...
'emailblock' => '禁止電子郵件',
'blocklist-nowiki_usertalk' => '禁止編輯自己的用戶討論頁',
...
'contribslink' => '貢獻',
'emaillink' => '傳送電郵',
'autoblocker' => '因為您與“[[wiki_user:$1|$1]]”共享一個IP地址而被自動查封。
$1被封禁的理由是“$2”',
'blocklogpage' => '查封日誌',
...
'block-log-flags-nowiki_usertalk' => '禁止編輯自己的用戶討論頁',
...
'unblock-hidewiki_user' => '由於其用戶名已隱藏，你無法解封這個用戶。',
...
'cant-see-hidden-wiki_user' => '您現正嘗試封鎖的用戶已經被封鎖或隱藏。
...
'movearticle' => '移動頁面:',
'movewiki_userpage-warning' => "'''警告：'''您將會移動一個用戶頁面。請留意該頁面在移動後該用戶的名字是''不會''變更的。",
'movenologin' => '未登入',
'movenologintext' => '您必須是一名登記用戶並且[[Special:wiki_userLogin|登入]]
後才可移動一個頁面。',
'movenotallowed' => '您並沒有許可權去移動頁面。',
'movenotallowedfile' => '您並沒有許可權去移動檔案。',
'cant-move-wiki_user-page' => '您並沒有許可權去移動用戶頁面（它的子頁面除外）。',
'cant-move-to-wiki_user-page' => '您並沒有許可權去移動到用戶頁面（它的子頁面除外）。',
'newtitle' => '新標題:',
...
'tooltip-pt-wiki_userpage' => '您的使用者頁面',
'tooltip-pt-anonwiki_userpage' => '您編輯本站所用IP的對應用戶頁',
...
'tooltip-t-emailwiki_user' => '向該用戶發送電子郵件',
...
'tooltip-ca-nstab-wiki_user' => '檢視使用者頁面',
...
'others' => '其他',
'sitewiki_users' => '{{SITENAME}}{{PLURAL:$2|用戶|用戶}}$1',
...
'pageinfo-firstwiki_user' => '頁面的建立者',
'pageinfo-firsttime' => '頁面創建日期',
'pageinfo-lastwiki_user' => '最近編者',
...
'confirmemail_success' => '您的郵箱已經被確認。您現在可以[[Special:wiki_userLogin|登錄]]並使用此網站了。',
...
'confirmrecreate' => "在您開始編輯這個頁面後，用戶[[wiki_user:$1|$1]] （[[wiki_user talk:$1|對話]]）以下列原因刪除了這個頁面：
: ''$2''
請確認在您重新創建頁面前三思。",
'confirmrecreate-noreason' => '在您開始編輯後，用戶[[wiki_user:$1|$1]] （[[wiki_user talk:$1|對話]]）刪除了這個頁面。請在重新創建頁面前三思。',
'recreate' => '重建',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]]（[[{{ns:wiki_user_talk}}:$1|留言]]）',
...
'specialpages-group-wiki_users' => '用戶和權限',
...
'logentry-newwiki_users-newwiki_users' => '已建立用戶「$1」',
'logentry-newwiki_users-create' => '已建立用戶「$1」',
'logentry-newwiki_users-create2' => '用戶「$1」建立用戶「$3」',
'logentry-newwiki_users-autocreate' => '帳戶$1被自動創建',
'newwiki_userlog-byemail' => '密碼已由電子郵件寄出',
