...
'tog-enotifwiki_usertalkpages' => '個人留言版有修改時電郵通知我',
...
'gotaccount' => '已經有戶口？ $1。',
'gotaccountlink' => '登入',
'wiki_userlogin-resetlink' => '唔記得簽到資料？',
'createaccountmail' => '用電郵',
'createaccountreason' => '原因：',
'badretype' => '你入嘅密碼唔一致。',
'wiki_userexists' => '你入嘅用戶名已經有人用咗，唔該揀過個名啦。',
'loginerror' => '登入錯誤',
...
'nosuchwiki_user' => '呢度冇叫做 "$1"嘅用戶。
用戶名係有分大細楷嘅。
請檢查你個名嘅輸入方法，或者[[Special:wiki_userLogin/signup|建立一個新嘅戶口]]。',
'nosuchwiki_usershort' => '呢度冇叫做 "$1"嘅用戶。 請檢查你個名嘅輸入方法。',
'nowiki_userspecified' => '你需要指定一個用戶名。',
'login-wiki_userblocked' => '呢位用戶封鎖咗。唔容許登入。',
...
'wiki_usernamehasherror' => '用戶名唔可以包含切細字元',
'login-throttled' => '你已經試咗太多次登入動作。請等多一陣再試過。',
'loginlanguagelabel' => '語言：$1',
'suspicious-wiki_userlogout' => '你去登出嘅要求已經拒絕咗，因為佢可能由壞咗嘅瀏覽器或者快取代理傳送。',
...
'wiki_userpage-wiki_userdoesnotexist' => '用戶戶口"<nowiki>$1</nowiki>"重未開。請響䦒／編輯呢版之前先檢查一下。',
'wiki_userpage-wiki_userdoesnotexist-view' => '用戶戶口"$1"重未開。',
...
'wiki_usercssyoucanpreview' => "'''提示：'''響儲存前，用「{{int:showpreview}}」個掣嚟測試你嘅新CSS。",
'wiki_userjsyoucanpreview' => "'''提示：'''響儲存前，用「{{int:showpreview}}」個掣嚟測試你嘅新JavaScript。",
'wiki_usercsspreview' => "'''記住你而家只係預覽緊你嘅用戶CSS樣式表。'''
'''佢嘅內容重未儲存！'''",
'wiki_userjspreview' => "'''記住你而家只係測試／預覽緊你定義嘅JavaScript。'''
'''佢嘅內容重未儲存！'''",
'sitecsspreview' => "'''記住你而家只係預覽呢段 CSS。'''
'''佢嘅內容重未儲存！'''",
'sitejspreview' => "'''記住你而家只係預覽呢段 JavaScript 代碼。'''
'''佢嘅內容重未儲存！'''",
'wiki_userinvalidcssjstitle' => "'''警告：''' 無叫做 \"\$1\" 嘅畫面。請記住自訂介面的 .css 和 .js 頁面時應使用細楷，例如：{{ns:wiki_user}}:Foo/vector.css 而唔係 {{ns:wiki_user}}:Foo/Vector.css 。",
'updated' => '(己更新)',
'note' => "'''留意:'''",
...
'rev-deleted-wiki_user' => '(用戶名已經移除咗)',
'rev-deleted-event' => '(日誌動作已經移除咗)',
'rev-deleted-wiki_user-contribs' => '[用戶名或IP地址拎走咗 - 響貢獻度隱藏咗編輯]',
...
'revdelete-hide-wiki_user' => '隱藏編輯者嘅用戶名／IP地址',
...
'diff-multi-manywiki_users' => '（由$2位更多用戶所做嘅$1個中途修訂冇顯示到）',
...
'wiki_userrights-lookup-wiki_user' => '管理用戶組',
'wiki_userrights-wiki_user-editname' => '輸入一個用戶名：',
'editwiki_usergroup' => '編輯用戶組',
'editingwiki_user' => "改緊用戶'''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]]) 嘅用戶權限",
'wiki_userrights-editwiki_usergroup' => '編輯用戶組',
'savewiki_usergroups' => '儲存用戶組',
'wiki_userrights-groupsmember' => '屬於：',
'wiki_userrights-groupsmember-auto' => '固有屬於：',
'wiki_userrights-groups-help' => '你可以改呢位用戶所屬嘅組:
* 剔咗嘅盒代表個用戶係屬於嗰組。
* 未剔嘅盒代表個用戶唔係屬於嗰組。
* 一個 * 表示你加入咗佢之後唔可以拎走，反之亦然。',
'wiki_userrights-reason' => '原因:',
'wiki_userrights-no-interwiki' => '你並無權限去編輯響其它wiki嘅用戶權限。',
'wiki_userrights-nodatabase' => '資料庫$1唔存在或者唔係本地嘅。',
'wiki_userrights-nologin' => '你一定要以操作員戶口[[Special:wiki_userLogin|登入]]咗之後先可以指定用戶權限。',
'wiki_userrights-notallowed' => '你嘅戶口無權限去指定用戶權限。',
'wiki_userrights-changeable-col' => '你可以改嘅組',
'wiki_userrights-unchangeable-col' => '你唔可以改嘅組',
...
'right-move-rootwiki_userpages' => '搬根用戶版',
'right-movefile' => '搬檔案',
...
'right-editwiki_usercssjs' => '編輯其他用戶嘅CSS同埋JavaScript檔',
'right-editwiki_usercss' => '編輯其他用戶嘅CSS檔',
'right-editwiki_userjs' => '編輯其他用戶嘅JavaScript檔',
...
'right-wiki_userrights' => '編輯全部用戶嘅權限',
'right-wiki_userrights-interwiki' => '編輯響其它wiki嘅用戶權限',
...
'action-move-rootwiki_userpages' => '搬根用戶版',
...
'action-wiki_userrights' => '編輯全部嘅權限',
'action-wiki_userrights-interwiki' => '編輯響其它wiki用戶嘅權限',
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1位用戶監視]',
...
'statistics-wiki_users' => '註冊咗嘅[[Special:Listwiki_users|用戶]]',
'statistics-wiki_users-active' => '活躍用戶',
'statistics-wiki_users-active-desc' => '響$1日前做過動作嘅用戶',
...
'listwiki_users' => '用戶一覽',
'listwiki_users-editsonly' => '只顯示有編輯嘅用戶',
'listwiki_users-creationsort' => '按建立日期排序',
'wiki_usereditcount' => '$1次編輯',
'wiki_usercreated' => '響$1 $2{{GENDER:$3|建立}}',
'newpages' => '新頁',
...
'listwiki_usersfrom' => '顯示由呢個字開始嘅用戶：',
'listwiki_users-submit' => '顯示',
'listwiki_users-noresult' => '搵唔到用戶。',
'listwiki_users-blocked' => '(封鎖咗)',

# Special:Activewiki_users
'activewiki_users' => '活躍用戶名單',
'activewiki_users-intro' => '呢個係響最近$1日之內有一啲動作嘅用戶名單。',
'activewiki_users-count' => '響$3日之內嘅$1次編輯',
'activewiki_users-from' => '顯示用戶開始於:',
'activewiki_users-hidebots' => '隱藏機械人',
'activewiki_users-hidesysops' => '隱藏管理員',
'activewiki_users-noresult' => '搵唔到用戶。',

# Special:Log/newwiki_users
'newwiki_userlogpage' => '使用者開戶記錄',
'newwiki_userlogpagetext' => '呢個係一個使用者開戶嘅日誌',
...
'wiki_usermaildisabledtext' => '你唔可以發送電郵到響呢個wiki度嘅其他用戶',
'noemailtitle' => '無電郵地址',
...
'emailwiki_userfooter' => '呢封電郵係由$1寄畀$2經{{SITENAME}}嘅「電郵用戶」功能發出嘅。',

# wiki_user Messenger
'wiki_usermessage-summary' => '留低系統訊息。',
'wiki_usermessage-editor' => '系統訊息',
...
'revertpage-nowiki_user' => '已經反轉由（刪咗用戶名）所寫嘅編輯到[[wiki_user:$1|$1]]所寫嘅最後修訂。',
...
'ipbwatchwiki_user' => '監視呢位用戶嘅用戶頁同埋佢嘅討論頁',
...
'emailblock' => '封咗電郵',
'blocklist-nowiki_usertalk' => '唔可以編輯自己嘅討論頁',
...
'block-log-flags-nowiki_usertalk' => '唔可以編輯自己嘅討論版',
...
'cant-see-hidden-wiki_user' => '你試緊封鎖嘅用戶已經封鎖咗或者隱藏咗。
...
'movearticle' => '搬頁:',
'movewiki_userpage-warning' => "'''警告：'''你將會搬一個用戶版。請留意嗰版搬咗之後個用戶係''唔會''改名。",
'movenologin' => '未登入',
'movenologintext' => '你要係註冊用戶而且要[[Special:wiki_userLogin|登入]]咗先可以搬頁',
'movenotallowed' => '你並無權限去搬版。',
'movenotallowedfile' => '你並無權限去搬檔。',
'cant-move-wiki_user-page' => '你並無權限去搬用戶版（佢嘅細版之外）。',
'cant-move-to-wiki_user-page' => '你並無權限去搬到一個用戶版（佢嘅細版之外）。',
'newtitle' => '到新標題:',
...
'tooltip-pt-wiki_userpage' => '你嘅用戶頁',
'tooltip-pt-anonwiki_userpage' => '你編輯呢個IP嘅對應用戶頁',
...
'tooltip-t-emailwiki_user' => '寄封電子郵件畀呢一位用戶',
...
'tooltip-ca-nstab-wiki_user' => '睇吓用戶頁',
...
'sitewiki_user' => '{{SITENAME}}嘅用戶$1',
'anonwiki_user' => '{{SITENAME}}嘅匿名用戶$1',
'lastmodifiedatby' => '呢一頁最後響 $1 $2 畀 $3 修改。',
'othercontribs' => '以$1嘅作品為基礎。',
'others' => '其他',
'sitewiki_users' => '{{SITENAME}}嘅{{PLURAL:$2|用戶|用戶}}$1',
'anonwiki_users' => '{{SITENAME}}嘅匿名{{PLURAL:$2|用戶|用戶}} $1',
'creditspage' => '頁面信譽',
...
'spambot_wiki_username' => 'MediaWiki垃圾清除',
...
'specialpages-group-wiki_users' => '用戶同權限',
...
'newwiki_userlog-byemail' => '密碼已由電郵寄出',
