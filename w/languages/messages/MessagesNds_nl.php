...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'ANTALGEBRUKERS', 'AANTALGEBRUIKERS', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'ANTALAKTIEVEGEBRUKERS', 'AANTALACTIEVEGEBRUIKERS', 'ACTIEVEGEBRUIKERS', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'VERSIEGEBRUKER', 'VERSIEGEBRUIKER', 'REVISIONUSER' ),
...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Aktieve_gebrukers' ),
	...
	'Emailwiki_user'                 => array( 'Bericht_sturen' ),
	...
	'Listwiki_users'                 => array( 'Gebrukerslieste' ),
...
'tog-enotifwiki_usertalkpages' => 'Stuur mien n berichjen as mien overlegzied ewiezigd is.',
...
'youhavenewmessagesfromwiki_users' => 'Je hebben $1 van {{PLURAL:$3|n aandere gebruker|$3 gebrukers}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Je hebben $1 van n bulte gebrukers ($2).',
...
'nosuchwiki_user' => 'Der is gien gebruker mit de naam "$1".
...
'nosuchwiki_usershort' => 'Der is gien gebruker mit de naam "$1". Kiek de spelling nao.',
'nowiki_userspecified' => 'Vul n naam in',
'login-wiki_userblocked' => 'Disse gebruker is eblokkeerd.
...
'wiki_usernamehasherror' => "In n gebrukersnaam ma'j gien hekjen gebruken.",
...
'suspicious-wiki_userlogout' => 'Joew verzeuk um of te melden is aofewezen umdat t dernaor uutziet dat t verstuurd is deur n kepotte webkieker of tussenopslagbuffer',

# E-mail sending
'php-mail-error-unknown' => 'Der was n onbekende fout mit de mail()-funksie van PHP',
'wiki_user-mail-no-addy' => 'Eprobeerd n berichjen te versturen zonder n netpostadres',
...
'passwordreset-wiki_username' => 'Gebruker:',
...
'passwordreset-emailtext-wiki_user' => "De gebruker $1 van {{SITENAME}} hef joew gebrukersgegevens veur {{SITENAME}} ($4) op-evreugen vanaof t IP-adres $1.
De volgende {{PLURAL:$3|gebruker is|gebrukers bin}} ekoppeld an dit netpostadres:
...
'wiki_userpage-wiki_userdoesnotexist' => 'Je bewarken n gebrukerszied van n gebruker die niet besteet (gebruker "<nowiki>$1</nowiki>"). Kiek effen nao o\'j disse zied wel anmaken/bewarken willen.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Gebruker "$1" steet hier niet in-eschreven',
...
'wiki_usercssyoucanpreview' => "'''Tip:''' gebruuk de knoppe \"{{int:showpreview}}\" um joew nieje css/js nao te kieken veurda'j t opslaon.",
'wiki_userjsyoucanpreview' => "'''Tip:''' gebruuk de knoppe \"{{int:showpreview}}\" um joew nieje css/js nao te kieken veurda'j t opslaon.",
'wiki_usercsspreview' => "'''Dit is allinnig n naokieksel van joew persoonlike CSS.'''
'''t Is nog niet op-esleugen!'''",
'wiki_userjspreview' => "'''Denk deran da'j joew persoonlike JavaScript allinnig nog mer an t bekieken bin, t is nog niet op-esleugen!'''",
...
'''t Is nog niet op-esleugen!'''",
'wiki_userinvalidcssjstitle' => "'''Waorschuwing:''' der is gien uutvoering mit de naam \"\$1\". Vergeet niet dat joew eigen .css- en .js-ziejen beginnen mit n kleine letter, bv. \"{{ns:wiki_user}}:Naam/'''v'''ector\" in plaotse van \"{{ns:wiki_user}}:Naam/'''V'''ector.css\".",
'updated' => '(Bewark)',
'note' => "'''Opmarking:'''",
...
'rev-deleted-wiki_user' => '(gebrukersnaam vortedaon)',
'rev-deleted-event' => '(antekening vortedaon)',
'rev-deleted-wiki_user-contribs' => '[gebrukersnaam of IP-adres vortedaon - bewarking verbörgen in biedragen]',
...
'revdelete-hide-wiki_user' => 'Verbarg gebrukersnamen en IP-adressen van aandere luui.',
...
'diff-multi-manywiki_users' => '($1 tussenliggende {{PLURAL:$1|versie|versies}} deur meer as $2 {{PLURAL:$2|gebruker|gebrukers}} niet weeregeven)',
...
'prefs-wiki_user-pages' => 'Gebrukersziejen',
...
# wiki_user rights
'wiki_userrights' => 'Gebrukersrechtenbeheer',
'wiki_userrights-lookup-wiki_user' => 'Beheer gebrukersgroepen',
'wiki_userrights-wiki_user-editname' => 'Vul n gebrukersnaam in:',
'editwiki_usergroup' => 'Bewark gebrukersgroepen',
'editingwiki_user' => "Doonde mit t wiezigen van de gebrukersrechten van '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Bewark gebrukersgroep',
'savewiki_usergroups' => 'Gebrukergroepen opslaon',
'wiki_userrights-groupsmember' => 'Lid van:',
'wiki_userrights-groupsmember-auto' => 'Lid van:',
'wiki_userrights-groups-help' => 'Je kunnen de groepen wiezigen waor as de gebruker lid van is.
...
'wiki_userrights-no-interwiki' => "Je hebben gien rechten um gebrukersrechten op aandere wiki's te wiezigen.",
'wiki_userrights-nodatabase' => 'Databanke $1 besteet niet of is gien plaotselike databanke.',
'wiki_userrights-nologin' => 'Je mutten [[Special:wiki_userLogin|an-emeld]] ween en as gebruker de juuste rechten hebben um gebrukersrechten toe te kunnen wiezen.',
'wiki_userrights-notallowed' => 'Je hebben gien rechten um gebrukersrechten toe te kunnen wiezen of in te trekken.',
'wiki_userrights-changeable-col' => "Groepen die'j beheren kunnen",
'wiki_userrights-unchangeable-col' => "Groepen die'j niet beheren kunnen",

# Groups
'group' => 'Groep:',
'group-wiki_user' => 'gebrukers',
...
'group-wiki_user-member' => '{{GENDER:$1|gebruker}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Gebrukers',
...
'right-move-rootwiki_userpages' => 'Gebrukersziejen van t hoogste nivo herneumen',
...
'right-hidewiki_user' => 'n Gebruker veur de aandere gebrukers verbargen',
...
'right-editwiki_usercssjs' => 'De CSS- en JS-bestaanden van aandere gebrukers bewarken',
'right-editwiki_usercss' => 'De CSS-bestaanden van aandere gebrukers bewarken',
'right-editwiki_userjs' => 'De JS-bestaanden van aandere gebrukers bewarken',
...
'right-wiki_userrights' => 'Alle gebrukersrechten bewarken',
'right-wiki_userrights-interwiki' => "Gebrukersrechten van gebrukers in aandere wiki's wiezigen",
...
'action-move-rootwiki_userpages' => 'gebrukersziejen van t hoogste nivo herneumen',
...
'action-wiki_userrights' => 'alle gebrukersrechten bewarken',
'action-wiki_userrights-interwiki' => "de rechten van gebrukers op aandere wiki's bewarken",
...
'boteditletter' => 'B',
'unpatrolledletter' => '!',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|keer|keer}} op n volglieste]',
...
'statistics-header-wiki_users' => 'Gebrukerstaotistieken',
...
'statistics-wiki_users' => 'In-eschreven [[Special:Listwiki_users|gebrukers]]',
'statistics-wiki_users-active' => 'Aktieve gebrukers',
'statistics-wiki_users-active-desc' => 'Gebrukers die de veurbieje {{PLURAL:$1|dag|$1 dagen}} n haandeling uutevoerd hebben',
...
'listwiki_users-editsonly' => 'Allinnig gebrukers mit bewarkingen laoten zien',
'listwiki_users-creationsort' => 'Sorteren op inschriefdaotum',
'wiki_usereditcount' => '$1 {{PLURAL:$1|bewarking|bewarkingen}}',
'wiki_usercreated' => '{{GENDER:$3|Eregistreerd}} op $1 um $2',
'newpages' => 'Nieje artikels',
'newpages-wiki_username' => 'Gebrukersnaam:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Uutvoerende gebruker:',
...
'listwiki_usersfrom' => 'Laot gebrukers zien vanaof:',
'listwiki_users-submit' => 'Bekiek',
'listwiki_users-noresult' => 'Gien gebrukers evunnen. Zeuk oek naor variaanten mit kleine letters of heufdletters.',
'listwiki_users-blocked' => '(eblokkeerd)',

# Special:Activewiki_users
'activewiki_users' => 'Aktieve gebrukers',
'activewiki_users-intro' => 'Dit is n lieste van gebrukers die de aofgeleupen $1 {{PLURAL:$1|dag|dagen}} enigszins aktief ewest hebben.',
'activewiki_users-count' => '$1 leste {{PLURAL:$1|bewarking|bewarkingen}} in de aofgeleupen {{PLURAL:$3|dag|$3 dagen}}',
'activewiki_users-from' => 'Laot gebrukers zien vanaof:',
'activewiki_users-hidebots' => 'Bots verbargen',
'activewiki_users-hidesysops' => 'Beheerders verbargen',
'activewiki_users-noresult' => 'Gien aktieve gebrukers evunnen.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Logboek mit anwas',
'newwiki_userlogpagetext' => 'Hieronder staon de niej in-eschreven gebrukers',
...
'emailwiki_user' => 'n Bericht sturen',
'emailwiki_user-title-target' => 'Disse {{GENDER:$1|gebruker}} n bericht sturen',
'emailwiki_user-title-notarget' => 'Gebruker n bericht sturen',
...
'wiki_usermailererror' => 'Foutmelding bie t versturen:',
'defemailsubject' => 'Bericht van {{SITENAME}}-gebruker "$1"',
'wiki_usermaildisabled' => 'n Persoonlik berichjen sturen geet niet.',
'wiki_usermaildisabledtext' => 'Je kunnen gien berichjes sturen naor aandere gebrukers van disse wiki',
...
'emailwiki_username' => 'Gebrukersnaam:',
'emailwiki_usernamesubmit' => 'Opslaon',
...
'emailwiki_userfooter' => 'Dit bericht is verstuurd deur $1 an $2 deur de funksie "n Bericht sturen" van {{SITENAME}} te gebruken.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Systeemteksten achter-eleuten',
'wiki_usermessage-editor' => 'Systeemtekste',
...
'revertpage-nowiki_user' => 'Wiezigingen deur (gebrukersnaam vortedaon) weerummedreid naor de leste versie deur [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'gebrukersrechtenbeheer',
...
'sp-contributions-wiki_username' => 'IP-adres of gebrukersnaam:',
...
'ipadressorwiki_username' => 'IP-adres of gebrukersnaam',
...
'ipbwatchwiki_user' => 'Gebrukerszied en overlegzied op volglieste zetten',
'ipb-disablewiki_usertalk' => 'Veurkoemen dat disse gebruker tiejens de blokkering de eigen overlegzied kan bewarken',
...
'ipb-confirmhidewiki_user' => "Hiermee blokkeer je n verbörgen gebruker. Hierveur wörden gebrukersnamen in alle liesten en logboekregels verbörgen. Wi'j dat?",
...
'blocklist-wiki_userblocks' => 'Verbarg gebrukers die eblokkeerd bin',
...
'blocklist-nowiki_usertalk' => 'kan zien eigen overlegzied niet bewarken',
...
'block-log-flags-nowiki_usertalk' => 'kan zien eigen overlegzied niet bewarken',
...
'unblock-hidewiki_user' => 'Je kunnen disse gebruker niet deblokkeeren, umdat de gebrukersnaam verbörgen is.',
...
'cant-see-hidden-wiki_user' => "De gebruker die'j proberen te blokkeren is al eblokkeerd en verbörgen.
...
'movearticle' => 'Herneum',
'movewiki_userpage-warning' => "'''Waorschuwing:''' Je staon op t punt um n gebrukerszied te herneumen. Allinnig disse zied zal herneumd wörden, '''niet''' de gebruker.",
...
'cant-move-wiki_user-page' => 'Je hebben gien rechten um gebrukersziejen te herneumen.',
'cant-move-to-wiki_user-page' => "Je hebben gien rechten um n zied naor n gebrukerszied te herneumen. Herneumen naor n zied die deronder völt ma'j wel doon.",
'newtitle' => 'Nieje naam',
...
'tooltip-pt-wiki_userpage' => 'Oew gebroekersbladziede',
'tooltip-pt-anonwiki_userpage' => "Gebroekersbladziede vuur t IP-adres da'j broekt",
...
'tooltip-t-emailwiki_user' => 'Stuur disse gebroeker n netpostbericht',
...
'tooltip-ca-nstab-wiki_user' => 'Loat de gebroekersbladziede zeen',
...
'sitewiki_user' => '{{SITENAME}}-gebruker $1',
'anonwiki_user' => 'Anonieme {{SITENAME}}-gebruker $1',
'lastmodifiedatby' => 'Disse zied is t lest ewiezigd op $2, $1 deur $3.',
'othercontribs' => 'Ebaseerd op wark van $1.',
'others' => 'aandere',
'sitewiki_users' => '{{SITENAME}}-{{PLURAL:$2|gebruker|gebrukers}}  $1',
'anonwiki_users' => 'Anonieme {{SITENAME}}-{{PLURAL:$2|gebruker|gebrukers}} $1',
...
'spambot_wiki_username' => 'MediaWiki ongewunste zooi oprumen',
...
'pageinfo-firstwiki_user' => 'Gebruker die de zied an-emaakt hef',
'pageinfo-firsttime' => 'Daotum waorop de zied an-emaakt is',
'pageinfo-lastwiki_user' => 'Leste bewarker',
...
'exif-wiki_usercomment' => 'Opmarkingen',
...
'specialpages-group-wiki_users' => 'Gebrukers en rechten',
...
'logentry-newwiki_users-newwiki_users' => '$1 hef n gebruker an-emaakt',
'logentry-newwiki_users-create' => '$1 hef n gebruker an-emaakt',
'logentry-newwiki_users-create2' => '$1 hef n gebruker $3 an-emaakt',
'logentry-newwiki_users-autocreate' => 'De gebruker $1 is automaties an-emaakt',
'newwiki_userlog-byemail' => 'wachtwoord is verstuurd via de netpost',
