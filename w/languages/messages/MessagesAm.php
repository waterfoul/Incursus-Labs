...
'tog-enotifwiki_usertalkpages' => 'የተጠቃሚ መወያያ ገጼ ሲቀየር ኤመልዕክት ይላክልኝ',
...
'views' => 'ዕይታዎች',
'toolbox' => 'ትዕዛዝ ማስጫ',
'wiki_userpage' => 'የአባል መኖሪያ ገጽ ለማየት',
...
'youhavenewmessagesfromwiki_users' => 'ከ{{PLURAL:$3|ሌላ አባል|$3 አባላት}} $1 {{PLURAL:$1|አለዎት|አሉልዎ}}። ($2).',
'youhavenewmessagesmanywiki_users' => 'ከአሥር አባላት በላይ $1 አሉልዎ! ($2)',
...
'wiki_userlogin' => 'ግባ / ተመዝገብ',
'wiki_userloginnocreate' => 'ለመግባት',
...
'gotaccountlink' => 'በዚህ',
'wiki_userlogin-resetlink' => 'የመግቢያ ዝርዝርዎን ረተዋልን?',
'createaccountmail' => 'በኢ-ሜል',
'createaccountreason' => 'ምክንያት:',
'badretype' => 'የጻፉት መግቢያ ቃሎች አይስማሙም።',
'wiki_userexists' => 'ይህ ብዕር ስም አሁን ይኖራል። እባክዎ፣ ሌላ ብዕር ስም ይምረጡ።',
...
'nosuchwiki_user' => '«$1» የሚል ብዕር ስም አልተገኘም። አጻጻፉን ይመልከቱ ወይም አዲስ ብዕር ስም ያውጡ።',
'nosuchwiki_usershort' => '«$1» የሚል ብዕር ስም አልተገኘም። አጻጻፉን ይመልከቱ።',
'nowiki_userspecified' => 'አንድ ብዕር ስም መጠቆም ያስፈልጋል።',
'login-wiki_userblocked' => 'ተጠቃሚው አሁን የታገደ ነው። መግባት አልተፈቀደም።',
...
# E-mail sending
'wiki_user-mail-no-addy' => 'እሚደርስበት ኢ-ሜል አድራሻ ሳይታወቅ መላክ አይቻልም።',
...
'passwordreset-wiki_username' => 'የብዕር ስም:',
...
'wiki_userpage-wiki_userdoesnotexist' => 'የብዕር ስም «<nowiki>$1</nowiki>» አልተመዘገበም። እባክዎ ይህን ገጽ ለመፍጠር/ ለማስተካከል የፈለጉ እንደ ሆነ ያረጋግጡ።',
'wiki_userpage-wiki_userdoesnotexist-view' => 'የአባል ስም «$1» ገና አልተመዘገበም።',
'blocked-notice-logextract' => 'ይህ ተጠቃሚ $1 አሁን የታገደ ነው። 
ከዚህ ታች የማገጃ መዝገብ መጨረሻ ድርጊት ይታያል።',
'wiki_usercssyoucanpreview' => "'''ምክር፦''' ሳይቆጠብ አዲስ CSSዎን ለመሞከር 'ቅድመ እይታ' የሚለውን ይጫኑ።",
'wiki_userjsyoucanpreview' => "'''ምክር፦''' ሳይቆጠብ አዲስ JSዎን ለመሞከር 'ቅድመ እይታ' የሚለውን ይጫኑ።",
'wiki_usercsspreview' => "'''ማስታወሻ፦ CSS-ዎን ለሙከራ ብቻ እያዩ ነው፤ ገና አልተቆጠበም!'''",
'wiki_userjspreview' => "'''ማስታወሻ፦ JavaScriptዎን ለሙከራ ብቻ እያዩ ነው፤ ገና አልተቆጠበም!'''",
'sitecsspreview' => "'''ማስታወሻ፦ CSSዎን ለሙከራ ብቻ እያዩ ነው፤ ገና አልተቆጠበም!'''",
'sitejspreview' => "'''ማስታወሻ፦ JavaScriptዎን ለሙከራ ብቻ እያዩ ነው፤ ገና አልተቆጠበም!'''",
'wiki_userinvalidcssjstitle' => "'''ማስጠንቀቂያ፦''' «$1» የሚባል መልክ የለም። ልዩ .css እና .js ገጾች በትንንሽ እንግሊዝኛ ፊደል መጀመር እንዳለባቸው ያስታውሱ። ለምሳሌ፦  {{ns:wiki_user}}:Foo/vector.css ልክ ነው እንጂ {{ns:wiki_user}}:Foo/Vector.css አይደለም።",
'updated' => '(የታደሰ)',
'note' => "'''ማሳሰቢያ፦'''",
...
'rev-deleted-wiki_user' => '(ብዕር ስም ተደለዘ)',
...
'revdelete-hide-wiki_user' => 'የአዘጋጁ ብዕር ስም ወይም ቁ. አድርሻ ይደበቅ',
...
'prefs-wiki_user-pages' => 'የአባል ገጾች',
...
# wiki_user rights
'wiki_userrights' => 'የአባል መብቶች ለማስተዳደር',
'wiki_userrights-lookup-wiki_user' => 'የ1 አባል ማዕረግ ለማስተዳደር',
'wiki_userrights-wiki_user-editname' => 'ለዚሁ ብዕር ስም፦',
'editwiki_usergroup' => 'የአባሉ ማዕረግ ለማስተካከል',
'editingwiki_user' => "ይህ ማመልከቻ ለብዕር ስም '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]]) መብቶቹን ለመቀየር ነው።",
'wiki_userrights-editwiki_usergroup' => 'የአባሉ ማዕረግ ለማስተካከል',
'savewiki_usergroups' => 'ለውጦቹ ይቆጠቡ',
'wiki_userrights-groupsmember' => 'አሁን ያሉባቸው ማዕረጎች፦',
'wiki_userrights-groups-help' => 'ይኸው አባል (ብዕር ስም) ያለባቸው ስብሰባዎች (ማዕረጎች) ለመቀይር እርስዎ ይችላሉ።
...
'wiki_userrights-reason' => 'ምክንያቱ፦',
'wiki_userrights-no-interwiki' => 'ማዕረጎችን በሌላ ዊኪ ላይ ለማስተካከል ፈቃድ የለዎም።',
'wiki_userrights-nodatabase' => 'መረጃ-ቤቱ $1 አይኖርም ወይም የቅርብ አካባቢ አይደለም።',
'wiki_userrights-nologin' => 'የአባል መብቶች ለመወሰን መጋቢ ሆነው [[Special:wiki_userLogin|መግባት]] ያስፈልግዎታል።',
'wiki_userrights-notallowed' => 'የአባል መብቶች ለማስተካከል ፈቃድ የለዎም።',
'wiki_userrights-changeable-col' => 'ሊቀይሩ የሚችሉት ስብስባዎች',
'wiki_userrights-unchangeable-col' => 'ሊቀይሩ የማይችሉት ስብስባዎች፦',

# Groups
'group' => 'ደረጃ፦',
'group-wiki_user' => 'ተጠቃሚዎች',
...
'right-wiki_userrights' => 'ያባላት ሁሉ መብቶች ለማስተካከል',
...
'action-wiki_userrights' => 'ያባላት ሁሉ መብቶች ለማስተካከል',
...
'newpageletter' => 'አ',
'boteditletter' => 'B',
'number_of_watching_wiki_users_pageview' => '[$1 የሚከታተሉ {{PLURAL:$1|ተጠቃሚ|ተጠቃሚዎች}}]',
...
'statistics-header-wiki_users' => 'ያባላት ዝርዝር ቁጥሮች',
...
'statistics-wiki_users' => 'አባልነት የገቡ [[Special:Listwiki_users|ተጠቃሚዎች]]',
'statistics-wiki_users-active' => 'ተግባራዊ ተጠቃሚዎች',
'statistics-wiki_users-active-desc' => 'ባለፈው {{PLURAL:$1|ቀን|$1 ቀን}} ማንኛውንም ድርጊት የሠሩት ተጠቃሚዎች',
...
'listwiki_users' => 'አባላት',
'listwiki_users-editsonly' => 'ለውጦች ያላቸው ተጠቃሚዎች ብቻ ይታዩ',
'wiki_usereditcount' => '$1 {{PLURAL:$1|ለውጥ|ለውጦች}}',
'wiki_usercreated' => 'በ$1 በ$2 {{GENDER:$3|ተፈጠረ|ተፈጠረች}}።',
'newpages' => 'አዳዲስ መጣጥፎች',
'newpages-wiki_username' => 'በአቅራቢው፦',
...
# Special:Log
'speciallogwiki_userlabel' => 'ብዕር ስም፡',
...
'listwiki_usersfrom' => 'ከዚሁ ፊደል ጀምሮ፦',
'listwiki_users-submit' => 'ይታይ',
'listwiki_users-noresult' => 'ማንም ተጠቃሚ አልተገኘም።',
'listwiki_users-blocked' => '(ታግዷል)',

# Special:Activewiki_users
'activewiki_users' => 'ተግባራዊ አባላት ዝርዝር',
'activewiki_users-intro' => 'እነዚህ አባላት ባለፈው $1 ቀን ውስጥ ማናቸውንም አይነት ተግባር ፈጸሙ።',
'activewiki_users-count' => '$1 {{PLURAL:$1|ለውጥ|ለውጦች}} ባለፈው $3 ቀን ውስጥ',
'activewiki_users-hidebots' => 'ሎሌዎች ይደበቁ',
'activewiki_users-hidesysops' => 'መጋቢዎች ይደበቁ',
'activewiki_users-noresult' => 'ማንም ተጠቃሚ አልተገኘም።',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'የአባልነት መዝገብ (wiki_user log)',
'newwiki_userlogpagetext' => 'ይህ መዝገብ ወደ አባልነት የገቡትን ብዕር ስሞች ይዘርዝራል።',
...
'emailwiki_user' => 'ለዚህ/ች ሰው ኢሜል መላክ',
'emailwiki_user-title-target' => '{{GENDER:$1|ለዚህ|ለዚች}} አባል ኢ-ሜል መላክ',
'emailwiki_user-title-notarget' => 'ወደ አባል ኢ-ሜል ለመላክ',
...
'wiki_usermaildisabledtext' => 'በዚሁ ዊኪ ኢ-ሜል ለአባላት መላክ አይችሉም።',
...
'emailwiki_username' => 'የተጠቃሚ ሥም',
'emailwiki_usernamesubmit' => 'ለማቅረብ',
...
'sp-contributions-wiki_userrights' => 'የአባል መብቶች ለማስተዳደር',
...
'sp-contributions-wiki_username' => 'ብዕር ስም ወይም የቁ. አድራሻ፦',
...
'ipadressorwiki_username' => 'የቁ. አድራሻ ወይም የብዕር ስም፦',
'ipbexpiry' => 'የሚያልቅበት፦',
'ipbreason' => 'ምክንያቱ፦',
...
'emailblock' => 'ኢ-ሜል ታገደ',
'blocklist-nowiki_usertalk' => 'የገዛ ውይይት ገጹን ማዘጋጀት አይችልም',
...
'block-log-flags-nowiki_usertalk' => 'የገዛ ውይይት ገጹን ማዘጋጀት አይችልም',
...
'cant-move-wiki_user-page' => 'ከንዑስ ገጾች በቀር፣ የአባል ገጽ ለማዛወር ፈቃድ የለዎም።',
'newtitle' => 'አዲሱ አርእስት',
...
'tooltip-pt-wiki_userpage' => 'መደነኛው ገጽህ/ሽ',
'tooltip-pt-anonwiki_userpage' => 'ለቁ. አድራሻዎ የመኖርያ ገጽ',
...
'tooltip-t-emailwiki_user' => 'ወደዚሁ አባል ኢ-ሜል ለመላክ',
...
'tooltip-ca-nstab-wiki_user' => 'የአባል መኖሪያ ገጽ ለማየት',
...
'sitewiki_user' => '{{SITENAME}} ተጠቃሚ $1',
'lastmodifiedatby' => 'ይህ ገጽ መጨረሻ የተቀየረው $2፣ $1 በ$3 ነበር።',
'others' => 'ሌሎች',
'sitewiki_users' => '{{SITENAME}} ተጠቃሚ(ዎች) $1',

# Spam protection
'spamprotectiontitle' => 'የስፓም መከላከል ማጣሪያ',
'spambot_wiki_username' => 'MediaWiki የስፓም ማፅዳት',
'spam_reverting' => 'ወደ $1 የሚወስድ መያያዣ ወደሌለበት መጨረሻ ዕትም መለሰው',

# Info page
'pageinfo-firstwiki_user' => 'የገጹ ፈጣሪ',
'pageinfo-firsttime' => 'የተፈጠረበት ቀን',
'pageinfo-lastwiki_user' => 'የመጨረሻው አራሚ',
...
'exif-wiki_usercomment' => 'የተጠቃሚው ማጠቃለያ',
...
'specialpages-group-wiki_users' => 'አባሎችና መብቶች',
...
'newwiki_userlog-byemail' => 'ማለፊያ-ቃል በኤ-መልዕክት ተልኳል',
