...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'КОЛЬКАСЬЦЬ_УДЗЕЛЬНІКАЎ', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'КОЛЬКАСЬЦЬ_АКТЫЎНЫХ_УДЗЕЛЬНІКАЎ', 'NUMBEROFACTIVEUSERS' ),
...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'Даслаць_ліст' ),
	...
	'Listwiki_users'                 => array( 'Сьпіс_удзельнікаў' ),
...
'tog-enotifwiki_usertalkpages' => 'Паведамляць праз электронную пошту пра зьмены маёй старонкі гутарак',
...
'views' => 'Прагляды',
'toolbox' => 'Інструмэнты',
'wiki_userpage' => 'Паказаць старонку ўдзельніка',
...
'youhavenewmessagesfromwiki_users' => 'Вы атрымалі $1 ад {{PLURAL:$3|іншага ўдзельніка|$3 удзельнікаў}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Вы атрымалі $1 ад некалькіх удзельнікаў ($2).',
...
'nstab-main' => 'Старонка',
'nstab-wiki_user' => 'Старонка {{GENDER:{{BASEPAGENAME}}|ўдзельніка|ўдзельніцы}}',
'nstab-media' => 'Мэдыя',
...
Калі ласка, паведаміце пра гэта [[Special:Listwiki_users/sysop|адміністратару]], пазначыўшы URL.',
...
'titleprotected' => "Стварэньне старонкі з такой назвай было забароненае ўдзельнікам [[wiki_user:$1|$1]].
Прычына забароны: ''$2''.",
...
Вы можаце працягваць працу ў {{GRAMMAR:месны|{{SITENAME}}}} ананімна, альбо можаце [[Special:wiki_userLogin|ўвайсьці ў сыстэму]] як той жа альбо іншы ўдзельнік.
...
'wiki_userlogin' => 'Увайсьці ў сыстэму',
'wiki_userloginnocreate' => 'Увайсьці',
'logout' => 'Выйсьці',
'wiki_userlogout' => 'Выйсьці',
...
'wiki_userlogin-resetlink' => 'Забыліся пра зьвесткі для ўваходу?',
'createaccountmail' => 'па электроннай пошце',
'createaccountreason' => 'Прычына:',
'badretype' => 'Уведзеныя Вамі паролі не супадаюць.',
'wiki_userexists' => 'Уведзенае Вамі імя ўдзельніка ўжо выкарыстоўваецца кімсьці іншым. 
...
'nosuchwiki_user' => 'Удзельніка «$1» не існуе.
Вялікія і малыя літары адрозьніваюцца ў імёнах удзельнікаў.
Праверце напісаньне альбо [[Special:wiki_userLogin/signup|стварыце новы рахунак]].',
'nosuchwiki_usershort' => 'Удзельніка зь іменем «$1» не існуе. Праверце напісаньне.',
'nowiki_userspecified' => 'Вы мусіце пазначыць імя ўдзельніка.',
'login-wiki_userblocked' => '{{GENDER:$1|Гэты ўдзельнік заблякаваны|Гэтая ўдзельніца заблякаваная}}. Уваход у сыстэму забаронены.',
...
'wiki_usernamehasherror' => 'Імя ўдзельніка ня можа ўтрымліваць сымбаль #',
...
'suspicious-wiki_userlogout' => 'Ваш запыт на выхад з сыстэмы быў адхілены, таму што выглядае, што ён быў дасланы пашкоджаным браўзэрам альбо кэшаваным проксі-сэрвэрам.',

# E-mail sending
'php-mail-error-unknown' => 'Узьнікла невядомая памылка ў функцыі PHP mail()',
'wiki_user-mail-no-addy' => 'Спроба даслаць электронны ліст без адрасу дастаўкі',
...
'passwordreset-wiki_username' => 'Імя ўдзельніка:',
...
'passwordreset-emailtext-wiki_user' => 'Удзельнік $1 зрабіў запыт на атрыманьне падрабязнасьцяў Вашага рахунку ў {{GRAMMAR:месны|{{SITENAME}}}} ($4). {{PLURAL:$3|Наступны рахунак удзельніка зьвязаны|Наступныя рахункі удзельнікаў зьвязаныя}} з гэтым адрасам электроннай пошты:
...
'accmailtext' => "Выпадковым чынам створаны пароль для [[wiki_user talk:$1|$1]] быў адасланы па адрасе $2.
...
'anontalkpagetext' => "----''Гэта старонка гутарак ананімнага ўдзельніка, які яшчэ не стварыў сабе рахунак альбо не ўжывае яго. Таму мы вымушаныя ўжываць лічбавы IP-адрас дзеля ягонай ідэнтыфікацыі. Адзін IP-адрас можа выкарыстоўвацца некалькімі ўдзельнікамі. Калі Вы — ананімны ўдзельнік і лічыце, што атрымалі не прызначаныя Вам камэнтары, калі ласка, [[Special:wiki_userLogin/signup|стварыце рахунак]] альбо [[Special:wiki_userLogin|увайдзіце ў сыстэму]], каб у будучыні пазьбегнуць магчымай блытаніны зь іншымі ананімнымі ўдзельнікамі.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Рахунак удзельніка «<nowiki>$1</nowiki>» не зарэгістраваны. Калі ласка, удакладніце, ці жадаеце Вы стварыць/рэдагаваць гэтую старонку.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Рахунак «$1» ня створаны.',
...
'wiki_usercssyoucanpreview' => "'''Падказка:''' выкарыстоўвайце кнопку «{{int:showpreview}}», каб паспрабаваць новы код CSS перад тым як яго запісаць.",
'wiki_userjsyoucanpreview' => "'''Падказка:''' выкарыстоўвайце кнопку «{{int:showpreview}}», каб паспрабаваць новы код JavaScript перад тым, як яго запісаць.",
'wiki_usercsspreview' => "'''Памятайце, што гэта толькі папярэдні прагляд Вашага CSS. Ён яшчэ не запісаны!'''",
'wiki_userjspreview' => "'''Памятайце, што гэта толькі папярэдні прагляд Вашага JavaScript, ён яшчэ не запісаны!'''",
...
'''Ён яшчэ не захаваны!'''",
'wiki_userinvalidcssjstitle' => "'''Папярэджаньне:''' няма тэмы афармленьня «$1».
Памятайце, што ўласныя старонкі .css і .js павінны мець назву, якая складаецца з малых літараў, напрыклад, {{ns:wiki_user}}:Хтосьці/vector.css, а не {{ns:wiki_user}}:Хтосьці/Vector.css.",
'updated' => '(Абноўлена)',
'note' => "'''Заўвага: '''",
...
Калі ласка, паспрабуйце яшчэ раз. Калі памылка ня зьнікне, паспрабуйце [[Special:wiki_userLogout|выйсьці з сыстэмы]] і ўвайсьці ізноў.'''",
...
'''Калі гэта сапраўдная спроба рэдагаваньня, калі ласка, паспрабуйце яшчэ раз. Калі гэта не дапамагае, паспрабуйце [[Special:wiki_userLogout|выйсьці з сыстэмы]] і ўвайсьці ізноў.'''",
...
Вы можаце вярнуцца і рэдагаваць існуючую старонку, альбо [[Special:wiki_userLogin|ўвайсьці ў сыстэму ці стварыць рахунак]].',
...
'undo-summary' => 'Скасаваньне праўкі $1 удзельніка [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|гутаркі]])',

# Account creation failure
'cantcreateaccounttitle' => 'Немагчыма стварыць рахунак',
'cantcreateaccount-text' => "Стварэньне рахункаў з гэтага IP-адрасу ('''$1''') было заблякаванае [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(імя ўдзельніка выдаленае)',
'rev-deleted-event' => '(запіс з журнала падзеяў выдалены)',
'rev-deleted-wiki_user-contribs' => '[імя ўдзельніка альбо IP-адрас выдалены — рэдагаваньне схаванае з унёску]',
...
'revdelete-hide-wiki_user' => 'Схаваць імя/IP-адрас удзельніка',
...
'diff-multi-manywiki_users' => '($1 {{PLURAL:$1|прамежная вэрсія|прамежныя вэрсіі|прамежных вэрсіяў}} $2 {{PLURAL:$2|удзельніка|удзельнікаў|удзельнікаў}} {{PLURAL:$1|не паказаная|не паказаныя|не паказаныя}})',
...
'prefsnologintext' => 'Вам трэба <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} ўвайсьці ў сыстэму]</span>, каб зьмяняць свае налады.',
...
'prefs-wiki_user-pages' => 'Старонкі ўдзельніка',
...
'wiki_username' => 'Імя ўдзельніка/ўдзельніцы:',
...
# wiki_user rights
'wiki_userrights' => 'Кіраваньне правамі ўдзельнікаў і ўдзельніц',
'wiki_userrights-lookup-wiki_user' => 'Кіраваньне групамі ўдзельнікаў і ўдзельніц',
'wiki_userrights-wiki_user-editname' => 'Увядзіце імя ўдзельніка:',
'editwiki_usergroup' => 'Рэдагаваць групы ўдзельнікаў і ўдзельніц',
'editingwiki_user' => "Зьмена правоў {{GENDER:$1|удзельніка|удзельніцы}} '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Рэдагаваць групы ўдзельнікаў і ўдзельніц',
'savewiki_usergroups' => 'Захаваць групы ўдзельнікаў і ўдзельніц',
'wiki_userrights-groupsmember' => 'Уваходзіць у:',
'wiki_userrights-groupsmember-auto' => 'Няяўны чалец:',
'wiki_userrights-groups-help' => 'Тут можна зьмяняць групы, да якіх належыць гэты ўдзельнік:
...
'wiki_userrights-reason' => 'Прычына:',
'wiki_userrights-no-interwiki' => 'Вы ня маеце дазволу зьмяняць правы ўдзельнікаў іншых вікаў.',
'wiki_userrights-nodatabase' => 'Базы зьвестак $1 не існуе альбо яна не зьяўляецца лякальнай.',
'wiki_userrights-nologin' => 'Вы павінны [[Special:wiki_userLogin|ўвайсьці ў сыстэму]] як адміністратар, каб прызначаць правы ўдзельнікам.',
'wiki_userrights-notallowed' => 'Ваш рахунак ня мае права прызначаць ці выдаляць правы ўдзельнікам.',
'wiki_userrights-changeable-col' => 'Групы, якія Вы можаце мяняць',
'wiki_userrights-unchangeable-col' => 'Групы, якія Вы ня можаце мяняць',

# Groups
'group' => 'Група:',
'group-wiki_user' => 'Удзельнікі',
...
'group-wiki_user-member' => '{{GENDER:$1|удзельнік|удзельніца}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Удзельнікі',
...
'right-move-rootwiki_userpages' => 'Перанос карэнных старонак удзельнікаў',
...
'right-hidewiki_user' => 'блякаваньне рахунку ўдзельніка і яго хаваньне',
...
'right-editwiki_usercssjs' => 'рэдагаваньне CSS і JS файлаў іншых удзельнікаў',
'right-editwiki_usercss' => 'рэдагаваньне CSS файлаў іншых удзельнікаў',
'right-editwiki_userjs' => 'рэдагаваньне JS файлаў іншых удзельнікаў',
...
'right-wiki_userrights' => 'рэдагаваньне правоў усіх удзельнікаў',
'right-wiki_userrights-interwiki' => 'рэдагаваньне правоў удзельнікаў у іншых вікі',
...
'action-move-rootwiki_userpages' => 'перанос карэнных старонак удзельнікаў',
...
'action-wiki_userrights' => 'рэдагаваньне правоў усіх удзельнікаў',
'action-wiki_userrights-interwiki' => 'рэдагаваньне правоў удзельнікаў у іншых вікі',
...
'newpageletter' => 'Н',
'boteditletter' => 'р',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|назіральнік|назіральнікі|назіральнікаў}}]',
...
'uploadnologintext' => 'Вам трэба [[Special:wiki_userLogin|ўвайсьці ў сыстэму]] для загрузкі файлаў.',
...
Калі ласка, зьвярніцеся да [[Special:Listwiki_users/sysop|сыстэмнага адміністратара]].',
...
Калі памылка паўтарыцца, зьвярніцеся да [[Special:Listwiki_users/sysop|сыстэмнага адміністратара]].',
...
'statistics-header-wiki_users' => 'Статыстыка ўдзелу',
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Зарэгістраваныя ўдзельнікі]]',
'statistics-wiki_users-active' => 'Актыўныя ўдзельнікі',
'statistics-wiki_users-active-desc' => 'Удзельнікі, якія выканалі нейкае дзеяньне цягам {{PLURAL:$1|апошняга $1 дня|апошніх $1 дзён|апошніх $1 дзён}}',
...
'listwiki_users' => 'Сьпіс удзельнікаў і ўдзельніц',
'listwiki_users-editsonly' => 'Паказаць толькі ўдзельнікаў, якія маюць рэдагаваньні',
'listwiki_users-creationsort' => 'Адсартаваць па даце стварэньня',
'wiki_usereditcount' => '$1 {{PLURAL:$1|рэдагаваньне|рэдагаваньні|рэдагаваньняў}}',
'wiki_usercreated' => '{{GENDER:$3|}}Створаны $1 у $2',
'newpages' => 'Новыя старонкі',
'newpages-wiki_username' => 'Імя ўдзельніка/ўдзельніцы:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Выканаўца:',
...
'listwiki_usersfrom' => 'Паказаць удзельнікаў, пачынаючы з:',
'listwiki_users-submit' => 'Паказаць',
'listwiki_users-noresult' => 'Удзельнікі ня знойдзеныя.',
'listwiki_users-blocked' => '({{GENDER:$1|заблякаваны|заблякаваная}})',

# Special:Activewiki_users
'activewiki_users' => 'Сьпіс актыўных удзельнікаў',
'activewiki_users-intro' => 'Гэта сьпіс удзельнікаў, якія былі актыўнымі на працягу $1 {{PLURAL:$1|апошняга дня|апошніх дзён|апошніх дзён}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|дзеяньне|дзеяньні|дзеяньняў}} за $3 {{PLURAL:$3|апошні дзень|апошнія дні|апошніх дзён}}',
'activewiki_users-from' => 'Паказваць ўдзельнікаў, пачынаючы з:',
'activewiki_users-hidebots' => 'Схаваць робатаў',
'activewiki_users-hidesysops' => 'Схаваць адміністратараў',
'activewiki_users-noresult' => 'Удзельнікі ня знойдзеныя.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Журнал стварэньня рахункаў',
'newwiki_userlogpagetext' => 'Гэта журнал стварэньня рахункаў удзельнікаў і ўдзельніц.',
...
'mailnologintext' => 'Вам неабходна [[Special:wiki_userLogin|ўвайсьці ў сыстэму]] і мець пацьверджаны адрас электроннай пошты ў Вашых [[Special:Preferences|наладах]], каб дасылаць лісты іншым удзельнікам.',
'emailwiki_user' => 'Даслаць ліст',
'emailwiki_user-title-target' => 'Адправіць гэта па электроннай пошце {{GENDER:$1|гэтаму ўдзельніку|гэтай удзельніцы}}',
'emailwiki_user-title-notarget' => 'Даслаць ліст ўдзельніку ці ўдзельніцы па электроннай пошце',
...
'wiki_usermailererror' => 'Пры адсыланьні пошты адбылася памылка:',
'defemailsubject' => 'Ліст з {{GRAMMAR:родны|{{SITENAME}}}} ад {{GENDER:$1|удзельніка|удзельніцы}} «$1»',
'wiki_usermaildisabled' => 'Электронная пошта ўдзельніка адключаная',
'wiki_usermaildisabledtext' => 'Вы ня можаце дасылаць электронныя лісты іншым удзельнікам {{GRAMMAR:родны|{{SITENAME}}}}',
...
'emailwiki_username' => 'Імя ўдзельніка:',
'emailwiki_usernamesubmit' => 'Даслаць',
...
'emailwiki_userfooter' => 'Гэты ліст быў дасланы ўдзельнікам $1 да ўдзельніка $2 з дапамогай функцыі «Даслаць ліст» праекту {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Паведамленьне пра выхад з сыстэмы.',
'wiki_usermessage-editor' => 'Дастаўка сыстэмных паведамленьняў',
...
'watchnologintext' => 'Вам неабходна [[Special:wiki_userLogin|ўвайсьці ў сыстэму]], каб зьмяніць Ваш сьпіс назіраньня.',
...
'alreadyrolled' => 'Немагчыма адкаціць апошнюю зьмену [[:$1]], якую {{GENDER:$2|зрабіў|зрабіла}} [[wiki_user:$2|$2]] ([[wiki_user talk:$2|гутаркі]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]); нехта іншы ўжо зьмяніў старонку альбо адкаціў зьмены.

Апошнія зьмены зробленыя [[wiki_user:$3|$3]] ([[wiki_user talk:$3|гутаркі]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Кароткае апісаньне зьменаў было: «''$1''».",
'revertpage' => 'Рэдагаваньні [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|гутаркі]]) скасаваныя да папярэдняй вэрсіі [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Рэдагаваньні (імя ўдзельніка выдаленае) скасаваныя да папярэдняй вэрсіі [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'кіраваньне правамі ўдзельнікаў і ўдзельніц',
...
'sp-contributions-wiki_username' => 'IP-адрас альбо імя ўдзельніка/ўдзельніцы:',
...
'ipadressorwiki_username' => 'IP-адрас альбо імя ўдзельніка/ўдзельніцы:',
'ipbexpiry' => 'Тэрмін:',
'ipbreason' => 'Прычына:',
...
'ipbwatchwiki_user' => 'Назіраць за старонкай удзельніка і яго гутаркамі',
'ipb-disablewiki_usertalk' => 'Забараніць удзельніку рэдагаваньне ўласнай старонкі гутарак падчас блякаваньня',
...
'ipb-confirmhidewiki_user' => 'Вы зьбіраецеся заблякаваць удзельніка са статусам «схаваны». Гэтае дзеяньне прывядзе да таго, што яго імя зьявіцца ва ўсіх сьпісах і журналах уваходу. Вы ўпэўнены, што жадаеце гэта зрабіць?',
...
'unblocked' => '[[wiki_user:$1|$1]] быў разблякаваны.',
...
'blocklist-wiki_userblocks' => 'Схаваць блякаваньні рахункаў',
...
'blocklist-nowiki_usertalk' => 'ня можа рэдагаваць уласную старонку гутарак',
...
'autoblocker' => "Вы аўтаматычна заблякаваныя, таму што Ваш IP-адрас нядаўна ўжываўся «[[wiki_user:$1|$1]]». Прычына блякаваньня $1 наступная: «'''$2'''»",
...
'block-log-flags-nowiki_usertalk' => 'ня можа рэдагаваць уласную старонку гутарак',
...
'unblock-hidewiki_user' => 'Вы ня можаце разблякаваць гэтага ўдзельніка, таму што яго імя было схаванае.',
...
'cant-see-hidden-wiki_user' => 'Удзельнік, якога Вы спрабуеце заблякаваць, ужо заблякаваны і схаваны. З-за таго, што Вы ня маеце правоў хаваньня ўдзельнікаў, Вы ня можаце бачыць альбо зьмяняць блякаваньне удзельніка.',
...
'movewiki_userpage-warning' => "'''Папярэджаньне:''' Вы зьбіраецеся перанесьці старонку ўдзельніка. Калі ласка заўважце, што старонка будзе перанесеная, але імя ўдзельніка ''ня'' будзе зьмененае.",
'movenologin' => 'Вы не ўвайшлі ў сыстэму',
'movenologintext' => 'Вам неабходна [[Special:wiki_userLogin|ўвайсьці ў сыстэму]], каб перанесьці старонкі.',
'movenotallowed' => 'Вы ня маеце дазволу на перанос старонак.',
'movenotallowedfile' => 'Вы ня маеце правоў на перайменаваньне файлаў.',
'cant-move-wiki_user-page' => 'Вы ня маеце правоў для пераносу старонак удзельнікаў (апрача падстаронак).',
'cant-move-to-wiki_user-page' => 'Вы ня маеце правоў для пераносу старонкі ў прастору ўдзельніка (апрача падстаронак).',
...
'tooltip-pt-wiki_userpage' => 'Вашая ўласная старонка',
'tooltip-pt-anonwiki_userpage' => 'Старонка ўдзельніка для IP-адрасу, зь якога Вы рэдагуеце',
...
'tooltip-t-emailwiki_user' => 'Даслаць ліст гэтаму ўдзельніку/гэтай удзельніцы па электроннай пошце',
...
'tooltip-ca-nstab-wiki_user' => 'Паказаць старонку ўдзельніка',
...
'sitewiki_user' => 'Удзельнік/удзельніца {{GRAMMAR:родны|{{SITENAME}}}} $1',
'anonwiki_user' => 'Ананімны ўдзельнік {{GRAMMAR:родны|{{SITENAME}}}} $1',
'lastmodifiedatby' => 'Гэтую старонку апошні раз рэдагаваў $3 $2, $1.',
'othercontribs' => 'На аснове працы $1.',
'others' => 'іншыя',
'sitewiki_users' => '{{PLURAL:$2|Удзельнік|Удзельнікі}} {{GRAMMAR:родны|{{SITENAME}}}} $1',
'anonwiki_users' => '{{PLURAL:$2|Ананімны ўдзельнік|Ананімныя ўдзельнікі}} {{GRAMMAR:родны|{{SITENAME}}}} $1',
'creditspage' => 'Падзякі',
...
'spambot_wiki_username' => 'Чыстка спаму MediaWiki',
...
'pageinfo-firstwiki_user' => 'Стваральнік старонкі',
'pageinfo-firsttime' => 'Дата стварэньня',
'pageinfo-lastwiki_user' => 'Апошні рэдактар',
...
'exif-wiki_usercomment' => 'Камэнтары карыстальніка',
...
'confirmrecreate' => "{{GENDER:$1|Удзельнік|Удзельніца}} [[wiki_user:$1|$1]] ([[wiki_user talk:$1|гутаркі]]) {{GENDER:$1|выдаліў|выдаліла}} гэтую старонку, перад тым як Вы пачалі яе рэдагаваць, з прычыны:
: ''$2''
Калі ласка, пацьвердзіце, што Вы сапраўды жадаеце стварыць нанава гэтую старонку.",
'confirmrecreate-noreason' => '{{GENDER:$1|Удзельнік|Удзельніца}} [[wiki_user:$1|$1]] ([[wiki_user talk:$1|гутаркі]]) {{GENDER:$1|выдаліў|выдаліла}} гэтую старонку, пасьля таго як Вы пачалі яе рэдагаваць. Калі ласка, пацьвердзіце, што Вы сапраўды жадаеце стварыць гэтую старонку ізноў.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|гутаркі]])',
'timezone-utc' => 'UTC',
...
'specialpages-group-wiki_users' => 'Удзельнікі і правы',
...
'logentry-newwiki_users-newwiki_users' => 'Быў створаны рахунак $1',
'logentry-newwiki_users-create' => 'Быў створаны рахунак $1',
'logentry-newwiki_users-create2' => '$1 стварыў рахунак $3',
'logentry-newwiki_users-autocreate' => 'Рахунак $1 быў створаны аўтаматычна',
'newwiki_userlog-byemail' => 'Пароль адасланы па электроннай пошце',
