...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'EChaskitaManakuy' ),
	...
	'Listwiki_users'                 => array( 'Ruraqkuna', 'RuraqSutisuyu' ),
	...
	'wiki_userlogin'                 => array( 'RuraqYaykuy' ),
	'wiki_userlogout'                => array( 'RuraqLluqsiy' ),
	'wiki_userrights'                => array( 'RuraqpaHaynin' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'HAYKARURAQ', 'NÚMERODEUSUARIOS', 'NUMERODEUSUARIOS', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'HAYKARURACHKAQ', 'NÚMERODEUSUARIOSACTIVOS', 'NUMERODEUSUARIOSACTIVOS', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'MUSUQCHASQARURAQ', 'USUARIODEREVISION', 'USUARIODEREVISIÓN', 'REVISIONUSER' ),
...
'tog-enotifwiki_usertalkpages' => "Rimachinay p'anqa hukchasqa kaptinqa, e-chaskita kachamuway",
...
'wiki_userpage' => "Ruraqpa p'anqanta qhaway",
...
'youhavenewmessagesfromwiki_users' => '$1 {{PLURAL:$3|huk ruraqmanta|$3 ruraqkunamanta}} qhawanayki kachkan ($2).',
'youhavenewmessagesmanywiki_users' => '$1 achka ruraqkunamanta qhawanayki kachkan ($2).',
...
'nstab-main' => 'Qillqa',
'nstab-wiki_user' => "Ruraqpa p'anqan",
'nstab-media' => 'Midya',
...
Ama hina kaspa, huk [[Special:Listwiki_users/sysop|kamachiqman]] willariy, URL nisqa llika tiyaytapas willaspa.",
...
'titleprotected' => "Kay p'anqa sutitaqa [[wiki_user:$1|$1]] sutiyuq ruraq kamariymanta hark'arqanmi, kayraykum nispa: ''$2''.",
...
Sutinnaq kaspaykipas {{SITENAME}}pi wamp'uytam atinki. Mana hinataq munaspaykiqa, [[Special:wiki_userLogin|musuqmanta yaykuy]] ñawpaq icha huk sutiwan. Huk p'anqakunaqa kaqllam rikch'akunqa, ''cache'' nisqa pakasqa hallch'ata mana ch'usaqchaptiykiqa.",
...
'wiki_userlogin' => 'Yaykuy / rakiqunata kamariy',
'wiki_userloginnocreate' => 'Yaykuy',
'logout' => 'Lluqsiy',
'wiki_userlogout' => 'Lluqsiy',
...
'wiki_userlogin-resetlink' => 'Yaykuna willayniykikunatari qunqarqankichu?',
'createaccountmail' => 'chaskipaq',
'createaccountreason' => 'Kayrayku:',
'badretype' => 'Qusqayki yaykuna rimakunaqa manam kaqllachu.',
'wiki_userexists' => 'Munasqayki ruraqpa sutiykiqa kachkanñam.
...
'nosuchwiki_user' => 'Nisqayki "$1" sutiyuq ruraqqa manam kanchu.
Ruraqpa sutinqa uchuypas hatunpas sanampakunayuqmi kayta atin.
Allin qillqasqaykita llanchiriy, ichataq urapi kaq hunt\'ana p\'anqata llamk\'achiy [[Special:wiki_userLogin/signup|musuq rakiqunata kicharinaykipaq]].',
'nosuchwiki_usershort' => 'Nisqayki "$1" sutiyuq ruraqqa manam kanchu.
Allin qillqasqaykita llanchiriy.',
'nowiki_userspecified' => 'Ruraqpa sutiykitam qunayki.',
'login-wiki_userblocked' => "Kay ruraqqa hark'asqam. Manam yaykuyta atinchu.",
...
'wiki_usernamehasherror' => 'Ruraqpa sutinqa ama iskaychakana (<nowiki>#</nowiki>) sananchayuqchu kachun',
...
'suspicious-wiki_userlogout' => "Lluqsiy mañakuyniykiqa mananchasqam karqan, waqllisqa wamp'unamanta icha pakaq proksimanta kachasqa kaspanchá.",

# E-mail sending
'php-mail-error-unknown' => 'Mana riqsisqa pantasqa PHP mail() rurananpi',
'wiki_user-mail-no-addy' => 'Mana chaskiqniyuq e-chaskita kachayta munarqanki.',
...
'passwordreset-wiki_username' => 'Ruraqpa sutin:',
...
'passwordreset-emailtext-wiki_user' => "{{SITENAME}}-pi kaq $1 sutiyuq ruraqqa {{SITENAME}}-paq ($4)
rakiqunaykipaq willakunayuq yuyachinatam mañakurqan. Kay qatiq ruraqpa {{PLURAL:$3|rakiqunanmi|rakiqunankunam}}
kay e-chaski imamaytayuq kachkan:
...
'accmailtext' => "Kikinmanta kamarisqa [[wiki_user talk:$1|$1]]-paq yaykuna rimaqa $2-manmi kachasqaña.
...
'anontalkpagetext' => "---- ''Kayqa huk sutinnaq icha mana sutinta llamk'achiq ruraqpa rimanakuyninmi. IP huchhantam hallch'asunchik payta sutinchanapaq. Achka ruraqkunam huklla IP huchhanta llamk'achiyta atin. Sutinnaq ruraq kaspaykiqa, mana qampa rurasqaykimanta willamusqakunata rikuspaykiqa, ama hina kaspa [[Special:wiki_userLogin/signup|rakiqunaykita kamariy]] icha [[Special:wiki_userLogin|yaykuy]] huk sutinnaq ruraqkunawan ama pantasqa kanaykipaq.''",
...
'wiki_userpage-wiki_userdoesnotexist' => '"<nowiki>$1</nowiki>" sutiyuq ruraqpa rakiqunanqa manam kanchu. Ama hina kaspa, llanchikuy kay p\'anqata kamarinaykimanta.',
'wiki_userpage-wiki_userdoesnotexist-view' => '"$1" sutiyuq rakiqunaqa manam hallch\'asqachu.',
...
'wiki_usercssyoucanpreview' => "'''Kunay:''' \"{{int:showpreview}}\" nisqa ñit'inata llamk'achiy musuq css nisqata qhawanaykipaq, manaraq waqaychaspa.",
'wiki_userjsyoucanpreview' => "'''Kunay:''' \"{{int:showpreview}}\" nisqa ñit'inata llamk'achiy musuq JavaScript nisqata qhawanaykipaq, manaraq waqaychaspa.",
'wiki_usercsspreview' => "Yuyariy, qhawarillachkankim ruraqpa CSS-niykita, manaraqmi waqaychasqachu!'''",
'wiki_userjspreview' => "'''Yuyariy, qhawarillachkankim ruraqpa JavaScript-niykita, manaraqmi waqaychasqachu!'''",
...
'''Manaraqmi waqaychasqachu!'''",
'wiki_userinvalidcssjstitle' => "'''Paqtataq:''' Manam kanchu \"\$1\" qara. Yuyariy, kikinpa .css, .js p'anqankunaqa uchuy sanampa umalliyuqmi, ahinataq {{ns:wiki_user}}:Foo/vector.css manataq  {{ns:wiki_user}}:Foo/Vector.css nisqachu.",
'updated' => '(Musuqchasqa)',
'note' => "'''Musyay:'''",
...
'session_fail_preview' => "'''Achachaw! Llamk'apusqaykiqa manam waqaychasqachu, llamk'ana tiyaypa willankuna chinkaptinmi. Ama hina kaspa, musuqmanta ruraykachay. Mana atispaykiqa, [[Special:wiki_userLogout|lluqsispa]] musuqmanta yaykuy.'''",
...
'''Allin sunquwan kamarirqaspaykiqa, musuqmanta ruraykachay. Mana atispaykiqa, [[Special:wiki_userLogout|lluqsispa]] musuqmanta yaykuspa ruraykachay.'''",
...
'nocreatetext' => "{{SITENAME}}piqa saywachasqam musuq p'anqakunata kamariy. Ñawpaqman kutiytam atinkiman kachkaqña p'anqata llamk'apuspa. Astawantaq, [[Special:wiki_userLogin|yaykuy icha musuq rakiqunata kichariy]].",
...
'undo-summary' => '[[Special:Contributions/$2|$2]]-pa $1 hukchasqanta kutichisqa ([[wiki_user talk:$2|rimay]])',

# Account creation failure
'cantcreateaccounttitle' => 'Manam atinichu rakiqunata kichayta',
'cantcreateaccount-text' => "Kay IP tiyaymanta ('''$1''') rakiquna kichariyqa [[wiki_user:$3|$3]]-pa hark'asqanmi.
...
'rev-deleted-wiki_user' => '(qullusqa ruraqpa sutin)',
'rev-deleted-event' => "(qullusqa hallch'a)",
'rev-deleted-wiki_user-contribs' => "[ruraqpa sutinqa icha IP tiyayqa qichusqam - musuqchasqaqa llamk'apusqakunamanta pakasqam]",
...
'revdelete-hide-wiki_user' => 'Ruraqpa sutinta/IP huchhanta pakay',
...
'diff-multi-manywiki_users' => "({{PLURAL:$2|Hukmanta|$2-manta}} aswan ruraqkunap {{PLURAL:$1|chawpipi huk llamk'apusqanqa manam rikuchisqachu|chawpipi $1 llamk'apusqankunaqa manam rikuchisqachu}})",
...
'prefsnologintext' => '<span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} Yaykunaykim]</span> tiyan allinkachinaykikunata hukchanaykipaq.',
...
'prefs-wiki_user-pages' => "Ruraqpa p'anqankuna",
...
# wiki_user rights
'wiki_userrights' => 'Ruraqkunata saqillanap allinkachinan',
'wiki_userrights-lookup-wiki_user' => 'Ruraqkunap huñunkunata allinkachiy',
'wiki_userrights-wiki_user-editname' => 'Ruraqpa sutinta qillqamuy:',
'editwiki_usergroup' => 'Ruraqkunap huñunkunata hukchay',
'editingwiki_user' => "Kay ruraqpa hayñinkunata hukchaspa: '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Ruraqkunap huñunkunata hukchay',
'savewiki_usergroups' => 'Ruraq huñukunata waqaychay',
'wiki_userrights-groupsmember' => 'Kayman kapuq:',
'wiki_userrights-groupsmember-auto' => "Ch'aqtasqalla wankurisqa kaypi:",
'wiki_userrights-groups-help' => 'Ima huñukunapichus kay ruraq kachkan, chaytam hukchayta atinki.
...
'wiki_userrights-reason' => 'Kayrayku:',
'wiki_userrights-no-interwiki' => 'Manam saqillasunkichu huk wikikunapi ruraqkunap hayñinkunata hukchayta.',
'wiki_userrights-nodatabase' => '$1 sutiyuq willañiqintinqa manam kanchu icha manam kayllapichu.',
'wiki_userrights-nologin' => 'Kamachiqpa rakiqunaykiwan [[Special:wiki_userLogin|yaykunaykim]] tiyan ruraqkunap hayñinkunata rurapunaykipaq.',
'wiki_userrights-notallowed' => 'Qampa rakiqunaykiwanqa manam ruraqkunap hayñinkunata yapayta icha qichuyta atinkichu.',
'wiki_userrights-changeable-col' => 'Hukchanayki huñukuna',
'wiki_userrights-unchangeable-col' => 'Mana hukchanayki huñukuna',

# Groups
'group' => 'Huñu:',
'group-wiki_user' => 'Ruraqkuna',
...
'group-wiki_user-member' => '{{GENDER:$1|}}Ruraq',
...
'grouppage-wiki_user' => '{{ns:project}}:Ruraqkuna',
...
'right-move-rootwiki_userpages' => "Ruraqpa saphi p'anqankunata astay",
...
'right-hidewiki_user' => "Ruraqpa sutinta hark'ay, sapsimanta pakaspa",
...
'right-editwiki_usercssjs' => "Huk ruraqkunap CSS, JS willañiqinkunata llamk'apuy",
'right-editwiki_usercss' => "Huk ruraqkunap CSS willañiqinkunata llamk'apuy",
'right-editwiki_userjs' => "Huk ruraqkunap JS willañiqinkunata llamk'apuy",
...
'right-wiki_userrights' => "Tukuy ruraqkunap hayñinkunata llamk'apuy",
'right-wiki_userrights-interwiki' => "Wakin wiki tiyaykunapi ruraqkunap hayñinkunata llamk'apuy",
...
'action-move-rootwiki_userpages' => "ruraqpa saphi p'anqankunata astay",
...
'action-wiki_userrights' => "tukuy ruraqkunap hayñinkunata llamk'apuy",
'action-wiki_userrights-interwiki' => "hawa wikikunapi ruraqkunap hayñinkunata llamk'apuy",
...
'newpageletter' => 'M',
'boteditletter' => 'r',
'number_of_watching_wiki_users_pageview' => '[$1 watiqachkaq {{PLURAL:$1|ruraq|ruraqkuna}}]',
...
'uploadnologintext' => '[[Special:wiki_userLogin|Yaykunaykim]] tiyan willañiqikunata churkunaykipaq.',
...
'upload-file-error-text' => "Ukhu pantasqam tukurqan sirwiqpi mit'alla willañiqita kamariykachaptiyki. Ama hina kaspa, llika [[Special:Listwiki_users/sysop|kamachiqta]] tapuy.",
'upload-misc-error' => 'Mana riqsisqa churkuy pantasqa',
'upload-misc-error-text' => 'Churkuchkaptiyki mana riqsisqa pantasqam tukurqan. Ama hina kaspa, URL tiyay allinchu chayanallachu chaymanta llanchispa musuqmanta ruraykachay. Mana allinyaptinqa, llika [[Special:Listwiki_users/sysop|kamachiqta]] tapuy.',
...
'statistics-header-wiki_users' => 'Ruraqmanta ranuy',
...
'statistics-wiki_users' => 'Rakiqunayuq [[Special:Listwiki_users|ruraqkuna]]',
'statistics-wiki_users-active' => "Llamk'achkaq ruraqkuna",
'statistics-wiki_users-active-desc' => "Ñaqha {{PLURAL:$1|p'unchawpi|$1 p'unchawkunapi}} llamk'apuq ruraqkuna",
...
'listwiki_users' => 'Tukuy ruraqkuna',
'listwiki_users-editsonly' => "Llamk'apusqayuq ruraqkunallata rikuchiy",
'listwiki_users-creationsort' => 'Kamarisqap pachankama allichay',
'wiki_usereditcount' => "$1 {{PLURAL:$1|llamk'apusqa|llamk'apusqakuna}}",
'wiki_usercreated' => "{{GENDER:$3|}}Kamarisqa $1 p'unchawpi $2 pachapi",
'newpages' => "Musuq p'anqakuna",
'newpages-wiki_username' => 'Ruraqpa sutin:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Rurapuq:',
...
'listwiki_usersfrom' => 'Kaywan qallariq ruraqkunata rikuchiy:',
'listwiki_users-submit' => 'Rikuchiy',
'listwiki_users-noresult' => 'Ruraqqa manam tarisqachu.',
'listwiki_users-blocked' => "(hark'asqa)",

# Special:Activewiki_users
'activewiki_users' => "Llamk'achkaq ruraqkuna",
'activewiki_users-intro' => "Kay qatiqpiqa ruraqkunatam rikunki, qhipaq $1 {{PLURAL:$1|p'unchawpi|p'unchawkunapi}} kay wikipi imatapas ruraq.",
'activewiki_users-count' => "$1 {{PLURAL:$1|llamk'apusqa|llamk'apusqakuna}} ñaqha {{PLURAL:$3|p'unchawpi|$3 p'unchawkunapi}}",
'activewiki_users-from' => 'Ruraqkunata rikuchiy, kaywan qallarispa:',
'activewiki_users-hidebots' => 'Rurana antachakunata pakay',
'activewiki_users-hidesysops' => 'Kamachiqkunata pakay',
'activewiki_users-noresult' => 'Ruraqkunataqa manam tarinichu.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => "Rakiquna kamariy hallch'a",
'newwiki_userlogpagetext' => "Kayqa ruraqkunap rakiqunankunata kamariymanta hallch'am.",
...
'mailnologintext' => '[[Special:wiki_userLogin|Yaykunaykim]], [[Special:Preferences|allinkachinaykikunapi]] chaniyuq e-chaski imamaytappas kananmi tiyan huk ruraqkunaman e-chaskita kachanaykipaq.',
'emailwiki_user' => 'Kay ruraqman e-chaskita kachay',
'emailwiki_user-title-target' => 'Kay {{GENDER:$1|ruraqman}} e-chaskita kachay',
'emailwiki_user-title-notarget' => 'E-chaski kay ruraqman:',
...
'wiki_usermailererror' => 'Chaski llikaqa pantasqatam kutichimurqan:',
'defemailsubject' => '{{SITENAME}} p\'anqamanta chaski "$1" sutiyuq ruraqmanta',
'wiki_usermaildisabled' => "Ruraqpa e-chaskinqa hark'asqam",
'wiki_usermaildisabledtext' => 'Manam atinkichu kay wikipi huk ruraqkunaman e-chaskita kachayta.',
...
'emailwiki_username' => 'Ruraqpa sutin:',
'emailwiki_usernamesubmit' => 'Kachay',
...
'emailwiki_userfooter' => 'Kay e-chaskitaqa $1 sutiyuqmi kacharqan $2 sutiyuqman "e-chaski kachay" nisqapaq ruranawan kay tiyaypi: {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Llika willayta kachaspa.',
'wiki_usermessage-editor' => 'Llika willay kachaq',
...
'watchnologintext' => '[[Special:wiki_userLogin|Yaykunaykim]] tiyan watiqana sutisuyuykita hukchanaykipaq.',
...
'alreadyrolled' => "Manam atinichu [[wiki_user:$2|$2]]-pa ([[wiki_user talk:$2|rimanakuy]]) [[$1]] nisqa qhipaq llamk'apusqanta kutichiyta; pipas kay p'anqataqa llamk'apurqunñam icha kutichirqunñam.

Qhipaq kaq llamk'apusqaqa [[wiki_user:$3|$3]]-pa ([[wiki_user talk:$3|rimanakuy]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]) rurasqanmi.",
'editcomment' => "Llamk'apusqakunamanta pisichasqaqa kay hinam: \"''\$1''\".",
'revertpage' => '[[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|rimachina]]) sutiyuq ruraqpa hukchasqankunaqa kutichisqam [[wiki_user:$1|$1]]-pa ñawpaq hukchasqanman',
'revertpage-nowiki_user' => "Ruraqpa hukchasqankunaqa (sutinqa qichusqam) kutichisqañam [[wiki_user:$1|$1]]-pa ñawpaq llamk'apusqanta paqarichispa",
...
'sp-contributions-wiki_userrights' => 'ruraqkunata saqillanap allinkachinan',
...
'sp-contributions-wiki_username' => 'IP huchha icha ruraqpa sutin:',
...
'ipadressorwiki_username' => 'IP huchha icha ruraqpa sutin',
...
'ipbwatchwiki_user' => "Kay ruraqpa p'anqanta rimachinantapas watiqay",
'ipb-disablewiki_usertalk' => "Kay ruraq hark'asqa kaspa kikinpa rimanakuy p'anqanta ama llamk'apuchunchu",
...
'ipb-confirmhidewiki_user' => 'Ruraqta hark\'aykachachkanki, payman "Ruraqta pakay" nisqam.  Chaywanqa manam pipas chay ruraqpa sutinta ima sutisuyupipas hallch\'apipas rikunqachu.  Chiqapta kayta rurayta munankichu?',
...
'unblocked' => "Hark'asqa [[wiki_user:$1|$1]] qispisqañam",
...
'blocklist-wiki_userblocks' => "Rakiquna hark'asqakunata pakay",
...
'blocklist-nowiki_usertalk' => "kikinpa rimanakuy p'anqanta manam hukchayta atinchu",
...
'autoblocker' => 'Kikinmanta hark\'asqam kanki, "[[wiki_user:$1|$1]]" sutiyuq ruraq IP huchhaykita ñaqha llamk\'arquptinmi. Hark\'aqqa "[[wiki_user:$1|$1]]"-ta hark\'aspa kaytam nirqan, kayrayku: "$2".',
...
'block-log-flags-nowiki_usertalk' => "kikinpa rimanakuy p'anqanta manam hukchayta atinchu",
...
'unblock-hidewiki_user' => "Kay hark'asqa ruraqtaqa manam qispichiyta atinkichu, ruraqpa sutin pakasqa kaptinmi.",
...
'cant-see-hidden-wiki_user' => "Hark'aykachasqayki ruraqqa pipapas hark'asqanñam pakasqanñapas. Ruraqta pakay hayñiyuq mana kaspaykim, manam atinkichu ruraqpaq hark'ay hallch'asqata rikuyta icha hukchasqayta.",
...
'movewiki_userpage-warning' => "'''Paqtataq:''' Ruraqpa p'anqantam astaykachachkanki. Qhawariy, p'anqallam astasqa kanqa, ruraqpa sutintaq '''manam''' wakinchasqachu kanqa.",
'movenologin' => "Manam qallarisqachu llamk'apuy tiyayniyki",
'movenologintext' => "P'anqata astanaykipaqqa hallch'asqa ruraqmi kanayki [[Special:wiki_userLogin|llamk'apuy tiyay qallarinaykipas]] tiyan.",
'movenotallowed' => "Manam saqillasunkichu p'anqata astayta.",
'movenotallowedfile' => 'Manam atinkichu willañiqikunata astayta.',
'cant-move-wiki_user-page' => "Ruraqpa p'anqankunataqa manam astayta atinkichu (urin p'anqakunallatam).",
'cant-move-to-wiki_user-page' => "Ruraqpa p'anqanmanqa manam astayta atinkichu (urin p'anqallamanmi).",
...
'tooltip-pt-wiki_userpage' => "Qampa ruraqpa p'anqayki",
'tooltip-pt-anonwiki_userpage' => "IP huchhaykipaq ruraqpa p'anqan",
...
'tooltip-t-emailwiki_user' => 'Kay ruraqman chaskita kachay',
...
'tooltip-ca-nstab-wiki_user' => "Ruraqpa p'anqanta qhaway",
...
'sitewiki_user' => '{{SITENAME}}-pa $1 sutiyuq ruraqnin',
'anonwiki_user' => '{{SITENAME}} rakiqunannaq ruraq $1',
'lastmodifiedatby' => "Kay p'anqaqa $2, $1 qhipaq kutitam $3-pa hukchasqan karqan.",
'othercontribs' => '$1-pa rurasqanmanta paqariq.',
'others' => 'hukkuna',
'sitewiki_users' => '{{SITENAME}}-pa $1 sutiyuq {{PLURAL:$2|ruraqnin|ruraqninkuna}}',
'anonwiki_users' => '{{SITENAME}} rakiqunannaq {{PLURAL:$2|ruraq|ruraqkuna}} $1',
...
'spambot_wiki_username' => 'MediaWiki-ta spam nisqamanta pichay',
...
'pageinfo-firstwiki_user' => "P'anqap kamariqnin",
'pageinfo-firsttime' => "P'anqa kamariypa p'unchawnin",
'pageinfo-lastwiki_user' => "Ñaqha llamk'apuqnin",
...
'exif-wiki_usercomment' => "Llamk'achiqpa willayninkuna",
...
Kunanqa wikiman [[Special:wiki_userLogin|yaykamuspayki]] ayniytam atinki.',
...
'confirmrecreate' => "Qam kay p'anqata llamk'apuyta qallarirqaptiyki, [[wiki_user:$1|$1]] sutiyuq ruraqmi ([[wiki_user talk:$1|rimanakuy]]) qullurqan, kayraykum nispa:
: ''$2''
Ama hina kaspa, chiqapta kay p'anqatam musuqmanta kamayta munani nispa takyachiy.",
'confirmrecreate-noreason' => "Qam kay p'anqata llamk'apuyta qallarirqaptiyki, [[wiki_user:$1|$1]] sutiyuq ruraqmi ([[wiki_user talk:$1|rimanakuy]]) qullurqan. Ama hina kaspa, chiqapta kay p'anqatam musuqmanta kamayta munani nispa takyachiy.",
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|rimanakuy]])',
...
'specialpages-group-wiki_users' => 'Ruraqkuna hayñinkunapas',
...
'logentry-newwiki_users-newwiki_users' => '$1 sutiyuq rakiquna kamarisqañam',
'logentry-newwiki_users-create' => '$1 sutiyuq rakiquna kamarisqañam',
'logentry-newwiki_users-create2' => '$1 sutiyuq ruraqqa $3 sutiyuq rakiqunatam kamarirqanñam',
'logentry-newwiki_users-autocreate' => '$1 sutiyuq rakiqunaqa kikinmanta kamarisqam',
'newwiki_userlog-byemail' => 'e-chaskiwan kachasqa yaykuna rima',
