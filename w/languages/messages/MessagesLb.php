...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Aktiv_Benotzer' ),
	...
	'Emailwiki_user'                 => array( 'Dësem_Benotzer_eng_E-Mail_schécken' ),
	...
	'Listwiki_users'                 => array( 'Lëscht_vun_de_Benotzer' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'Benotzerzuel', 'BENUTZERANZAHL', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'Aktiv_Benotzer', 'AKTIVE_BENUTZER', 'NUMBEROFACTIVEUSERS' ),
...
'tog-enotifwiki_usertalkpages' => 'Schéckt mir E-Maile wa meng Diskussiounssäit geännert gëtt.',
...
'youhavenewmessagesfromwiki_users' => 'Dir hutt $1 vu(n) {{PLURAL:$3|engem anere Benotzer|$3 anere Benotzer}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Dir hutt $1 vu ville Benotzer ($2)',
...
'wiki_userlogin' => 'Aloggen / Benotzerkont uleeën',
'wiki_userloginnocreate' => 'Umellen',
'logout' => 'Ofmellen',
'wiki_userlogout' => 'Ausloggen',
...
'wiki_userlogin-resetlink' => "Hutt Dir d'Detailer vun Ärem Login vergiess?",
'createaccountmail' => 'Via E-Mail',
'createaccountreason' => 'Grond:',
'badretype' => 'Är Passwierder stëmmen net iwwerdeneen.',
'wiki_userexists' => 'De Benotzernumm deen agi gouf gëtt scho benotzt.
...
'nosuchwiki_user' => 'Et gëtt kee Benotzernumm mam Numm "$1".
...
'nosuchwiki_usershort' => 'De Benotzernumm "$1" gëtt et net.
Kuckt w.e.g. op d\'Schreifweis richteg ass.',
'nowiki_userspecified' => 'Gitt w.e.g. e Benotzernumm un.',
'login-wiki_userblocked' => 'Dëse Benotzer ass gespaart. Aloggen ass net erlaabt.',
...
'wiki_usernamehasherror' => "Am Benotzernumm däerfe keng ''hash'' Zeeche sinn",
...
'suspicious-wiki_userlogout' => 'Är Ufro fir Iech auszeloggen gouf refuséiert well et esou ausgesäit wéi wann se vun engem Futtise Browser oder Proxy-Tëschespäicher kënnt.',

# E-mail sending
'php-mail-error-unknown' => 'Onbekannte Feeler an der PHP-Mail-Fonctioun',
'wiki_user-mail-no-addy' => 'Huet versicht eng Mail ouni Mailadress ze schécken',
...
'passwordreset-wiki_username' => 'Benotzernumm:',
...
'wiki_userpage-wiki_userdoesnotexist' => 'De Benotzerkont "<nowiki>$1</nowiki>" ass net registréiert.
Iwwerpréift w.e.g. op Dir dës Säit uleeën/ännere wëllt.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'De Benotzerkont "$1" ass net registréiert.',
...
'wiki_usercssyoucanpreview' => "'''Tipp:''' Benotzt de \"{{int:showpreview}}\"-Knäppchen, fir Ären neien CSS virum Späicheren ze testen.",
'wiki_userjsyoucanpreview' => "'''Tipp:''' Benotzt de ''{{int:showpreview}}''-Knäppchen, fir Ären neie JavaScript virum Späicheren ze testen.",
'wiki_usercsspreview' => "'''Bedenkt: Dir kuckt just är Benotzer CSS.
Si gouf nach net gespäichert!'''",
'wiki_userjspreview' => "'''Denkt drun datt Dir Äre Javascript nëmmen test.'''
...
E gouf nach net gespäichert!'''",
'wiki_userinvalidcssjstitle' => "'''Opgepasst:''' Et gëtt keen Ausgesinn (skin) \"\$1\".
Denkt drun datt eegen .css an .js Säiten e kleng geschriwwenen Titel benotzen, z. Bsp. {{ns:wiki_user}}:Foo/vector.css am Géigesaz zu {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(Geännert)',
'note' => "'''Notiz:'''",
...
'rev-deleted-wiki_user' => '(Benotzernumm ewechgeholl)',
'rev-deleted-event' => '(Aktioun aus dem Logbuch erausgeholl)',
'rev-deleted-wiki_user-contribs' => '[Benotzernumm oder IP-Adress ewechgeholl - Ännerung an der Lescht vun de Kontributioune verstoppt]',
...
'revdelete-hide-wiki_user' => 'Dem Auteur säi Benotzernumm/IP verstoppen',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Eng Tëscheversioun|$1 Tëscheversioune}} vu méi wéi $2 {{PLURAL:$2|Benotzer|Benotzer}} ginn net gewisen)',
...
'prefs-wiki_user-pages' => 'Benotzersäiten',
...
# wiki_user rights
'wiki_userrights' => 'Benotzerrechterverwaltung',
'wiki_userrights-lookup-wiki_user' => 'Benotzergrupp verwalten',
'wiki_userrights-wiki_user-editname' => 'Benotzernumm uginn:',
'editwiki_usergroup' => 'Benotzergruppen änneren',
'editingwiki_user' => "Ännere vun de Rechter vum Benotzer '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Benotzergruppen änneren',
'savewiki_usergroups' => 'Benotzergruppe späicheren',
'wiki_userrights-groupsmember' => 'Member vun:',
'wiki_userrights-groupsmember-auto' => 'Implizit Member vun:',
'wiki_userrights-groups-help' => "Dir kënnt d'Gruppen zu deenen dëse Benotzer gehéiert änneren.
...
'wiki_userrights-reason' => 'Grond:',
'wiki_userrights-no-interwiki' => "Dir hutt net déi néideg Rechter, fir d'Rechter vu Benoutzer op anere Wikien z'änneren.",
'wiki_userrights-nodatabase' => "D'Datebank $1 gëtt et net oder se ass net lokal.",
'wiki_userrights-nologin' => 'Dir musst mat engem Administrateurs-Benotzerkont [[Special:wiki_userLogin|ageloggt sinn]], fir Benotzerrechter änneren ze kënnen.',
'wiki_userrights-notallowed' => "Äre Benotzerkont hutt net déi néideg Rechter fir d'Rechter vun anere Benotzer z'änneren.",
'wiki_userrights-changeable-col' => 'Gruppen déi Dir ännere kënnt',
'wiki_userrights-unchangeable-col' => 'Gruppen déi Dir net ännere kënnt',

# Groups
'group' => 'Grupp:',
'group-wiki_user' => 'Benotzer',
...
'group-wiki_user-member' => '{{GENDER:$1|Benotzer}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Benotzer',
...
'right-move-rootwiki_userpages' => 'Haapt-Benotzersäite réckelen',
...
'right-hidewiki_user' => 'E Benotzernumm spären, an deem e virun der Ëffentlechkeet verstoppt gëtt',
...
'right-editwiki_usercssjs' => 'Anere Benotzer hir CSS a JS Fichieren änneren',
'right-editwiki_usercss' => 'Anere Benotzer hir CSS Fichieren änneren',
'right-editwiki_userjs' => 'Anere Benotzer hir JavaScript Fichieren änneren',
...
'right-wiki_userrights' => 'All Benotzerrechter änneren',
'right-wiki_userrights-interwiki' => 'Benotzerrechter vu Benotzer op anere Wiki-Siten änneren',
...
'action-move-rootwiki_userpages' => 'Haapt-Benotzersäite réckelen',
...
'action-wiki_userrights' => "all Benotzerrechter z'änneren",
'action-wiki_userrights-interwiki' => "d'Rechter vu Benotzer vun anere Wikien z'änneren",
...
'newpageletter' => 'N',
'boteditletter' => 'B',
'number_of_watching_wiki_users_pageview' => '[$1 Benotzer {{PLURAL:$1|iwwerwaacht|iwwerwaachen}}]',
...
'statistics-header-wiki_users' => 'Benotzerstatistik',
...
'statistics-wiki_users' => 'Registréiert [[Special:Listwiki_users|Benotzer]]',
'statistics-wiki_users-active' => 'Aktiv Benotzer',
'statistics-wiki_users-active-desc' => 'Benotzer déi während {{PLURAL:$1|dem leschten Dag|de leschten $1 Deeg}} eppes gemaach hunn',
...
'listwiki_users' => 'Benotzerlëscht',
'listwiki_users-editsonly' => 'Nëmme Benotzer mat Ännerunge weisen',
'listwiki_users-creationsort' => 'Nom Datum vum Uleeën zortéieren',
'wiki_usereditcount' => '$1 {{PLURAL:$1|Ännerung|Ännerungen}}',
'wiki_usercreated' => "{{GENDER:$3|De(n)|D'}} $1 ëm $2 Auer ugeluecht",
'newpages' => 'Nei Säiten',
'newpages-wiki_username' => 'Benotzernumm:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Aktive Benotzer:',
...
'listwiki_usersfrom' => "D'Benotzer weisen, ugefaange bei:",
'listwiki_users-submit' => 'Weis',
'listwiki_users-noresult' => 'Kee Benotzer fonnt.',
'listwiki_users-blocked' => '(gespaart)',

# Special:Activewiki_users
'activewiki_users' => 'Lëscht vun den aktive Benotzer',
'activewiki_users-intro' => 'Dëst ass eng Lëscht vun de Benotzer déi op iergend eng Manéier an de leschten $1 {{PLURAL:$1|Dag|Deeg}} aktiv waren.',
'activewiki_users-count' => '$1 {{PLURAL:$1|Aktioun|Aktiounen}} {{PLURAL:$3|gëschter|an de leschten $3 Deeg}}',
'activewiki_users-from' => 'Benotzer weisen, ugefaang bäi:',
'activewiki_users-hidebots' => 'Botte verstoppen',
'activewiki_users-hidesysops' => 'Administrateure verstoppen',
'activewiki_users-noresult' => 'Keng Benotzer fonnt.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Logbuch vun den neien Umeldungen',
'newwiki_userlogpagetext' => "Dëst ass d'Lescht vun de Benotzernimm déi ugeluecht goufen.",
...
'emailwiki_user' => 'Dësem Benotzer eng E-Mail schécken',
'emailwiki_user-title-target' => '{{GENDER:$1|Dëser Benotzerin|Dësem Benotzer}} eng Mail schécken',
'emailwiki_user-title-notarget' => 'Dem Benotzer eng E-Mail schécken',
...
'wiki_usermailererror' => 'E-Mail-Objet mellt deen heite Feeler:',
'defemailsubject' => '{{SITENAME}} E-Mail vum Benotzer "$1"',
'wiki_usermaildisabled' => 'Benotzer E-Mail ausgeschalt',
'wiki_usermaildisabledtext' => 'Dir kënnt op dëser Wiki anere Benotzer keng E-Mail schécken',
...
'emailwiki_username' => 'Benotzernumm:',
'emailwiki_usernamesubmit' => 'Späicheren',
...
'emailwiki_userfooter' => 'Dës E-Mail gouf vum $1 dem $2 geschéckt dobäi gouf d\'Funktioun "Benotzer E-Mail" op {{SITENAME}} benotzt.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Benoriichtegung hannerloossen.',
'wiki_usermessage-editor' => 'Benoriichtegungs-System',
...
'revertpage-nowiki_user' => 'Zréckgesaten Ännerungen vum (Benotzernummewechgeholl) op déilescht Versioun vum [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'Verwaltung vun de Benotzerrechter',
...
'sp-contributions-wiki_username' => 'IP-Adress oder Benotzernumm:',
...
'ipadressorwiki_username' => 'IP-Adress oder Benotzernumm:',
...
'ipbwatchwiki_user' => 'Dësem Benotzer seng Benotzer- an Diskussiouns-Säit iwwerwaachen',
'ipb-disablewiki_usertalk' => "Dëse Benotzer dorun hënnere fir seng eegen Diskussiounssäit z'änneren esou laang wéi et gespaart ass",
...
'ipb-confirmhidewiki_user' => 'Dir sidd am gaang e Benotzer ze späre mat der Fonctioun "Benotzer verstoppen" ageschalt. Dëst hëlt den Numm vum Benotzer aus alle Lëschten a Logbicher eraus. Sidd Dir sécher datt Dir dat maache wëllt?',
...
'blocklist-wiki_userblocks' => 'Benotzerspäre verstoppen',
...
'blocklist-nowiki_usertalk' => 'däerf seng eegen Diskussiounssäit net ännereen',
...
'block-log-flags-nowiki_usertalk' => 'däerf seng Diskussiounssäiten net änneren',
...
'unblock-hidewiki_user' => "D'Spär vun dësem Benotzer kann net vun Iech opgehuewe gi well dee Benotzernumm verstoppt gouf.",
...
'cant-see-hidden-wiki_user' => "De Benotzer deen Dir versicht ze spären ass scho gespaart a verstoppt. Well Dir d'Recht ''Hidewiki_user'' net hutt kënnt Dir dëse Benotzer net gesinn an dem Benotzer seng Spär net änneren.",
...
'movewiki_userpage-warning' => "'''Opgepasst:''' Dir sidd am gaang eng Benotzersäit ze réckelen. Denkt w.e.g. dorunn datt just d'Säit geréckelt gëtt an datt de Benotzer ''net'' ëmbenannt gëtt.",
...
'cant-move-wiki_user-page' => 'Dir hutt net déi néideg Rechter fir Benotzerhaaptsäiten ze réckelen.',
'cant-move-to-wiki_user-page' => "Dir hutt net d'Recht fir eng Säit op eng Benotzersäit (ausser op eng Ënnersäit vun enger Benotzersäit) ze réckelen.",
...
'tooltip-pt-wiki_userpage' => 'Är Benotzersäit',
'tooltip-pt-anonwiki_userpage' => 'Benotzersäit vun der IP-Adress vun där aus Dir den Ament Ännerunge maachtt',
...
'tooltip-t-emailwiki_user' => 'Dësem Benotzer eng E-Mail schécken',
...
'tooltip-ca-nstab-wiki_user' => 'Benotzersäit weisen',
...
'sitewiki_user' => '{{SITENAME}}-Benotzer $1',
'anonwiki_user' => 'Anonyme(n) {{SITENAME}}-Benotzer $1',
...
'others' => 'anerer',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|Benotzer|Benotzer}} $1',
'anonwiki_users' => '{{PLURAL:$2|Anonyme(n)|Anonym}} {{SITENAME}}-Benotzer $1',
'creditspage' => 'Quellen',
...
'spambot_wiki_username' => 'Botz vum Spam duerch MediaWiki',
...
'pageinfo-firstwiki_user' => '1. Auteur vun der Säit',
'pageinfo-firsttime' => 'Datum vum Uleeë vun der Säit',
'pageinfo-lastwiki_user' => 'Leschte Benotzer deen eppes geännert huet',
...
'exif-wiki_usercomment' => 'Bemierkunge vum Benotzer',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|Diskussioun]])',
...
'specialpages-group-wiki_users' => 'Benotzer a Rechter',
...
'logentry-newwiki_users-newwiki_users' => 'De Benotzerkont $1 gouf ugeluecht',
'logentry-newwiki_users-create' => 'De Benotzerkont $1 gouf ugeluecht',
'logentry-newwiki_users-create2' => 'De Benotzerkont $3 gouf vum $1 ugeluecht',
'logentry-newwiki_users-autocreate' => 'De Benotzerkont $1 gouf automatesch ugeluecht',
'newwiki_userlog-byemail' => "d'Passwuert gouf per E-Mail geschéckt",
