...
'tog-enotifwiki_usertalkpages' => 'sifd yi tabrat  igh tbdl tawriqt ohokko-no',
...
'wiki_userpage' => 'Ẓr n tasna n umsqdac',
...
'nstab-main' => 'Tasnat',
'nstab-wiki_user' => 'Tasnat u-msxdam',
...
'wiki_userlogin' => 'kchem / qiyd amskhdam amaynu',
'wiki_userloginnocreate' => 'Kcm ɣid',
'logout' => 'Fuɣ',
'wiki_userlogout' => 'Fuɣ',
...
'gotaccountlink' => 'Kcm',
'wiki_userlogin-resetlink' => 'Ttut ismnk d tasarut n ukccum nk',
'createaccountmail' => 'S tirawt taliktunant',
'createaccountreason' => 'Maɣ:',
'badretype' => 'Tasarut lin tgit ur dis tucka.',
'wiki_userexists' => 'Asaɣ nu umsqdac li tskcmt illa yad',
...
'nosuchwiki_user' => 'Asqdac « $1 » ur illi.
Ussaɣ n isqdacn ḥiln hlli.
Ẓṛ daɣ ist turit mzyan mayad, niɣd [[Special:wiki_userLogin/signup|tmmurẓmt amiḍan amaynu]].',
'nosuchwiki_usershort' => 'Ur illa umsaws lli ilan assaɣ « $1 ». Ẓṛ ist turit mzyan mayad.',
'nowiki_userspecified' => 'Illa fllak ad tarat assaɣ nk.',
'login-wiki_userblocked' => 'Asqdac ad ur as yufi ad ikcm. Tazdayt ɣ ifalan uras ttuyskar',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|yan ulqm n gratsn|$1 ilqmn ngratsn}} zdar mnnaw {{PLURAL:$2|amcgr |n $2 imcgrn}} {{PLURAL:$1|iḥba|lli iḥban}})',
...
'boteditletter' => 'q',
'unpatrolledletter' => '!',
'number_of_watching_wiki_users_pageview' => '[$1 iżŗi {{PLURAL:$1|amsqdac|imsqdacn}}]',
...
'wiki_usercreated' => '{{GENDER:$3|tuyskar}}  z $1 ar $2',
...
# Special:Log
'speciallogwiki_userlabel' => 'Amsqdac',
...
'newwiki_userlogpage' => 'Aɣmis n willi mmurzmn imiḍan amsqdac',

# Special:ListGroupRights
'listgrouprights-members' => 'Umuɣ n  midn',

# E-mail wiki_user
'emailwiki_user' => 'Azn tabrat umsqdac ad',
...
'sp-contributions-wiki_userrights' => 'Sgiddi izrfan',
...
'sp-contributions-wiki_username' => 'Tansa IP niɣ assaɣ nu umsqdac:',
...
'ipbwatchwiki_user' => 'Tfr tisniwin d imsgdaln n umqdac',
...
'tooltip-pt-wiki_userpage' => 'Tasna n umsqdac',
...
'tooltip-t-emailwiki_user' => 'Ṣafd tabrat umsqdac ad',
...
'tooltip-ca-nstab-wiki_user' => 'Ẓr tasna n useqdac',
...
'specialpages-group-wiki_users' => 'imskhdamn d salahiyat',
