...
'tog-enotifwiki_usertalkpages' => 'Ҳангоме ки дар саҳифаи корбариам тағйир дода мешавад ба ман тариқи почтаи электронӣ пайём бифиристед.',
...
'wiki_userpage' => 'Саҳифаи корбарро бинед',
...
'nstab-main' => 'Мақола',
'nstab-wiki_user' => 'Саҳифаи корбар',
'nstab-media' => 'Расона',
...
Лутфан инро ба [[Special:Listwiki_users/sysop|мудир]] бо ишора кардани нишонаи URL хабар диҳед.',
...
'titleprotected' => "Эҷоди саҳифае бо ин унвон аз тарафи [[wiki_user:$1|$1]] ҷилавгирӣ шудааст.
...
Шумо метавонед гумном аз {{SITENAME}} истифодабариро идома диҳед, ё метавонед бо ҳамин номи корбариатон ва ё номи корбарии дигаре [[Special:wiki_userLogin|боз вуруд кунед]].
...
'wiki_userlogin' => 'Вуруд / Сохтани ҳисоби ҷадид',
'wiki_userloginnocreate' => 'Вуруд',
'logout' => 'Хуруҷ аз систем',
'wiki_userlogout' => 'Хуруҷ аз систем',
...
'wiki_userexists' => 'Номи корбарии дохил кардашуда мавриди истифода аст.
...
'nosuchwiki_user' => 'Корбаре бо номи "$1" вуҷуд надорад.
Амали номро барраси кунед, ё [[Special:wiki_userLogin/signup|ҳисоби ҷадидеро эҷод кунед]].',
'nosuchwiki_usershort' => 'Ягон корбаре бо номи "$1" вуҷуд надорад. Тарзи навишти номро санҷед.',
'nowiki_userspecified' => 'Шумо бояд як номи корбарӣ мушаххас кунед.',
'login-wiki_userblocked' => 'Ин корбар баста шудааст. Вуруд манъ аст.',
...
'wiki_usernamehasherror' => 'Номи корбарӣ наметавонад шомили аломатҳои дар ҳам бошад',
...
'passwordreset-wiki_username' => 'Номи корбарӣ',
...
'wiki_userpage-wiki_userdoesnotexist' => 'Ҳисоби корбар "<nowiki>$1</nowiki>" сабт нашудааст. Итминон ҳосил кунед ки мехоҳед ин саҳифаро эчод ё вироиш кунед.',
...
'wiki_usercssyoucanpreview' => "'''Эзоҳ:''' Пеш парвандаи CSS ё JS худро захира кунед, бо истифода аз тугмаи \"Пешнамоиш\" метавонед онро озмоиш кунед.",
'wiki_userjsyoucanpreview' => "'''Эзоҳ:''' Пеш парвандаи CSS ё JS худро захира кунед, бо истифода аз тугмаи \"Пешнамоиш\" метавонед онро озмоиш кунед.",
'wiki_usercsspreview' => "'''Фаромӯш накунед, ки шумо фақат CSS корбариатонро пешнамоиш карда истодааед ва он ҳанӯз захира нашудааст!'''",
'wiki_userjspreview' => "'''Фаромӯш накунед, ки шумо фақат ҶаваСкрипти корбариатонро имтиҳон,пешнамоиш карда истодаед ва он ҳанӯз захира нашудааст!'''",
'wiki_userinvalidcssjstitle' => "'''Ҳушдор:'''Пӯсте бо номи \"\$1\" вуҷуд надорад. Таваҷҷӯҳ кунед ки саҳифаҳои .css ва .js бо ҳарфҳои хурд навишта мешаванд, Намуна. {{ns:wiki_user}}:Фу/vector.css дар муқобили корбар {{ns:wiki_user}}:Фу/Vector.css.",
'updated' => '(Ба рӯз шуда)',
'note' => "'''Эзоҳ:'''",
...
Шумо метавонед бозгашта саҳифаи мавҷудбударо вироиш кунед, ё [[Special:wiki_userLogin|ба систем вуруд кунед ё ҳисоби корбарӣ эҷод кунед]].',
...
'undo-summary' => 'Ботили нусхаи $1 аз тарафи [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Баҳс]])',

# Account creation failure
'cantcreateaccounttitle' => 'Ҳисобе сохта наметавонам',
'cantcreateaccount-text' => "Имкони сохтани ҳисоби корбарӣ аз ин нишонаи IP ('''$1''') аз тарафи [[wiki_user:$3|$3]] баста шудааст.
...
'rev-deleted-wiki_user' => '(номи корбар ҳазф шудааст)',
...
'revdelete-hide-wiki_user' => 'Номи корбар/нишонаи IP пинҳон шавад',
...
'prefsnologintext' => 'Барои танзими тарҷиҳоти корбарӣ бояд [[Special:wiki_userLogin|вуруд ба систем шавед]].',
...
# wiki_user rights
'wiki_userrights' => 'Мудирияти ихтиёроти корбарӣ',
'wiki_userrights-lookup-wiki_user' => 'Мудирияти гурӯҳҳои корбарӣ',
'wiki_userrights-wiki_user-editname' => 'Номи корбарро дохил кунед:',
'editwiki_usergroup' => 'Гуруҳҳои корбарро вироиш кунед',
'editingwiki_user' => "Дар ҳоли вироиши корбар '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Вироиши гурӯҳҳои корбарӣ',
'savewiki_usergroups' => 'Сабти гурӯҳҳои корбарӣ',
'wiki_userrights-groupsmember' => 'Аъзои:',
'wiki_userrights-groups-help' => 'Шумо метавонед гурӯҳҳое, ки корбар дар он қарор доштаро тағйир диҳед.
...
'wiki_userrights-reason' => 'Сабаб:',
'wiki_userrights-no-interwiki' => 'Шумо иҷозати тағйири ихтиёроти корбарони дигар викиҳоро надоред.',
'wiki_userrights-nodatabase' => 'Пойгоҳи дода $1 вуҷуд надорад ё маҳаллӣ нест.',
'wiki_userrights-nologin' => 'Шумо бояд бо як ҳисоби корбарӣ дорои ихтиёроти мудириятӣ [[Special:wiki_userLogin|ба систем вуруд кунед]], то битавонед ихтиёроти корбаронро таъйид кунед.',
'wiki_userrights-notallowed' => 'Ҳисоби корбарии шумо иҷозати тағйири ихтиёроти корбариро надорад.',
'wiki_userrights-changeable-col' => 'Гурӯҳҳое, ки шумо метавонед тағйир диҳед',
'wiki_userrights-unchangeable-col' => 'Гурӯҳҳое, ки шумо наметавонед тағйир диҳед',

# Groups
'group' => 'Гурӯҳ:',
'group-wiki_user' => 'Корбарон',
...
'grouppage-wiki_user' => '{{ns:project}}:Корбарон',
...
'right-hidewiki_user' => 'Бастани корбар, бо пинҳон кардани он аз омма',
'right-editprotected' => 'Вироиши саҳифаҳои ҳифзшуда (бидуни ҳифзи обшорӣ)',
'right-editinterface' => 'Вироиши намоиши корбарӣ',
'right-editwiki_usercssjs' => 'Вироиши парвандаҳои CSS ва JS дигар корбарон',
'right-editwiki_usercss' => 'Вироиши парвандаҳои CSS дигар корбарон',
'right-editwiki_userjs' => 'Вироиши парвандаҳои JS дигар корбарон',
...
'right-wiki_userrights' => 'Вироиши ҳамаи ихтиёроти корбарон',
'right-wiki_userrights-interwiki' => 'Вироиши ихтиёроти корбарии корбарони дигар викиҳо',
...
'newpageletter' => 'Нав',
'boteditletter' => 'б',
'number_of_watching_wiki_users_pageview' => '[$1 пайгирикунанда {{PLURAL:$1|корбар|корбарон}}]',
...
'uploadnologintext' => 'Барои фиристодани файлҳо Шумо бояд [[Special:wiki_userLogin|вуруд кунед]].',
...
'statistics-header-wiki_users' => 'Омори корбарон',
'statistics-articles' => 'Саҳифаҳои мӯҳтаво',
'statistics-pages' => 'Саҳифаҳо',
'statistics-files' => 'Парвандаҳои боршуда',
'statistics-wiki_users' => '[[Special:Listwiki_users|Корбарони]] сабтиномшуда',
'statistics-wiki_users-active' => 'Корбарони фаъол',
...
'listwiki_users' => 'Рӯйхати корбарон',
'newpages' => 'Саҳифаҳои нав',
'newpages-wiki_username' => 'Номи корбар:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Корбар:',
...
'listwiki_usersfrom' => 'Намоиши корбарон бо шурӯъ аз:',
'listwiki_users-submit' => 'Нишон додани',
'listwiki_users-noresult' => 'Ҳеҷ корбаре ёфт нашуд.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Гузориши эҷоди корбар',
'newwiki_userlogpagetext' => 'Ин гузориш аз номҳои корбарии тозасохташуда аст.',
...
'mailnologintext' => 'Барои фиристодани почтаи электронӣ барои корбарони дигар бояд [[Special:wiki_userLogin|ба систем ворид шавед]] ва нишонаи почтаи электронии мӯътабар дар [[Special:Preferences|тарҷиҳоти]] худ дошта бошед.',
'emailwiki_user' => 'Фиристодани email ба ин корбар',
...
'wiki_usermailererror' => 'Почтаи электрони ба хатое дучор шуд:',
...
'watchnologintext' => 'Барои тағйири феҳристи пайгириҳои худ бояд [[Special:wiki_userLogin|ба систем ворид шавед]].',
...
'alreadyrolled' => 'Охирин вироиши [[:$1]] аз тарафи [[wiki_user:$2|$2]] ([[wiki_user talk:$2|Баҳс]]) наметавон вогардонӣ кард; пеш аз ин шахси дигаре мақоларо вироиш ё вогардонӣ кардааст.

Охирин вироиш аз тарафи [[wiki_user:$3|$3]] ([[wiki_user talk:$3|Баҳс]]) буд.',
'editcomment' => "Хулосаи вироиш ин буд: \"''\$1''\".",
'revertpage' => 'Вироиши [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Баҳс]]) вогардонида шуд ба охирин тағйире, ки [[wiki_user:$1|$1]] анҷом дода буд',
...
'sp-contributions-wiki_userrights' => 'Мудирияти ихтиёроти корбарӣ',
'sp-contributions-search' => 'Ҷустуҷӯи ҳиссагузориҳо',
'sp-contributions-wiki_username' => 'IP нишона ё номи корбар:',
...
'ipadressorwiki_username' => 'IP нишона ё номи корбар:',
'ipbexpiry' => 'Хотима:',
'ipbreason' => 'Сабаб:',
...
'unblocked' => 'Дастрасии [[wiki_user:$1|$1]] боз карда шуд',
...
'autoblocker' => 'Ба таври худкор нишонаи IP-и шумо баста шуда чун аз тарафи "[[wiki_user:$1|$1]]" истифод шуда буд, ки нишонааш бо шумо як аст. Далели бастан $1 чунини аст: "$2"',
...
'movenologintext' => 'Барои кӯчонидани саҳифа шумо бояд корбари сабтшуда ва [[Special:wiki_userLogin|ба систем вурудшуда]] бошед.',
...
'cant-move-wiki_user-page' => 'Шумо иҷозат надоред саҳифаҳои корбарии саршохаро интиқол диҳед.',
'cant-move-to-wiki_user-page' => 'Шумо иҷозат надоред, ки як саҳифаро ба як саҳифаи корбар диҳед (ба истиснои зерсаҳифаҳои корбарӣ)',
...
'tooltip-pt-wiki_userpage' => 'Саҳифаи корбарии шумо',
'tooltip-pt-anonwiki_userpage' => 'Саҳифаи корбари IP, ки бо он шумо вироиш мекунед',
...
'tooltip-t-emailwiki_user' => 'Фиристодани почтаи электронӣ ба ин корбар',
...
'tooltip-ca-nstab-wiki_user' => 'Намоиши саҳифаи корбар',
...
'sitewiki_user' => 'Википедиа wiki_user $1',
...
'others' => 'дигарон',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|корбар|корбарон}} $1',
...
'spambot_wiki_username' => 'Спамтозакуни МедиаВики',
...
'exif-wiki_usercomment' => 'Тавзеҳоти корбар',
...
'confirmrecreate' => "Корбар [[wiki_user:$1|$1]] ([[wiki_user talk:$1|баҳс]]) ин мақоларо пас аз он ки огоз ба вироиши он намудаед бо далели зерин ҳазф кардааст:
: ''$2''
...
'newwiki_userlog-byemail' => 'калимаи убур ба почтаи электронӣ фиристода шуд',
