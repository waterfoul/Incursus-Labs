...
'views' => 'Көрүүшкүннери',
'toolbox' => 'Херекселдер',
'wiki_userpage' => 'Ажыглакчының арынын көөрү',
...
'nstab-main' => 'Арын',
'nstab-wiki_user' => 'Ажыглакчының арыны',
...
'wiki_userlogin' => 'Кирери / бүрүткел бижикти чогаадыры',
'wiki_userloginnocreate' => 'Кирери',
'logout' => 'Үнери',
'wiki_userlogout' => 'Үнери',
'notloggedin' => 'Кирбес',
...
'passwordreset-wiki_username' => 'Aжыглакчының ады:',
...
'newarticle' => '(Чаа)',
'wiki_userpage-wiki_userdoesnotexist' => '«<nowiki>$1</nowiki>» деп ажыглакчы is not registered.
Please check if you want to create/edit this page.',
'wiki_userpage-wiki_userdoesnotexist-view' => '«$1» деп ажыглакчы not registered.',
'note' => "'''Тайылбыр:'''",
...
'rev-deleted-wiki_user' => '(ажыглакчының адын ап каан)',
...
'revdelete-hide-wiki_user' => 'Чогаалчының адын/ИП-адресин чажырар',
...
'wiki_username' => 'Aжыглакчының ады:',
...
# wiki_user rights
'editwiki_usergroup' => 'Ажыглакчының бөлгүмнерни өскертири',
'editingwiki_user' => "Changing wiki_user rights of wiki_user '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]]{{int:pipe-separator}}[[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Ажыглакчының бөлгүмнерни өскертири',
'savewiki_usergroups' => 'Ажыглакчының бөлгүмнерни шыгжаары',
'wiki_userrights-reason' => 'Чылдагаан:',

# Groups
'group' => 'Бөлгүм:',
'group-wiki_user' => 'Ажыглакчылар',
'group-bot' => 'Роботтар',
...
'group-wiki_user-member' => 'ажыглакчы',
...
'grouppage-wiki_user' => '{{ns:project}}:Ажыглакчылар',
...
'right-editwiki_usercssjs' => 'Өске ажыглакчыларның CSS база Javascript файлдарын өскертири.',
'right-editwiki_usercss' => 'Өске ажыглакчыларның CSS файлдарын өскертири.',
'right-editwiki_userjs' => 'Өске ажыглакчыларның JavaScript файлдарын өскертири.',
...
'newpageletter' => 'Ч',
'boteditletter' => 'р',
'number_of_watching_wiki_users_pageview' => '[$1 хайгаараар {{PLURAL:$1|ажыглакчы}}]',
...
'listwiki_users' => 'Ажыглакчылар даңзызы',
'wiki_usereditcount' => '$1 {{PLURAL:$1|эдилге}}',
'wiki_usercreated' => '$1 хүнде $2 {{GENDER:$3|бүрүткенип алган}}',
'newpages' => 'Чаа арыннар',
'newpages-wiki_username' => 'Ажыглакчының ады:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Күүседикчи:',
...
'listwiki_users-submit' => 'Көргүзери',

# Special:Activewiki_users
'activewiki_users-hidebots' => 'Роботтарны чажырары',
'activewiki_users-hidesysops' => 'Эргелекчыларны чажырары',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Чаа ажыглакчы кырында журнал',
...
# E-mail wiki_user
'emailwiki_user' => 'Бо ажыглакчыга э-чагааны чорудаары',
'defemailsubject' => '{{grammar:ablative|{{SITENAME}}}} э-чагаа',
'emailwiki_usernamesubmit' => 'Күүcедири',
'emailfrom' => 'Кымдан:',
'emailto' => 'Кымга:',
...
'protect-default' => 'Allow all wiki_users',
...
'sp-contributions-wiki_username' => 'ИП-адрес азы ажыглачының ады:',
...
'ipadressorwiki_username' => 'ИП-адрес азы aжыглaкчының aды',
'ipbreason' => 'Чылдагаан:',
...
'tooltip-pt-wiki_userpage' => 'Силерниң ажыглакчы арыныңнар',
...
'tooltip-t-emailwiki_user' => 'Бо ажыглакчыга э-чагааны чорудаары',
...
'tooltip-ca-nstab-wiki_user' => 'Ажыглакчының арынын көөрү',
...
'exif-wiki_usercomment' => 'Ажыглакчының тайылбырлары',
