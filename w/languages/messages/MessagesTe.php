...
$specialPageAliases = array(
	...
	'Emailwiki_user'                 => array( 'వాడుకరికిఈమెయిలుచెయ్యి' ),
	'Export'                    => array( 'ఎగుమతి' ),
	...
	'Listwiki_users'                 => array( 'వాడుకరులజాబితా' ),
	...
	'wiki_userlogin'                 => array( 'వాడుకరిప్రవేశం' ),
	'wiki_userlogout'                => array( 'వాడుకరినిష్క్రమణ' ),
	'wiki_userrights'                => array( 'వాడుకరిహక్కులు' ),
...
'tog-enotifwiki_usertalkpages' => 'నా చర్చా పేజీలో మార్పులు జరిగినపుడు నాకు ఈ-మెయిలు పంపించు',
...
'wiki_userpage' => 'వాడుకరి పేజీని చూడండి',
...
'youhavenewmessagesfromwiki_users' => 'మీకు {{PLURAL:$3|మరో వాడుకరి|$3 వాడుకరుల}} నుండి $1 ($2).',
'youhavenewmessagesmanywiki_users' => 'మీకు చాలా వాడుకరుల నుండి $1 ($2).',
...
ఈ URLను సూచిస్తూ, దీన్ని ఓ [[Special:Listwiki_users/sysop|నిర్వాహకునికి]] తెలియజెయ్యండి.',
...
'titleprotected' => "సభ్యులు [[wiki_user:$1|$1]] ఈ పేజీని సృష్టించనివ్వకుండా నిరోదిస్తున్నారు.
...
మీరు {{SITENAME}}ని అజ్ఞాతంగా వాడుతూండొచ్చు, లేదా ఇదే వాడుకరిగా కానీ లేదా వేరే వాడుకరిగా కానీ [[Special:wiki_userLogin|మళ్ళీ ప్రవేశించవచ్చు]].
...
'wiki_userlogin' => 'ప్రవేశించండి / ఖాతాను సృష్టించుకోండి',
'wiki_userloginnocreate' => 'ప్రవేశించండి',
'logout' => 'నిష్క్రమించు',
'wiki_userlogout' => 'నిష్క్రమించు',
...
'wiki_userlogin-resetlink' => 'మీ ప్రవేశ వివరాలను మరచిపోయారా?',
...
'wiki_userexists' => 'ఇచ్చిన వాడుకరిపేరు ఇప్పటికే వాడుకలో ఉంది.
...
'nosuchwiki_user' => '"$1" అనే పేరుతో వాడుకరులు లేరు.
వాడుకరి పేర్లు కేస్ సెన్సిటివ్.
అక్షరక్రమం సరిచూసుకోండి, లేదా [[Special:wiki_userLogin/signup|కొత్త ఖాతా సృష్టించుకోండి]].',
'nosuchwiki_usershort' => '"$1" అనే పేరుతో సభ్యులు లేరు. పేరు సరి చూసుకోండి.',
'nowiki_userspecified' => 'సభ్యనామాన్ని తప్పనిసరిగా ఎంచుకోవాలి.',
'login-wiki_userblocked' => 'ఈ వాడుకరిని నిరోధించారు. ప్రవేశానికి అనుమతి లేదు.',
...
'wiki_usernamehasherror' => 'వాడుకరిపేరులో హాష్ అక్షరాలు ఉండకూడదు',
...
'suspicious-wiki_userlogout' => 'సరిగా పనిచేయని విహారిణి లేదా కాషింగ్ ప్రాక్సీ వల్ల పంపబడడం చేత, నిష్క్రమించాలనే మీ అభ్యర్థనని నిరాకరించారు.',

# E-mail sending
'php-mail-error-unknown' => 'PHP యొక్క mail() ఫంక్షన్‍లో ఏదో తెలియని లోపం దొర్లింది',
'wiki_user-mail-no-addy' => 'ఈ-మెయిలు చిరునామాని ఇవ్వకుండానే ఈ-మెయిలు పంపడానికి ప్రయత్నించారు.',
...
'passwordreset-wiki_username' => 'వాడుకరి పేరు:',
...
'passwordreset-emailtext-wiki_user' => '{{SITENAME}} లోని వాడుకరి $1, {{SITENAME}} ($4) లోని మీ ఖాతా వివరాలను చెప్పమంటూ అడిగారు. కింది వాడుకరి {{PLURAL:$3|ఖాతా|ఖాతాలు}}
ఈ ఈమెయిలు అడ్రసుతో అనుసంధింపబడి ఉన్నాయి:
...
'accmailtext' => "[[wiki_user talk:$1|$1]] కొరకు ఒక యాదృచ్చిక సంకేతపదాన్ని $2కి పంపించాం.
...
'wiki_userpage-wiki_userdoesnotexist' => '"<nowiki>$1</nowiki>" అనే వాడుకరి ఖాతా నమోదయిలేదు. మీరు ఈ పేజీని సృష్టించ/సరిదిద్దాలనుకుంటే, సరిచూసుకోండి.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'వాడుకరి ఖాతా "$1" నమోదుకాలేదు.',
...
'wiki_usercssyoucanpreview' => "'''చిట్కా:''' భద్రపరిచేముందు మీ కొత్త CSSని పరీక్షించడానికి \"{{int:showpreview}}\" అనే బొత్తాన్ని వాడండి.",
'wiki_userjsyoucanpreview' => "'''చిట్కా:''' భద్రపరిచేముందు మీ కొత్త జావాస్క్రిప్టుని పరీక్షించడానికి \"{{int:showpreview}}\" అనే బొత్తాన్ని వాడండి.",
'wiki_usercsspreview' => "'''మీరు వాడుకరి CSSను కేవలం సరిచూస్తున్నారని గుర్తుంచుకోండి.'''
'''దాన్నింకా భద్రపరచలేదు!'''",
'wiki_userjspreview' => "'''గుర్తుంచుకోండి, మీరింకా మీ వాడుకరి జావాస్క్రిప్ట్&zwnj;ను భద్రపరచలేదు, కేవలం పరీక్షిస్తున్నారు/సరిచూస్తున్నారు!'''",
...
'''దీన్నింకా భద్రపరచలేదు!'''",
'wiki_userinvalidcssjstitle' => "'''హెచ్చరిక:''' \"\$1\" అనే అలంకారం లేదు.
అభిమత .css మరియు .js పుటల శీర్షికలు ఇంగ్లీషు చిన్నబడి అక్షరాల లోనే ఉండాలని గుర్తుంచుకోండి, ఉదాహరణకు ఇలా {{ns:wiki_user}}:Foo/vector.css అంతేగానీ, {{ns:wiki_user}}:Foo/Vector.css ఇలా కాదు.",
...
అయినా పని జరక్కపోతే, ఓసారి [[Special:wiki_userLogout|నిష్క్రమించి]] మళ్ళీ లోనికి ప్రవేశించి ప్రయత్నించండి.",
...
మీరు వెనక్కి వెళ్ళి వేరే పేజీలు మార్చవచ్చు, లేదా [[Special:wiki_userLogin|లోనికి ప్రవేశించండి లేదా ఖాతా సృష్టించుకోండి]].',
...
'undo-summary' => '[[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|చర్చ]]) దిద్దుబాటు చేసిన కూర్పు $1 ను రద్దు చేసారు',

# Account creation failure
'cantcreateaccounttitle' => 'ఈ ఖాతా తెరవలేము',
'cantcreateaccount-text' => "ఈ ఐపీ అడ్రసు ('''$1''') నుండి ఖాతా సృష్టించడాన్ని [[wiki_user:$3|$3]] నిరోధించారు.
...
'rev-deleted-wiki_user' => '(వాడుకరి పేరుని తొలగించారు)',
'rev-deleted-event' => '(దినచర్యని తొలగించాం)',
'rev-deleted-wiki_user-contribs' => '[వాడుకరిపేరు లేదా ఐపీ చిరునామాని తొలగించారు  - మార్పుచేర్పుల నుండి మార్పుని దాచారు]',
...
'revdelete-hide-wiki_user' => 'దిద్దుబాటు చేసినవారి సభ్యనామాన్ని/ఐపీని దాచు',
...
'diff-multi-manywiki_users' => '$2 మంది పైన ({{PLURAL:$2|ఒక వాడుకరి|వాడుకరుల}} యొక్క {{PLURAL:$1|ఒక మధ్యంతర కూర్పును|$1 మధ్యంతర కూర్పులను}} చూపించట్లేదు)',
...
'prefsnologintext' => 'వాడుకరి అభిరుచులను మార్చుకోడానికి, మీరు <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} లోనికి ప్రవేశించి]</span> ఉండాలి.',
...
'prefs-wiki_user-pages' => 'వాడుకరి పేజీలు',
...
# wiki_user rights
'wiki_userrights' => 'వాడుకరి హక్కుల నిర్వహణ',
'wiki_userrights-lookup-wiki_user' => 'వాడుకరి సమూహాలను సంభాళించండి',
'wiki_userrights-wiki_user-editname' => 'సభ్యనామాన్ని ఇవ్వండి:',
'editwiki_usergroup' => 'వాడుకరి గుంపులను మార్చు',
'editingwiki_user' => "వాడుకరి '''[[wiki_user:$1|$1]]''' $2 యొక్క వాడుకరి హక్కులను మారుస్తున్నారు",
'wiki_userrights-editwiki_usergroup' => 'వాడుకరి సమూహాలను మార్చండి',
'savewiki_usergroups' => 'వాడుకరి గుంపులను భద్రపరచు',
'wiki_userrights-groupsmember' => 'సభ్యులు:',
'wiki_userrights-groupsmember-auto' => 'సంభావిత సభ్యులు:',
'wiki_userrights-groups-help' => 'ఈ వాడుకరి ఏయే గుంపులలో ఉండవచ్చో మీరు మార్చవచ్చు.
...
'wiki_userrights-reason' => 'కారణం:',
'wiki_userrights-no-interwiki' => 'ఇతర వికీలలో వాడుకరి హక్కులను మార్చడానికి మీకు అనుమతి లేదు.',
'wiki_userrights-nodatabase' => '$1 అనే డేటాబేసు లేదు లేదా అది స్థానికం కాదు.',
'wiki_userrights-nologin' => 'వాడుకరి హక్కులను ఇవ్వడానికి మీరు తప్పనిసరిగా ఓ నిర్వాహక ఖాతాతో [[Special:wiki_userLogin|లోనికి ప్రవేశించాలి]].',
'wiki_userrights-notallowed' => 'వాడుకరి హక్కులను చేర్చే మరియు తొలగించే అనుమతి మీ ఖాతాకు లేదు.',
'wiki_userrights-changeable-col' => 'మీరు మార్చదగిన గుంపులు',
'wiki_userrights-unchangeable-col' => 'మీరు మార్చలేని గుంపులు',

# Groups
'group' => 'గుంపు:',
'group-wiki_user' => 'వాడుకరులు',
...
'group-wiki_user-member' => '{{GENDER:$1|వాడుకరి}}',
...
'grouppage-wiki_user' => '{{ns:project}}:వాడుకరులు',
...
'right-move-rootwiki_userpages' => 'వాడుకరుల ప్రధాన పేజీలను తరలించగలగడం',
...
'right-hidewiki_user' => 'ప్రజలకు కనబడకుండా చేసి, సభ్యనామాన్ని నిరోధించు',
...
'right-editwiki_usercssjs' => 'ఇతర వాడుకరుల CSS, JS ఫైళ్ళలో దిద్దుబాటు చెయ్యి',
'right-editwiki_usercss' => 'ఇతర వాడుకరుల CSS ఫైళ్ళలో దిద్దుబాటు చెయ్యి',
'right-editwiki_userjs' => 'ఇతర వాడుకరుల JS ఫైళ్ళలో దిద్దుబాటు చెయ్యి',
...
'right-wiki_userrights' => 'వాడుకరులందరి హక్కులను మార్చు',
'right-wiki_userrights-interwiki' => 'ఇతర వికీల్లోని వాడుకరుల హక్కులను మార్చు',
...
'action-move-rootwiki_userpages' => 'ప్రధాన వాడుకరి పేజీలని తరలించగడగడం',
...
'action-wiki_userrights' => 'అందరు వాడుకరుల హక్కులను మార్చే',
'action-wiki_userrights-interwiki' => 'ఇతర వికీలలో వాడుకరుల యొక్క హక్కులను మార్చే',
...
'newpageletter' => 'కొ',
'boteditletter' => 'బా',
'number_of_watching_wiki_users_pageview' => '[వీక్షిస్తున్న సభ్యులు: {{PLURAL:$1|ఒక్కరు|$1}}]',
...
'uploadnologintext' => 'ఫైలు అప్‌లోడు చెయ్యాలంటే, మీరు [[Special:wiki_userLogin|లాగిన్‌]] కావాలి',
...
'upload-file-error-text' => 'సర్వరులో తాత్కాలిక ఫైలును సృష్టించబోగా ఏదో అంతర్గత లోపం తలెత్తింది. ఎవరైనా [[Special:Listwiki_users/sysop|నిర్వాహకుడిని]] సంప్రదించండి.',
...
'statistics-header-wiki_users' => 'వాడుకరులు',
...
'statistics-wiki_users' => 'నమోదైన [[Special:Listwiki_users|వాడుకర్లు]]',
'statistics-wiki_users-active' => 'క్రియాశీల వాడుకర్లు',
'statistics-wiki_users-active-desc' => 'గత {{PLURAL:$1|రోజు|$1 రోజుల}}లో ఒక్క చర్యైనా చేసిన వాడుకరులు',
...
'listwiki_users' => 'వాడుకరుల జాబితా',
'listwiki_users-editsonly' => 'మార్పులు చేసిన వాడుకరులను మాత్రమే చూపించు',
'listwiki_users-creationsort' => 'చేరిన తేదీ క్రమంలో చూపించు',
'wiki_usereditcount' => '$1 {{PLURAL:$1|మార్పు|మార్పులు}}',
'wiki_usercreated' => '$1 న $2కి {{GENDER:$3|చేరారు}}',
'newpages' => 'కొత్త పేజీలు',
'newpages-wiki_username' => 'వాడుకరి పేరు:',
...
'listwiki_usersfrom' => 'వాడుకరులను ఇక్కడ నుండి చూపించు:',
'listwiki_users-submit' => 'చూపించు',
'listwiki_users-noresult' => 'వాడుకరి దొరకలేదు.',
'listwiki_users-blocked' => '(నిరోధించారు)',

# Special:Activewiki_users
'activewiki_users' => 'క్రియాశీల వాడుకరుల జాబితా',
'activewiki_users-intro' => 'ఇది గత $1 {{PLURAL:$1|రోజులో|రోజులలో}} ఏదైనా కార్యకలాపం చేసిన వాడుకరుల జాబితా.',
'activewiki_users-count' => 'గడచిన {{PLURAL:$3|ఒక రోజు|$3 రోజుల}}లో $1 {{PLURAL:$1|మార్పు|మార్పులు}}',
'activewiki_users-from' => 'వాడుకరులను ఇక్కడ నుండి చూపించు:',
'activewiki_users-hidebots' => 'బాట్లను దాచు',
'activewiki_users-hidesysops' => 'నిర్వాహకులను దాచు',
'activewiki_users-noresult' => 'వాడుకరులెవరూ లేరు.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'కొత్త వాడుకరుల చిట్టా',
'newwiki_userlogpagetext' => 'ఇది వాడుకరి నమోదుల చిట్టా.',
...
'mailnologintext' => 'ఇతరులకు ఈ-మెయిలు పంపించాలంటే, మీరు [[Special:wiki_userLogin|లాగిన్‌]] అయి ఉండాలి, మరియు మీ [[Special:Preferences|అభిరుచుల]]లో సరైన ఈ-మెయిలు చిరునామా ఇచ్చి ఉండాలి.',
'emailwiki_user' => 'ఈ వాడుకరికి ఈ-మెయిలుని పంపించండి',
'emailwiki_user-title-target' => 'ఈ {{GENDER:$1|వాడుకరికి}} ఈమెయిలు పంపించండి',
'emailwiki_user-title-notarget' => 'ఈ-మెయిలు వాడుకరి',
...
'wiki_usermailererror' => 'మెయిలు ఆబ్జెక్టు ఈ లోపాన్ని చూపింది:',
'defemailsubject' => 'వాడుకరి "$1" నుండి {{SITENAME}} ఈ-మెయిలు',
'wiki_usermaildisabled' => 'వాడుకరి ఈ-మెయిళ్ళు అచేతనం చేసారు',
'wiki_usermaildisabledtext' => 'ఈ వికీలో మీరు ఇతర వాడుకరులకి ఈ-మెయిళ్ళని పంపించలేరు',
...
'emailwiki_username' => 'వాడుకరి పేరు:',
'emailwiki_usernamesubmit' => 'దాఖలుచెయ్యి',
...
'emailwiki_userfooter' => 'ఈ ఈ-మెయిలుని $2 కి {{SITENAME}} లోని "వాడుకరికి ఈమెయిలు" అనే సౌలభ్యం ద్వారా $1 పంపించారు.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'వ్యవస్థ సందేశాన్ని వదిలివేస్తున్నాం.',
'wiki_usermessage-editor' => 'వ్యవస్థ సందేశకులు',
...
'watchnologintext' => 'మీ వీక్షణ జాబితాను మార్చడానికి మీరు [[Special:wiki_userLogin|లాగిన్‌]] అయి ఉండాలి.',
...
'alreadyrolled' => '[[:$1]]లో [[wiki_user:$2|$2]] ([[wiki_user talk:$2|చర్చ]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]) చేసిన చివరి మార్పును రద్దు చెయ్యలేము;
మరెవరో ఆ పేజీని వెనక్కి మళ్ళించారు, లేదా మార్చారు.

చివరి మార్పులు చేసినవారు: [[wiki_user:$3|$3]] ([[wiki_user talk:$3|చర్చ]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "దిద్దుబాటు సారాశం: \"''\$1''\".",
'revertpage' => '[[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|చర్చ]]) చేసిన మార్పులను [[wiki_user:$1|$1]] యొక్క చివరి కూర్పు వరకు తిప్పికొట్టారు.',
'revertpage-nowiki_user' => '(తొలగించిన వాడుకరిపేరు) చేసిన మార్పులను [[wiki_user:$1|$1]] యొక్క చివరి కూర్పుకి తిప్పికొట్టారు',
...
'sp-contributions-wiki_userrights' => 'వాడుకరి హక్కుల నిర్వహణ',
...
'sp-contributions-wiki_username' => 'ఐపీ చిరునామా లేదా వాడుకరిపేరు:',
...
'ipadressorwiki_username' => 'ఐపీ చిరునామా లేదా వాడుకరిపేరు:',
...
'ipbwatchwiki_user' => 'ఈ సభ్యుని సభ్యుని పేజీ, చర్చాపేజీలను వీక్షణలో ఉంచు',
'ipb-disablewiki_usertalk' => 'నిరోధంలో ఉండగా ఈ వాడుకరి తన స్వంత చర్చ పేజీలో మార్పుచేర్పులు చెయ్యకుండా నిరోధించు',
...
'unblocked' => '[[wiki_user:$1|$1]]పై నిరోధం తొలగించబడింది',
...
'blocklist-wiki_userblocks' => 'ఖాతా నిరోధాలను దాచు',
...
'blocklist-nowiki_usertalk' => 'తమ చర్చాపేజీని మార్చలేరు',
...
'autoblocker' => 'మీ ఐ.పీ. అడ్రసును "[[wiki_user:$1|$1]]" ఇటీవల వాడుట చేత, అది ఆటోమాటిక్‌గా నిరోధించబడినది. $1ను నిరోధించడానికి కారణం: "\'\'\'$2\'\'\'"',
...
'block-log-flags-nowiki_usertalk' => 'తమ చర్చాపేజీని మార్చలేరు',
...
'unblock-hidewiki_user' => 'ఈ వాడుకరి యొక్క వాడుకరిపేరు దాచబడి ఉంది కాబట్టి, వారిపై నిరోధాన్ని తీసెయ్యలేరు.',
...
'cant-see-hidden-wiki_user' => 'మీరు నిరోధించదలచిన వాడుకరి ఇప్పటికే నిరోధించబడి, దాచబడి ఉన్నారు. మీకు హక్కు లేదు కాబట్టి, ఆ వాడుకరి నిరోధాన్ని చూడటంగానీ, దాన్ని మార్చడంగానీ చెయ్యలేరు.',
...
'movewiki_userpage-warning' => "'''హెచ్చరిక:''' మీరు ఒక వాడుకరి పేజీని తరలించబోతున్నారు. పేజీ మాత్రమే తరలించబడుతుందనీ, వాడుకరి పేరుమార్పు జరగదనీ గమనించండి.",
'movenologin' => 'లాగిన్‌ అయిలేరు',
'movenologintext' => 'పేజీని తరలించడానికి మీరు [[Special:wiki_userLogin|లాగిన్‌]] అయిఉండాలి.',
'movenotallowed' => 'పేజీలను తరలించడానికి మీకు అనుమతి లేదు.',
'movenotallowedfile' => 'మీకు ఫైళ్ళను తరలించే అనుమతి లేదు.',
'cant-move-wiki_user-page' => 'వాడుకరి పేజీలను (ఉపపేజీలు కానివాటిని) తరలించే అనుమతి మీకు లేదు .',
'cant-move-to-wiki_user-page' => 'మీకు ఒక పేజీని వాడుకరి పేజీగా (వాడుకరి ఉపపేజీగా తప్ప) తరలించే అనుమతి లేదు.',
...
'tooltip-pt-wiki_userpage' => 'మీ వాడుకరి పేజీ',
'tooltip-pt-anonwiki_userpage' => 'మీ ఐపీ చిరునామాకి సంబంధించిన వాడుకరి పేజీ',
...
'tooltip-t-emailwiki_user' => 'ఈ వాడుకరికి ఓ ఈమెయిలు పంపండి',
...
'tooltip-ca-nstab-wiki_user' => 'వాడుకరి పేజీని చూడండి',
...
'sitewiki_user' => '{{SITENAME}} వాడుకరి $1',
'anonwiki_user' => '{{SITENAME}} అజ్ఞాత వాడుకరి $1',
'lastmodifiedatby' => 'ఈ పేజీకి $3 $2, $1న చివరి మార్పు చేసారు.',
'othercontribs' => '$1 యొక్క కృతిపై ఆధారితం.',
'others' => 'ఇతరాలు',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|వాడుకరి|వాడుకరులు}} $1',
'anonwiki_users' => '{{SITENAME}} అజ్ఞాత {{PLURAL:$2|వాడుకరి|వాడుకరులు}} $1',
...
'spambot_wiki_username' => 'మీడియావికీ స్పాము శుద్ధి',
...
'exif-wiki_usercomment' => 'వాడుకరి వ్యాఖ్యలు',
...
ఇక [[Special:wiki_userLogin|లోనికి ప్రవేశించి]] వికీని అస్వాదించండి.',
...
'confirmrecreate' => "మీరు పేజీ రాయటం మొదలుపెట్టిన తరువాత [[wiki_user:$1|$1]] ([[wiki_user talk:$1|చర్చ]]) దానిని తీసివేసారు. దానికి ఈ కారణం ఇచ్చారు: ''$2''
మీరు ఈ పేజీని మళ్ళీ తయారు చేయాలనుకుంటున్నారని ధృవీకరించండి.",
'confirmrecreate-noreason' => 'మీరు మార్చడం మొదలుపెట్టిన తర్వాత ఈ పుటను వాడుకరి [[wiki_user:$1|$1]] ([[wiki_user talk:$1|చర్చ]]) తొలగించారు. ఈ పుటను మీరు నిజంగానే పునఃసృష్టించాలనుకుంటున్నారని నిర్ధారించండి.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|చర్చ]])',
...
'specialpages-group-wiki_users' => 'వాడుకర్లు మరియు హక్కులు',
...
'logentry-newwiki_users-newwiki_users' => '$1 వాడుకరి ఖాతాను సృష్టించారు',
'logentry-newwiki_users-create' => '$1 ఒక వాడుకరి ఖాతాను సృష్టించారు',
'logentry-newwiki_users-create2' => '$1  వాడుకరి ఖాతా $3ను సృష్టించారు',
'logentry-newwiki_users-autocreate' => '$1 ఖాతాను ఆటోమెటిగ్గా సృష్టించారు',
'newwiki_userlog-byemail' => 'ఈ-మెయిలులో సంకేతపదం పంపించాం',
