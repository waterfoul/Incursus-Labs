...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Актівны_хоснователї' ),
	...
	'Emailwiki_user'                 => array( 'Писмо_хоснователёви' ),
	...
	'Listwiki_users'                 => array( 'Список_хоснователїв' ),
...
'tog-enotifwiki_usertalkpages' => 'Послати електронічну пошту при змінї моёй діскузной сторінкы',
...
'views' => 'Перегляды',
'toolbox' => 'Інштрументы',
'wiki_userpage' => 'Посмотрити сторінку хоснователя',
...
'youhavenewmessagesfromwiki_users' => 'Мате $1 од {{PLURAL:$3|іншого хоснователя|$3 іншых хоснователїв}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Мате $1 од много далшых хоснователїв ($2).',
...
'nstab-main' => 'Сторінка',
'nstab-wiki_user' => 'Сторінка хоснователя',
...
Просиме Вас, оголоште то [[Special:Listwiki_users/sysop|адміністраторам]], придайте і URL.',
...
'titleprotected' => "Створїня сторінкы з таков назвов было заборонене хоснователём [[wiki_user:$1|$1]] з причінов: ''$2''.",
...
Можете продовжовати в анонімнім перезераню і едітації {{grammar:2sg|{{SITENAME}}}}, або ся можете [[Special:wiki_userLogin|зясь приголосити]] як тот самый або як іншый хоснователь. Даякы сторінкы ся можуть зображовати як кібы сьте были дотеперь приголошены, покы не змажете кеш переглядача.",
...
'wiki_userlogin' => 'Приголошіня / створїня конта',
'wiki_userloginnocreate' => 'Приголошіня',
'logout' => 'Одголосити',
'wiki_userlogout' => 'Одголошіня',
...
'wiki_userlogin-resetlink' => 'Забыли сьте вашы даны на приголошіня?',
'createaccountmail' => 'електроничнов поштов',
'createaccountreason' => 'Причіна:',
'badretype' => 'Вами написаны гесла не сугласять.',
'wiki_userexists' => 'Уведжене імя хоснователя ся уж хоснує.
...
'nosuchwiki_user' => 'Не екзістує хоснователь з меном «$1». У хосновательскых мен ся розлишують малы/великы писмена. Сконтролюйте запис, або собі [[Special:wiki_userLogin/signup|зареґіструйте нове конто]].',
'nosuchwiki_usershort' => 'Хоснователь з меном $1 не екзістує.
Перевірте правилность написаня мена.',
'nowiki_userspecified' => 'Мусите задати мено хоснователя.',
'login-wiki_userblocked' => 'Тот хоснователь є заблокованый. Приголошіня не є дозволене.',
...
'wiki_usernamehasherror' => 'Мено хоснователя не сміє обсяговати сімбол мережка (#)',
...
'suspicious-wiki_userlogout' => 'Ваша пожадавка на одголошіня была одвергнута, бо вызерає то так, же была послана розбитым переглядачом або кешуючім проксі-сервером.',

# E-mail sending
'php-mail-error-unknown' => 'Незнама хыба у PHP mail() функції',
'wiki_user-mail-no-addy' => 'Проба одослати електронічну пошту без імейловой адресы.',
...
'passwordreset-wiki_username' => 'Мено хоснователя:',
...
'passwordreset-emailtext-wiki_user' => '{{gender:$1|Хоснователь|Хоснователька|Хоснователь}} $1 {{grammar:2sg|{{SITENAME}}}} {{gender:$1|попросив|попросила|попросив}} о припомянутя інформацій ку вашому
...
'accmailtext' => 'Трафунково выґенероване гесло про хоснователя [[wiki_user talk:$1|$1]] было послане на $2.
...
'wiki_userpage-wiki_userdoesnotexist' => 'Хосновательске конто під назвов  "<nowiki>$1</nowiki>" не є реґістроване. Сконтролюйте ці хочете вытворити/едітовати тоту сторінку.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Хосновательске конто „$1 не є реґістроване.',
...
'wiki_usercssyoucanpreview' => "'''Тіп:''' Хоснуйте ґомбічку „{{int:showpreview}}“ про тестованя вашого нового CSS перед уложінём.",
'wiki_userjsyoucanpreview' => "'''Тіп:''' Хоснуйте ґомбічку „{{int:showpreview}}“ про тестованя вашого нового коду JavaScript перед уложінём.",
'wiki_usercsspreview' => "'''Памятайте, же собі перезерате лем нагляд вашого хосновательского CSS.'''
'''Іщі не было уложено!'''",
'wiki_userjspreview' => "'''Памятайте, же тестуєте а перезерате лем нагляд вашого хосновательского JavaScript-у, іщі не быв уложеный!'''",
...
'''Іщі не быв уложеный!'''",
'wiki_userinvalidcssjstitle' => "'''Увага:''' Тема взгляду „$1“ не екзістує. Не забудьте, же хосновательске .css і .js файлы хоснують малы писмена, наприклад {{ns:wiki_user}}:{{BASEPAGENAME}}/vector.css, а не {{ns:wiki_user}}:{{BASEPAGENAME}}/Vector.css.",
...
Кідь ся тот проблем буде повторити, спробуйте ся [[Special:wiki_userLogout|одголосити]] і знову приголосити до сістемы.'''",
...
'''Кідь іде о рядну едітацію, спробуйте то знову. Кідь ся тот проблем буде повторити, спробуйте ся [[Special:wiki_userLogout|одголосити]] і знову приголосити до сістемы.'''",
...
Можете ся вернути і едітовати уж екзістуючу сторінку, або [[Special:wiki_userLogin|ся приголосити ці ся реґістровати]].',
...
'undo-summary' => 'Зрушена верзія $1 од хоснователя [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|діскузія]])',

# Account creation failure
'cantcreateaccounttitle' => 'Не є можне вытворити конто',
'cantcreateaccount-text' => "Створёваня новых конт з той IP адресы ('''$1''') было заблоковане хоснователём [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(імя автора стерто)',
'rev-deleted-event' => '(лоґ одстраненый)',
'rev-deleted-wiki_user-contribs' => '[мено хоснователя або IP адреса одстранене – едітованя є в приспевках сховане]',
...
'revdelete-hide-wiki_user' => 'Сховату мено автора/IP-адресу',
...
'diff-multi-manywiki_users' => '(Не є зображено $1 міджілеглых верзій од веце як $2 {{PLURAL:$2|хоснователя|хоснователїв}}.)',
...
'prefsnologintext' => 'Кідь хочете мінити хосновательскы наставлїня, мусите ся <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} приголосити]</span>.',
...
'prefs-wiki_user-pages' => 'Сторінкы хоснователя',
...
'wiki_username' => 'Мено хоснователя:',
...
# wiki_user rights
'wiki_userrights' => 'Справа хосновательскых ґруп',
'wiki_userrights-lookup-wiki_user' => 'Управовати хосновательскы ґрупы',
'wiki_userrights-wiki_user-editname' => 'Задайте мено хоснователя:',
'editwiki_usergroup' => 'Едітовати хосновательскы ґрупы',
'editingwiki_user' => "Зміна прав хоснователя '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Змінити ґрупы хоснователя',
'savewiki_usergroups' => 'Уложыти хосновательскы ґрупы',
'wiki_userrights-groupsmember' => 'Член ґруп:',
'wiki_userrights-groupsmember-auto' => 'Автоматічный  член ґруп:',
'wiki_userrights-groups-help' => 'Можете мінити ґрупы, до котрых належыть хоснователь:
...
'wiki_userrights-reason' => 'Причіна:',
'wiki_userrights-no-interwiki' => 'Не маєте поволїня мінити права хоснователїв на іншых вікі.',
'wiki_userrights-nodatabase' => 'Датабаза $1 не екзістує або не є місцёва.',
'wiki_userrights-nologin' => 'Мусите ся [[Special:wiki_userLogin|приголосити]] на конто адміністратора, жебы сьте могли мінити права хоснователїв.',
'wiki_userrights-notallowed' => 'Ваше конто не має права придати або одстранити хосновательскы права.',
'wiki_userrights-changeable-col' => 'Ґрупы, котры можете змінити',
'wiki_userrights-unchangeable-col' => 'Ґрупы, котры не можете змінити',

# Groups
'group' => 'Ґрупа:',
'group-wiki_user' => 'Хоснователї',
...
'group-wiki_user-member' => '{{GENDER:$1|хоснователь|хоснователька|хоснователь}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Хоснователї',
...
'right-move-rootwiki_userpages' => 'Переменованя корінёвых сторінок хоснователїв',
...
'right-hidewiki_user' => 'Блокованя мена хоснователя і ёго схованя',
...
'right-editwiki_usercssjs' => 'Едітованя CSS і JS файлів іншых хоснователїв',
'right-editwiki_usercss' => 'Едітованя CSS файлів іншых хоснователїв',
'right-editwiki_userjs' => 'Едітованя JS файлів іншых хоснователїв',
...
'right-wiki_userrights' => 'Зміна вшыткых прав остатнім хоснователям',
'right-wiki_userrights-interwiki' => 'Зміна прав хоснователям на іншых вікі',
...
'action-move-rootwiki_userpages' => 'переменовати корінёвы сторінкы хостователїв',
...
'action-wiki_userrights' => 'Зміна прав вшыткым хоснователям',
'action-wiki_userrights-interwiki' => 'зміна прав хоснователїв на іншых вікі',
...
'newpageletter' => 'Н',
'boteditletter' => 'б',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|слїдуючій хоснователь|слїдуючі хоснователї|слїдуючіх хоснователїв}}]',
...
'uploadnologintext' => 'Жебы наладовати файл, мусите ся [[Special:wiki_userLogin|приголосити]].',
...
Просиме контактуйте  [[Special:Listwiki_users/sysop|адміністратора]].',
'upload-misc-error' => 'Незнама хыба',
'upload-misc-error-text' => 'Незнана хыба ся трафила під час наладованя файлу. Перевірте ці є  URL правилна і приступна і спробуйте то знову. Кідь ся хыба обявить знову, контактуйте [[Special:Listwiki_users/sysop|адміністратора]]. сістемы.',
...
'listfiles_wiki_user' => 'Хоснователь',
...
'filehist-wiki_user' => 'Хоснователь',
...
'statistics-header-wiki_users' => 'Штатістіка хоснователїв',
...
'statistics-wiki_users' => 'Реґістрованы [[Special:Listwiki_users|хоснователї]]',
'statistics-wiki_users-active' => 'Актівны хоснователї',
'statistics-wiki_users-active-desc' => 'Хоснователї, котры в {{plural:$1|минулого дня|минулых  $1 днїв}} провели даяку операцію',
...
'listwiki_users' => 'Список хоснователїв',
'listwiki_users-editsonly' => 'Вказати лем хоснователїв з едітованями',
'listwiki_users-creationsort' => 'Сортовати за датумом створїня',
'wiki_usereditcount' => '$1 {{PLURAL:$1|едітованя|едітованя|едітовань}}',
'wiki_usercreated' => '{{GENDER:$3|Реґістрованый|Реґістрована|Реґістрованый(а)}} $1 в $2',
'newpages' => 'Новы сторінкы',
'newpages-wiki_username' => 'Мено хоснователя:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Супроводник:',
...
'listwiki_usersfrom' => 'Вказати хоснователїв, што ся зачінають на:',
'listwiki_users-submit' => 'Вказати',
'listwiki_users-noresult' => 'Ненайдженый жаден хоснователь.',
'listwiki_users-blocked' => '({{GENDER:$1|заблокованый|заблокована|заблокованый}})',

# Special:Activewiki_users
'activewiki_users' => 'Список актівных хоснователїв',
'activewiki_users-intro' => 'Тото є список хоснователїв, котры были даяк актівны за {{plural:$1|остатнїй день|остатных $1 днїв}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|едітованя|едітованя|едітовань}} бігом {{PLURAL:$3|остатнёго дня|остатнїх  $3 днїв}}',
'activewiki_users-from' => 'Вказати хоснователїв, што ся зачінають на:',
'activewiki_users-hidebots' => 'Сховати ботів',
'activewiki_users-hidesysops' => 'Сховати адміністраторів',
'activewiki_users-noresult' => 'Ненайдженый жаден хоснователь.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Лоґ вытварянь хоснователїв',
'newwiki_userlogpagetext' => 'Тото є список ново реґістрованых хоснователїв.',
...
'mailnologintext' => 'Кідь хочете посылати ел. пошту іншым хоснователям, мусите ся [[Special:wiki_userLogin|приголосити]] і мати платну адресу ел. пошты в своїм [[Special:Preferences|наставлїню]].',
'emailwiki_user' => 'Послати імейл тому хоснователёви',
'emailwiki_user-title-target' => 'Загнати імейл {{GENDER:$1|тому хоснователёви|тій хосновательцї}}',
'emailwiki_user-title-notarget' => 'Загнати імейл хоснователёви',
...
'wiki_usermailererror' => 'Хыба поштового проґраму:',
'defemailsubject' => '{{SITENAME}}: лист од "$1"',
'wiki_usermaildisabled' => 'Посыланя ел. пошты є выпнуте',
'wiki_usermaildisabledtext' => 'Не маєте право одосылати ел. пошту іншым хоснователям той вікі',
...
'emailwiki_username' => 'Імя хоснователя:',
'emailwiki_usernamesubmit' => 'Одослати',
...
'emailwiki_userfooter' => 'Тота ел. пошта была послана з {{grammar:2sg|{{SITENAME}}}} за помочі функції „Послати ел, пошту“; одослав го хоснователь $1 хоснователёви $2',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Зохабити сістемове повідомлїня',
'wiki_usermessage-editor' => 'Сістемовый вістник',
...
'watchnologintext' => 'Про слїдованя сторінок ся мусите [[Special:wiki_userLogin|приголосити]].',
...
'alreadyrolled' => 'Не годен вернути послїднє едітованя [[:$1]] од хоснователя [[wiki_user:$2|$2]] ([[wiki_user talk:$2|діскузія]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]), бо дахто друхый уже сторінку едітовав або вернув тоту зміну назад.

Остатнє едітованя провив(а) [[wiki_user:$3|$3]] ([[wiki_user talk:$3|діскузуя]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Згорнутя едітованя было: ''„$1“''.",
'revertpage' => 'Едітованя хоснователя „[[Special:Contributions/$2|$2]]“ ([[wiki_user talk:$2|діскузія]]) вернуты до минулого ставу, котрого автором є „[[wiki_user:$1|$1]]“',
'revertpage-nowiki_user' => 'Едітованя хоснователя (мено хоснователя є сховане) вернуты до минулого ставу, котрого автором є „[[wiki_user:$1|$1]]“',
...
'sp-contributions-wiki_userrights' => 'Справа хосновательскых прав',
...
'sp-contributions-wiki_username' => 'IP-адреса або імя хоснователя:',
...
'ipadressorwiki_username' => 'IP-адреса або мено хоснователя:',
'ipbexpiry' => 'Кінчіть:',
'ipbreason' => 'Причіна:',
...
'ipbwatchwiki_user' => 'Слїдовати хосновательску і діскузну сторінку того хоснователя',
'ipb-disablewiki_usertalk' => 'Заборонити тому хоснователёви едітовати властну хосновательску діскузію по час блокованя',
...
'ipb-confirmhidewiki_user' => 'Рыхтуєте ся заблоковати хоснователя зо запнутов вольбов "сховати імя хоснователя". То запрічінить же імя хоснователя счезне зо вшыткых списків і протоколёвачіх записів.  Сьте собі {{gender:|певный|певна|певны}}, же хочете тото зробити?',
...
'unblocked' => '[[wiki_user:$1|$1]] одблокованый',
...
'blocklist-wiki_userblocks' => 'Сховати заблокованы конта',
...
'blocklist-nowiki_usertalk' => 'не може едітовати властну сторінку діскузії',
...
'autoblocker' => 'Сьте были автоматічно блокованы, протоже здїляте IP-адресу з хоснователём „[[wiki_user:$1|$1]]“. Причіна блокованя того хоснователя: „$2“',
...
'block-log-flags-nowiki_usertalk' => 'не може едітовати властну сторінку діскузії',
...
'unblock-hidewiki_user' => 'Того хоснователя не можете одблоковати, бо ёго імя хоснователя было сховане.',
...
'cant-see-hidden-wiki_user' => 'Хоснователь, котрого хочете заблоковати, уж быв заблокованый і схованый. Кідьже не маєте права hidewiki_user, не можете собі наставлїня блокованя того хоснователя посмотрити ани го змінити.',
...
'movewiki_userpage-warning' => "'''Увага:''' Рихтуєте ся переменовати сторінку хоснователя. Усвідомте собі, же буде переменована лем тота сторінка, а хоснователь  ''не буде'' переменованый.",
'movenologin' => 'Не сьте приголошеный(а)!',
'movenologintext' => 'Про переменованя сторінок ся мусите [[Special:wiki_userLogin|приголосити]].',
'movenotallowed' => 'Не маєте права переменовати сторінкы.',
'movenotallowedfile' => 'Не маєте права переменовати файлы.',
'cant-move-wiki_user-page' => 'Не маєте права переменовати сторінкы хоснователїв.',
'cant-move-to-wiki_user-page' => 'Не маєте права переменовати сторінку на сторінку хоснователя (окрем підсторінкы сторінкы хоснователя)',
'newtitle' => 'Нова назва:',
...
'tooltip-pt-wiki_userpage' => 'Ваша сторінка хоснователя',
'tooltip-pt-anonwiki_userpage' => 'Сторінка хоснователя про IP-адресу, з котрой едітуєте',
...
'tooltip-t-emailwiki_user' => 'Послати імейл тому хоснователёви',
...
'tooltip-ca-nstab-wiki_user' => 'Видїти сторінку хоснователя',
...
'sitewiki_user' => 'хоснователь {{grammar:2sg|{{SITENAME}}}} $1',
'anonwiki_user' => 'анонімный хоснователь {{grammar:2sg|{{SITENAME}}}} $1',
'lastmodifiedatby' => 'Остатня зміна $2, $1 хоснователём $3.',
'othercontribs' => 'На базї роботы $1.',
'others' => 'іншы',
'sitewiki_users' => '{{PLURAL:$2|Хоснователь|Хоснователї}} {{grammar:genitive|{{SITENAME}}}} $1',
'anonwiki_users' => '{{PLURAL:$2|анонімный хоснователь|анонімны хоснователї}} {{grammar:genitive|{{SITENAME}}}} $1',
...
'spambot_wiki_username' => 'MediaWiki очістка спаму',
...
'pageinfo-firstwiki_user' => 'Заснователь сторінкы',
'pageinfo-firsttime' => 'Дата створїня сторінкы',
'pageinfo-lastwiki_user' => 'Остатнїй редактор',
...
'exif-wiki_usercomment' => 'Додатковый коментарь',
...
'confirmemail_success' => 'Ваша адреса ел. пошты была потверджена. Нынї ся можете [[Special:wiki_userLogin|приголосити]] і хосновати вікі.',
...
'confirmrecreate' => 'Хоснователь [[wiki_user:$1|$1]] ([[wiki_user talk:$1|діскузія]]) тоту сторінку змазав потім, як сьте зачали едітовати з причінов:
: „$2“
Справды собі хочете знову тоту сторінку створити?',
'confirmrecreate-noreason' => 'Хоснователь [[wiki_user:$1|$1]] ([[wiki_user talk:$1|діскузія]]) тоту сторінку змазав потім, як сьте зачали едітовати з причінов.
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|діскузія]])',
...
'specialpages-group-wiki_users' => 'Хоснователї і права',
...
'logentry-newwiki_users-newwiki_users' => 'Створене хосновательске конто $1',
'logentry-newwiki_users-create' => 'Створене было хосновательске конто $1',
'logentry-newwiki_users-create2' => '$1 створив хосновательске конто $3',
'logentry-newwiki_users-autocreate' => 'Автоматічно было створене конто $1',
'newwiki_userlog-byemail' => 'гело послане електронічнов поштов',
