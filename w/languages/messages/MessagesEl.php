...
/**
  ...
  * with over 98% of the messages translated into wiki_user-friendly Greek.
  *
...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'ΕνεργοίΧρήστες' ),
	...
	'Emailwiki_user'                 => array( 'EmailΧρήστη' ),
	...
	'Listwiki_users'                 => array( 'ΚατάλογοςΧρηστών', 'ΧρήστεςΚατάλογος' ),
	...
	'wiki_userlogin'                 => array( 'ΣύνδεσηΧρήστη' ),
	'wiki_userlogout'                => array( 'ΑποσύνδεσηΧρήστη' ),
	'wiki_userrights'                => array( 'ΔικαιώματαΧρηστών' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'ΑΡΙΘΜΟΣΧΡΗΣΤΩΝ', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'ΕΝΕΡΓΟΙΧΡΗΣΤΕΣ', 'ΑΡΙΘΜΟΣΕΝΕΡΓΩΝΧΡΗΣΤΩΝ', 'NUMBEROFACTIVEUSERS' ),
...
'tog-enotifwiki_usertalkpages' => 'Να μου αποστέλλεται μήνυμα ηλεκτρονικού ταχυδρομείου όταν αλλάζει η προσωπική μου σελίδα συζήτησης χρήστη',
...
'wiki_userpage' => 'Εμφάνιση σελίδας χρήστη',
...
'youhavenewmessagesfromwiki_users' => 'Έχετε $1 από {{PLURAL:$3|ένα άλλο χρήστη|$3 χρήστες}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Έχετε $1 από πολλούς χρήστες ($2).',
...
Παρακαλούμε αναφέρετε το σε ένα [[Special:Listwiki_users/sysop|διαχειριστή]], δίνοντας το URL.',
...
'titleprotected' => "Αυτός ο τίτλος έχει προστατευθεί από την δημιουργία από τον [[wiki_user:$1|$1]].
...
Μπορείτε να παραμείνετε στο {{SITENAME}} ανώνυμα, ή μπορείτε [[Special:wiki_userLogin|να συνδεθείτε ξανά]] με το ίδιο ή με διαφορετικό (εάν έχετε) όνομα χρήστη.
...
'wiki_userlogin' => 'Δημιουργία Λογαριασμού/Είσοδος',
'wiki_userloginnocreate' => 'Είσοδος',
'logout' => 'Έξοδος',
'wiki_userlogout' => 'Έξοδος',
...
'wiki_userlogin-resetlink' => 'Ξεχάσατε τα στοιχεία σύνδεσής σας;',
'createaccountmail' => 'Με ηλεκτρονικό ταχυδρομείο',
'createaccountreason' => 'Αιτία:',
'badretype' => 'Οι κωδικοί που έχετε δηλώσει δεν συμφωνούν μεταξύ τους.',
'wiki_userexists' => 'Το όνομα χρήστη που εισαγάγατε βρίσκεται ήδη σε χρήση.
...
'nosuchwiki_user' => 'Δεν υπάρχει χρήστης με το όνομα "$1".
Τα ονόματα χρηστών είναι ευαίσθητα σε κεφαλαιογράμματη και μικρογράμματη γραφή.
Ελέγξτε την ορθογραφία ή [[Special:wiki_userLogin/signup|δημιουργήστε ένα νέο λογαριασμό]].',
'nosuchwiki_usershort' => 'Δεν υπάρχει χρήστης με το όνομα "$1". Παρακαλούμε ελέγξτε την ορθογραφία.',
'nowiki_userspecified' => 'Πρέπει να ορίσετε ένα όνομα χρήστη.',
'login-wiki_userblocked' => 'Αυτός ο χρήστης έχει αποκλειστεί. Δεν επιτρέπεται σύνδεση.',
...
'wiki_usernamehasherror' => 'Το όνομα χρήστη δεν μπορεί να περιέχει ειδικούς χαρακτήρες',
...
'suspicious-wiki_userlogout' => 'Το αίτημα αποσύνδεσής σας απερρίφθη επειδή φαίνεται ότι στάλθηκε από ένα λανθασμένο φυλλομετρητή (browser) ή διακομιστή προσωρινής αποθήκευσης.',

# E-mail sending
'php-mail-error-unknown' => 'Άγνωστο σφάλμα στη συνάρτηση mail() της PHP.',
'wiki_user-mail-no-addy' => 'Προσπαθήσατε να στείλετε e-mail χωρίς μια διεύθυνση e-mail.',
...
'passwordreset-wiki_username' => 'Όνομα χρήστη:',
...
'passwordreset-emailtext-wiki_user' => 'Ο χρήστης $1 στη {{SITENAME}} ζήτησε μια υπενθύμιση των λεπτομερειών του λογαριασμού σας σε {{SITENAME}} ($4).  {{PLURAL:$3|Ο ακόλουθος λογαριασμός|Οι ακόλουθοι λογαριασμοί}} χρήστη συνδέονται με αυτή τη διεύθυνση e-mail:
...
'accmailtext' => "Ο τυχαία παρηγμένος κωδικός για τον/την [[wiki_user talk:$1|$1]] έχει σταλεί στο $2.
...
'anontalkpagetext' => "----''Αυτή η σελίδα συζήτησης προορίζεται για ανώνυμο χρήστη που δεν έχει δημιουργήσει ακόμα λογαριασμό ή που δεν τον χρησιμοποιεί. Έτσι για την ταυτοποίηση ενός ανώνυμου χρήστη χρησιμοποιείται η διεύθυνση IP του. Είναι όμως πιθανόν η διεύθυνση αυτή να είναι κοινή για πολλούς διαφορετικούς χρήστες.  Αν είστε ανώνυμος χρήστης και νομίζετε ότι άσχετα σχόλια απευθύνθηκαν σε σας, παρακαλούμε να [[Special:wiki_userLogin/signup|δημιουργήσετε ένα λογαριασμό]] ή να  [[Special:wiki_userLogin|συνδεθείτε]] για να αποφεύγεται η μελλοντική σύγχυση με άλλους ανώνυμους χρήστες.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Ο Λογαριασμός του χρήστη "<nowiki>$1</nowiki>" δεν είναι καταχωρημένος. Παρακαλώ δείτε αν θα θέλατε να δημιουργήσετε/επεξεργαστείτε αυτή τη σελίδα.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Ο λογαριασμός χρήστη "$1" δεν είναι εγγεγραμμένος.',
...
'wiki_usercssyoucanpreview' => "'''Χρήσιμη συμβουλή:''' Χρησιμοποιήστε το κουμπί \"{{int:showpreview}}\" για να ελέγξτε τα νέα σας CSS πριν τα αποθηκεύσετε.",
'wiki_userjsyoucanpreview' => "'''Χρήσιμη συμβουλή:''' Χρησιμοποιήστε το κουμπί \"{{int:showpreview}}\" για να ελέγξτε τη νέα σας JS πριν την αποθηκεύσετε.",
'wiki_usercsspreview' => "'''Σας υπενθυμίζουμε ότι κάνετε απλώς έλεγχο/προεπισκόπηση του CSS του χρήστη -δεν το έχετε ακόμα αποθηκεύσει! '''",
'wiki_userjspreview' => "'''Σας υπενθυμίζουμε ότι κάνετε απλώς έλεγχο/προεπισκόπηση του JavaScript του χρήστη -δεν το έχετε ακόμα αποθηκεύσει!'''",
...
'wiki_userinvalidcssjstitle' => "'''Προσοχή:''' Δεν υπάρχει skin με τίτλο \"\$1\". Θυμηθείτε οι προσαρμοσμένες σελίδες .css και .js χρησιμοποιούν έναν τίτλο με μικρά γράμματα, π.χ. {{ns:wiki_user}}:Foo/vector.css σε αντίθεση με το {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(Ενημερώθηκε)',
'note' => "'''Προσοχή: '''",
...
Μπορείτε να πάτε πίσω και να επεξεργαστείτε μια υπάρχουσα σελίδα, ή να [[Special:wiki_userLogin|συνδεθείτε ή να δημιουργήσετε ένα λογαριασμό]].',
...
'undo-summary' => 'Αναίρεση αναθεώρησης $1 υπό τον/την [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Συζήτηση]])',

# Account creation failure
'cantcreateaccounttitle' => 'Ο λογαριασμός δεν μπορεί να δημιουργηθεί',
'cantcreateaccount-text' => "Η δημιουργία λογαριασμού από αυτή τη διεύθυνση IP ('''$1''') έχει αποτραπεί από τον [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(όνομα χρήστη αφαιρέθηκε)',
'rev-deleted-event' => '(η καταγραφή στο αρχείο αφαιρέθηκε)',
'rev-deleted-wiki_user-contribs' => '[όνομα χρήστη ή διεύθυνση ΙΡ έχουν αφαιρεθεί - η επεξεργασία έχει αποκρυφθεί από τις συνεισφορές]',
...
'revdelete-hide-wiki_user' => 'Κρύψε όνομα χρήστη/IP συντάκτη',
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Μία ενδιάμεση αναθεώρηση|$1 ενδιάμεσες αναθεωρήσεις}} από περισσότερο από $2 {{PLURAL:$2|χρήστη|χρήστες}} δεν εμφανίζ{{PLURAL:$1|εται|ονται}})',
...
'prefsnologintext' => 'Πρέπει να έχετε <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} συνδεθεί]</span> για να καθορίσετε τις προτιμήσεις χρήστη.',
...
'prefs-wiki_user-pages' => 'Σελίδες του χρήστη',
...
# wiki_user rights
'wiki_userrights' => 'Διαχείριση δικαιωμάτων χρηστών',
'wiki_userrights-lookup-wiki_user' => 'Διαχείριση ομάδων χρηστών',
'wiki_userrights-wiki_user-editname' => 'Δηλώστε όνομα χρήστη:',
'editwiki_usergroup' => 'Επεξεργασία ομάδων χρηστών',
'editingwiki_user' => "Αλλαγή δικαιωμάτων χρήστη του χρήστη '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Επεξεργασία ομάδων χρηστών',
'savewiki_usergroups' => 'Αποθήκευση ομάδων χρηστών',
'wiki_userrights-groupsmember' => 'Μέλος της ομάδας:',
'wiki_userrights-groupsmember-auto' => 'Αυτονόητο μέλος του:',
'wiki_userrights-groups-help' => 'Μπορείτε να τροποποιήσετε τις ομάδες στις οποίες ανήκει αυτός ο χρήστης:
...
'wiki_userrights-reason' => 'Αιτία:',
'wiki_userrights-no-interwiki' => 'Δεν έχετε άδεια να επεξεργαστείτε τα δικαιώματα χρηστών σε άλλα wiki.',
'wiki_userrights-nodatabase' => 'Η βάση δεδομένων $1 δεν υπάρχει ή δεν είναι τοπική.',
'wiki_userrights-nologin' => 'Πρέπει να [[Special:wiki_userLogin|συνδεθείτε]] με έναν λογαριασμό διαχειριστή συστήματος ώστε να ορίσετε δικαιώματα χρηστών.',
'wiki_userrights-notallowed' => 'Ο λογαριασμός σας δεν έχει άδεια για να προσθέσει ή να αφαιρέσει  δικαιώματα χρηστών.',
'wiki_userrights-changeable-col' => 'Ομάδες που μπορείτε να αλλάξετε',
'wiki_userrights-unchangeable-col' => 'Ομάδες που δεν μπορείτε να αλλάξετε',
...
'group-wiki_user-member' => 'χρήστης',
...
'grouppage-wiki_user' => '{{ns:project}}:Χρήστες',
...
'right-move-rootwiki_userpages' => 'Μετακίνηση κεντρικών σελίδων χρηστών',
...
'right-hidewiki_user' => 'Φραγή ενός ονόματος χρήστη, αποκρύπτοντάς το από το κοινό',
...
'right-editwiki_usercssjs' => 'Μεταγραφή των αρχείων CSS και JS άλλων χρηστών',
'right-editwiki_usercss' => 'Μεταγραφή των αρχείων CSS άλλων χρηστών',
'right-editwiki_userjs' => 'Μεταγραφή των αρχείων JS άλλων χρηστών',
...
'right-wiki_userrights' => 'Τροποποίηση όλων των δικαιωμάτων χρηστών',
'right-wiki_userrights-interwiki' => 'Τροποποίηση δικαιωμάτων χρηστών σε άλλα wiki',
...
'action-move-rootwiki_userpages' => 'να μετακινήσετε κεντρικές σελίδες χρηστών',
...
'action-wiki_userrights' => 'να επεξεργαστείτε όλα τα δικαιώματα χρηστών',
'action-wiki_userrights-interwiki' => 'επεξεργαστείτε τα δικαιώματα χρηστών σε άλλα wiki',
...
'newpageletter' => 'Ν',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|χρήστης|χρήστες}} παρακολουθούν]',
...
'uploadnologintext' => 'Για να φορτώσετε αρχεία πρέπει πρώτα να [[Special:wiki_userLogin|συνδεθείτε]].',
...
Παρακαλούμε επικοινωνήστε με έναν [[Special:Listwiki_users/sysop|διαχειριστή]] του συστήματος.',
...
Εάν το πρόβλημα παραμένει, επικοινωνήστε με έναν [[Special:Listwiki_users/sysop|διαχειριστή του συστήματος]].',
...
'statistics-header-wiki_users' => 'Στατιστικά χρηστών',
...
'statistics-wiki_users' => 'Εγγεγραμμένοι [[Special:Listwiki_users|χρήστες]]',
'statistics-wiki_users-active' => 'Ενεργοί χρήστες',
'statistics-wiki_users-active-desc' => 'Χρήστες που έχουν κάνει κάποια επεξεργασία μέσα σε {{PLURAL:$1|μέρα|$1 μέρες}}',
...
'listwiki_users' => 'Κατάλογος χρηστών',
'listwiki_users-editsonly' => 'Εμφάνιση μόνο των χρηστών με επεξεργασίες',
'listwiki_users-creationsort' => 'Ταξινόμηση κατά ημερομηνία δημιουργίας',
'wiki_usereditcount' => '$1 {{PLURAL:$1|επεξεργασία|επεξεργασίες}}',
'wiki_usercreated' => '{{GENDER:$3|Δημιουργήθηκε}} στις $1, $2',
'newpages' => 'Νέες σελίδες',
'newpages-wiki_username' => 'Όνομα χρήστη:',
...
'listwiki_usersfrom' => 'Προβολή χρηστών ξεκινώντας από:',
'listwiki_users-submit' => 'Δείξε',
'listwiki_users-noresult' => 'Δεν βρέθηκε χρήστης.',
'listwiki_users-blocked' => '(υπό φραγή)',

# Special:Activewiki_users
'activewiki_users' => 'Κατάλογος ενεργών χρηστών',
'activewiki_users-intro' => 'Αυτή είναι μια λίστα από χρήστες που είχαν κάποιου είδους δραστηριότητα {{PLURAL:$1|την τελευταία $1 μέρα|τις τελευταίες $1 μέρες}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|ενέργεια|ενέργειες}} τις τελευταίες {{PLURAL:$3|μέρα|$3 μέρες}}',
'activewiki_users-from' => 'Προβολή χρηστών ξεκινώντας από:',
'activewiki_users-hidebots' => 'Απόκρυψη bots',
'activewiki_users-hidesysops' => 'Απόκρυψη διαχειριστών',
'activewiki_users-noresult' => 'Δεν βρέθηκε χρήστης.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Αρχείο δημιουργίας χρηστών',
'newwiki_userlogpagetext' => 'Αυτή είναι μια καταγραφή δημιουργίας χρηστών.',
...
'mailnologintext' => 'Πρέπει να έχετε [[Special:wiki_userLogin|συνδεθεί]] και να έχετε δηλώσει
μια έγκυρη ηλεκτρονική διεύθυνση στις [[Special:Preferences|Προτιμήσεις]]
για να στείλετε e-mail σε άλλους χρήστες.',
'emailwiki_user' => 'Στείλτε μήνυμα σε αυτό τον χρήστη',
'emailwiki_user-title-target' => 'Αποστολή e-mail {{GENDER:$1|στο|στη}} χρήστη',
'emailwiki_user-title-notarget' => 'Αποστολή e-mail σε χρήστη',
...
'wiki_usermailererror' => 'Σφάλμα ηλεκτρονικού ταχυδρομείου:',
'defemailsubject' => '{{SITENAME}} e-mail από τον χρήστη "$1"',
'wiki_usermaildisabled' => 'To e-mail χρήστη είναι απενεργοποιημένο',
'wiki_usermaildisabledtext' => 'Είναι αδύνατη η αποστολή e-mail σε άλλους χρήστες σε αυτό το wiki',
...
'emailwiki_username' => 'Όνομα χρήστη:',
'emailwiki_usernamesubmit' => 'Υποβολή',
...
'emailwiki_userfooter' => 'Αυτό το ηλεκτρονικό μήνυμα στάλθηκε από τον/την "$1" στον τον/την "$2" μέσω της λειτουργίας "αποστολής μηνυμάτων" στο {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Φεύγετε από τις ειδοποιήσεις συστήματος.',
'wiki_usermessage-editor' => 'Μηνύματα συστήματος',
...
'watchnologintext' => 'Για να κάνετε αλλαγές στη λίστα παρακολούθησης πρέπει να [[Special:wiki_userLogin|συνδεθείτε]].',
...
'alreadyrolled' => 'Αδύνατον να αναιρεθεί η τελευταία αλλαγή της σελίδας [[:$1]] από το χρήστη ([[wiki_user:$2|$2]] ([[wiki_user talk:$2|Συζήτηση]]){{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]), διότι κάποιος έχει ήδη αναιρέσει την αλλαγή ή έχει αλλάξει εκ νέου τη σελίδα.

Τελευταία αλλαγή από το χρήστη ([[wiki_user:$3|$3]] ([[wiki_user talk:$3|Συζήτηση]]){{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Το σχόλιο της επεξεργασίας ήταν: \"''\$1''\".",
'revertpage' => 'Ανάκληση των αλλαγών $2 (επιστροφή στην προηγούμενη αναθεώρηση $1)',
'revertpage-nowiki_user' => 'Αναστράφηκαν οι επεξεργασίες από τον (όνομα χρήστη αφαιρέθηκε) στη τελευταία έκδοση από τον/την [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'διαχείριση δικαιωμάτων χρηστών',
...
'sp-contributions-wiki_username' => 'Διεύθυνση IP ή όνομα χρήστη:',
...
'ipadressorwiki_username' => 'Διεύθυνση IP ή όνομα χρήστη',
'ipbexpiry' => 'Λήξη',
'ipbreason' => 'Αιτία:',
...
'ipbwatchwiki_user' => "Παρακολούθηση των σελίδων 'χρήστη' και 'συζήτησης χρήστη' αυτού του χρήστη",
'ipb-disablewiki_usertalk' => 'Αποτρέψτε αυτό το χρήστη από την επεξεργασία της δική του σελίδας συζήτησης, ενώ είναι αποκλεισμένος',
...
'ipb-confirmhidewiki_user' => 'Είστε {{GENDER:|έτοιμος|έτοιμη}} να μπλοκάρετε ένα χρήστη με ενεργοποιημένη την "απόκρυψη χρήστη" . Αυτό θα καταστείλει το όνομα του χρήστη σε όλες τις λίστες και τις καταχωρήσεις ημερολογίου. Είστε {{GENDER:|σίγουρος|σίγουρη}} ότι θέλετε να το κάνετε αυτό;',
...
'unblocked' => 'Η φραγή για τον/την [[wiki_user:$1|$1]] έχει τερματιστεί',
...
'blocklist-wiki_userblocks' => 'Απόκρυψη φραγών λογαριασμού',
...
'blocklist-nowiki_usertalk' => 'δεν μπορούν να επεξεργαστούν τη σελίδα συζήτησής τους',
...
'autoblocker' => 'Έχετε υποστεί αυτόματα φραγή από το σύστημα επειδή χρησιμοποιείτε την ίδια διεύθυνση IP με το χρήστη "[[wiki_user:$1|$1]]". Η αιτιολογία για την φραγή του $1 είναι "$2".',
...
'block-log-flags-nowiki_usertalk' => 'δεν μπορεί να επεξεργαστεί τη σελίδα συζήτησής του',
...
'unblock-hidewiki_user' => 'Δεν μπορείτε να καταργήσετε τον αποκλεισμό αυτού του χρήστη, καθώς το όνομα χρήστη του έχει αποκρυβεί.',
...
'cant-see-hidden-wiki_user' => 'Ο χρήστης που προσπαθείτε να αποκλείσετε έχει ήδη αποκλειστεί και αποκρυφτεί.
Δεδομένου ότι δεν έχετε το δικαίωμα hidewiki_user, δεν μπορείτε να δείτε ή να επεξεργαστείτε την φραγή του χρήστη.',
...
'movewiki_userpage-warning' => "'''Προσοχή:''' Ετοιμάζεστε να μετακινήσετε μια σελίδα χρήστη. Σημειώστε παρακαλώ ότι θα μετακινηθεί μόνο η σελίδα και ο χρήστης '''δεν''' θα μετονομαστεί.",
'movenologin' => 'Δεν έχετε συνδεθεί.',
'movenologintext' => 'Για να μετακινήσετε μια σελίδα πρέπει να είστε εγγεγραμένος χρήστης και [[Special:wiki_userLogin|να έχετε συνδεθεί]] στο Wiκi.',
'movenotallowed' => 'Δεν έχετε άδεια να μετακινείτε σελίδες.',
'movenotallowedfile' => 'Δεν έχετε άδεια να μετακινείτε αρχεία.',
'cant-move-wiki_user-page' => 'Δεν έχετε άδεια για να μετακινήσετε σελίδες χρηστών (παρά μόνο υποσελίδες).',
'cant-move-to-wiki_user-page' => 'Δεν έχετε άδεια για να μετακινήσετε μια σελίδα σε σελίδα χρήστη (παρά μόνο σε υποσελίδα χρήστη).',
...
'tooltip-pt-wiki_userpage' => 'Η σελίδα χρήστη σας',
'tooltip-pt-anonwiki_userpage' => 'Η σελίδα χρήστη στον οποίο αντιστοιχεί η διεύθυνση IP που έχετε',
...
'tooltip-t-emailwiki_user' => 'Αποστολή μηνύματος σε αυτό το χρήστη',
...
'tooltip-ca-nstab-wiki_user' => 'Δείτε τη σελίδα του χρήστη',
...
'sitewiki_user' => '{{SITENAME}} χρήστης $1',
'anonwiki_user' => 'ανώνυμος χρήστης $1 του {{SITENAME}}',
...
'others' => 'άλλοι',
'sitewiki_users' => '{{SITENAME}} {{PLURAL:$2|χρηστή|χρηστών}} του ιστοχώρου $1',
'anonwiki_users' => '{{PLURAL:$2|ανώνυμος χρήστης|ανώνυμοι χρήστες}} $1 του {{SITENAME}}',
...
'spambot_wiki_username' => 'Καθαρισμός spam από το MediaWiki',
...
'pageinfo-firstwiki_user' => 'Δημιουργός της σελίδας',
'pageinfo-firsttime' => 'Ημερομηνία δημιουργίας της σελίδας',
'pageinfo-lastwiki_user' => 'Τελευταίος συντάκτης',
...
'exif-wiki_usercomment' => 'Σχόλια χρήστη',
...
'confirmrecreate' => "Ο χρήστης [[wiki_user:$1|$1]] ([[wiki_user talk:$1|συζήτηση]]) διέγραψε αυτή τη σελίδα αφότου ξεκινήσατε την επεξεργασία με αιτιολόγηση:
: ''$2''
Παρακαλώ επιβεβαιώστε ότι θέλετε πραγματικά να ξαναδημιουργήσετε αυτή τη σελίδα.",
'confirmrecreate-noreason' => 'Ο χρήστης [[wiki_user:$1|$1]] ([[wiki_user talk:$1|συζήτηση]]) διέγραψε αυτή τη σελίδα αφότου ξεκινήσατε την επεξεργασία.
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|συζήτηση]])',
...
'specialpages-group-wiki_users' => 'Χρήστες και δικαιώματα',
...
'logentry-newwiki_users-newwiki_users' => 'Ο λογαριασμός χρήστη $1 δημιουργήθηκε',
'logentry-newwiki_users-create' => 'Ο λογαριασμός χρήστη $1 δημιουργήθηκε',
'logentry-newwiki_users-create2' => 'Ο λογαριασμός χρήστη $3 δημιουργήθηκε από {{GENDER:$1|τον|την}} $1',
'logentry-newwiki_users-autocreate' => 'Ο λογαριασμός $1 δημιουργήθηκε αυτόματα',
'newwiki_userlog-byemail' => 'ο κωδικός έχει σταλεί μέσω ηλεκτρονικού μηνύματος',
