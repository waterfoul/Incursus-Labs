...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'UtentiAtivi' ),
	...
	'Emailwiki_user'                 => array( 'MandaEMail' ),
	...
	'Upload'                    => array( 'Carga' ),
	'wiki_userlogin'                 => array( 'Entra' ),
	'wiki_userlogout'                => array( 'VàFora' ),
	'wiki_userrights'                => array( 'ParmessiUtente' ),
...
'tog-enotifwiki_usertalkpages' => 'Avìseme par e-mail se i scrive su la me pagina de discussion',
...
'views' => 'Visite',
'toolbox' => 'Strumenti',
'wiki_userpage' => 'Varda la pagina utente',
...
'youhavenewmessagesfromwiki_users' => "Te ghè $1 da {{PLURAL:$3|n'altro utente|$3 utenti}} ($2).",
'youhavenewmessagesmanywiki_users' => 'Te ghè $1 da vari utenti ($2).',
...
Se prega de dìrghelo a un [[Special:Listwiki_users/sysop|aministradore]] indicando l\'URL en question.',
...
'titleprotected' => 'Ła creasion de na pajina con sto titoło xè sta blocà da [[wiki_user:$1|$1]].
...
Te poli 'ndar vanti doparando {{SITENAME}} come utente anonimo o se nò [[Special:wiki_userLogin|entrar da novo]], col stesso nome utente o uno difarente.
...
'wiki_userlogin' => 'Entra / Regìstrete',
...
'wiki_userlogin-resetlink' => "Desmentegà i to dati d'aceso?",
'createaccountmail' => 'Par e-mail',
'createaccountreason' => 'Motivassion:',
'badretype' => 'Le do password le xe difarenti.',
'wiki_userexists' => 'El nome utente inserido vien xa doparà da cualchedun altro.
...
'nosuchwiki_user' => 'Nol xè rejistrà alcun utente de nome "$1". I nomi utente i xè sensibiłi a łe majuscołe. Verifegare el nome inserio o [[Special:wiki_userLogin/signup|creare on novo aceso]].',
'nosuchwiki_usershort' => 'No ghe xe nissun utente de nome "$1". Sito sicuro che te lo ghè scrito ben?',
'nowiki_userspecified' => 'Te ghè da métar un nome utente.',
'login-wiki_userblocked' => 'Sta utensa xè blocà. No xè posibiłe efetuare el login.',
...
'wiki_usernamehasherror' => "El nome utente no'l pode contegner caràteri hash",
...
'suspicious-wiki_userlogout' => 'Ła to richiesta de disconesion xè sta negà parché e a senbra invià da on browser non funsionante o on proxy de caching.',

# E-mail sending
'php-mail-error-unknown' => "Erore sconosudo nte'l funsionamento deła posta ełetronega PHP",
'wiki_user-mail-no-addy' => 'Te ghe provà spedire un mesajo de posta ełetronega sensa un indiriso.',
...
'passwordreset-emailtext-wiki_user' => "El utente $1 da {{SITENAME}} (probabilmente ti steso) ga richiesto l'invio dei to detaji del profiło par {{SITENAME}} ($4). {{PLURAL:$3|El profiło utente asocià|I profiłi utenti asociadi}} a sto indiriso de posta ełetronega łi xe:
...
'accmailtext' => "Na password xenerà casualmente par [[wiki_user talk:$1|$1]] la xe stà mandà a $2.
...
Se te sì un utente anonimo e te ghè ricevù dei messagi che te secondo ti i gera par qualchedun altro, te podi [[Special:wiki_userLogin/signup|registrarte]] o [[Special:wiki_userLogin|entrar col to nome utente]] par evitar confusion con altri utenti anonimi in futuro.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'L\'account "<nowiki>$1</nowiki>" no\'l corisponde mìa a un utente registrà. Verifica se te voli dal bon crear o modificar sta pagina.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'L\'utensa "$1" no la xe gnancora registrà.',
...
'wiki_usercssyoucanpreview' => "'''Sugerimento:''' se consiglia de doparar el boton \"{{int:showpreview}} par proàr i novi CSS prima de salvarli.",
'wiki_userjsyoucanpreview' => "'''Sugerimento:''' se consiglia de doparar el boton \"{{int:showpreview}}\" par proàr i novi JavaScript prima de salvarli.",
'wiki_usercsspreview' => "'''Sta qua la xe solo n'anteprima del proprio CSS personal.
Le modifiche no le xe gnancora stà salvà!'''",
'wiki_userjspreview' => "'''Sta qua la xe solo n'anteprima par proar el proprio JavaScript personal; le modifiche no le xe gnancora stà salvà!'''",
...
'wiki_userinvalidcssjstitle' => "'''Ocio:'''  No ghe xe nissuna skin con nome \"\$1\". Nota che le pagine par i .css e .js personalizà le gà l'iniziale del titolo minuscola, par esenpio {{ns:wiki_user}}:Esenpio/vector.css e no {{ns:wiki_user}}:Esenpio/Vector.css.",
'updated' => '(Agiornà)',
'note' => "'''Nota:'''",
...
Se no funsiona gnancora, proa a [[Special:wiki_userLogout|scołegarte]] e a cołegarte de novo.'''",
...
Se no funsiona gnancora, te pol proár a [[Special:wiki_userLogout|scolegarte]] e efetuar da novo l'acesso.'''",
...
'nocreatetext' => 'La possibilità de crear pagine nóve su {{SITENAME}} la xe stà limità ai soli utenti registrà. Se pol tornar indrìo e modificar na pagina esistente, opure [[Special:wiki_userLogin|entrar o crear un nóvo acesso]].',
...
'undo-summary' => 'Anulà la modifica $1 de [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Discussion]] | [[Special:Contributions/$2|{{MediaWiki:Contribslink}}]])',

# Account creation failure
'cantcreateaccounttitle' => "Inpossibile registrar l'utente",
'cantcreateaccount-text' => "La creazion de account novi a partir da sto indirizo IP ('''$1''') la xe stà blocà da [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(nome utente cavà)',
'rev-deleted-event' => '(elemento cavà)',
'rev-deleted-wiki_user-contribs' => '[nome utente o indirisso IP cavà - modifica sconta dai contributi]',
...
'revdelete-hide-wiki_user' => "Scondi el nome o l'indirisso IP dell'autore",
...
'diff-multi-manywiki_users' => '({{PLURAL:$1|Una revision intermedia|$1 revision intermedie}} de pi de {{PLURAL:$2|un utente|$2 utenti}} mia mostrà)',
...
'prefsnologintext' => 'Te ghè da aver eseguìo el <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} login]</span> par poder personalixare le to preferense.',
...
'prefs-wiki_user-pages' => 'Pàjine utente',
...
# wiki_user rights
'wiki_userrights' => 'Gestion dei parmessi relativi ai utenti',
'wiki_userrights-lookup-wiki_user' => 'Gestion de i gruppi utente',
'wiki_userrights-wiki_user-editname' => 'Inserir el nome utente:',
'editwiki_usergroup' => 'Modifica grupi utente',
'editingwiki_user' => "Modifega dei diriti utente de'l utente '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Modifica grupi utente',
'savewiki_usergroups' => 'Salva grupi utente',
'wiki_userrights-groupsmember' => 'Apartien ai grupi:',
'wiki_userrights-groupsmember-auto' => 'Menbro implìcito de:',
'wiki_userrights-groups-help' => "Se pol modificar i grupi a cui l'utente l'è assegnà.
...
'wiki_userrights-reason' => 'Motivassion:',
'wiki_userrights-no-interwiki' => 'No te ghè i parmessi necessari par modificar i diriti dei utenti su altri siti.',
'wiki_userrights-nodatabase' => "El database $1 no l'esiste mìa o no l'è un database local.",
'wiki_userrights-nologin' => "Par assegnarghe diriti ai utenti te ghè da [[Special:wiki_userLogin|efetuar l'acesso]] come aministrador.",
'wiki_userrights-notallowed' => 'No te ghe i parmesi necesari par xontarghe o cavarghe diriti ai utenti.',
'wiki_userrights-changeable-col' => 'Grupi che te pol canbiar',
'wiki_userrights-unchangeable-col' => 'Grupi che no te pol canbiar',
...
'right-move-rootwiki_userpages' => 'Sposta le pàxene prinsipài dei utenti',
...
'right-hidewiki_user' => 'Bloca un nome utente, scondéndolo al publico',
...
'right-editwiki_usercssjs' => 'Modifica i file CSS e JS de altri utenti',
'right-editwiki_usercss' => 'Modifica i file CSS de altri utenti',
'right-editwiki_userjs' => 'Modifica i file JS de altri utenti',
...
'right-wiki_userrights' => "Modifica tuti quanti i diriti de l'utente",
'right-wiki_userrights-interwiki' => 'Modifica i diriti de utenti de altri siti wiki',
...
'action-move-rootwiki_userpages' => 'spostar le pàxene prinsipài dei utenti',
...
'action-wiki_userrights' => 'canbiar tuti i diriti dei utenti',
'action-wiki_userrights-interwiki' => 'canbiar i diriti dei utenti su altre wiki',
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[osservà da {{PLURAL:$1|un utente|$1 utenti}}]',
...
'uploadnologintext' => 'Te ghè da far [[Special:wiki_userLogin|el login]]
...
Par piaser, contatar un [[Special:Listwiki_users/sysop|aministrador]].',
...
Se el problema el persiste, contatar un [[Special:Listwiki_users/sysop|aministrador]].',
...
'statistics-header-wiki_users' => 'Statistiche dei utenti',
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Utenti]] registrà',
'statistics-wiki_users-active' => 'Utenti atìvi',
'statistics-wiki_users-active-desc' => "Utenti che gà fato almanco un'azion in {{PLURAL:$1|tel'ultimo zorno|in tei ultimi $1 zorni}}",
...
'listwiki_users' => 'Elenco dei utenti',
'listwiki_users-editsonly' => 'Fà védar sol che i utenti che gà fato dei contributi',
'listwiki_users-creationsort' => 'Òrdena par data de creassion',
'wiki_usereditcount' => '$1 {{PLURAL:$1|contributo|contributi}}',
'wiki_usercreated' => '{{GENDER:$3|Creà|Creà}} el $1 a le $2',
...
# Special:Log
'speciallogwiki_userlabel' => 'Asion efetuà da:',
...
'listwiki_usersfrom' => 'Mostra i utenti tacando da:',
'listwiki_users-submit' => 'Mostra',
'listwiki_users-noresult' => 'Nissun utente el risponde ai criteri inpostà.',
'listwiki_users-blocked' => '(blocà)',

# Special:Activewiki_users
'activewiki_users' => 'Lista dei utenti ativi',
'activewiki_users-intro' => 'Sta qua xe la lista dei utenti che ga fato calcossa {{PLURAL:$1|sto ultimo zorno|sti ultimi $1 zorni}}.',
'activewiki_users-count' => "$1 {{PLURAL:$1|asion}} {{PLURAL:$3|inte'l ultimo xorno|inte i ultimi $3 xorni}}",
'activewiki_users-from' => 'Fà védar i utenti a partir da:',
'activewiki_users-hidebots' => 'Scondi i bot',
'activewiki_users-hidesysops' => 'Scondi i aministradori',
'activewiki_users-noresult' => 'Nissun utente catà.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Novi utenti',
'newwiki_userlogpagetext' => 'Sto qua el xè el registro dei novi utenti registrai.',
...
'mailnologintext' => 'Par inviare messagi e-mail ad altri utenti bisogna [[Special:wiki_userLogin|acedere al sito]] e aver registrà un indirisso vałido ne łe proprie [[Special:Preferences|preferense]].',
'emailwiki_user' => 'Scrìveghe a sto utente',
'emailwiki_user-title-target' => 'Scrivi na e-mail a {{GENDER:$1|sto|sta}} utente',
'emailwiki_user-title-notarget' => "Scrivi na e-mail a l'utente",
...
'wiki_usermailererror' => "L'ogeto mail el gà restituìo l'eror:",
'defemailsubject' => 'Mesajo da {{SITENAME}} dal utente "$1"',
'wiki_usermaildisabled' => 'e-mail utente disabiłità',
'wiki_usermaildisabledtext' => 'No xè posibiłe inviare e-mail ad altri utenti so sto wiki',
...
'emailwiki_usernamesubmit' => 'Manda',
...
'emailwiki_userfooter' => 'Sta e-mail la xe stà mandà da $1 a $2 \'traverso la funsion "Manda na e-mail a l\'utente" su {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Messajo de sistema.',
'wiki_usermessage-editor' => 'Messagero de sistema',
...
'watchnologintext' => 'Te ghè prima da far el [[Special:wiki_userLogin|login]] par modificar la to lista de osservati speciali.',
...
'alreadyrolled' => "No xè mia possibile efetuar el ripristino de [[:$1]] da [[wiki_user:$2|$2]] ([[wiki_user talk:$2|discussion]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]); qualcun altro gà xà modificà o efetuà el ripristino de sta voxe.

L'ultima modefega l'è stà fata da [[wiki_user:$3|$3]] ([[wiki_user talk:$3|discussion]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).",
'editcomment' => "El comento a la modifica el xera: \"''\$1''\".",
'revertpage' => 'Anułàe łe modifeghe de [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|discussion]]), riportà a ła version de prima de [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Anulà le modìfeghe de (nome utente cavà), riportà a la version precedente de [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'gestion dei parmessi relativi ai utenti',
...
'sp-contributions-wiki_username' => 'Indirizo IP o nome utente:',
...
'ipadressorwiki_username' => 'Indirizo IP o nome utente',
'ipbexpiry' => 'Scadensa',
...
'ipbwatchwiki_user' => "Tien d'ocio la pagina utente e la pagina de discussion de sto utente",
'ipb-disablewiki_usertalk' => "Inpedissi a sto utente de modifegar la propia pajina de discussion mentre l'è blocà",
...
'ipb-confirmhidewiki_user' => 'Se sta par blocar un utente cò l\'opsion "Scondi utente" abiłità.
...
'unblocked' => '[[wiki_user:$1|$1]] el xe stà sblocà',
...
'blocklist-wiki_userblocks' => 'Scondi i blochi de i account',
...
'blocklist-nowiki_usertalk' => "no'l pol scrivar su la so pàxena de discussion",
...
'autoblocker' => 'Bloccà automaticamente parché el to indirisso IP el xè stà doparà de recente da "[[wiki_user:$1|$1]]". La motivassion del bloco de $1 la xe: "$2"',
'blocklogpage' => 'Blochi',
...
'block-log-flags-nowiki_usertalk' => "no'l pode scrìvar su la so pàxena de discussion",
...
'unblock-hidewiki_user' => "Nò te poi sblocar sto utente, parché el so nome utente 'l'è sta sconto.",
...
'cant-see-hidden-wiki_user' => "L'utente che te vol blocar el xe zà stà blocà e sconto. Sicome a no te ghè mia i diriti de hidewiki_user, no te pol mia védar o canbiar el bloco de l'utente.",
...
'movewiki_userpage-warning' => "'''Ocio:''' Te sì drio spostar na pagina utente. Par piaser tien conto che vegnarà spostà solo la pagina e l'utente no'l vegnarà ''mia'' rinominà.",
'movenologin' => 'No te ghè efetuà el login',
'movenologintext' => 'Te ghè da èssar un utente registrà ed aver efetuà el [[Special:wiki_userLogin|login]] par poder spostar na pàxena.',
...
'cant-move-wiki_user-page' => 'No se dispone dei parmessi necessari par spostar le pàxene utente.',
'cant-move-to-wiki_user-page' => 'No se dispone dei parmessi necessari par spostar la pàxena su na pàxena utente (ad ecezion de na sotopàxena utente).',
...
'tooltip-pt-wiki_userpage' => 'La to pagina utente',
'tooltip-pt-anonwiki_userpage' => 'La pàxena utente de sto indirizo IP',
...
'tooltip-t-emailwiki_user' => 'Invia on mesajo e-mail a sto utente',
...
'tooltip-ca-nstab-wiki_user' => 'Varda la pagina utente',
...
'sitewiki_user' => '$1, utente de {{SITENAME}}',
'anonwiki_user' => 'Utente anonimo $1 de {{SITENAME}}',
...
'others' => 'altri',
'sitewiki_users' => '$1, {{PLURAL:$2|utente|utenti}} de {{SITENAME}}',
'anonwiki_users' => '{{PLURAL:$2|Utente anonimo|Utenti anonimi}} $1 de {{SITENAME}}',
...
'spambot_wiki_username' => 'MediaWiki - sistema de rimozion del spam',
...
'pageinfo-firstwiki_user' => 'Creador de sta pagina',
'pageinfo-firsttime' => 'Data de creassion de la pagina',
'pageinfo-lastwiki_user' => 'Ultimo contribudor',
...
'exif-wiki_usercomment' => "Note de l'utente",
...
'confirmrecreate' => "L'utente [[wiki_user:$1|$1]] ([[wiki_user talk:$1|discussion]]) el ga scancełà sta voxe dopo che te ghè scuminsià a modificarla, con ła seguente motivazion:
: ''$2''
Par piaser, conferma che te vołi dal bon ricrear sta voxe.",
'confirmrecreate-noreason' => 'El utente [[wiki_user:$1|$1]] ([[wiki_user talk:$1|discussion]]) el ga scansełà sta voxe dopo che te ghè scuminsià a modifegarla.
Par piaser, conferma che te vołi dal bon ricrear sta voxe.',
'recreate' => 'Ricrea',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|msj]])',
...
'specialpages-group-wiki_users' => 'Utenti e diriti',
...
'logentry-newwiki_users-newwiki_users' => "L'utensa $1 xe sta creà",
'logentry-newwiki_users-create' => "L'utensa $1 xe sta creà",
'logentry-newwiki_users-create2' => "L'utensa $3 xe sta creà da $1",
'logentry-newwiki_users-autocreate' => "L'utensa $1 xè stà creà automategamente",
'newwiki_userlog-byemail' => 'password spedìa par e-mail',
