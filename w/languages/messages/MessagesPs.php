...
$specialPageAliases = array(
	...
	'Listwiki_users'                 => array( 'د_کارنانو_لړليک' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'دکارونکوشمېر', 'NUMBEROFUSERS' ),
...
'tog-enotifwiki_usertalkpages' => 'کله چې زما د خبرو اترو په مخ کې بدلون پېښېږي نو ما ته دې يو برېښليک ولېږلی شي.',
...
'youhavenewmessagesfromwiki_users' => 'تاسې د {{PLURAL:$3|يو بل کارن|$3 کارنانو}} لخوا $1 لرۍ ($2).',
'youhavenewmessagesmanywiki_users' => 'تاسې د يو شمېر کارنانو لخوا $1 لرۍ ($2).',
...
'wiki_userlogin' => 'ننوتل / ګڼون جوړول',
'wiki_userloginnocreate' => 'ننوتل',
'logout' => 'وتل',
'wiki_userlogout' => 'وتل',
...
'wiki_userlogin-resetlink' => 'د ننوتلو مالومات مو هېر شوي؟',
'createaccountmail' => 'د برېښليک له مخې',
'createaccountreason' => 'سبب:',
'badretype' => 'دا پټنوم چې تاسې ليکلی د مخکني پټنوم سره ورته نه دی.',
'wiki_userexists' => 'کوم کارن نوم چې تاسې ورکړی هغه بل چا کارولی.
...
'nosuchwiki_user' => 'د "$1" په نوم هېڅ کارن نشته.
د کارنانو نومونه د غټو او واړو تورو سره حساس دي.
خپل حجا وڅارۍ، او يا هم [[Special:wiki_userLogin/signup|يو نوی ګڼون جوړ کړی]].',
'nosuchwiki_usershort' => 'د "$1" په نوم هېڅ کوم ګڼون نشته. لطفاً خپل د نوم ليکلې بڼې ته ځير شی چې پکې تېروتنه نه وي.',
'nowiki_userspecified' => 'تاسې ځان ته کوم کارن نوم نه دی ځانګړی کړی.',
'login-wiki_userblocked' => 'په دې کارن بنديز لګېدلی. غونډال کې ننوتلو ته پرې نه ښودلی شو.',
...
'wiki_usernamehasherror' => 'کارن-نوم نشي کېدلای چې کرښکې لوښې ولري',
...
# E-mail sending
'wiki_user-mail-no-addy' => 'د يوې برېښليک پتې پرته د برېښليک لېږلو هڅه شوې.',
...
'passwordreset-wiki_username' => 'کارن-نوم:',
...
'wiki_userpage-wiki_userdoesnotexist' => 'د "<nowiki>$1</nowiki>" ګڼون نه دی ثبت شوی.
لطفاً ځان ډاډه کړۍ چې آيا تاسې په رښتيا همدا مخ جوړول که سمول غواړۍ.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'د "$1" ګڼون نه دی ثبت شوی.',
...
'wiki_usercsspreview' => "'''هېر مو نشي چې دا يوازې ستاسې د کارن CSS مخليدنه ده.'''
'''تر اوسه پورې لا ستاسې بدلونونه نه دي خوندي شوي!'''",
'wiki_userjspreview' => "'''هېر مو نشي چې دا يوازې ستاسې د کارن د جاوا سکرېپټ آزمېيل/مخليدنه ده.'''
'''تر اوسه پورې لا ستاسې بدلونونه نه دي خوندي شوي!'''",
...
'rev-deleted-wiki_user' => '(کارن-نوم ليري شوی)',
...
'revdelete-hide-wiki_user' => 'د سمونګر کارن-نوم/آی پي پته پټول',
...
# wiki_user rights
'wiki_userrights' => 'د کارن رښتو سمبالښت',
'wiki_userrights-lookup-wiki_user' => 'کارن ډلې سمبالول',
'wiki_userrights-wiki_user-editname' => 'يو کارن نوم وليکۍ:',
'editwiki_usergroup' => 'کارن ډلې سمول',
'wiki_userrights-editwiki_usergroup' => 'کارن ډلې سمول',
'savewiki_usergroups' => 'کارن ډلې خوندي کول',
'wiki_userrights-groupsmember' => 'غړی د:',
'wiki_userrights-reason' => 'سبب:',
'wiki_userrights-changeable-col' => 'هغه ډلې چې تاسې يې بدلولی شی',
'wiki_userrights-unchangeable-col' => 'هغه ډلې چې تاسې يې نه شی بدلولی',

# Groups
'group' => 'ډله:',
'group-wiki_user' => 'کارنان',
...
'group-wiki_user-member' => '{{GENDER:$1|کارن}}',
...
'grouppage-wiki_user' => '{{ns:project}}:کارنان',
...
'right-hidewiki_user' => 'پر يوه کارن-نوم بنديز لګول او له خلکو نه يې پټول',
'right-protect' => 'د ژغورنې کچه بدلول او ژغورلي مخونه سمول',
'right-editinterface' => 'د کارن ليدنمخ سمول',
'right-editwiki_usercssjs' => 'د نورو کارنانو د CSS او JS (جاوا سکرېپټ) دوتنې سمول',
'right-editwiki_usercss' => 'د نورو کارنانو د CSS دوتنې سمول',
'right-editwiki_userjs' => 'د نورو کارنانو د JS (جاوا سکرېپټ) دوتنې سمول',
'right-unwatchedpages' => 'د ناکتلو مخونو يو لړليک کتل',
'right-wiki_userrights' => 'د کارن ټولې رښتې سمول',
'right-wiki_userrights-interwiki' => 'په نورو ويکي ګانو د نورو کارنانو  کارن-رښتې سمول',
...
'action-wiki_userrights' => 'د کارن ټولې رښتې سمول',
...
'newpageletter' => 'نوی',
'boteditletter' => 'روباټ',
'number_of_watching_wiki_users_pageview' => '[$1  {{PLURAL:$1|کارن|کارنان}} يې ګوري]',
...
'statistics-header-wiki_users' => 'د کارنانو شمار',
...
'statistics-wiki_users' => 'ثبت شوي [[Special:Listwiki_users|کارنان]]',
'statistics-wiki_users-active' => 'فعاله کارنان',
'statistics-wiki_users-active-desc' => 'هغه کارنان چې په {{PLURAL:$1|وروستۍ ورځ|وروستيو $1 ورځو}} کې فعاله ونډه لرلې',
...
'listwiki_users' => 'کارن لړليک',
'listwiki_users-editsonly' => 'يوازې هغه کارنان چې سمونونه يې کړي ښکاره کول',
'listwiki_users-creationsort' => 'د جوړېدو د نېټې له مخې اوډل',
'wiki_usereditcount' => '{{PLURAL:$1|سمون|سمونونه}}',
'wiki_usercreated' => 'په $1 نېټه په $2 بجو {{GENDER:$3|جوړ شو}}',
'newpages' => 'نوي مخونه',
'newpages-wiki_username' => 'کارن-نوم:',
...
# Special:Log
'speciallogwiki_userlabel' => 'ترسره کوونکی:',
...
'listwiki_usersfrom' => 'هغه کارنان کتل چې نومونه يې پېلېږي په:',
'listwiki_users-submit' => 'ښکاره کول',
'listwiki_users-noresult' => 'هېڅ کوم کارن و نه موندل شو.',
'listwiki_users-blocked' => '(بنديز لګېدلی)',

# Special:Activewiki_users
'activewiki_users' => 'د فعالو کارنانو لړليک',
'activewiki_users-intro' => 'دا د هغو کارنانو لړليک دی چې په {{PLURAL:$1|تېرې|تېرو}} $1 {{PLURAL:$1|ورځ|ورځو}} کې يې ونډې ترسره کړي.',
'activewiki_users-count' => 'په {{PLURAL:$2|تېرې|تېرو}} {{PLURAL:$3|ورځ|$3 ورځو}} کې $1 {{PLURAL:$1|سمون|سمونونه}}',
'activewiki_users-from' => 'هغه کارنان کتل چې نومونه يې پېلېږي په:',
'activewiki_users-hidebots' => 'روباټونه پټول',
'activewiki_users-hidesysops' => 'پازوالان پټول',
'activewiki_users-noresult' => 'کارن و نه موندل شو.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'د کارن-نوم د جوړېدو يادښت',
'newwiki_userlogpagetext' => 'دا د کارن-نوم د جوړېدو يادښت دی',
...
'emailwiki_user' => 'کارن ته برېښليک لېږل',
'emailwiki_user-title-target' => 'دې {{GENDER:$1|کارن}} ته برېښليک لېږل',
'emailwiki_user-title-notarget' => 'کارن ته برېښليک لېږل',
'emailpage' => 'کارن ته برېښليک لېږل',
'defemailsubject' => 'د "$1" کارن لخوا د {{SITENAME}} برېښليک',
'wiki_usermaildisabled' => 'د کارن برېښليک ناچارند دی',
'wiki_usermaildisabledtext' => 'په دې ويکي تاسې نورو کارنانو ته برېښليک نه شی ورلېږلی',
...
'emailwiki_username' => 'کارن-نوم:',
'emailwiki_usernamesubmit' => 'سپارل',
...
'emailwiki_userfooter' => 'دا برېښليک د $1 لخوا $2 ته د {{SITENAME}} په وېبځي کې د "کارن ته برېښليک لېږل" د کړنې په مرسته لېږل شوی.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'د غونډال پيغام پرېښودل.',
'wiki_usermessage-editor' => 'د غونډال پيغام رسونکی',
...
'sp-contributions-wiki_username' => 'IP پته يا کارن-نوم:',
...
'ipadressorwiki_username' => 'IP پته يا کارن نوم',
...
'blocklist-wiki_userblocks' => 'ګڼون بنديزونه پټول',
...
'blocklist-nowiki_usertalk' => 'د خبرواترو خپل مخ نه شی سمولای',
...
'movewiki_userpage-warning' => "'''ګواښنه:''' تاسې د يو کارن مخ د لېږدولو په حال کې ياست. لطفاً دا مه هېروۍ چې يوازې همدا مخ به ولېږدول شي او د کارن نوم به ''نه'' بدلېږي.",
...
'cant-move-wiki_user-page' => 'تاسې د کارن مخونو د لېږدولو پرېښله نلرۍ (د څېرمه مخونو نه پرته).',
'cant-move-to-wiki_user-page' => 'تاسې د يو کارن مخ ته د يوه بل مخ د لېږدولو پرېښله نلرۍ (د يو کارن د څېرمه مخ نه پرته).',
...
'tooltip-pt-wiki_userpage' => 'ستاسې کارن مخ',
...
'tooltip-t-emailwiki_user' => 'دې کارن ته يو برېښليک لېږل',
...
'tooltip-ca-nstab-wiki_user' => 'د کارن پاڼه کتل',
...
'sitewiki_user' => 'د {{SITENAME}} کارن $1',
'anonwiki_user' => 'د {{SITENAME}} ورکنومی کارن $1',
'lastmodifiedatby' => 'دا مخ وروستی ځل د $3 لخوا په $2، $1 بدلون موندلی.',
'others' => 'نور',
'sitewiki_users' => 'د {{SITENAME}} {{PLURAL:$2|کارن|کارنان}} $1',
'anonwiki_users' => 'د {{SITENAME}} {{PLURAL:$2|ورکنومی کارن|ورکنومي کارنان}} $1',
...
'pageinfo-firstwiki_user' => 'مخ جوړونکی',
'pageinfo-firsttime' => 'د مخ جوړېدنې نېټه',
'pageinfo-lastwiki_user' => 'وروستنی سمونګر',
...
'exif-wiki_usercomment' => 'د کارن تبصرې',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|خبرې اترې]])',
...
'specialpages-group-wiki_users' => 'کارنان او رښتې',
...
'logentry-newwiki_users-newwiki_users' => 'د $1 کارن ګڼون جوړ شو',
'logentry-newwiki_users-create' => 'د $1 کارن ګڼون جوړ شو',
'logentry-newwiki_users-autocreate' => 'د $1 ګڼون په اتوماتيک ډول جوړ شو',
'newwiki_userlog-byemail' => 'پټنوم مو برېښليک ته درولېږه',
