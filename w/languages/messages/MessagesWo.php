...
$specialPageAliases = array(
	...
	'Listwiki_users'                 => array( 'Limu jëfandikukat yi' ),
...
'tog-enotifwiki_usertalkpages' => 'Yónne ma ab bataaxal su ay coppite amee ci sama xëtu waxtaanuwaay',
...
'wiki_userpage' => 'Xëtu jëfandikukat',
...
'nstab-main' => 'Xët',
'nstab-wiki_user' => 'Xëtu jëfandikukat',
...
'wiki_userlogin' => 'Dugg / Bindu',
'logout' => 'Génnu',
'wiki_userlogout' => 'Génnu',
...
'wiki_userexists' => 'Turu jëfandikukat bi nga bind am na boroom ba noppi. Tànnal weneen.',
...
'nosuchwiki_user' => 'Amul benn jëfandikukat bu tudd « $1 ». Xoolaatal bu baax mbindiin mi walla nga sos meneen sàqum jëfandikukat.',
'nosuchwiki_usershort' => 'Amul benn jëfandikukat bu tudd « $1 ». Xoolaatal mbidiin mi.',
'nowiki_userspecified' => 'Laaj na nga tànn ab turu jëfandikukat',
...
'wiki_usernamehasherror' => 'Turu jëfandikukat bi warul am mandarga yu hash',
...
'wiki_userpage-wiki_userdoesnotexist' => 'Mii sàqum jëfandikukat « <nowiki>$1</nowiki> » du bu ku-bindu. Seetal bu baax ndax da ngaa namma sos walla soppi wii xët.',
...
'wiki_usercssyoucanpreview' => "'''Xelal :''' di la digël nga cuq ci «Wonendi» ngir gis say xobi CSS walla JavaScript yu bees laata nga leen di denc.",
'wiki_userjsyoucanpreview' => "'''Xelal :''' di la digël nga cuq ci «Wonendi» ngir gis say xobi CSS walla JavaScript yu bees laata nga leen di denc.",
'wiki_usercsspreview' => "Bul fatte ne lii wonendib sa CSS rekk la; dencagoo say coppite!'''",
'wiki_userjspreview' => "'''Bul fatte ne lii ab wonendib sa yoonu javaScript rekk la; dencagoo say coppite!'''",
'wiki_userinvalidcssjstitle' => "'''Moytul :''' amul genn col gu tudd « $1 ». Bul fatte ne xët yiy jeexee .css ak .js seeni koj ay araf yu tuut ñoo ciy tegu/.<br />ci misaal, {{ns:wiki_user}}:Foo/'''v'''ector.css moo baax, waaye bii du baax {{ns:wiki_user}}:Foo/'''V'''ector.css .",
'updated' => '(bees na)',
'note' => "'''Karmat :'''",
...
'rev-deleted-wiki_user' => '(turu jëfandikukat bi far nañ ko)',
...
'revdelete-hide-wiki_user' => 'Nëbb tur walla màkkaanu IP bu soppikat bi',
...
'wiki_username' => 'Turu jëfandikukat :',
...
# wiki_user rights
'wiki_userrights' => 'Yorug sañ-sañu aji-sos',
'wiki_userrights-lookup-wiki_user' => 'Yorug mboolooy jëfandikukat',
'wiki_userrights-wiki_user-editname' => 'Dugal ab turu jëfandikukat :',
'editwiki_usergroup' => 'Coppiteg mboolooy Jëfandikukat',
'editingwiki_user' => "Coppiteg sañ-sañi jëfandikukat bii di '''[[wiki_user:$1|$1]]''' ([[wiki_user talk:$1|{{int:talkpagelinktext}}]] | [[Special:Contributions/$1|{{int:contribslink}}]])",
'wiki_userrights-editwiki_usergroup' => 'Soppi mboolooy jëfandikukat',
'savewiki_usergroups' => 'Denc mboolooy jëfandikukat yi',
'wiki_userrights-groupsmember' => 'Cëru mbooloo mu:',
'wiki_userrights-groups-help' => 'Man ngaa soppi mbooloo yi jëfandikukat bi bokk
...
'wiki_userrights-reason' => 'Ngirte :',
'wiki_userrights-no-interwiki' => 'Amoo sañ-sañu soppi sañ-sañi jëfandikukat yi ci yeneen wiki',
'wiki_userrights-nodatabase' => 'Dàttub njoxe bii « $1 » amul walla nekkul ci barab bi.',
'wiki_userrights-nologin' => 'Faaw nga  [[Special:wiki_userLogin|dugg]] ak sàqum ab yorkat ngir man a soppi sañ-sañi ab jëfandukukat.',
'wiki_userrights-notallowed' => 'Sa sàq amul sañ-sañ ngir man a joxi sañ-sañ ab jëfandikukat.',
'wiki_userrights-changeable-col' => 'Mbooloo yees man a soppi',
'wiki_userrights-unchangeable-col' => 'Mbooloo yees manuta soppi',
'wiki_userrights-irreversible-marker' => '$1*',

# Groups
'group' => 'Mbooloo :',
'group-wiki_user' => 'Jëfandikukat',
...
'right-move-rootwiki_userpages' => 'Tuddewaat xëti njalbeen yu ay jëfandikukat.',
...
'right-hidewiki_user' => 'Téye ab jëfandikukat, nëbbaale ko mbooloo mi',
...
'right-editwiki_usercssjs' => 'Soppi dencukaay yu CSS ak  JS yu yeneen jëfandikukat',
'right-editwiki_usercss' => 'Soppi dencukaay yu CSS yu yeneen jëfandikukat',
'right-editwiki_userjs' => 'Soppi dencukaay yu JS yu yeneen jëfandikukat',
...
'right-wiki_userrights' => 'Soppi bépp sañ-sañu jëfandikukat bi',
'right-wiki_userrights-interwiki' => 'Soppi sañ-sañi jëfandikukat yu yeneen wiki',
...
'action-move-rootwiki_userpages' => 'tuddewaat xët wu njëkk wu ab jëfandikukat',
...
'action-wiki_userrights' => 'soppi aqi jëfanfikukat yépp',
'action-wiki_userrights-interwiki' => 'soppi aqi jëfandikukat yu jëfandikukat yu beneen wiki',
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[{{PLURAL:$1|jëfandikukat moo koy topp|$1 jëfandikukat ñoo koy topp}}]',
...
'listfiles_name' => 'Tur',
'listfiles_wiki_user' => 'Jëfandikukat',
...
'filehist-wiki_user' => 'Jëfandikukat',
...
'statistics-header-wiki_users' => 'Limbari ñeel jëfandikukat yi',
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Jëfandikukat]] yi bindu',
'statistics-wiki_users-active' => 'Jëfandikukat yu yëngu',
'statistics-wiki_users-active-desc' => 'Jëfandikukat yi amal ag yëngu-yëngu ci {{PLURAL:$1|bés bu mujj bi|$1 bés yu mujj yi}}',
...
'listwiki_users' => 'Limu jëfandikukat yi',
'listwiki_users-editsonly' => 'Wone jëfandikukat yi am ay cëru',
'wiki_usercreated' => 'Ñoo ngi ko sos  $1 ci $2',
'newpages' => 'Xët yu yees',
'newpages-wiki_username' => 'Jëfëndikookat :',
...
# Special:Log
'speciallogwiki_userlabel' => 'Jëfandikukat :',
...
'listwiki_usersfrom' => 'Wone jëfandikukat yi doore ko ci:',
'listwiki_users-submit' => 'Wone',
'listwiki_users-noresult' => 'Benn jëfandikukat giseesu ko',
'listwiki_users-blocked' => '(téyees)',

# Special:Activewiki_users
'activewiki_users' => 'Limu jëfandikukat yu yëngu',
'activewiki_users-count' => '$1 coppite {{PLURAL:$2|bu mujj|yu mujj}}',
'activewiki_users-from' => 'Wone jëfandikukat yi dalee ko ci:',
'activewiki_users-noresult' => 'Benn jëfandikukat giseesu ko',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Jëfandikukat yu yees yi',
'newwiki_userlogpagetext' => 'Xët wii daf lay won limu sáq yi fi mujjee sosu.',
...
'emailwiki_user' => 'Bind bii jëfandikukat',
'emailpage' => 'Yónne ab m-bataaxal bii jëfandikukat',
'wiki_usermailererror' => 'Njuumte ci koju m-bataaxal bi',
...
'emailwiki_userfooter' => '$1 moo yónne bii bataaxal $2 jaare ko ci solo su "Yónne ab bataaxal bii jëfandikukat" ci {{SITENAME}}.',
...
'sp-contributions-wiki_userrights' => 'Yorug sañ-sañi jëfandikukat yi',
'sp-contributions-search' => 'Seet ay cëru',
'sp-contributions-wiki_username' => 'Makkaanu IP walla turu jëfandikukat :',
...
'ipadressorwiki_username' => 'Màkkaanu IP walla turu jëfandikukat:',
...
'ipbwatchwiki_user' => 'Topp xëtu jëfandikukat ak bu waxtaanuwaay bu bii jëfandikukat',
...
'blocklist-nowiki_usertalk' => 'Du man a soppi xëtu waxtaanuwaayam',
...
'block-log-flags-nowiki_usertalk' => 'Du man a soppi xëtu waxtaanuwaayam',
...
'cant-move-wiki_user-page' => 'Amoo sañ-sañu tuddewaat xëti jëfandikukat yi (ba mu des ron-xët yi).',
'cant-move-to-wiki_user-page' => 'Amoo sañ-sañu tuddewaat aw xët jëme ko ciw xëtu jëfandikukat (ba mu des ron-xëti jëfandikukat yi)',
...
'tooltip-pt-wiki_userpage' => 'Sa xëtu jëfandikukat',
'tooltip-pt-anonwiki_userpage' => 'Xëtu jëfandikukat wu bii màkkaanu IP',
...
'tooltip-t-emailwiki_user' => 'Yónne ab m-bataaxal bii jëfandikukat',
...
'tooltip-ca-nstab-wiki_user' => 'Xool xëtu jëfandikukat wi',
...
'exif-wiki_usercomment' => 'Kadduy jëfëndikookat bi',
...
'newwiki_userlog-byemail' => 'baatujáll bi yónne nañu ko cib bataaxal',
