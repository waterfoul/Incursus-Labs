...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'ImplijerienOberiant' ),
	...
	'Emailwiki_user'                 => array( 'PostelImplijer' ),
	...
	'Listwiki_users'                 => array( 'RollImplijerien' ),
	'Log'                       => array( 'Marilh' ),
	...
	'wiki_userlogin'                 => array( 'KevreañImplijer' ),
	'wiki_userlogout'                => array( 'DigevreañImplijer' ),
	'wiki_userrights'                => array( 'GwirioùImplijer' ),
	'Version'                   => array( 'Stumm' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'NIVERAIMPLIJERIEN', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'NIVERAIMPLIJERIENOBERIANT', 'NUMBEROFACTIVEUSERS' ),
...
'tog-enotifwiki_usertalkpages' => 'Kas ur postel din pa vez kemmet ma fajenn gaozeal',
...
'youhavenewmessagesfromwiki_users' => '$1 ho peus eus {{PLURAL:$3|un implijer all|$3 implijer}} ($2).',
'youhavenewmessagesmanywiki_users' => ' $1 ho peus implijerien a-leizh  ($2).',
...
'nstab-main' => 'Pajenn',
'nstab-wiki_user' => 'Pajenn implijer',
'nstab-media' => 'Media',
...
Kasit keloù d'ur [[Special:Listwiki_users/sysop|merer]], en ur verkañ dezhañ chomlec'h an URL.",
...
'titleprotected' => "Gwarezet eo bet an titl-mañ p'eo bet krouet gant [[wiki_user:$1|$1]].
Setu amañ perak ''$2''.",
...
Gallout a rit kenderc'hel da implijout {{SITENAME}} en un doare dizanv, pe [[Special:wiki_userLogin|kevreañ en-dro]] gant an hevelep anv pe un anv all mar fell deoc'h.
...
'wiki_userlogin' => 'Kevreañ / krouiñ ur gont',
'wiki_userloginnocreate' => 'Kevreañ',
'logout' => 'Digevreañ',
'wiki_userlogout' => 'Digevreañ',
...
'wiki_userlogin-resetlink' => "Ha disoñjet eo bet ho titouroù kevreañ ganeoc'h ?",
'createaccountmail' => 'dre bostel',
'createaccountreason' => 'Abeg :',
'badretype' => 'Ne glot ket ar gerioù-tremen an eil gant egile.',
'wiki_userexists' => "Implijet eo an anv implijer lakaet ganeoc'h dija.
...
'nosuchwiki_user' => 'N\'eus ket eus an implijer "$1".
Kizidik eo anv an implijer ouzh ar pennlizherennoù
Gwiriit eo bet skrivet mat an anv ganeoc\'h pe [[Special:wiki_userLogin/signup|krouit ur gont nevez]].',
'nosuchwiki_usershort' => "N'eus perzhiad ebet gantañ an anv « $1 ». Gwiriit ar reizhskrivadur.",
'nowiki_userspecified' => "Ret eo deoc'h spisaat un anv implijer.",
'login-wiki_userblocked' => "Stanket eo an implijer-mañ. N'eo ket aotret da gevreañ.",
...
'wiki_usernamehasherror' => "N'haller ket ober gant an arouezenn # en anvioù an implijerien",
...
'suspicious-wiki_userlogout' => 'Distaolet eo bet ho koulenn digevreañ rak kaset e oa bet gant ur merdeer direizhet pe krubuilhadenn ur proksi, evit doare.',

# E-mail sending
'php-mail-error-unknown' => "Fazi dianav en arc'hwel postel () PHP",
'wiki_user-mail-no-addy' => "Klasket kas ur postel hep lakaat ur chomlec'h postel.",
...
'passwordreset-wiki_username' => 'Anv implijer :',
...
'passwordreset-emailtext-wiki_user' => "Goulennet en deus an implijer $1 war  {{SITENAME}} e vefe degaset soñj dezhañ eus titouroù e gont evit {{SITENAME}} ($4). Emañ liammet {{PLURAL:$3|ar gont implijer|ar c'hontoù implijer}} da-heul gant ar chomlec'h postel-mañ :
...
'accmailtext' => "Kaset ez eus bet ur ger-tremen dargouezhek evit [[wiki_user talk:$1|$1]] da $2.
...
Ma'z oc'h un implijer(ez) dizanv ha ma stadit ez eus bet kaset deoc'h kemennadennoù na sellont ket ouzhoc'h, gallout a rit [[Special:wiki_userLogin/signup|krouiñ ur gont]]pe [[Special:wiki_userLogin|kevreañ]] kuit a vagañ muioc'h a gemmesk gant implijerien dizanv all.",
...
'wiki_userpage-wiki_userdoesnotexist' => 'N\'eo ket enrollet ar gont "<nowiki>$1</nowiki>". Merkit ma fell deoc\'h krouiñ/kemmañ ar bajenn-mañ.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'N\'eo ket enrollet ar gont implijer "$1".',
...
'wiki_usercssyoucanpreview' => "'''Tun :''' Grit gant ar bouton \"{{int:showpreview}}\" evit testiñ ho follenn CSS nevez a-raok enrollañ anezhi.",
'wiki_userjsyoucanpreview' => "'''Tun :''' Grit gant ar bouton \"{{int:showpreview}}\" evit testiñ ho follenn JS nevez a-raok enrollañ anezhi.",
'wiki_usercsspreview' => "'''Dalc'hit soñj n'emaoc'h ken nemet o rakwelet ho follenn CSS deoc'h.'''
'''N'eo ket bet enrollet evit c'hoazh!'''",
'wiki_userjspreview' => "'''Dalc'hit soñj emaoc'h o rakwelet pe o testiñ ho kod javascript deoc'h ha n'eo ket bet enrollet c'hoazh!'''",
...
'''N'eo ket bet enrollet evit c'hoazh!'''",
'wiki_userinvalidcssjstitle' => "'''Diwallit:''' N'eus tamm gwiskadur \"\$1\" ebet. Ho pez soñj e vez implijet lizherennoù bihan goude an anv implijer hag ar veskell / gant ar pajennoù personel dezho un astenn .css ha .js; da skouer eo mat ar follenn stil {{ns:wiki_user}}:Foo/vector.css ha faziek an hini {{ns:wiki_user}}:Foo/Vector.css.",
'updated' => '(Hizivaet)',
'note' => "'''Notenn :'''",
...
Ma ne'z a ket en-dro c'hoazh, klaskit [[Special:wiki_userLogout|digevreañ]] hag adkevreañ war-lerc'h.",
...
Mar ned a ket en-dro, klaskit [[Special:wiki_userLogout|digevreañ]] ha kevreañ en-dro.",
...
Gallout a rit mont war-gil ha lakaat kemmañ ur bajenn zo anezhi dija, pe [[Special:wiki_userLogin|en em enrollañ ha krouiñ ur gont]].',
...
'undo-summary' => 'Disteurel kemmoù $1 a-berzh [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|kaozeal]])',

# Account creation failure
'cantcreateaccounttitle' => 'Dibosupl krouiñ ar gont',
'cantcreateaccount-text' => "Stanket eo bet ar c'hrouiñ kontoù adal ar chomlec'h IP ('''$1''') gant [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(anv implijer diverket)',
'rev-deleted-event' => '(elfenn dilamet)',
'rev-deleted-wiki_user-contribs' => "[anv implijer pe chomlec'h IP diverket - kemm kuzhet diouzh an degasadennoù]",
...
'revdelete-hide-wiki_user' => "Kuzhat anv implijer pe chomlec'h IP an aozer",
...
'diff-multi-manywiki_users' => "({{PLURAL:$1|Ur reizhadenn da c'hortoz|$1 reizhadenn da c'hortoz}} gant muioc'h eget $2 {{PLURAL:$2|implijer|implijer}} kuzhet.)",
...
'prefsnologintext' => 'Ret eo deoc\'h bezañ <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} kevreet]</span> a-benn gellout cheñch ho tibaboù implijer.',
...
'prefs-wiki_user-pages' => 'Pajennoù implijer',
...
# wiki_user rights
'wiki_userrights' => 'Merañ statud an implijerien',
'wiki_userrights-lookup-wiki_user' => 'Merañ strolladoù an implijer',
'wiki_userrights-wiki_user-editname' => 'Lakait un anv implijer :',
'editwiki_usergroup' => 'Kemmañ ar strolladoù implijerien',
'editingwiki_user' => "Kemmañ gwirioù an implijer '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Kemmañ strolladoù an implijer',
'savewiki_usergroups' => 'Enrollañ ar strolladoù implijer',
'wiki_userrights-groupsmember' => 'Ezel eus :',
'wiki_userrights-groupsmember-auto' => 'Ezel emplegat eus :',
'wiki_userrights-groups-help' => "Cheñch strollad an implijer a c'hallit ober.
...
'wiki_userrights-reason' => 'Abeg :',
'wiki_userrights-no-interwiki' => "N'oc'h ket aotreet da gemmañ ar gwirioù implijer war wikioù all.",
'wiki_userrights-nodatabase' => "N'eus ket eus an diaz titouroù $1 pe n'eo ket lec'hel.",
'wiki_userrights-nologin' => "Ret eo deoc'h [[Special:wiki_userLogin|bezañ enrollet]] gant ur gont merour a-benn reiñ gwirioù implijer.",
'wiki_userrights-notallowed' => "N'eo ket aotreet ho kont da cheñch gwirioù an implijerien.",
'wiki_userrights-changeable-col' => "Ar strolladoù a c'hallit cheñch",
'wiki_userrights-unchangeable-col' => "Ar strolladoù n'hallit ket cheñch",

# Groups
'group' => 'Strollad :',
'group-wiki_user' => 'Implijerien',
...
'group-wiki_user-member' => '{{GENDER:$1|implijer}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Implijerien',
...
'right-move-rootwiki_userpages' => 'Adenvel pajennoù diazez an implijer',
...
'right-hidewiki_user' => 'Stankañ un implijer, en ur guzhat anezhañ diouzh ar re all',
...
'right-editwiki_usercssjs' => 'Kemmañ restroù CSS ha JS implijerien all',
'right-editwiki_usercss' => 'Kemmañ restroù CSS implijerien all',
'right-editwiki_userjs' => 'Kemmañ restroù JS implijerien all',
...
'right-wiki_userrights' => 'Kemmañ holl wirioù un implijer',
'right-wiki_userrights-interwiki' => 'Kemmañ ar gwirioù implijer zo war ur wiki all',
...
'action-move-rootwiki_userpages' => "dilec'hiañ pajennoù an implijer diazez.",
...
'action-wiki_userrights' => 'Kemmañ an holl wirioù implijer',
'action-wiki_userrights-interwiki' => 'Kemmañ gwirioù an implijerien war wikioù all',
...
'newpageletter' => 'N',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|implijer o heuliañ|implijer}} o heuliañ]',
...
'uploadnologintext' => "Ret eo deoc'h bezañ [[Special:wiki_userLogin|kevreetet]] a-benn gellout enporzhiañ restroù war ar servijer.",
...
Kit e darempred gant [[Special:Listwiki_users/sysop|unan eus merourien ar reizhiad]].",
...
Ma talc'h ar gudenn, kit e darempred gant [[Special:Listwiki_users/sysop|merourien ar reizhiad]].",
...
'statistics-header-wiki_users' => 'Stadegoù implijer',
...
'statistics-wiki_users' => '[[Special:Listwiki_users|Implijerien]] enrollet',
'statistics-wiki_users-active' => 'Implijerien oberiant',
'statistics-wiki_users-active-desc' => "Implijerien o deus degaset da nebeutañ ur c'hemm {{PLURAL:$1|an deiz paseet|e-kerzh an $1 deiz diwezhañ}}",
...
'listwiki_users' => 'Roll an implijerien',
'listwiki_users-editsonly' => 'Na ziskouez nemet an implijerien o deus degaset un dra bennak',
'listwiki_users-creationsort' => 'Renket dre urzh krouiñ',
'wiki_usereditcount' => '$1 {{PLURAL:$1|kemm|kemm}}',
'wiki_usercreated' => "{{GENDER:$3|Krouet}} d'an $1 da $2",
'newpages' => 'Pajennoù nevez',
'newpages-wiki_username' => 'Anv implijer :',
...
# Special:Log
'speciallogwiki_userlabel' => 'Implijer :',
...
'listwiki_usersfrom' => 'Diskouez anv an implijerien adal :',
'listwiki_users-submit' => 'Diskouez',
'listwiki_users-noresult' => "N'eus bet kavet implijer ebet.",
'listwiki_users-blocked' => '(stanket)',

# Special:Activewiki_users
'activewiki_users' => 'Roll an implijerien oberiant',
'activewiki_users-intro' => 'Setu aze ur roll eus an implijerien zo bet oberiant mui pe vui e-pad an $1 {{PLURAL:$1|deiz|deiz}} diwezhañ.',
'activewiki_users-count' => '$1 {{PLURAL:$1|degasadenn}} abaoe an {{PLURAL:$3|deiz|$3 deiz}} diwezhañ',
'activewiki_users-from' => 'Diskouez an implijerien adal :',
'activewiki_users-hidebots' => 'Kuzhat ar robotoù',
'activewiki_users-hidesysops' => 'Kuzhat ar verourien',
'activewiki_users-noresult' => "N'eus bet kavet implijer ebet.",

# Special:Log/newwiki_users
'newwiki_userlogpage' => "Marilh ar c'hontoù krouet",
'newwiki_userlogpagetext' => "Marilh krouiñ ar c'hontoù implijer.",
...
'mailnologintext' => "Ret eo deoc'h bezañ [[Special:wiki_userLogin|kevreet]]
...
'emailwiki_user' => "Kas ur postel d'an implijer-mañ",
'emailwiki_user-title-target' => "Kas ur postel d'an {{PLURAL:$1|an implijer-mañ|an implijerez-mañ}}",
'emailwiki_user-title-notarget' => "Kas ur postel d'un implijer",
...
'wiki_usermailererror' => 'Fazi postel :',
'defemailsubject' => 'Postel kaset eus {{SITENAME}} gant an implijer "$1"',
'wiki_usermaildisabled' => "Diweredekaet eo ar c'has posteloù etre an implijerien.",
'wiki_usermaildisabledtext' => "Ne c'helloc'h ket kas posteloù da implijerien all er wiki-mañ",
...
'emailwiki_username' => 'Anv implijer :',
'emailwiki_usernamesubmit' => 'Kas',
...
'emailwiki_userfooter' => 'Kaset eo bet ar postel-mañ gant $1 da $2 dre an arc\'hwel "Kas ur postel d\'an implijer" war {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'En deus laosket ur gemennadenn sistem.',
'wiki_usermessage-editor' => 'Kemennerezh ar reizhiad',
...
'watchnologintext' => "Ret eo deoc'h bezañ [[Special:wiki_userLogin|kevreet]]
...
'alreadyrolled' => "Dibosupl eo disteuler ar c'hemm diwezhañ graet d'ar bajenn [[:$1]] gant [[wiki_user:$2|$2]] ([[wiki_user talk:$2|Kaozeal]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]);
kemmet pe distaolet eo bet c'hoazh gant unan bennak all.

Ar c'hemm diwezhañ d'ar bajenn-mañ a oa bet graet gant [[wiki_user:$3|$3]] ([[wiki_user talk:$3|Kaozeal]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).",
'editcomment' => "Diverradenn ar c'hemm a oa : \"''\$1''\".",
'revertpage' => "Kemmoù distaolet gant [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|Kaozeal]]); adlakaet d'ar stumm diwezhañ a-gent gant [[wiki_user:$1|$1]]",
'revertpage-nowiki_user' => "Disteuler kemmoù (anv implijer distaolet) ha distreiñ d'ar stumm diwezhañ gant [[wiki_user:$1|$1]]",
...
'sp-contributions-wiki_userrights' => 'Merañ ar gwirioù',
...
'sp-contributions-wiki_username' => "Anv implijer pe chomlec'h IP :",
...
'ipadressorwiki_username' => "Chomlec'h IP pe anv implijer",
...
'ipbwatchwiki_user' => 'Evezhiañ pajennoù implijer ha kaozeal an implijer-mañ',
'ipb-disablewiki_usertalk' => 'Mirout ouzh an implijer-mañ da implijout e bajenn gaozeal dezhañ e-unan e-keit hag emañ stanket',
...
'ipb-confirmhidewiki_user' => 'Emaoc\'h war-nes stankañ un implijer ha gweredekaet hoc\'h eus "kuzhat an implijer". Diverkañ a ra an dra-se anv an implijer en holl rolloù ha monedoù ar marilh.',
...
'unblocked' => 'Distanket eo bet [[wiki_user:$1|$1]]',
...
'blocklist-wiki_userblocks' => 'Kuzhat ar stankadennoù kont',
...
'blocklist-nowiki_usertalk' => "n'hall ket kemmañ e bajenn gaozeal dezhañ e-unan",
...
'autoblocker' => 'Emstanket rak implijet eo bet ho chomlec\'h IP gant "[[wiki_user:$1|$1]]" nevez zo.
...
'block-log-flags-nowiki_usertalk' => "n'hall ket kemmañ e bajenn gaozeal dezhañ e-unan",
...
'unblock-hidewiki_user' => "N'hallit ket distankañ an implijer-mañ rak kuzhet eo bet e anv kont.",
...
'cant-see-hidden-wiki_user' => "Stanket ha kuzhet eo bet dija an implijer emaoc'h o klask stankañ. Dre ma n'emañ ket ganeoc'h ar gwir hidewiki_user, n'hallit ket gwelet pe kemmañ stankadenn an implijer.",
...
'movewiki_userpage-warning' => "'''Diwallit : ''' War-nes dilec'hiañ ur bajenn implijer emaoc'h. Notit mat n'eus nemet ar bajenn a vo dilec'hiet ha ne vo ''ket'' adanvet an implijer.",
'movenologin' => 'Digevreet',
'movenologintext' => 'A-benn gellout adenvel ur pennad e rankit bezañ un implijer enrollet ha bezañ [[Special:wiki_userLogin|kevreet]].',
'movenotallowed' => "N'oc'h ket aotreet da zilec'hiañ pajennoù.",
'movenotallowedfile' => "N'oc'h ket aoteret da adenvel restroù.",
'cant-move-wiki_user-page' => "Noc'h ket aotreet da adenvel pajennoù pennañ an implijerien (er-maez eus o ispajennoù).",
'cant-move-to-wiki_user-page' => "Noc'h ket aotreet da adenvel ur bajenn gant anv hini un implijer all (nemet un ispajenn e vefe).",
'newtitle' => 'anv nevez',
...
'tooltip-pt-wiki_userpage' => 'Ho pajenn implijer',
'tooltip-pt-anonwiki_userpage' => "Ar bajenn implijer evit ar c'homlec'h IP implijet ganeoc'h",
...
'tooltip-t-emailwiki_user' => "Kas ur postel d'an implijer-mañ",
...
'tooltip-ca-nstab-wiki_user' => 'Gwelet ar bajenn implijer',
...
'sitewiki_user' => 'Implijer(ez) $1 eus {{SITENAME}}',
'anonwiki_user' => 'implijer dizanv $1 eus {{SITENAME}}',
'lastmodifiedatby' => "Kemmet eo bet ar bajenn-mañ da ziwezhañ da $2, d'an $1 gant $3",
'othercontribs' => 'Diazezet war labour $1.',
'others' => 're all',
'sitewiki_users' => '$1 {{PLURAL:$2|implijer|implijer}} eus {{SITENAME}}',
'anonwiki_users' => '{{PLURAL:$2|implijer dizanv|implijerien dizanv}} $1 eus {{SITENAME}}',
...
'spambot_wiki_username' => 'Naetaat ar strob gant MediaWiki',
...
'pageinfo-firstwiki_user' => 'Krouer ar bajenn',
'pageinfo-firsttime' => 'Deiziad krouiñ ar bajenn',
'pageinfo-lastwiki_user' => 'Kontroller diwezhañ',
...
'exif-wiki_usercomment' => 'Evezhiadennoù',
...
'confirmemail_success' => "Kadarnaet eo ho chomlec'h postel. A-benn bremañ e c'hallit [[Special:wiki_userLogin|kevreañ]] hag ober ho mad eus ar wiki.",
...
'confirmrecreate' => "Diverket eo bet ar pennad-mañ gant [[wiki_user:$1|$1]] ([[wiki_user talk:$1|kaozeal]]) goude ma vije bet kroget ganeoc'h kemmañ anezhañ :
: ''$2''
Kadarnait mar plij e fell deoc'h krouiñ ar pennad-mañ da vat.",
'confirmrecreate-noreason' => "Diverket eo bet ar pennad-mañ gant [[wiki_user:$1|$1]] ([[wiki_user talk:$1|kaozeal]]) goude ma vije bet kroget ganeoc'h kemmañ anezhañ. Kadarnait e fell deoc'h adkrouiñ ar pennad-mañ e gwirionez.",
'recreate' => 'Adkrouiñ',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|kaozeal]])',
...
'specialpages-group-wiki_users' => 'An implijerien hag o gwirioù',
...
'logentry-newwiki_users-newwiki_users' => 'Krouet eo bet ar gont implijer $1',
'logentry-newwiki_users-create' => 'Krouet eo bet ar gont implijer $1',
'logentry-newwiki_users-create2' => 'Gant $1 eo bet krouet ar gont implijer $3',
'logentry-newwiki_users-autocreate' => 'Krouet eo bet kont $1 ent emgefre',
'newwiki_userlog-byemail' => 'ger-tremen kaset dre bostel',
