...
'nosuchwiki_usershort' => 'Der Benutzername „$1“ ist nicht vorhanden. Bitte überprüfen Sie die Schreibweise.',
'nowiki_userspecified' => 'Bitte geben Sie einen Benutzernamen an.',
...
'passwordreset-emailtext-wiki_user' => 'Benutzer $1 auf {{SITENAME}} hat eine Erinnerung an Ihre Benutzerkonteninformationen für {{SITENAME}} angefordert ($4). {{PLURAL:$3|Das folgende Benutzerkonto ist|Die folgenden Benutzerkonten sind}} mit dieser E-Mail-Adresse verknüpft:
...
'wiki_userpage-wiki_userdoesnotexist' => 'Das Benutzerkonto „<nowiki>$1</nowiki>“ ist nicht vorhanden. Bitte prüfen Sie, ob Sie diese Seite wirklich erstellen/bearbeiten möchten.',
...
'wiki_usercssyoucanpreview' => "'''Tipp:''' Benutzen Sie den „{{int:showpreview}}“-Button, um Ihr neues CSS vor dem Speichern zu testen.",
'wiki_userjsyoucanpreview' => "'''Tipp:''' Benutzen Sie den „{{int:showpreview}}“-Button, um Ihr neues JavaScript vor dem Speichern zu testen.",
'wiki_usercsspreview' => "'''Beachten Sie, dass Sie nur eine Vorschau Ihres Benutzer-CSS betrachten.'''
'''Es wurde noch nicht gespeichert!'''",
'wiki_userjspreview' => "'''Beachten Sie, dass Sie nur eine Vorschau Ihres Benutzer-JavaScript betrachten.'''
'''Es wurde noch nicht gespeichert!'''",
...
'''Es wurde noch nicht gespeichert!'''",
'wiki_userinvalidcssjstitle' => "'''Achtung:''' Die Benutzeroberfläche „$1“ existiert nicht. Bedenken Sie, dass benutzerspezifische .css- und .js-Seiten mit einem Kleinbuchstaben anfangen müssen, also beispielsweise ''{{ns:wiki_user}}:Mustermann/vector.css'' an Stelle von ''{{ns:wiki_user}}:Mustermann/Vector.css''.",
...
# wiki_user rights
'wiki_userrights-groups-help' => 'Sie können die Gruppenzugehörigkeit dieses Benutzers ändern:
...
'wiki_userrights-no-interwiki' => 'Sie haben nicht die erforderliche Berechtigung, um Benutzerrechte in anderen Wikis ändern zu können.',
'wiki_userrights-nologin' => 'Sie müssen sich mit einem Administrator-Benutzerkonto [[Special:wiki_userLogin|anmelden]], um Benutzerrechte zu ändern.',
'wiki_userrights-notallowed' => 'Sie verfügen nicht über die erforderlichen Berechtigungen, um Benutzerrechte vergeben oder entziehen zu können.',
'wiki_userrights-changeable-col' => 'Gruppenzugehörigkeit, die Sie ändern dürfen',
'wiki_userrights-unchangeable-col' => 'Gruppenzugehörigkeit, die Sie nicht ändern dürfen',
...
'ipb-confirmhidewiki_user' => 'Sie sind gerade dabei, einen Benutzer im Modus „Benutzer verstecken“ zu sperren. Dies führt dazu, dass der Benutzername in allen Listen und Logbüchern unterdrückt wird. Möchten Sie das wirklich tun?',
...
'cant-see-hidden-wiki_user' => 'Der Benutzer, den Sie versuchen zu sperren, wurde bereits gesperrt und verborgen. Da Sie das „hidewiki_user“-Recht nicht haben, können Sie die Benutzersperre nicht sehen und nicht bearbeiten.',
...
'movewiki_userpage-warning' => "'''Warnung:''' Sie sind dabei, eine Benutzerseite zu verschieben. Bitte bedenken Sie, dass dadurch nur die Benutzerseite verschoben, '''nicht''' aber der Benutzer umbenannt wird.",
...
'cant-move-wiki_user-page' => 'Sie haben nicht die erforderliche Berechtigung, Benutzerhauptseiten verschieben zu können.',
'cant-move-to-wiki_user-page' => 'Sie haben nicht die Berechtigung, Seiten auf eine Benutzerseite zu verschieben (mit Ausnahme von Benutzerunterseiten).',
...
'tooltip-pt-wiki_userpage' => 'Ihre Benutzerseite',
'tooltip-pt-anonwiki_userpage' => 'Benutzerseite der IP-Adresse, von der aus Sie Änderungen durchführen',
