...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Активные_участники' ),
	...
	'Emailwiki_user'                 => array( 'Письмо_участнику', 'Отправить_письмо' ),
	...
	'Listwiki_users'                 => array( 'Список_участников' ),
	...
	'wiki_userlogin'                 => array( 'Вход' ),
	'wiki_userlogout'                => array( 'Завершение_сеанса', 'Выход' ),
	'wiki_userrights'                => array( 'Управление_правами' ),
...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'КОЛИЧЕСТВО_УЧАСТНИКОВ', 'NUMBEROFUSERS' ),
	'numberofactivewiki_users'       => array( '1', 'КОЛИЧЕСТВО_АКТИВНЫХ_УЧАСТНИКОВ', 'NUMBEROFACTIVEUSERS' ),
	...
	'revisionwiki_user'              => array( '1', 'ВЕРСИЯ_УЧАСТНИКА', 'REVISIONUSER' ),
...
'tog-enotifwiki_usertalkpages' => 'Уведомлять по эл. почте об изменении персональной страницы обсуждения',
...
'views' => 'Просмотры',
'toolbox' => 'Инструменты',
'wiki_userpage' => 'Просмотреть страницу участника',
...
'youhavenewmessagesfromwiki_users' => 'Вы получили $1 от {{PLURAL:$3|$3 участника|$3 участников|$3 участников}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Вы получили $1 от множества пользователей ($2).',
...
Пожалуйста, сообщите об этом одному из [[Special:Listwiki_users/sysop|администраторов]], указав данный URL.',
...
Вы можете продолжить участие в {{grammar:genitive|{{SITENAME}}}} анонимно или [[Special:wiki_userLogin|представиться заново]] под тем же или другим именем.
...
'wiki_userlogin' => 'Представиться или зарегистрироваться',
'wiki_userloginnocreate' => 'Представиться',
'logout' => 'Завершение сеанса',
'wiki_userlogout' => 'Завершение сеанса',
...
'wiki_userlogin-resetlink' => 'Забыли данные для входа?',
'createaccountmail' => 'Выслать пароль по эл. почте',
'createaccountreason' => 'Причина:',
'badretype' => 'Введённые вами пароли не совпадают.',
'wiki_userexists' => 'Введённое имя участника уже используется.
...
'nosuchwiki_user' => 'Участника с именем «$1» не существует.
Имена участников чувствительны к регистру букв.
Проверьте правильность написания имени или [[Special:wiki_userLogin/signup|создайте новую учётную запись]].',
'nosuchwiki_usershort' => 'Не существует участника с именем «$1». Проверьте написание имени.',
'nowiki_userspecified' => 'Вы должны указать имя участника.',
'login-wiki_userblocked' => 'Этот участник заблокирован. Вход в систему не разрешён.',
...
'wiki_usernamehasherror' => 'Имя участника не может содержать символ «решётки»',
...
'suspicious-wiki_userlogout' => 'Ваш запрос на завершение сеанса отклонён, так как он похож на запрос, отправленный некорректным браузером или кэширующим прокси.',

# E-mail sending
'php-mail-error-unknown' => 'Неизвестная ошибка в PHP-функции mail()',
'wiki_user-mail-no-addy' => 'Пытался отправить электронное письмо без адреса электронной почты',
...
'passwordreset-wiki_username' => 'Имя участника:',
...
'passwordreset-emailtext-wiki_user' => 'Участник $1 из проекта {{SITENAME}} запросил напоминание о вашей
учётной записи в проекте {{SITENAME}} ($4).
{{PLURAL:$3|Следующая учётная запись связана|Следующие учётные записи связаны}} с этим адресом электронной почты:
...
'accmailtext' => "Сгенерированный случайным образом пароль для [[wiki_user talk:$1|$1]] выслан на адрес $2.
...
Если вы анонимный участник и полагаете, что получили сообщения, адресованные не вам, пожалуйста, [[Special:wiki_userLogin/signup|создайте учётную запись]] или [[Special:wiki_userLogin|представьтесь системе]], чтобы впредь избежать возможной путаницы с другими анонимными участниками.''",
...
'wiki_userpage-wiki_userdoesnotexist' => 'Учётной записи «<nowiki>$1</nowiki>» не существует. Убедитесь, что вы действительно желаете создать или изменить эту страницу.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Не зарегистрировано учётной записи «$1».',
...
'wiki_usercssyoucanpreview' => "'''Подсказка.''' Нажмите кнопку «{{int:showpreview}}», чтобы проверить свой новый CSS-файл перед сохранением.",
'wiki_userjsyoucanpreview' => "'''Подсказка.''' Нажмите кнопку «{{int:showpreview}}», чтобы проверить свой новый JS-файл перед сохранением.",
'wiki_usercsspreview' => "'''Помните, что это только предварительный просмотр вашего CSS-файла, он ещё не сохранён!'''",
'wiki_userjspreview' => "'''Помните, что это только предварительный просмотр вашего javascript-файла, он ещё не сохранён!'''",
...
'''Он ещё не сохранён!'''",
'wiki_userinvalidcssjstitle' => "'''Внимание:''' тема оформления «$1» не найдена. Помните, что пользовательские страницы .css и .js должны иметь название, состоящее только из строчных букв, например «{{ns:wiki_user}}:Некто/vector.css», а не «{{ns:wiki_user}}:Некто/Vector.css».",
'updated' => '(Обновлена)',
'note' => "'''Примечание:'''",
...
Если эта ошибка повторится, попробуйте [[Special:wiki_userLogout|завершить сеанс]] и заново представиться системе.'''",
...
Если не получается повторная правка, попробуйте [[Special:wiki_userLogout|завершить сеанс]] работы и заново представиться.'''",
...
Вы можете вернуться назад и отредактировать существующую страницу, [[Special:wiki_userLogin|представиться системе или создать новую учётную запись]].',
...
'undo-summary' => 'Отмена правки $1, сделанной {{GENDER:$2|участником|участницей}} [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|обс.]])',

# Account creation failure
'cantcreateaccounttitle' => 'Невозможно создать учётную запись',
'cantcreateaccount-text' => "Создание учётных записей с этого IP-адреса ('''$1''') было заблокировано {{GENDER:$3|участником|участницей|}} [[wiki_user:$3|$3]].
...
'rev-deleted-wiki_user' => '(имя автора стёрто)',
'rev-deleted-event' => '(запись удалена)',
'rev-deleted-wiki_user-contribs' => '[имя участника или IP-адрес удалены — правка скрыта со страницы вклада]',
...
'revdelete-hide-wiki_user' => 'Скрыть имя автора',
...
'diff-multi-manywiki_users' => '(не {{PLURAL:$1|показана $1 промежуточная версия|показаны $1 промежуточные версии|показаны $1 промежуточных версий}}, сделанные более чем $2 {{PLURAL:$2|участником|участниками}})',
...
'prefsnologintext' => 'Вы должны <span class="plainlinks">[{{fullurl:{{#Special:wiki_userLogin}}|returnto=$1}} представиться системе]</span>, чтобы изменять настройки участника.',
...
'prefs-wiki_user-pages' => 'Страницы участника',
...
'wiki_username' => 'Имя учётной записи:',
...
# wiki_user rights
'wiki_userrights' => 'Управление правами участника',
'wiki_userrights-lookup-wiki_user' => 'Управление группами участников',
'wiki_userrights-wiki_user-editname' => 'Введите имя учётной записи:',
'editwiki_usergroup' => 'Изменить членство в группах',
'editingwiki_user' => "Изменение прав {{GENDER:$1|участника|участницы}} '''[[wiki_user:$1|$1]]''' $2",
'wiki_userrights-editwiki_usergroup' => 'Изменение членства в группах',
'savewiki_usergroups' => 'Сохранить группы участника',
'wiki_userrights-groupsmember' => 'Состоит в группах:',
'wiki_userrights-groupsmember-auto' => 'Неявно состоит в группах:',
'wiki_userrights-groups-help' => 'Вы можете изменить группы, в которые входит этот участник.
...
'wiki_userrights-no-interwiki' => 'У вас нет разрешения изменять права участников на других вики.',
'wiki_userrights-nodatabase' => 'База данных $1 не существует или не является локальной.',
'wiki_userrights-nologin' => 'Вы должны [[Special:wiki_userLogin|представиться системе]] с учётной записи администратора, чтобы присваивать права участникам.',
'wiki_userrights-notallowed' => 'С вашей учётной записи не разрешено добавлять и удалять права участников.',
'wiki_userrights-changeable-col' => 'Группы, которые вы можете изменять',
'wiki_userrights-unchangeable-col' => 'Группы, которые вы не можете изменять',

# Groups
'group' => 'Группа:',
'group-wiki_user' => 'Участники',
...
'group-wiki_user-member' => '{{GENDER:$1|участник|участница}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Участники',
...
'right-move-rootwiki_userpages' => 'переименование корневых страниц участников',
...
'right-hidewiki_user' => 'запрет имени участника и его сокрытие',
...
'right-editwiki_usercssjs' => 'правка CSS- и JS-файлов других участников',
'right-editwiki_usercss' => 'правка CSS-файлов других участников',
'right-editwiki_userjs' => 'правка JavaScript-файлов других участников',
...
'right-wiki_userrights' => 'изменение всех прав участников',
'right-wiki_userrights-interwiki' => 'изменение прав участников на других вики-сайтах',
...
'action-move-rootwiki_userpages' => 'переименование корневых страниц участников',
...
'action-wiki_userrights' => 'изменение всех прав участника',
'action-wiki_userrights-interwiki' => 'изменение прав участников в других вики',
...
'boteditletter' => 'б',
'unpatrolledletter' => '!',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|наблюдающий участник|наблюдающих участника|наблюдающих участников}}]',
...
'uploadnologintext' => 'Вы должны [[Special:wiki_userLogin|представиться системе]],
...
Пожалуйста, обратитесь к [[Special:Listwiki_users/sysop|администратору]].',
...
'statistics-header-wiki_users' => 'Статистика по участникам',
...
'statistics-wiki_users' => 'Зарегистрированные [[Special:Listwiki_users|участники]]',
'statistics-wiki_users-active' => 'Активные участники',
'statistics-wiki_users-active-desc' => 'Участники, совершившие какое-либо действие за {{PLURAL:$1|последний $1 день|последние $1 дня|последние $1 дней}}',
...
'listwiki_users' => 'Список участников',
'listwiki_users-editsonly' => 'Показать только тех участников, кто сделал хотя бы одну правку',
'listwiki_users-creationsort' => 'Упорядочить по дате создания',
'wiki_usereditcount' => '$1 {{PLURAL:$1|правка|правки|правок}}',
'wiki_usercreated' => '{{GENDER:$3|зарегистрировался|зарегистрировалась}} $1 в $2',
'newpages' => 'Новые страницы',
'newpages-wiki_username' => 'Участник:',
...
# Special:Log
'speciallogwiki_userlabel' => 'Исполнитель:',
...
'listwiki_usersfrom' => 'Показать участников, начиная с:',
'listwiki_users-submit' => 'Показать',
'listwiki_users-noresult' => 'Не найдено участников.',
'listwiki_users-blocked' => '(заблокирован{{GENDER:$1||а}})',

# Special:Activewiki_users
'activewiki_users' => 'Список активных участников',
'activewiki_users-intro' => 'Это список участников, совершавших какие-либо действия за {{PLURAL:$1|последний $1 день|последние $1 дня|последние $1 дней}}.',
'activewiki_users-count' => '$1 {{PLURAL:$1|правка|правки|правок}} за {{PLURAL:$3|последний $3 день|последние $3 дня|последние $3 дней}}',
'activewiki_users-from' => 'Показать участников, начиная с:',
'activewiki_users-hidebots' => 'Скрыть ботов',
'activewiki_users-hidesysops' => 'Скрыть администраторов',
'activewiki_users-noresult' => 'Не найдено участников.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Журнал регистрации участников',
'newwiki_userlogpagetext' => 'Список недавно зарегистрировавшихся участников',
...
'mailnologintext' => 'Вы должны [[Special:wiki_userLogin|представиться системе]] и иметь действительный адрес электронной почты в ваших [[Special:Preferences|настройках]], чтобы иметь возможность отправлять электронную почту другим участникам.',
'emailwiki_user' => 'Письмо участнику',
'emailwiki_user-title-target' => 'Написание электронного письма {{GENDER:$1|участнику|участнице}}',
'emailwiki_user-title-notarget' => 'Написание электронного письма участнику',
...
'wiki_usermailererror' => 'При отправке сообщения электронной почты произошла ошибка:',
'defemailsubject' => '{{SITENAME}} — Письмо от $1',
'wiki_usermaildisabled' => 'Электронная почта участника отключена',
'wiki_usermaildisabledtext' => 'Вы не можете отправлять электронные письма другим участникам этой вики',
...
'emailwiki_username' => 'Имя участника:',
'emailwiki_usernamesubmit' => 'Отправить',
...
'emailwiki_userfooter' => 'Это письмо было отправлено {{GENDER:$2|участнику|участнице}} $2 от {{GENDER:$1|участника|участницы}} $1 с помощью функции «Письмо участнику» проекта {{SITENAME}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Оставить системное сообщение.',
'wiki_usermessage-editor' => 'Системная доставка',
...
'watchnologintext' => 'Вы должны [[Special:wiki_userLogin|представиться системе]], чтобы иметь возможность изменять свой список наблюдения',
...
'alreadyrolled' => 'Невозможно откатить последние изменения страницы «[[:$1]]», совершённые [[wiki_user:$2|$2]] ([[wiki_user talk:$2|обсуждение]]{{int:pipe-separator}}[[Special:Contributions/$2|{{int:contribslink}}]]),
поскольку кто-то другой уже успел откатить эти правки или отредактировать страницу.

Последние изменения {{GENDER:$3|внёс|внесла}} [[wiki_user:$3|$3]] ([[wiki_user talk:$3|обсуждение]]{{int:pipe-separator}}[[Special:Contributions/$3|{{int:contribslink}}]]).',
'editcomment' => "Было дано описание изменения: ''$1''.",
'revertpage' => 'Откат правок [[Special:Contributions/$2|$2]] ([[wiki_user talk:$2|обсуждение]]) к версии [[wiki_user:$1|$1]]',
'revertpage-nowiki_user' => 'Правки (имя участника удалено) откачены к версии [[wiki_user:$1|$1]]',
...
'sp-contributions-wiki_userrights' => 'управление правами участника',
...
'sp-contributions-wiki_username' => 'IP-адрес или имя участника:',
...
'ipadressorwiki_username' => 'IP-адрес или имя участника:',
...
'ipbwatchwiki_user' => 'Добавить в список наблюдения личную страницу участника и его страницу обсуждения',
'ipb-disablewiki_usertalk' => 'Запретить этому участнику редактировать свою страницу обсуждения во время блокировки',
...
'ipb-confirmhidewiki_user' => 'Вы намереваетесь заблокировать участника и скрыть его имя. Оно не будет отображаться в списках и журналах. Вы уверены, что хотите это сделать?',
...
'unblocked' => '[[wiki_user:$1|$1]] {{GENDER:$1|разблокирован|разблокирована}}',
...
'blocklist-wiki_userblocks' => 'Скрыть блокировки учётных записей',
...
'blocklist-nowiki_usertalk' => 'не может править свою страницу обсуждения',
...
'autoblocker' => 'Автоблокировка из-за совпадения вашего IP-адреса с адресом, который недавно использовал [[wiki_user:$1|$1]].
...
'block-log-flags-nowiki_usertalk' => 'не может править свою страницу обсуждения',
...
'unblock-hidewiki_user' => 'Вы не можете разблокировать этого участника, так как его имя было скрыто.',
...
'cant-see-hidden-wiki_user' => 'Участник, которого вы пытаетесь заблокировать, уже заблокирован и скрыт. Поскольку у вас нет разрешения на работу по сокрытию участников, вы не можете просмотреть или изменить данную блокировку.',
...
'movewiki_userpage-warning' => "'''Внимание.''' Вы собираетесь переименовать страницу участника. Пожалуйста, обратите внимание, что переименована будет только страница, участник '''не''' будет переименован.",
'movenologin' => 'Вы не представились системе',
'movenologintext' => 'Вы должны [[Special:wiki_userLogin|представиться системе]],
...
'cant-move-wiki_user-page' => 'У вас нет разрешения переименовывать основные страницы участников.',
'cant-move-to-wiki_user-page' => 'У вас нет прав переименовывать страницу в страницу участника (можно переименовать в подстраницу).',
...
'tooltip-pt-wiki_userpage' => 'Ваша страница участника',
'tooltip-pt-anonwiki_userpage' => 'Страница участника для моего IP',
...
'tooltip-t-emailwiki_user' => 'Отправить письмо этому участнику',
...
'tooltip-ca-nstab-wiki_user' => 'Персональная страница участника',
...
'sitewiki_user' => '{{GENDER:$2|участник|участница}} {{grammar:genitive|{{SITENAME}}}} $1',
'anonwiki_user' => 'анонимный участник {{grammar:genitive|{{SITENAME}}}} $1',
...
'others' => 'другие',
'sitewiki_users' => '{{PLURAL:$2|участник|участники}} {{grammar:genitive|{{SITENAME}}}} $1',
'anonwiki_users' => '{{PLURAL:$2|анонимный участник|анонимные участники}} {{grammar:genitive|{{SITENAME}}}} $1',
...
'spambot_wiki_username' => 'Чистка спама',
...
'pageinfo-firstwiki_user' => 'Создатель страницы',
'pageinfo-firsttime' => 'Дата создания страницы',
'pageinfo-lastwiki_user' => 'Последний редактор',
...
'exif-wiki_usercomment' => 'Дополнительный комментарий',
...
'confirmrecreate' => "{{GENDER:$1|Участник&nbsp;|Участница&nbsp;|}}[[wiki_user:$1|$1]] ([[wiki_user talk:$1|обс]]) {{GENDER:$1|удалил|удалила}} эту страницу после того, как вы начали её редактировать, по следующей причине:
: ''$2''.
Пожалуйста, подтвердите, что вы хотите восстановить эту страницу.",
'confirmrecreate-noreason' => '{{GENDER:$1|Участник&nbsp;|Участница&nbsp;|}}[[wiki_user:$1|$1]] ([[wiki_user talk:$1|обс]]) {{GENDER:$1|удалил|удалила}} эту страницу после того, как вы начали её редактировать. Пожалуйста, подтвердите, что вы действительно хотите восстановить эту страницу.',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|обсуждение]])',
...
'specialpages-group-wiki_users' => 'Участники и права',
...
'logentry-newwiki_users-newwiki_users' => 'Создана учётная запись $1',
'logentry-newwiki_users-create' => 'Создана учётная запись $1',
'logentry-newwiki_users-create2' => '$1 {{GENDER:$2|создал|создала}} учётную запись для $3',
'logentry-newwiki_users-autocreate' => 'Автоматически создана учётная запись $1',
'newwiki_userlog-byemail' => 'пароль отправлен по эл. почте',
