...
$magicWords = array(
	...
	'numberofwiki_users'             => array( '1', 'KÄYTTÄJÄMÄÄRÄ', 'NUMBEROFUSERS' ),
...
$specialPageAliases = array(
	'Activewiki_users'               => array( 'Aktiiviset_käyttäjät' ),
	...
	'Emailwiki_user'                 => array( 'Lähetä_sähköpostia' ),
	...
	'Listwiki_users'                 => array( 'Käyttäjät' ),
...
'tog-enotifwiki_usertalkpages' => 'Lähetä sähköpostiviesti oman keskustelusivun muokkauksista',
...
'views' => 'Näkymät',
'toolbox' => 'Työkalut',
'wiki_userpage' => 'Näytä käyttäjäsivu',
...
'youhavenewmessagesfromwiki_users' => 'Sinulle on $1 {{PLURAL:$3|toiselta käyttäjältä|$3 käyttäjältä}} ($2).',
'youhavenewmessagesmanywiki_users' => 'Sinulle on $1 uusia viestejä useilta käyttäjiltä ($2).',
...
'wiki_userlogin' => 'Kirjaudu sisään tai luo tunnus',
'wiki_userloginnocreate' => 'Kirjaudu sisään',
'logout' => 'Kirjaudu ulos',
'wiki_userlogout' => 'Kirjaudu ulos',
...
'wiki_userlogin-resetlink' => 'Unohditko salasanasi?',
'createaccountmail' => 'sähköpostitse',
'createaccountreason' => 'Syy',
'badretype' => 'Syöttämäsi salasanat ovat erilaiset.',
'wiki_userexists' => 'Pyytämäsi käyttäjänimi on jo käytössä. Valitse toinen käyttäjänimi.',
...
'nosuchwiki_user' => 'Käyttäjää ”$1” ei ole olemassa. Nimet ovat kirjainkoosta riippuvaisia. Tarkista kirjoititko nimen oikein, tai [[Special:wiki_userLogin/signup|luo uusi käyttäjätunnus]].',
'nosuchwiki_usershort' => 'Käyttäjää nimeltä ”$1” ei ole. Kirjoititko nimen oikein?',
'nowiki_userspecified' => 'Käyttäjätunnusta ei ole määritelty.',
'login-wiki_userblocked' => 'Tämä käyttäjä on estetty. Kirjautuminen ei ole sallittua.',
...
'wiki_usernamehasherror' => 'Käyttäjätunnus ei voi sisältää tiivistemerkkejä.',
...
'suspicious-wiki_userlogout' => 'Pyyntösi kirjautua ulos evättiin, koska se näytti rikkinäisen selaimen tai välimuistipalvelimen lähettämältä.',

# E-mail sending
'php-mail-error-unknown' => 'Tuntematon virhe PHP:n mail()-funktiossa',
'wiki_user-mail-no-addy' => 'Yritit lähettää sähköpostia ilman sähköpostiosoitetta.',
...
'passwordreset-wiki_username' => 'Käyttäjätunnus',
...
'passwordreset-emailtext-wiki_user' => 'Käyttäjä $1 pyysi muistutusta tunnuksesi tiedoista sivustolla {{SITENAME}} ($4).
{{PLURAL:$3|Seuraava käyttäjätunnus on|Seuraavat käyttäjätunnukset ovat}} liitetty tähän sähköpostiosoitteeseen:
...
'wiki_userpage-wiki_userdoesnotexist' => 'Käyttäjätunnusta <nowiki>$1</nowiki> ei ole rekisteröity. Varmista haluatko muokata tätä sivua.',
'wiki_userpage-wiki_userdoesnotexist-view' => 'Käyttäjätunnusta ”$1” ei ole rekisteröity.',
...
'wiki_usercssyoucanpreview' => 'Voit testata uutta CSS:ää ennen tallennusta käyttämällä painiketta ”{{int:showpreview}}”.',
'wiki_userjsyoucanpreview' => 'Voit testata uutta JavaScriptiä ennen tallennusta käyttämällä painiketta ”{{int:showpreview}}”.',
'wiki_usercsspreview' => "'''Tämä on CSS:n esikatselu. Muutoksia ei ole vielä tallennettu.'''",
'wiki_userjspreview' => "'''Tämä on JavaScriptin esikatselu.'''",
...
'''Muutoksia ei ole vielä tallennettu.'''",
'wiki_userinvalidcssjstitle' => "'''Varoitus:''' Tyyliä nimeltä ”$1” ei ole olemassa. Muista, että käyttäjän määrittelemät .css- ja .js-sivut alkavat pienellä alkukirjaimella, esim. {{ns:wiki_user}}:Matti Meikäläinen/vector.css eikä {{ns:wiki_user}}:Matti Meikäläinen/Vector.css.",
'updated' => '(Päivitetty)',
'note' => "'''Huomautus:'''",
...
'rev-deleted-wiki_user' => '(käyttäjänimi poistettu)',
'rev-deleted-event' => '(lokitapahtuma poistettu)',
'rev-deleted-wiki_user-contribs' => '[käyttäjätunnus tai IP-osoite poistettu – muokkaus on piilotettu muokkausluettelosta]',
...
'revdelete-hide-wiki_user' => 'Piilota tekijän tunnus tai IP-osoite',
...
'diff-multi-manywiki_users' => '(Versioiden välissä on {{PLURAL:$1|yksi muu muokkaus|$1 muuta muokkausta, jotka on tehnyt {{PLURAL:$2|yksi käyttäjä|yli $2 eri käyttäjää}}}}.)',
...
'prefs-wiki_user-pages' => 'Käyttäjäsivut',
...
# wiki_user rights
'wiki_userrights' => 'Käyttöoikeuksien hallinta',
'wiki_userrights-lookup-wiki_user' => 'Käyttöoikeuksien hallinta',
'wiki_userrights-wiki_user-editname' => 'Käyttäjätunnus',
'editwiki_usergroup' => 'Muokkaa käyttäjän ryhmiä',
'editingwiki_user' => "Käyttäjän '''[[wiki_user:$1|$1]]''' oikeudet $2",
'wiki_userrights-editwiki_usergroup' => 'Käyttäjän ryhmät',
'savewiki_usergroups' => 'Tallenna',
'wiki_userrights-groupsmember' => 'Käyttäjä on jäsenenä ryhmissä',
'wiki_userrights-groupsmember-auto' => 'Virtuaaliset ryhmät:',
'wiki_userrights-groups-help' => 'Voit muuttaa ryhmiä, joissa tämä käyttäjä on.
* Merkattu valintaruutu tarkoittaa, että käyttäjä on kyseisessä ryhmässä.
* Merkkaamaton valintaruutu tarkoittaa, että käyttäjä ei ole kyseisessä ryhmässä.
* <nowiki>*</nowiki> tarkoittaa, että et pysty kumoamaan kyseistä operaatiota.',
'wiki_userrights-reason' => 'Syy',
'wiki_userrights-no-interwiki' => 'Sinulla ei ole lupaa muokata käyttöoikeuksia muissa wikeissä.',
'wiki_userrights-nodatabase' => 'Tietokantaa $1 ei ole tai se ei ole paikallinen.',
'wiki_userrights-nologin' => 'Sinun täytyy [[Special:wiki_userLogin|kirjautua sisään]] ylläpitäjätunnuksella, jotta voisit muuttaa käyttöoikeuksia.',
'wiki_userrights-notallowed' => 'Tunnuksellasi ei ole lupaa lisätä tai poistaa käyttöoikeuksia.',
'wiki_userrights-changeable-col' => 'Ryhmät, joita voit muuttaa',
'wiki_userrights-unchangeable-col' => 'Ryhmät, joita et voi muuttaa',

# Groups
'group' => 'Ryhmä',
'group-wiki_user' => 'käyttäjät',
...
'group-wiki_user-member' => '{{GENDER:$1|käyttäjä}}',
...
'grouppage-wiki_user' => '{{ns:project}}:Käyttäjät',
...
'right-move-rootwiki_userpages' => 'Siirtää käyttäjäsivuja',
...
'right-hidewiki_user' => 'Estää käyttäjätunnus ja piilottaa se näkyvistä',
...
'right-editwiki_usercssjs' => 'Muokata toisten käyttäjien CSS- ja JavaScript-tiedostoja',
'right-editwiki_usercss' => 'Muokata toisten käyttäjien CSS-tiedostoja',
'right-editwiki_userjs' => 'Muokata toisten käyttäjien JavaScript-tiedostoja',
...
'right-wiki_userrights' => 'Muuttaa kaikkia käyttäjäoikeuksia',
'right-wiki_userrights-interwiki' => 'Muokata käyttäjien oikeuksia muissa wikeissä',
...
'action-move-rootwiki_userpages' => 'siirtää käyttäjäsivuja',
...
'action-wiki_userrights' => 'muokata kaikkia käyttöoikeuksia',
'action-wiki_userrights-interwiki' => 'muokata muiden wikien käyttäjien käyttöoikeuksia',
...
'newpageletter' => 'U',
'boteditletter' => 'b',
'number_of_watching_wiki_users_pageview' => '[$1 {{PLURAL:$1|tarkkaileva käyttäjä|tarkkailevaa käyttäjää}}]',
...
'listfiles_name' => 'Nimi',
'listfiles_wiki_user' => 'Tallentaja',
'listfiles_size' => 'Koko',
...
'statistics-header-wiki_users' => 'Käyttäjätilastot',
...
'statistics-wiki_users' => 'Rekisteröityneitä [[Special:Listwiki_users|käyttäjiä]]',
'statistics-wiki_users-active' => 'Aktiivisia käyttäjiä',
'statistics-wiki_users-active-desc' => 'Käyttäjät, jotka ovat suorittaneet jonkin toiminnon {{PLURAL:$1|edellisen päivän|edellisten $1 päivän}} aikana.',
...
'listwiki_users' => 'Käyttäjälista',
'listwiki_users-editsonly' => 'Näytä vain käyttäjät, joilla on muokkauksia',
'listwiki_users-creationsort' => 'Lajittele tunnuksen luontipäivämäärän mukaan',
'wiki_usereditcount' => '$1 {{PLURAL:$1|muokkaus|muokkausta}}',
'wiki_usercreated' => '{{GENDER:$3|Luotu}} $1 kello $2',
'newpages' => 'Uudet sivut',
'newpages-wiki_username' => 'Käyttäjätunnus',
...
# Special:Log
'speciallogwiki_userlabel' => 'Käyttäjä',
...
'listwiki_usersfrom' => 'Katkaisuhaku',
'listwiki_users-submit' => 'Hae',
'listwiki_users-noresult' => 'Käyttäjiä ei löytynyt.',
'listwiki_users-blocked' => '(estetty)',

# Special:Activewiki_users
'activewiki_users' => 'Aktiivisten käyttäjien lista',
'activewiki_users-intro' => 'Tämä on luettelo käyttäjistä, jotka ovat tehneet jotain viimeisen $1 {{PLURAL:$1|päivän}} sisällä.',
'activewiki_users-count' => '$1 {{PLURAL:$1|toiminto|toimintoa}} viimeisen {{PLURAL:$3|päivän|$3 päivän}} aikana',
'activewiki_users-from' => 'Näytä käyttäjät alkaen',
'activewiki_users-hidebots' => 'Piilota botit',
'activewiki_users-hidesysops' => 'Piilota ylläpitäjät',
'activewiki_users-noresult' => 'Käyttäjiä ei löytynyt.',

# Special:Log/newwiki_users
'newwiki_userlogpage' => 'Uudet käyttäjät',
'newwiki_userlogpagetext' => 'Tämä on loki luoduista käyttäjätunnuksista.',
...
'emailwiki_user' => 'Lähetä sähköpostia tälle käyttäjälle',
'emailwiki_user-title-target' => 'Lähetä sähköpostia tälle {{GENDER:$1|käyttäjälle}}',
'emailwiki_user-title-notarget' => 'Lähetä sähköpostia käyttäjälle',
...
'wiki_usermailererror' => 'Postitus palautti virheen:',
'defemailsubject' => 'Sähköpostia käyttäjältä $1 sivustolta {{SITENAME}}',
'wiki_usermaildisabled' => 'Käyttäjien sähköposti poistettu käytöstä',
'wiki_usermaildisabledtext' => 'Et voi lähettää sähköpostia muille käyttäjille tässä wikissä',
...
'emailwiki_username' => 'Käyttäjätunnus',
'emailwiki_usernamesubmit' => 'Hae lomake',
...
'emailwiki_userfooter' => 'Tämän sähköpostin lähetti $1 käyttäjälle $2 käyttämällä ”Lähetä sähköpostia” -toimintoa {{GRAMMAR:inessive|{{SITENAME}}}}.',

# wiki_user Messenger
'wiki_usermessage-summary' => 'Jätetään järjestelmäviesti.',
'wiki_usermessage-editor' => 'Järjestelmäviestittäjä',
...
'revertpage-nowiki_user' => 'Käyttäjän (käyttäjänimi poistettu) muokkaukset kumottiin ja sivu palautettiin viimeisimpään käyttäjän [[wiki_user:$1|$1]] tekemään versioon.',
...
'sp-contributions-wiki_userrights' => 'käyttöoikeuksien hallinta',
...
'sp-contributions-wiki_username' => 'IP-osoite tai käyttäjätunnus',
...
'ipadressorwiki_username' => 'IP-osoite tai käyttäjätunnus',
'ipbexpiry' => 'Kesto',
'ipbreason' => 'Syy',
...
'ipbwatchwiki_user' => 'Tarkkaile tämän käyttäjän käyttäjä- ja keskustelusivua',
'ipb-disablewiki_usertalk' => 'Estä käyttäjää muokkaamasta omaa keskustelusivuaan eston aikana',
...
'ipb-confirmhidewiki_user' => 'Olet estämässä käyttäjää ”piilota käyttäjä” -toiminnon kanssa.  Tämä piilottaa käyttäjän nimen kaikissa luetteloissa ja lokitapahtumissa.  Oletko varma, että haluat tehdä näin?',
...
'blocklist-wiki_userblocks' => 'Piilota tunnusten estot',
...
'blocklist-nowiki_usertalk' => 'oman keskustelusivun muokkaaminen estetty',
...
'block-log-flags-nowiki_usertalk' => 'oman keskustelusivun muokkaaminen estetty',
...
'unblock-hidewiki_user' => 'Et voi poistaa estoa tältä käyttäjältä, kun käyttäjänimi on piilotettuna.',
...
'cant-see-hidden-wiki_user' => 'Käyttäjä, jota yrität estää on jo estetty ja piilotettu. Koska sinulla ei ole hidewiki_user-oikeutta, et voi nähdä tai muokata käyttäjän estoa.',
...
'movewiki_userpage-warning' => "'''Varoitus:''' Olet siirtämässä käyttäjäsivua. Huomaa, että vain sivu siirretään ja käyttäjää ''ei'' nimetä uudelleen.",
...
'cant-move-wiki_user-page' => 'Sinulla ei ole lupaa siirtää käyttäjäsivuja (lukuun ottamatta alasivuja).',
'cant-move-to-wiki_user-page' => 'Sinulla ei ole lupaa siirtää sivuja käyttäjäsivuiksi (paitsi alasivuiksi).',
...
'tooltip-pt-anonwiki_userpage' => 'IP-osoitteesi käyttäjäsivu',
...
'tooltip-t-emailwiki_user' => 'Lähetä sähköpostia tälle käyttäjälle',
...
'sitewiki_user' => '{{GRAMMAR:genitive|{{SITENAME}}}} käyttäjä $1',
'anonwiki_user' => '{{GRAMMAR:genitive|{{SITENAME}}}} anonyymi käyttäjä $1',
'lastmodifiedatby' => 'Tätä sivua muokkasi viimeksi $3 $1 kello $2.',
'othercontribs' => 'Perustuu työlle, jonka teki $1.',
'others' => 'muut',
'sitewiki_users' => '{{GRAMMAR:genitive|{{SITENAME}}}} {{PLURAL:$2|käyttäjä|käyttäjät}} $1',
'anonwiki_users' => '{{GRAMMAR:genitive|{{SITENAME}}}} {{PLURAL:$2|anonyymi käyttäjä|anonyymit käyttäjät}} $1',
...
'spambot_wiki_username' => 'MediaWikin mainospoistaja',
...
'pageinfo-firstwiki_user' => 'Sivun luonut',
'pageinfo-firsttime' => 'Sivun luontipäivämäärä',
'pageinfo-lastwiki_user' => 'Viimeisin muokkaaja',
...
'exif-wiki_usercomment' => 'Käyttäjän kommentit',
...
# Signatures
'signature' => '[[{{ns:wiki_user}}:$1|$2]] ([[{{ns:wiki_user_talk}}:$1|keskustelu]])',
...
'specialpages-group-wiki_users' => 'Käyttäjät',
...
'logentry-newwiki_users-newwiki_users' => 'Käyttäjätunnus $1 luotiin',
'logentry-newwiki_users-create' => 'Käyttäjätunnus $1 luotiin',
'logentry-newwiki_users-create2' => '$1 loi käyttäjätunnuksen $3',
'logentry-newwiki_users-autocreate' => 'Käyttäjätunnus $1 luotiin automaattisesti',
'newwiki_userlog-byemail' => 'salasana lähetetty sähköpostitse',
