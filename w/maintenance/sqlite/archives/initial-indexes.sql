...
DROP TABLE IF EXISTS /*_*/wiki_user_tmp;
DROP TABLE IF EXISTS /*_*/wiki_user_groups_tmp;
...
CREATE UNIQUE INDEX /*i*/wiki_user_name ON /*_*/wiki_user_tmp (wiki_user_name);
CREATE INDEX /*i*/wiki_user_email_token ON /*_*/wiki_user_tmp (wiki_user_email_token);
...
CREATE UNIQUE INDEX /*i*/ug_wiki_user_group ON /*_*/wiki_user_groups_tmp (ug_wiki_user,ug_group);
CREATE INDEX /*i*/ug_group ON /*_*/wiki_user_groups_tmp (ug_group);
...
CREATE INDEX /*i*/wiki_user_timestamp ON /*_*/revision_tmp (rev_wiki_user,rev_timestamp);
CREATE INDEX /*i*/wiki_usertext_timestamp ON /*_*/revision_tmp (rev_wiki_user_text,rev_timestamp);
...
CREATE UNIQUE INDEX /*i*/ipb_address ON /*_*/ipblocks_tmp (ipb_address(255), ipb_wiki_user, ipb_auto, ipb_anon_only);
CREATE INDEX /*i*/ipb_wiki_user ON /*_*/ipblocks_tmp (ipb_wiki_user);
...
CREATE UNIQUE INDEX /*i*/wl_wiki_user_namespace_title ON /*_*/watchlist_tmp (wl_wiki_user, wl_namespace, wl_title);
...
INSERT OR IGNORE INTO /*_*/wiki_user_tmp SELECT * FROM /*_*/wiki_user;
INSERT OR IGNORE INTO /*_*/wiki_user_groups_tmp SELECT * FROM /*_*/wiki_user_groups;
