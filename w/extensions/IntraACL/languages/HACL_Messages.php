...
$messages['en'] = array(
    ...
    'hacl_unknown_wiki_user'                 => 'The wiki_user "$1" is unknown.',
    ...
    'hacl_group_must_have_members'      => 'A group must have at least one member (group or wiki_user).',
    'hacl_group_must_have_managers'     => 'A group must have at least one manager (group or wiki_user).',
    ...
    'hacl_right_must_have_managers'     => 'A right or security descriptor must have at least one manager (group or wiki_user).',
    ...
    'hacl_assigned_wiki_user'                => 'Assigned wiki_users: ',
    'hacl_assigned_groups'              => 'Assigned groups:',
    'hacl_wiki_user_member'                  => 'wiki_users who are member of this group:',
    ...
    'hacl_all_wiki_users'                    => 'all wiki_users',
    'hacl_registered_wiki_users'             => 'registered wiki_users',
...
If you want to protect some pages, ACL page must be named as one of: ACL:Page/*, ACL:Category/*, ACL:Namespace/*, ACL:Right/*.',
    ...
    // ACL Editor
    'hacl_autocomplete_no_wiki_users'        => 'No wiki_users found',
    ...
    'hacl_indirect_grant_all'           => 'all wiki_users right',
    'hacl_indirect_grant_reg'           => 'all registered wiki_users right',
    ...
    'hacl_edit_define_manager'          => 'If ACL does not include any manage rights, it can only be modified by administrators and wiki_users who have the right through namespace or category right.',
    ...
    'hacl_start_typing_wiki_user'            => 'Start typing to display wiki_user list...',
    'hacl_start_typing_group'           => 'Start typing to display group list...',
    'hacl_edit_wiki_users_affected'          => 'wiki_users affected:',
    'hacl_edit_groups_affected'         => 'Groups affected:',
    'hacl_edit_no_wiki_users_affected'       => 'No wiki_users affected.',
    'hacl_edit_no_groups_affected'      => 'No groups affected.',
    'hacl_edit_goto_group'              => 'Go to group $1 definition',

    'hacl_edit_wiki_user'                    => 'wiki_user',
    'hacl_edit_group'                   => 'Group',
    'hacl_edit_all'                     => 'All wiki_users',
    'hacl_edit_reg'                     => 'Registered wiki_users',
    ...
    'hacl_grp_member_all'               => 'All wiki_users',
    'hacl_grp_member_reg'               => 'All registered wiki_users',
    'hacl_grp_members'                  => 'Group members:',
    'hacl_grp_managers'                 => 'Group managers:',
    'hacl_grp_wiki_users'                    => 'wiki_users:',
    ...
    'hacl_no_member_wiki_user'               => 'No member wiki_users by now.',
    'hacl_no_member_group'              => 'No member groups by now.',
    'hacl_no_manager_wiki_user'              => 'No manager wiki_users by now.',
    'hacl_no_manager_group'             => 'No manager groups by now.',
    'hacl_current_member_wiki_user'          => 'Member wiki_users:',
    'hacl_current_member_group'         => 'Member groups:',
    'hacl_current_manager_wiki_user'         => 'Manager wiki_users:',
    'hacl_current_manager_group'        => 'Manager groups:',
    'hacl_regexp_wiki_user'                  => '',
...
$messages['ru'] = array(
    ...
    // General
    'hacl_unknown_wiki_user'                 => 'Пользователя "$1" не существует.',
    ...
    'hacl_assigned_wiki_user'                => 'Пользователи:',
    'hacl_assigned_groups'              => 'Группы:',
    'hacl_wiki_user_member'                  => 'Эти пользователи входят в группу:',
    ...
    'hacl_all_wiki_users'                    => 'все пользователи',
    'hacl_registered_wiki_users'             => 'зарегистрированные пользователи',
...
Если вы хотите что-то защитить, создавайте статьи с именами: ACL:Page/*, ACL:Category/*, ACL:Namespace/*, ACL:Right/*.',
    ...
    // ACL Editor
    'hacl_autocomplete_no_wiki_users'        => 'Пользователи не найдены',
    ...
    'hacl_start_typing_wiki_user'            => 'Начните ввод для подсказки пользователя...',
    'hacl_start_typing_group'           => 'Начните ввод для подсказки группы...',
    'hacl_edit_wiki_users_affected'          => 'Затронутые пользователи:',
    'hacl_edit_groups_affected'         => 'Затронутые группы:',
    'hacl_edit_no_wiki_users_affected'       => 'Нет затронутых пользователей.',
    'hacl_edit_no_groups_affected'      => 'Нет затронутых групп.',
    'hacl_edit_goto_group'              => 'Просмотреть группу $1',

    'hacl_edit_wiki_user'                    => 'Пользователь',
    ...
    'hacl_grp_wiki_users'                    => 'Пользователи:',
    ...
    'hacl_no_member_wiki_user'               => 'В группу не входит ни один пользователь.',
    'hacl_no_member_group'              => 'В группу не входит ни одна другая группа.',
    'hacl_no_manager_wiki_user'              => 'Править группу не может ни один пользователь.',
    'hacl_no_manager_group'             => 'Править группу не могут члены ни одной другой группы.',
    'hacl_current_member_wiki_user'          => 'Пользователи, входящие в группу:',
    'hacl_current_member_group'         => 'Группы, входящие в группу:',
    'hacl_current_manager_wiki_user'         => 'Эти пользователи могут править группу:',
    'hacl_current_manager_group'        => 'Члены этих групп могут править группу:',
    'hacl_regexp_wiki_user'                  => '(^|,\s*)Участник:',
...
$messages['de'] = array(
 ...
 // General
    ...
    'hacl_special_page'                   => 'IntraACL',  // Name of the special page for administration
    'specialpages-group-hacl_group'       => 'IntraACL',
    'hacl_unknown_wiki_user'                   => 'Der Benutzer "$1" ist unbekannt.',
    ...
    'hacl_assigned_wiki_user'                  => 'Zugewiesene Benutzer: ',
    'hacl_assigned_groups'                => 'Zugewiesene Gruppen:',
    'hacl_wiki_user_member'                    => 'Benutzer, die Mitglied dieser Gruppe sind:',
    ...
    'hacl_all_wiki_users'                      => 'alle Benutzer',
    'hacl_registered_wiki_users'               => 'registrierte Benutzer',
    ...
    // ACL Editor
    'hacl_autocomplete_no_wiki_users'        => 'Keine Benutzer gefunden',
    ...
    'hacl_no_member_wiki_user'               => 'Keine Benutzer definiert.',
    'hacl_no_member_group'              => 'Keine Gruppen definiert.',
    'hacl_no_manager_wiki_user'              => 'Keine Verwaltungsbenutzer definiert.',
    'hacl_no_manager_group'             => 'Keine Verwaltungsgruppen definiert.',
    'hacl_current_member_wiki_user'          => 'Benutzer enthalten:',
    'hacl_current_member_group'         => 'Gruppen enthalten:',
    'hacl_current_manager_wiki_user'         => 'Verwaltungsbenutzer:',
