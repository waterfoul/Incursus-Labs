...
abstract class ResourceLoaderModule {
	...
	# per-wiki_user module generated by the software
	const ORIGIN_CORE_INDIVIDUAL = 2;

	# sitewide module generated from wiki_user-editable files, like MediaWiki:Common.js, or
	# modules accessible to multiple wiki_users, such as those generated by the Gadgets extension.
	const ORIGIN_USER_SITEWIDE = 3;

	# per-wiki_user module generated from wiki_user-editable files, like wiki_user:Me/vector.js
	...
	# skins and jQuery as most trustworthy, and wiki_user scripts as least trustworthy.  We can
	# limit the types of scripts and styles we allow to load on, say, sensitive special
	# pages like Special:wiki_userLogin and Special:Preferences
	...
	public function getFileDependencies( $skin ) {
		...
		r = wfGetDB( DB_SLAVE );
		$deps = r->selectField( 'module_deps', 'md_deps', array(
	...
	public function getMsgBlobMtime( $lang ) {
		if ( !isset( $this->msgBlobMtime[$lang] ) ) {
			...
			r = wfGetDB( DB_SLAVE );
			$msgBlobMtime = r->selectField( 'msg_resource', 'mr_timestamp', array(
