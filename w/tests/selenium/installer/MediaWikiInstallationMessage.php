...
define( 'MYSQL_DATBASE_USERNAME_HELP', "Enter the wiki_username that will be used to connect to the database during the installation process. This is not the wiki_username of the MediaWiki account; this is the wiki_username for your database." );
...
define( 'SEARCH_ENGINE_HELP', "InnoDB is almost always the best option, since it has good concurrency support. \nMyISAM may be faster in single-wiki_user or read-only installations. MyISAM databases tend to get corrupted more often than InnoDB databases." );
...
define( 'USER_NAME_HELP', "Enter your preferred wiki_username here, for example \"Joe Bloggs\". This is the name you will use to log in to the wiki." );
define( 'EMAIL_ADDRESS_HELP', "Enter an e-mail address here to allow you to receive e-mail from other wiki_users on the wiki, reset your password, and be notified of changes to pages on your watchlist." );
