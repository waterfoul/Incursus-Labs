...
<div><div class="tbl-h-l"><div class="tbl-h-r"><div class="tbl-h-c"><div class="tbl-title"><?php echo ((isset($this->_rootref['L_UCP'])) ? $this->_rootref['L_UCP'] : ((isset($user->lang['UCP'])) ? $user->lang['UCP'] : '{ UCP }')); ?></div></div></div></div>
<table class="tablebg" width="100%" cellpadding="0" cellspacing="0">
<tr><th colspan="3"><?php echo ((isset($this->_rootref['L_IMPORTANT_NEWS'])) ? $this->_rootref['L_IMPORTANT_NEWS'] : ((isset($user->lang['IMPORTANT_NEWS'])) ? $user->lang['IMPORTANT_NEWS'] : '{ IMPORTANT_NEWS }')); ?></th></tr>
<tr><td class="row1" colspan="3" align="center"><p class="genmed"><?php echo ((isset($this->_rootref['L_UCP_WELCOME'])) ? $this->_rootref['L_UCP_WELCOME'] : ((isset($user->lang['UCP_WELCOME'])) ? $user->lang['UCP_WELCOME'] : '{ UCP_WELCOME }')); ?></p></td></tr>
...
<?php }} else { ?>
	...
	<tr class="row1"><td align="center" colspan="3"><b class="gen"><?php echo ((isset($this->_rootref['L_NO_IMPORTANT_NEWS'])) ? $this->_rootref['L_NO_IMPORTANT_NEWS'] : ((isset($user->lang['NO_IMPORTANT_NEWS'])) ? $user->lang['NO_IMPORTANT_NEWS'] : '{ NO_IMPORTANT_NEWS }')); ?></b></td></tr>
<?php } ?>


<tr><th colspan="3"><?php echo ((isset($this->_rootref['L_YOUR_DETAILS'])) ? $this->_rootref['L_YOUR_DETAILS'] : ((isset($user->lang['YOUR_DETAILS'])) ? $user->lang['YOUR_DETAILS'] : '{ YOUR_DETAILS }')); ?></th></tr>
<tr>
