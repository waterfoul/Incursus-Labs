...
<div><div class="tbl-h-l"><div class="tbl-h-r"><div class="tbl-h-c"><div class="tbl-title"><?php if (! $this->_rootref['S_ADMIN_AUTH']) {  echo ((isset($this->_rootref['L_LOGIN'])) ? $this->_rootref['L_LOGIN'] : ((isset($user->lang['LOGIN'])) ? $user->lang['LOGIN'] : '{ LOGIN }')); } else { echo (isset($this->_rootref['LOGIN_EXPLAIN'])) ? $this->_rootref['LOGIN_EXPLAIN'] : ''; } ?></div></div></div></div>
...
<?php if ($this->_rootref['LOGIN_EXPLAIN'] && ! $this->_rootref['S_ADMIN_AUTH']) {  ?>
	...
	<tr><td class="row3" colspan="2" align="center"><span class="gensmall"><?php echo (isset($this->_rootref['LOGIN_EXPLAIN'])) ? $this->_rootref['LOGIN_EXPLAIN'] : ''; ?></span></td></tr>
<?php } ?>
...
<tr><?php if (! $this->_rootref['S_ADMIN_AUTH'] && $this->_rootref['S_REGISTER_ENABLED']) {  ?>
	...
	<td <?php if (! $this->_rootref['S_ADMIN_AUTH']) {  ?>class="row2"<?php } else { ?>class="row1"<?php } ?>>
		...
		<?php if ($this->_rootref['LOGIN_ERROR']) {  ?>
			...
			<tr><td class="gensmall" colspan="2" align="center"><span class="error"><?php echo (isset($this->_rootref['LOGIN_ERROR'])) ? $this->_rootref['LOGIN_ERROR'] : ''; ?></span></td></tr>
		<?php } ?>
...
<div><div class="tbl-h-l"><div class="tbl-h-r"><div class="tbl-h-c"><div class="tbl-title"><?php if ($this->_rootref['L_LOGIN_CONFIRMATION']) {  echo ((isset($this->_rootref['L_LOGIN_CONFIRMATION'])) ? $this->_rootref['L_LOGIN_CONFIRMATION'] : ((isset($user->lang['LOGIN_CONFIRMATION'])) ? $user->lang['LOGIN_CONFIRMATION'] : '{ LOGIN_CONFIRMATION }')); } else { ?>&nbsp;<?php } ?></div></div></div></div>
<table class="tablebg" width="100%" cellpadding="0" cellspacing="0">
...
<tr><td class="cat-bottom" <?php if (! $this->_rootref['S_ADMIN_AUTH'] || $this->_rootref['S_CONFIRM_CODE']) {  ?>colspan="2"<?php } ?> align="center"><?php echo (isset($this->_rootref['S_HIDDEN_FIELDS'])) ? $this->_rootref['S_HIDDEN_FIELDS'] : ''; ?><input type="submit" name="login" class="btnmain" value="<?php echo ((isset($this->_rootref['L_LOGIN'])) ? $this->_rootref['L_LOGIN'] : ((isset($user->lang['LOGIN'])) ? $user->lang['LOGIN'] : '{ LOGIN }')); ?>" tabindex="5" /></td></tr>
</table>
<div class="tbl-f-l"><div class="tbl-f-r"><div class="tbl-f-c">&nbsp;</div></div></div></div>
